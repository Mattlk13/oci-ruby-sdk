...
module OCI
  ...
  class KeyManagement::Models::HsmCluster
    ...
    # **[Required]** A user-friendly display name for the HSMCluster resource. It does not have to be unique, and it is changeable.
    ...
    # **[Required]** DNS name for the HSM Cluster -- this will contain information about the region as well.
    # @return [String]
