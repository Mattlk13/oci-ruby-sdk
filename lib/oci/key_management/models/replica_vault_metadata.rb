...
module OCI
  ...
  class KeyManagement::Models::ReplicaVaultMetadata
    VAULT_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'vaultType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::KeyManagement::Models::ReplicaExternalVaultMetadata' if type == 'EXTERNAL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::KeyManagement::Models::ReplicaVaultMetadata'
    end
