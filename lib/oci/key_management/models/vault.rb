...
module OCI
  ...
  class KeyManagement::Models::Vault
    ...
    # @return [BOOLEAN]
    attr_accessor :is_vault_replicable
    ...
    # @option attributes [BOOLEAN] :is_vault_replicable The value to assign to the {#is_vault_replicable} property
    ...
    def initialize(attributes = {})
      ...
      self.is_vault_replicable = attributes[:'isVaultReplicable'] unless attributes[:'isVaultReplicable'].nil?

      raise 'You cannot provide both :isVaultReplicable and :is_vault_replicable' if attributes.key?(:'isVaultReplicable') && attributes.key?(:'is_vault_replicable')

      self.is_vault_replicable = attributes[:'is_vault_replicable'] unless attributes[:'is_vault_replicable'].nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_vault_replicable == other.is_vault_replicable &&
    ...
    def hash
      [compartment_id, crypto_endpoint, defined_tags, display_name, freeform_tags, id, lifecycle_state, management_endpoint, time_created, time_of_deletion, vault_type, restored_from_vault_id, wrappingkey_id, replica_details, is_primary, is_vault_replicable, external_key_manager_metadata_summary].hash
    end
