...
require 'date'
require_relative 'replica_vault_metadata'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Metadata of the replica region External Vault
  class KeyManagement::Models::ReplicaExternalVaultMetadata < KeyManagement::Models::ReplicaVaultMetadata
    # **[Required]** OCID of the EKMS private endpoint in the replica region and must be in ACTIVE state
    # @return [String]
    attr_accessor :private_endpoint_id

    # **[Required]** Replica region URL of the IDCS domain
    # @return [String]
    ...
    def hash
      [vault_type, private_endpoint_id, idcs_account_name_url].hash
    end
