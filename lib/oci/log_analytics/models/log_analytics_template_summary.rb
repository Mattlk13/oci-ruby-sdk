...
module OCI
  ...
  #
  class LogAnalytics::Models::LogAnalyticsTemplateSummary
    ...
    def hash
      [id, description, compartment_id, time_created, time_updated, freeform_tags, defined_tags, name, type, is_system, lifecycle_state, facets].hash
    end
