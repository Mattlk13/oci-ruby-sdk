...
module OCI
  ...
  class LogAnalytics::Models::RecalledData
    ...
    # @option attributes [Integer] :percentage_complete The value to assign to the {#percentage_complete} property
    def initialize(attributes = {})
      ...
      self.percentage_complete = attributes[:'percentageComplete'] if attributes[:'percentageComplete']

      raise 'You cannot provide both :percentageComplete and :percentage_complete' if attributes.key?(:'percentageComplete') && attributes.key?(:'percentage_complete')

      self.percentage_complete = attributes[:'percentage_complete'] if attributes[:'percentage_complete']
    end
    ...
    def hash
      [time_data_ended, time_data_started, time_started, status, recall_count, storage_usage_in_bytes, not_recalled_data_in_bytes, purpose, query_string, log_sets, created_by, collection_id, time_recalled_data_started, time_recalled_data_ended, percentage_complete].hash
    end
