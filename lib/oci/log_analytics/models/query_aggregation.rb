...
module OCI
  ...
  class LogAnalytics::Models::QueryAggregation
    ...
    #
    # @return [Integer]
    attr_accessor :total_group_count
    ...
    #
    # @return [Array<OCI::LogAnalytics::Models::RecallDefinition>]
    attr_accessor :recalls
    ...
    # @option attributes [Integer] :total_group_count The value to assign to the {#total_group_count} property
    # @option attributes [OCI::LogAnalytics::Models::TimeRange] :time_filter The value to assign to the {#time_filter} property
    # @option attributes [Array<OCI::LogAnalytics::Models::RecallDefinition>] :recalls The value to assign to the {#recalls} property
    ...
    def initialize(attributes = {})
      ...
      self.total_group_count = attributes[:'totalGroupCount'] if attributes[:'totalGroupCount']

      raise 'You cannot provide both :totalGroupCount and :total_group_count' if attributes.key?(:'totalGroupCount') && attributes.key?(:'total_group_count')

      self.total_group_count = attributes[:'total_group_count'] if attributes[:'total_group_count']
      ...
      self.recalls = attributes[:'recalls'] if attributes[:'recalls']
    ...
    def hash
      [total_count, total_matched_count, total_group_count, time_filter, recalls, are_partial_results, partial_result_reason, is_content_hidden, columns, fields, items, query_execution_time_in_ms, percent_complete].hash
    end
