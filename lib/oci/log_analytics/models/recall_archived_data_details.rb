...
module OCI
  ...
  class LogAnalytics::Models::RecallArchivedDataDetails
    ...
    def hash
      [compartment_id, time_data_ended, time_data_started, data_type, log_sets, query, purpose, is_recall_new_data_only, is_use_recommended_data_set, collection_id].hash
    end
