...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsObjectCollectionRule
    ...
    STREAM_CURSOR_TYPE_ENUM = [
      ...
      STREAM_CURSOR_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @option attributes [String] :stream_cursor_type The value to assign to the {#stream_cursor_type} property
    # @option attributes [DateTime] :stream_cursor_time The value to assign to the {#stream_cursor_time} property
    # @option attributes [String] :last_collected_object The value to assign to the {#last_collected_object} property
    ...
    def initialize(attributes = {})
      ...
      self.last_collected_object = attributes[:'lastCollectedObject'] if attributes[:'lastCollectedObject']

      raise 'You cannot provide both :lastCollectedObject and :last_collected_object' if attributes.key?(:'lastCollectedObject') && attributes.key?(:'last_collected_object')

      self.last_collected_object = attributes[:'last_collected_object'] if attributes[:'last_collected_object']
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] stream_cursor_type Object to be assigned
    def stream_cursor_type=(stream_cursor_type)
      # rubocop:disable Style/ConditionalAssignment
      if stream_cursor_type && !STREAM_CURSOR_TYPE_ENUM.include?(stream_cursor_type)
        OCI.logger.debug("Unknown value for 'stream_cursor_type' [" + stream_cursor_type + "]. Mapping to 'STREAM_CURSOR_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @stream_cursor_type = STREAM_CURSOR_TYPE_UNKNOWN_ENUM_VALUE
      else
        @stream_cursor_type = stream_cursor_type
      end
      # rubocop:enable Style/ConditionalAssignment
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        last_collected_object == other.last_collected_object &&
    ...
    def hash
      [id, name, description, compartment_id, os_namespace, os_bucket_name, collection_type, poll_since, poll_till, log_group_id, log_source_name, entity_id, char_encoding, timezone, log_set, log_set_key, log_set_ext_regex, overrides, lifecycle_state, lifecycle_details, time_created, time_updated, is_enabled, object_name_filters, log_type, is_force_historic_collection, stream_id, stream_cursor_type, stream_cursor_time, last_collected_object, defined_tags, freeform_tags].hash
    end
