...
module OCI
  ...
  class LogAnalytics::Models::StreamAction < LogAnalytics::Models::Action
    ...
    # @return [OCI::LogAnalytics::Models::TemplateDetails]
    attr_accessor :template_details
    ...
    def self.swagger_types
      {
        ...
        'template_details': :'OCI::LogAnalytics::Models::TemplateDetails',
    ...
    # @option attributes [OCI::LogAnalytics::Models::TemplateDetails] :template_details The value to assign to the {#template_details} property
    ...
    def initialize(attributes = {})
      ...
      self.template_details = attributes[:'templateDetails'] if attributes[:'templateDetails']

      raise 'You cannot provide both :templateDetails and :template_details' if attributes.key?(:'templateDetails') && attributes.key?(:'template_details')

      self.template_details = attributes[:'template_details'] if attributes[:'template_details']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        template_details == other.template_details &&
    ...
    def hash
      [type, saved_search_id, template_details, metric_extraction, saved_search_duration].hash
    end
