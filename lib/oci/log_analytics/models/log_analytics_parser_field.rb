...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsParserField
    ...
    #
    # @return [Array<OCI::LogAnalytics::Models::ParserAction>]
    ...
    def self.swagger_types
      {
        ...
        'actions': :'Array<OCI::LogAnalytics::Models::ParserAction>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::ParserAction>] :actions The value to assign to the {#actions} property
    ...
    def hash
      [field, parser_field_id, parser_field_expression, parser_field_name, storage_field_name, parser_field_integrator_name, parser_name, parser_field_sequence, parser, structured_column_info, actions].hash
    end
