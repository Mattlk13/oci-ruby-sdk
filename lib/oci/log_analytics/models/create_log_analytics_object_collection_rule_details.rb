...
module OCI
  ...
  class LogAnalytics::Models::CreateLogAnalyticsObjectCollectionRuleDetails
    ...
    def stream_cursor_type=(stream_cursor_type)
      raise "Invalid value for 'stream_cursor_type': this must be one of the values in STREAM_CURSOR_TYPE_ENUM." if stream_cursor_type && !STREAM_CURSOR_TYPE_ENUM.include?(stream_cursor_type)
    ...
    def hash
      [name, description, compartment_id, os_namespace, os_bucket_name, collection_type, poll_since, poll_till, log_group_id, log_source_name, entity_id, char_encoding, is_enabled, timezone, log_set, log_set_key, log_set_ext_regex, overrides, object_name_filters, log_type, is_force_historic_collection, stream_id, stream_cursor_type, stream_cursor_time, defined_tags, freeform_tags].hash
    end
