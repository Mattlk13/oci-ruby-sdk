...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsEntity
    ...
    #
    # @return [Integer]
    attr_accessor :associated_sources_count
    ...
    def self.swagger_types
      {
        ...
        'associated_sources_count': :'Integer'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Integer] :associated_sources_count The value to assign to the {#associated_sources_count} property
    def initialize(attributes = {})
      ...
      self.associated_sources_count = attributes[:'associatedSourcesCount'] if attributes[:'associatedSourcesCount']

      raise 'You cannot provide both :associatedSourcesCount and :associated_sources_count' if attributes.key?(:'associatedSourcesCount') && attributes.key?(:'associated_sources_count')

      self.associated_sources_count = attributes[:'associated_sources_count'] if attributes[:'associated_sources_count']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        associated_sources_count == other.associated_sources_count
    end
    ...
    def hash
      [id, name, compartment_id, entity_type_name, entity_type_internal_name, lifecycle_state, lifecycle_details, management_agent_id, management_agent_display_name, management_agent_compartment_id, timezone_region, properties, creation_source, time_created, time_updated, time_last_discovered, metadata, are_logs_collected, cloud_resource_id, hostname, source_id, freeform_tags, defined_tags, associated_sources_count].hash
    end
