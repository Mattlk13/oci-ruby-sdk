...
module OCI
  ...
  class LogAnalytics::Models::ParseQueryOutput
    ...
    #
    # @return [Array<OCI::LogAnalytics::Models::VariableDefinition>]
    attr_accessor :variables

    # Optional list of properties for the query.
    #
    # @return [Array<OCI::LogAnalytics::Models::PropertyDefinition>]
    ...
    def self.swagger_types
      {
        ...
        'variables': :'Array<OCI::LogAnalytics::Models::VariableDefinition>',
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::VariableDefinition>] :variables The value to assign to the {#variables} property
    # @option attributes [Array<OCI::LogAnalytics::Models::PropertyDefinition>] :properties The value to assign to the {#properties} property
    ...
    def hash
      [display_query_string, internal_query_string, columns, response_time_in_ms, time_filter, commands, variables, properties].hash
    end
