...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsObjectCollectionRuleSummary
    ...
    def hash
      [id, name, description, compartment_id, os_namespace, os_bucket_name, collection_type, lifecycle_state, lifecycle_details, time_created, time_updated, is_enabled, object_name_filters, log_type, stream_id, defined_tags, freeform_tags].hash
    end
