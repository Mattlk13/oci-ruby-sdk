...
module OCI
  ...
  class LogAnalytics::Models::ModuleCommandDescriptor < LogAnalytics::Models::AbstractCommandDescriptor
    ...
    # @option attributes [Array<OCI::LogAnalytics::Models::VariableDefinition>] :arguments The value to assign to the {#arguments} property
    ...
    def hash
      [name, display_query_string, internal_query_string, category, referenced_fields, declared_fields, is_hidden, description, example, properties, arguments].hash
    end
