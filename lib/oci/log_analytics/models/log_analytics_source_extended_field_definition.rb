...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsSourceExtendedFieldDefinition
    ...
    # @return [OCI::LogAnalytics::Models::GenericConditionBlock]
    ...
    def self.swagger_types
      {
        ...
        'condition_block': :'OCI::LogAnalytics::Models::GenericConditionBlock'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::LogAnalytics::Models::GenericConditionBlock] :condition_block The value to assign to the {#condition_block} property
