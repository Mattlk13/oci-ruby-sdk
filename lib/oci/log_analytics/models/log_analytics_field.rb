...
module OCI
  ...
  class LogAnalytics::Models::LogAnalyticsField
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_keep_duplicates
    ...
    # @option attributes [BOOLEAN] :is_keep_duplicates The value to assign to the {#is_keep_duplicates} property
    def initialize(attributes = {})
      ...
      self.is_keep_duplicates = attributes[:'isKeepDuplicates'] unless attributes[:'isKeepDuplicates'].nil?

      raise 'You cannot provide both :isKeepDuplicates and :is_keep_duplicates' if attributes.key?(:'isKeepDuplicates') && attributes.key?(:'is_keep_duplicates')

      self.is_keep_duplicates = attributes[:'is_keep_duplicates'] unless attributes[:'is_keep_duplicates'].nil?
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_keep_duplicates == other.is_keep_duplicates
    end
