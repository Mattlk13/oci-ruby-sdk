...
module OCI
  ...
  #
  class LogAnalytics::Models::UpdateTableCommandDescriptor < LogAnalytics::Models::AbstractCommandDescriptor
    # **[Required]** Name of the table being updated.
    #
    # @return [String]
