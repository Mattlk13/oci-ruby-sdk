...
module OCI
  ...
  class Core::ComputeClientCompositeOperations
    ...
    # Calls {OCI::Core::ComputeClient#attach_compute_host_group_host} and then waits for the {OCI::Core::Models::ComputeHost} acted upon
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::ComputeHost#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#attach_compute_host_group_host}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Core::Models::ComputeHost}
    def attach_compute_host_group_host_and_wait_for_state(compute_host_id, attach_compute_host_group_host_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.attach_compute_host_group_host(compute_host_id, attach_compute_host_group_host_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_compute_host(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::Core::ComputeClient#change_compute_host_compartment} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] compute_host_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host.
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#change_compute_host_compartment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def change_compute_host_compartment_and_wait_for_state(compute_host_id, change_compute_host_compartment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_compute_host_compartment(compute_host_id, change_compute_host_compartment_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::ComputeClient#change_compute_host_group_compartment} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#change_compute_host_group_compartment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def change_compute_host_group_compartment_and_wait_for_state(compute_host_group_id, change_compute_host_group_compartment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_compute_host_group_compartment(compute_host_group_id, change_compute_host_group_compartment_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::ComputeClient#create_compute_gpu_memory_cluster} and then waits for the {OCI::Core::Models::ComputeGpuMemoryCluster} acted upon
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::ComputeGpuMemoryCluster#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#create_compute_gpu_memory_cluster}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Core::Models::ComputeGpuMemoryCluster}
    def create_compute_gpu_memory_cluster_and_wait_for_state(create_compute_gpu_memory_cluster_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_compute_gpu_memory_cluster(create_compute_gpu_memory_cluster_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_compute_gpu_memory_cluster(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::Core::ComputeClient#create_compute_host_group} and then waits for the {OCI::Core::Models::ComputeHostGroup} acted upon
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::ComputeHostGroup#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#create_compute_host_group}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Core::Models::ComputeHostGroup}
    def create_compute_host_group_and_wait_for_state(create_compute_host_group_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_compute_host_group(create_compute_host_group_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_compute_host_group(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::Core::ComputeClient#delete_compute_gpu_memory_cluster} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] compute_gpu_memory_cluster_id The OCID of the compute GPU memory cluster.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#delete_compute_gpu_memory_cluster}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def delete_compute_gpu_memory_cluster_and_wait_for_state(compute_gpu_memory_cluster_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_compute_gpu_memory_cluster(compute_gpu_memory_cluster_id, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::ComputeClient#delete_compute_host_group} and then waits for the {OCI::Core::Models::ComputeHostGroup} acted upon
    # to enter the given state(s).
    #
    # @param [String] compute_host_group_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host group.
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::ComputeHostGroup#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#delete_compute_host_group}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type nil
    def delete_compute_host_group_and_wait_for_state(compute_host_group_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      initial_get_result = @service_client.get_compute_host_group(compute_host_group_id)
      operation_result = @service_client.delete_compute_host_group(compute_host_group_id, base_operation_opts)
    ...
    # Calls {OCI::Core::ComputeClient#detach_compute_host_group_host} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] compute_host_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host.
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#detach_compute_host_group_host}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def detach_compute_host_group_host_and_wait_for_state(compute_host_id, detach_compute_host_group_host_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.detach_compute_host_group_host(compute_host_id, detach_compute_host_group_host_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::ComputeClient#update_compute_gpu_memory_cluster} and then waits for the {OCI::Core::Models::ComputeGpuMemoryCluster} acted upon
    # to enter the given state(s).
    #
    # @param [String] compute_gpu_memory_cluster_id The OCID of the compute GPU memory cluster.
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::ComputeGpuMemoryCluster#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#update_compute_gpu_memory_cluster}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Core::Models::ComputeGpuMemoryCluster}
    def update_compute_gpu_memory_cluster_and_wait_for_state(compute_gpu_memory_cluster_id, update_compute_gpu_memory_cluster_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_compute_gpu_memory_cluster(compute_gpu_memory_cluster_id, update_compute_gpu_memory_cluster_details, base_operation_opts)
    ...
    # Calls {OCI::Core::ComputeClient#update_compute_gpu_memory_fabric} and then waits for the {OCI::Core::Models::ComputeGpuMemoryFabric} acted upon
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::ComputeGpuMemoryFabric#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#update_compute_gpu_memory_fabric}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Core::Models::ComputeGpuMemoryFabric}
    def update_compute_gpu_memory_fabric_and_wait_for_state(compute_gpu_memory_fabric_id, update_compute_gpu_memory_fabric_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_compute_gpu_memory_fabric(compute_gpu_memory_fabric_id, update_compute_gpu_memory_fabric_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_compute_gpu_memory_fabric(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::Core::ComputeClient#update_compute_host} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] compute_host_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host.
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#update_compute_host}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def update_compute_host_and_wait_for_state(compute_host_id, update_compute_host_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_compute_host(compute_host_id, update_compute_host_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Core::ComputeClient#update_compute_host_group} and then waits for the {OCI::Core::Models::ComputeHostGroup} acted upon
    # to enter the given state(s).
    #
    # @param [String] compute_host_group_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host group.
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::ComputeHostGroup#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#update_compute_host_group}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::Core::Models::ComputeHostGroup}
    def update_compute_host_group_and_wait_for_state(compute_host_group_id, update_compute_host_group_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_compute_host_group(compute_host_group_id, update_compute_host_group_details, base_operation_opts)
    ...
    # Calls {OCI::Core::ComputeClient#update_instance_maintenance_event} and then waits for the {OCI::Core::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Core::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Core::ComputeClient#update_instance_maintenance_event}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Core::Models::WorkRequest}
    def update_instance_maintenance_event_and_wait_for_state(instance_maintenance_event_id, update_instance_maintenance_event_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_instance_maintenance_event(instance_maintenance_event_id, update_instance_maintenance_event_details, base_operation_opts)
      use_util = OCI::Core::Util.respond_to?(:wait_on_work_request)
