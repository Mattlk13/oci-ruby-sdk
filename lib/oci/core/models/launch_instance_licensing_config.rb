...
module OCI
  ...
  class Core::Models::LaunchInstanceLicensingConfig
    TYPE_ENUM = [
      TYPE_WINDOWS = 'WINDOWS'.freeze,
      TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    LICENSE_TYPE_ENUM = [
      LICENSE_TYPE_OCI_PROVIDED = 'OCI_PROVIDED'.freeze,
    ...
    # **[Required]** Operating System type of the Configuration.
    # @return [String]
    attr_reader :type
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Core::Models::LaunchInstanceWindowsLicensingConfig' if type == 'WINDOWS'
    ...
    def initialize(attributes = {})
      ...
      self.license_type = "OCI_PROVIDED" if license_type.nil? && !attributes.key?(:'licenseType') # rubocop:disable Style/StringLiterals
      ...
      self.license_type = "OCI_PROVIDED" if license_type.nil? && !attributes.key?(:'licenseType') && !attributes.key?(:'license_type') # rubocop:disable Style/StringLiterals
    end
