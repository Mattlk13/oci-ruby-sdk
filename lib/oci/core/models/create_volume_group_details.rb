...
module OCI
  ...
  class Core::Models::CreateVolumeGroupDetails
    ...
    def hash
      [availability_domain, backup_policy_id, compartment_id, defined_tags, display_name, freeform_tags, source_details, volume_group_replicas, cluster_placement_group_id, xrc_kms_key_id].hash
    end
