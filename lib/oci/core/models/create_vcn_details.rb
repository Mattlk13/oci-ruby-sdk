...
module OCI
  ...
  class Core::Models::CreateVcnDetails
    ...
    def hash
      [cidr_block, cidr_blocks, compartment_id, ipv6_private_cidr_blocks, is_oracle_gua_allocation_enabled, byoipv6_cidr_details, defined_tags, display_name, dns_label, freeform_tags, security_attributes, is_ipv6_enabled, is_zpr_only].hash
    end
