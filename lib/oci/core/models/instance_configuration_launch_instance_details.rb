...
module OCI
  ...
  class Core::Models::InstanceConfigurationLaunchInstanceDetails
    ...
    def hash
      [availability_domain, capacity_reservation_id, compartment_id, cluster_placement_group_id, create_vnic_details, defined_tags, security_attributes, display_name, extended_metadata, freeform_tags, ipxe_script, metadata, shape, shape_config, platform_config, source_details, fault_domain, dedicated_vm_host_id, launch_mode, launch_options, agent_config, is_pv_encryption_in_transit_enabled, preferred_maintenance_action, instance_options, availability_config, preemptible_instance_config, licensing_configs].hash
    end
