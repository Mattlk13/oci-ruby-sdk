...
module OCI
  ...
  class Core::Models::AttachComputeHostGroupHostDetails
    # **[Required]** 'The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host group.'
    #
    # @return [String]
