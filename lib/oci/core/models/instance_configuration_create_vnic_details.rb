...
module OCI
  ...
  class Core::Models::InstanceConfigurationCreateVnicDetails
    ...
    def hash
      [assign_ipv6_ip, assign_public_ip, assign_private_dns_record, defined_tags, display_name, freeform_tags, security_attributes, ipv6_address_ipv6_subnet_cidr_pair_details, hostname_label, nsg_ids, private_ip, skip_source_dest_check, subnet_id].hash
    end
