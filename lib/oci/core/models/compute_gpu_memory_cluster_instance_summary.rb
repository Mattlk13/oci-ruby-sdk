...
module OCI
  ...
  #
  class Core::Models::ComputeGpuMemoryClusterInstanceSummary
    ...
    # You can list all available shapes by calling {#list_shapes list_shapes}.
    #
    # @return [String]
    ...
    def hash
      [availability_domain, id, compartment_id, fault_domain, instance_configuration_id, region, instance_shape, lifecycle_state, display_name, time_created].hash
    end
