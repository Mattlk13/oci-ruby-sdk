...
module OCI
  ...
  class Core::Models::UpdateVolumeDetails
    ...
    def hash
      [defined_tags, display_name, freeform_tags, vpus_per_gb, size_in_gbs, is_auto_tune_enabled, block_volume_replicas, autotune_policies, is_reservations_enabled].hash
    end
