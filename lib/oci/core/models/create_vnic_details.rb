...
module OCI
  ...
  class Core::Models::CreateVnicDetails
    ...
    def hash
      [assign_ipv6_ip, assign_public_ip, assign_private_dns_record, defined_tags, display_name, freeform_tags, security_attributes, hostname_label, ipv6_address_ipv6_subnet_cidr_pair_details, nsg_ids, private_ip, skip_source_dest_check, subnet_id, vlan_id].hash
    end
