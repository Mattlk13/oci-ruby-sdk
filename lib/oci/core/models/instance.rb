...
module OCI
  ...
  class Core::Models::Instance
    SECURITY_ATTRIBUTES_STATE_ENUM = [
      SECURITY_ATTRIBUTES_STATE_STABLE = 'STABLE'.freeze,
      SECURITY_ATTRIBUTES_STATE_UPDATING = 'UPDATING'.freeze,
      SECURITY_ATTRIBUTES_STATE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @return [OCI::Core::Models::PlacementConstraintDetails]
    attr_accessor :placement_constraint_details
    ...
    # @return [String]
    attr_reader :security_attributes_state
    ...
    # @return [Array<OCI::Core::Models::LicensingConfig>]
    attr_accessor :licensing_configs
    ...
    # @option attributes [String] :security_attributes_state The value to assign to the {#security_attributes_state} property
    ...
    # @option attributes [Array<OCI::Core::Models::LicensingConfig>] :licensing_configs The value to assign to the {#licensing_configs} property
    ...
    def initialize(attributes = {})
      ...
      self.security_attributes_state = attributes[:'securityAttributesState'] if attributes[:'securityAttributesState']

      raise 'You cannot provide both :securityAttributesState and :security_attributes_state' if attributes.key?(:'securityAttributesState') && attributes.key?(:'security_attributes_state')

      self.security_attributes_state = attributes[:'security_attributes_state'] if attributes[:'security_attributes_state']
    ...
    # @param [Object] security_attributes_state Object to be assigned
    def security_attributes_state=(security_attributes_state)
      # rubocop:disable Style/ConditionalAssignment
      if security_attributes_state && !SECURITY_ATTRIBUTES_STATE_ENUM.include?(security_attributes_state)
        OCI.logger.debug("Unknown value for 'security_attributes_state' [" + security_attributes_state + "]. Mapping to 'SECURITY_ATTRIBUTES_STATE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @security_attributes_state = SECURITY_ATTRIBUTES_STATE_UNKNOWN_ENUM_VALUE
      else
        @security_attributes_state = security_attributes_state
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        security_attributes_state == other.security_attributes_state &&
