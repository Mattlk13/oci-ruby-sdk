...
module OCI
  ...
  #
  class Core::Models::ComputeHostGroupSummary
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the Customer-unique host group
    #
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The current state of the compute host group
    # @return [String]
    ...
    def hash
      [availability_domain, id, display_name, compartment_id, time_created, time_updated, defined_tags, freeform_tags, system_tags, lifecycle_state, is_targeted_placement_required].hash
    end
