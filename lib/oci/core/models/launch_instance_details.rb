...
module OCI
  ...
  class Core::Models::LaunchInstanceDetails
    ...
    # @return [Array<OCI::Core::Models::LaunchInstanceLicensingConfig>]
    ...
    # @option attributes [Array<OCI::Core::Models::LaunchInstanceLicensingConfig>] :licensing_configs The value to assign to the {#licensing_configs} property
    ...
    def hash
      [availability_domain, capacity_reservation_id, compartment_id, create_vnic_details, dedicated_vm_host_id, defined_tags, security_attributes, display_name, extended_metadata, fault_domain, cluster_placement_group_id, freeform_tags, compute_host_group_id, compute_cluster_id, hostname_label, image_id, ipxe_script, launch_options, instance_options, availability_config, preemptible_instance_config, metadata, agent_config, shape, shape_config, source_details, subnet_id, launch_volume_attachments, is_pv_encryption_in_transit_enabled, platform_config, placement_constraint_details, instance_configuration_id, licensing_configs].hash
    end
