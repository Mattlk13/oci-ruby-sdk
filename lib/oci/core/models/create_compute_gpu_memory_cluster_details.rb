...
module OCI
  ...
  #
  class Core::Models::CreateComputeGpuMemoryClusterDetails
    ...
    # **[Required]** Instance Configuration to be used for this GPU Memory Cluster
    #
    # @return [String]
    ...
    def hash
      [availability_domain, compartment_id, gpu_memory_fabric_id, compute_cluster_id, instance_configuration_id, size, defined_tags, freeform_tags, display_name].hash
    end
