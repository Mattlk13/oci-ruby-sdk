...
module OCI
  ...
  #
  class Core::Models::HostGroupPlacementConstraintDetails < Core::Models::PlacementConstraintDetails
    # **[Required]** The OCID of the compute host group.
    # @return [String]
    ...
    def hash
      [type, compute_host_group_id].hash
    end
