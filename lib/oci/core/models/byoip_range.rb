...
module OCI
  ...
  class Core::Models::ByoipRange
    ...
    # @return [OCI::Core::Models::ByoipRangeOriginAsn]
    attr_accessor :origin_asn
    ...
    def self.swagger_types
      {
        ...
        'origin_asn': :'OCI::Core::Models::ByoipRangeOriginAsn',
        'id': :'String',
    ...
    # @option attributes [OCI::Core::Models::ByoipRangeOriginAsn] :origin_asn The value to assign to the {#origin_asn} property
    ...
    def initialize(attributes = {})
      ...
      self.origin_asn = attributes[:'originAsn'] if attributes[:'originAsn']

      raise 'You cannot provide both :originAsn and :origin_asn' if attributes.key?(:'originAsn') && attributes.key?(:'origin_asn')

      self.origin_asn = attributes[:'origin_asn'] if attributes[:'origin_asn']
    ...
    def hash
      [byoip_range_vcn_ipv6_allocations, cidr_block, compartment_id, defined_tags, display_name, freeform_tags, origin_asn, id, ipv6_cidr_block, lifecycle_details, lifecycle_state, time_created, time_validated, time_advertised, time_withdrawn, validation_token].hash
    end
