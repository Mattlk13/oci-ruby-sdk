...
module OCI
  ...
  class Core::Models::BlockVolumeReplica
    ...
    def hash
      [availability_domain, compartment_id, defined_tags, display_name, freeform_tags, id, lifecycle_state, size_in_gbs, time_created, time_last_synced, block_volume_id, total_data_transferred_in_gbs, volume_group_replica_id, kms_key_id].hash
    end
