...
module OCI
  ...
  class Core::Models::InstanceConfigurationCreateVolumeDetails
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_reservations_enabled
    ...
    # @option attributes [String] :xrc_kms_key_id The value to assign to the {#xrc_kms_key_id} property
    # @option attributes [BOOLEAN] :is_reservations_enabled The value to assign to the {#is_reservations_enabled} property
    ...
    def hash
      [availability_domain, backup_policy_id, compartment_id, is_auto_tune_enabled, block_volume_replicas, defined_tags, display_name, freeform_tags, kms_key_id, vpus_per_gb, cluster_placement_group_id, size_in_gbs, source_details, autotune_policies, xrc_kms_key_id, is_reservations_enabled].hash
    end
