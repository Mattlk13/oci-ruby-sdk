...
module OCI
  ...
  class Core::Models::Ipv6
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, id, ip_address, lifecycle_state, subnet_id, time_created, vnic_id, ip_state, lifetime, route_table_id].hash
    end
