...
module OCI
  ...
  class Core::Models::ComputeGpuMemoryCluster
    ...
    # **[Required]** The number of instances currently running in the GpuMemoryCluster
    #
    # @return [Integer]
    attr_accessor :size
    ...
    def hash
      [availability_domain, id, instance_configuration_id, compartment_id, lifecycle_state, gpu_memory_fabric_id, compute_cluster_id, size, defined_tags, freeform_tags, system_tags, display_name, time_created].hash
    end
