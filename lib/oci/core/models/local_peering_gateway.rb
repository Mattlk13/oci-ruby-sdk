...
module OCI
  ...
  class Core::Models::LocalPeeringGateway
    ...
    def hash
      [compartment_id, defined_tags, display_name, freeform_tags, security_attributes, id, is_cross_tenancy_peering, lifecycle_state, peer_advertised_cidr, peer_advertised_cidr_details, peering_status, peering_status_details, peer_id, route_table_id, time_created, vcn_id].hash
    end
