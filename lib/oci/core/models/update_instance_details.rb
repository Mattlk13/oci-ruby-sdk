...
module OCI
  ...
  class Core::Models::UpdateInstanceDetails
    ...
    # @return [Array<OCI::Core::Models::UpdateInstanceLicensingConfig>]
    ...
    # @option attributes [Array<OCI::Core::Models::UpdateInstanceLicensingConfig>] :licensing_configs The value to assign to the {#licensing_configs} property
    ...
    def hash
      [capacity_reservation_id, defined_tags, security_attributes, display_name, freeform_tags, agent_config, shape, shape_config, source_details, update_operation_constraint, instance_options, fault_domain, launch_options, availability_config, time_maintenance_reboot_due, dedicated_vm_host_id, platform_config, licensing_configs].hash
    end
