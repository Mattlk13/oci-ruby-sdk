...
module OCI
  ...
  #
  class Core::Models::ComputeHostGroup
    ...
    # @return [Array<OCI::Core::Models::HostGroupConfiguration>]
    attr_accessor :configurations

    # **[Required]** The date and time the host group was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    # **[Required]** The lifecycle state of the host group
    #
    # @return [String]
    ...
    # @return [BOOLEAN]
    attr_accessor :is_targeted_placement_required
    ...
    # @option attributes [Array<OCI::Core::Models::HostGroupConfiguration>] :configurations The value to assign to the {#configurations} property
    ...
    # @option attributes [BOOLEAN] :is_targeted_placement_required The value to assign to the {#is_targeted_placement_required} property
    ...
    def hash
      [availability_domain, id, display_name, compartment_id, configurations, time_created, defined_tags, freeform_tags, system_tags, time_updated, lifecycle_state, is_targeted_placement_required].hash
    end
