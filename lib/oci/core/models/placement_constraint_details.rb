...
module OCI
  ...
  class Core::Models::PlacementConstraintDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Core::Models::HostGroupPlacementConstraintDetails' if type == 'HOST_GROUP'
      return 'OCI::Core::Models::ComputeBareMetalHostPlacementConstraintDetails' if type == 'COMPUTE_BARE_METAL_HOST'
