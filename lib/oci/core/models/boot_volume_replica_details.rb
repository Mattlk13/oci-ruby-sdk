...
module OCI
  ...
  class Core::Models::BootVolumeReplicaDetails
    ...
    # @option attributes [String] :xrr_kms_key_id The value to assign to the {#xrr_kms_key_id} property
    def initialize(attributes = {})
      ...
      self.xrr_kms_key_id = attributes[:'xrrKmsKeyId'] if attributes[:'xrrKmsKeyId']

      raise 'You cannot provide both :xrrKmsKeyId and :xrr_kms_key_id' if attributes.key?(:'xrrKmsKeyId') && attributes.key?(:'xrr_kms_key_id')

      self.xrr_kms_key_id = attributes[:'xrr_kms_key_id'] if attributes[:'xrr_kms_key_id']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        xrr_kms_key_id == other.xrr_kms_key_id
    end
    ...
    def hash
      [display_name, availability_domain, xrr_kms_key_id].hash
    end
