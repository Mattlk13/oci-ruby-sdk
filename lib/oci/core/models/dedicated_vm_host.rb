...
module OCI
  ...
  class Core::Models::DedicatedVmHost
    ...
    def hash
      [availability_domain, compartment_id, dedicated_vm_host_shape, defined_tags, display_name, fault_domain, freeform_tags, placement_constraint_details, id, lifecycle_state, time_created, total_ocpus, remaining_ocpus, total_memory_in_gbs, remaining_memory_in_gbs].hash
    end
