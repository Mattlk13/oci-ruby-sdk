...
module OCI
  ...
  class Core::Models::LaunchAttachVolumeDetails
    ...
    # **[Required]** The type of volume attachment. Currently, the only supported values are \"iscsi\" and \"paravirtualized\".
    # @return [String]
    attr_accessor :type
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Core::Models::LaunchAttachParavirtualizedVolumeDetails' if type == 'paravirtualized'
