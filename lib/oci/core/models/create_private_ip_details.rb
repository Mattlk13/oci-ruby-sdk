...
module OCI
  ...
  class Core::Models::CreatePrivateIpDetails
    ...
    def initialize(attributes = {})
      ...
      self.lifetime = "EPHEMERAL" if lifetime.nil? && !attributes.key?(:'lifetime') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [defined_tags, display_name, freeform_tags, hostname_label, ip_address, vnic_id, vlan_id, subnet_id, lifetime, route_table_id].hash
    end
