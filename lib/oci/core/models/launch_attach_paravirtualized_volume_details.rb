...
module OCI
  ...
  class Core::Models::LaunchAttachParavirtualizedVolumeDetails < Core::Models::LaunchAttachVolumeDetails
    ...
    def hash
      [device, display_name, is_read_only, is_shareable, type, volume_id, launch_create_volume_details, is_pv_encryption_in_transit_enabled].hash
    end
