...
module OCI
  ...
  class Zpr::Models::WorkRequestErrorCollection
    # **[Required]** A list of work request errors.
    # @return [Array<OCI::Zpr::Models::WorkRequestError>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Zpr::Models::WorkRequestError>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Zpr::Models::WorkRequestError>] :items The value to assign to the {#items} property
