...
module OCI
  ...
  class Zpr::Models::WorkRequestSummaryCollection
    # **[Required]** A list of work requests.
    # @return [Array<OCI::Zpr::Models::WorkRequestSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Zpr::Models::WorkRequestSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Zpr::Models::WorkRequestSummary>] :items The value to assign to the {#items} property
