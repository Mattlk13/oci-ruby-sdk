...
module OCI
  ...
  class Zpr::Models::WorkRequest
    ...
    # @return [Array<OCI::Zpr::Models::WorkRequestResource>]
    ...
    # **[Required]** The date and time the work request was updated, in the format defined by
    # [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
    #
    # @return [DateTime]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::Zpr::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::Zpr::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
