...
module OCI
  ...
  class DelegateAccessControl::Models::DelegationControlSummary
    RESOURCE_TYPE_ENUM = [
    ...
    # **[Required]** resourceType for which the Delegation Control is applicable
    # @return [String]
    ...
    def hash
      [id, display_name, compartment_id, resource_type, time_created, time_updated, time_deleted, lifecycle_state, lifecycle_state_details, freeform_tags, defined_tags, system_tags].hash
    end
