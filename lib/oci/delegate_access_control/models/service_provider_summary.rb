...
module OCI
  ...
  #
  class DelegateAccessControl::Models::ServiceProviderSummary
    SERVICE_TYPES_ENUM = [
    ...
    # @return [String]
    attr_accessor :service_provider_type
    ...
    def hash
      [id, compartment_id, name, service_provider_type, service_types, supported_resource_types, lifecycle_state, lifecycle_state_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
