...
module OCI
  ...
  class DatabaseMigration::Models::PhaseStatus
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_suspend_available
    ...
    #
    # @return [Array<String>]
    attr_reader :editable_parameter_files
    ...
    # @option attributes [BOOLEAN] :is_suspend_available The value to assign to the {#is_suspend_available} property
    # @option attributes [Array<String>] :editable_parameter_files The value to assign to the {#editable_parameter_files} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] editable_parameter_files Object to be assigned
    def editable_parameter_files=(editable_parameter_files)
      # rubocop:disable Style/ConditionalAssignment
      if editable_parameter_files.nil?
        @editable_parameter_files = nil
      else
        @editable_parameter_files =
          editable_parameter_files.collect do |item|
            if EDITABLE_PARAMETER_FILES_ENUM.include?(item)
              item
            else
              OCI.logger.debug("Unknown value for 'editable_parameter_files' [#{item}]. Mapping to 'EDITABLE_PARAMETER_FILES_UNKNOWN_ENUM_VALUE'") if OCI.logger
              EDITABLE_PARAMETER_FILES_UNKNOWN_ENUM_VALUE
            end
          end
      end
      # rubocop:enable Style/ConditionalAssignment
    ...
    def hash
      [name, status, duration_in_ms, is_advisor_report_available, issue, action, extract, log_location, progress, is_suspend_available, editable_parameter_files].hash
    end
