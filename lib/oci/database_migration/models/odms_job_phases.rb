...
module OCI
  module DatabaseMigration::Models
    ODMS_JOB_PHASES_ENUM = [
      ...
      ODMS_JOB_PHASES_ODMS_FETCH_METADATA_SRC = 'ODMS_FETCH_METADATA_SRC'.freeze,
      ODMS_JOB_PHASES_ODMS_FETCH_METADATA_TGT = 'ODMS_FETCH_METADATA_TGT'.freeze,
      ODMS_JOB_PHASES_ODMS_VALIDATE = 'ODMS_VALIDATE'.freeze,
      ODMS_JOB_PHASES_ODMS_PREPARE = 'ODMS_PREPARE'.freeze,
      ODMS_JOB_PHASES_ODMS_INITIALIZE_REPLICATION_INFRASTRUCTURE = 'ODMS_INITIALIZE_REPLICATION_INFRASTRUCTURE'.freeze,
      ...
      ODMS_JOB_PHASES_ODMS_METADATA_TRANSFER = 'ODMS_METADATA_TRANSFER'.freeze,
      ODMS_JOB_PHASES_ODMS_INITIAL_LOAD_EXPORT_DATA_UPLOAD = 'ODMS_INITIAL_LOAD_EXPORT_DATA_UPLOAD'.freeze,
