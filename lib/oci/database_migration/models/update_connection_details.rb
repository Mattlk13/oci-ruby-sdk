...
module OCI
  ...
  class DatabaseMigration::Models::UpdateConnectionDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseMigration::Models::UpdateOracleConnectionDetails' if type == 'ORACLE'
      return 'OCI::DatabaseMigration::Models::UpdateMysqlConnectionDetails' if type == 'MYSQL'
    ...
    def hash
      [connection_type, display_name, description, freeform_tags, defined_tags, vault_id, key_id, subnet_id, nsg_ids, username, password, replication_username, replication_password].hash
    end
