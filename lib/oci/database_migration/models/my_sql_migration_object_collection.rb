...
module OCI
  ...
  class DatabaseMigration::Models::MySqlMigrationObjectCollection < DatabaseMigration::Models::MigrationObjectCollection
    # **[Required]** An array of database objects that are either included or excluded from the migration.
    # @return [Array<OCI::DatabaseMigration::Models::MySqlDatabaseObjectSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::DatabaseMigration::Models::MySqlDatabaseObjectSummary>',
    ...
    # @option attributes [Array<OCI::DatabaseMigration::Models::MySqlDatabaseObjectSummary>] :items The value to assign to the {#items} property
