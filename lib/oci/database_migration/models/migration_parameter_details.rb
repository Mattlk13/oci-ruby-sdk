...
module OCI
  ...
  class DatabaseMigration::Models::MigrationParameterDetails
    DATA_TYPE_ENUM = [
    ...
    # **[Required]** If a STRING data type then the value should be an array of characters,
