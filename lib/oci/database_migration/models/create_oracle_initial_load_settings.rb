...
module OCI
  ...
  class DatabaseMigration::Models::CreateOracleInitialLoadSettings
    JOB_MODE_ENUM = [
    ...
    def hash
      [data_pump_parameters, tablespace_details, export_directory_object, import_directory_object, job_mode, metadata_remaps].hash
    end
