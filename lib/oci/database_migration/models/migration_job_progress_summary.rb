...
module OCI
  ...
  class DatabaseMigration::Models::MigrationJobProgressSummary
    CURRENT_PHASE_ENUM = [
      ...
      CURRENT_PHASE_ODMS_FETCH_METADATA_SRC = 'ODMS_FETCH_METADATA_SRC'.freeze,
      CURRENT_PHASE_ODMS_FETCH_METADATA_TGT = 'ODMS_FETCH_METADATA_TGT'.freeze,
      CURRENT_PHASE_ODMS_VALIDATE = 'ODMS_VALIDATE'.freeze,
      CURRENT_PHASE_ODMS_PREPARE = 'ODMS_PREPARE'.freeze,
      CURRENT_PHASE_ODMS_INITIALIZE_REPLICATION_INFRASTRUCTURE = 'ODMS_INITIALIZE_REPLICATION_INFRASTRUCTURE'.freeze,
      ...
      CURRENT_PHASE_ODMS_METADATA_TRANSFER = 'ODMS_METADATA_TRANSFER'.freeze,
      CURRENT_PHASE_ODMS_INITIAL_LOAD_EXPORT_DATA_UPLOAD = 'ODMS_INITIAL_LOAD_EXPORT_DATA_UPLOAD'.freeze,
