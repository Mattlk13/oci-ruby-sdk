...
require 'date'
require_relative 'my_sql_data_transfer_medium_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # OCI Object Storage bucket will be used to store dump files for the migration.
  class DatabaseMigration::Models::MySqlObjectStorageDataTransferMediumDetails < DatabaseMigration::Models::MySqlDataTransferMediumDetails
