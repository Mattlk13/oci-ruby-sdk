...
module OCI
  ...
  class DatabaseMigration::Models::CreateMysqlConnectionDetails < DatabaseMigration::Models::CreateConnectionDetails
    ...
    # **[Required]** The name of the database being referenced.
    # @return [String]
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, vault_id, key_id, subnet_id, nsg_ids, username, password, replication_username, replication_password, technology_type, host, port, database_name, security_protocol, ssl_mode, ssl_ca, ssl_crl, ssl_cert, ssl_key, additional_attributes, db_system_id].hash
    end
