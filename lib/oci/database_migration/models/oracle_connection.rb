...
module OCI
  ...
  class DatabaseMigration::Models::OracleConnection < DatabaseMigration::Models::Connection
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, subnet_id, ingress_ips, nsg_ids, username, password, replication_username, replication_password, secret_id, private_endpoint_id, technology_type, connection_string, database_id, ssh_host, ssh_key, ssh_user, ssh_sudo_location].hash
    end
