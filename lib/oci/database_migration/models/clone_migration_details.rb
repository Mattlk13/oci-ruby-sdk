...
module OCI
  ...
  class DatabaseMigration::Models::CloneMigrationDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseMigration::Models::OracleCloneMigrationDetails' if type == 'ORACLE'
      return 'OCI::DatabaseMigration::Models::MySqlCloneMigrationDetails' if type == 'MYSQL'
