...
module OCI
  ...
  class DatabaseMigration::Models::MigrationObjectCollection
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseMigration::Models::MySqlMigrationObjectCollection' if type == 'MYSQL'
      return 'OCI::DatabaseMigration::Models::OracleMigrationObjectCollection' if type == 'ORACLE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseMigration::Models::MigrationObjectCollection'
    end
