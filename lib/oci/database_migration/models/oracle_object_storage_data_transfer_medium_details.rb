...
require 'date'
require_relative 'oracle_data_transfer_medium_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # OCI Object Storage bucket will be used to store Data Pump dump files for the migration.
  class DatabaseMigration::Models::OracleObjectStorageDataTransferMediumDetails < DatabaseMigration::Models::OracleDataTransferMediumDetails
