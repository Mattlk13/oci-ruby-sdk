...
module OCI
  ...
  class DatabaseMigration::Models::CreateMySqlInitialLoadSettings
    ...
    def initialize(attributes = {})
      ...
      self.handle_grant_errors = "ABORT" if handle_grant_errors.nil? && !attributes.key?(:'handleGrantErrors') # rubocop:disable Style/StringLiterals
      ...
      self.handle_grant_errors = "ABORT" if handle_grant_errors.nil? && !attributes.key?(:'handleGrantErrors') && !attributes.key?(:'handle_grant_errors') # rubocop:disable Style/StringLiterals
