...
module OCI
  ...
  class DatabaseMigration::Models::CreateOracleMigrationDetails < DatabaseMigration::Models::CreateMigrationDetails
    # @return [OCI::DatabaseMigration::Models::CreateOracleDataTransferMediumDetails]
    attr_accessor :data_transfer_medium_details

    # @return [OCI::DatabaseMigration::Models::CreateOracleInitialLoadSettings]
    attr_accessor :initial_load_settings

    # @return [OCI::DatabaseMigration::Models::CreateOracleAdvisorSettings]
    attr_accessor :advisor_settings

    # @return [OCI::DatabaseMigration::Models::CreateGoldenGateHubDetails]
    attr_accessor :hub_details

    # @return [OCI::DatabaseMigration::Models::CreateOracleGgsDeploymentDetails]
    ...
    def self.swagger_types
      {
        ...
        'data_transfer_medium_details': :'OCI::DatabaseMigration::Models::CreateOracleDataTransferMediumDetails',
        'initial_load_settings': :'OCI::DatabaseMigration::Models::CreateOracleInitialLoadSettings',
        'advisor_settings': :'OCI::DatabaseMigration::Models::CreateOracleAdvisorSettings',
        'hub_details': :'OCI::DatabaseMigration::Models::CreateGoldenGateHubDetails',
        'ggs_details': :'OCI::DatabaseMigration::Models::CreateOracleGgsDeploymentDetails',
    ...
    # @option attributes [OCI::DatabaseMigration::Models::CreateOracleDataTransferMediumDetails] :data_transfer_medium_details The value to assign to the {#data_transfer_medium_details} property
    # @option attributes [OCI::DatabaseMigration::Models::CreateOracleInitialLoadSettings] :initial_load_settings The value to assign to the {#initial_load_settings} property
    # @option attributes [OCI::DatabaseMigration::Models::CreateOracleAdvisorSettings] :advisor_settings The value to assign to the {#advisor_settings} property
    ...
    # @option attributes [OCI::DatabaseMigration::Models::CreateOracleGgsDeploymentDetails] :ggs_details The value to assign to the {#ggs_details} property
