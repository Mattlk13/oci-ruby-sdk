...
require 'date'
require_relative 'clone_migration_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Oracle Clone Migration Summary
  class DatabaseMigration::Models::OracleCloneMigrationDetails < DatabaseMigration::Models::CloneMigrationDetails
    ...
    # @option attributes [String] :display_name The value to assign to the {OCI::DatabaseMigration::Models::CloneMigrationDetails#display_name #display_name} proprety
    # @option attributes [String] :compartment_id The value to assign to the {OCI::DatabaseMigration::Models::CloneMigrationDetails#compartment_id #compartment_id} proprety
    # @option attributes [String] :source_database_connection_id The value to assign to the {OCI::DatabaseMigration::Models::CloneMigrationDetails#source_database_connection_id #source_database_connection_id} proprety
    # @option attributes [String] :target_database_connection_id The value to assign to the {OCI::DatabaseMigration::Models::CloneMigrationDetails#target_database_connection_id #target_database_connection_id} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::DatabaseMigration::Models::CloneMigrationDetails#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::DatabaseMigration::Models::CloneMigrationDetails#defined_tags #defined_tags} proprety
    ...
    def hash
      [database_combination, display_name, compartment_id, source_database_connection_id, target_database_connection_id, freeform_tags, defined_tags, source_container_database_connection_id].hash
    end
