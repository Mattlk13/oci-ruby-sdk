...
require 'date'
require_relative 'create_oracle_data_transfer_medium_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # OCI Object Storage bucket will be used to store Data Pump dump files for the migration.
  class DatabaseMigration::Models::CreateOracleObjectStorageDataTransferMediumDetails < DatabaseMigration::Models::CreateOracleDataTransferMediumDetails
    ...
    # @option attributes [OCI::DatabaseMigration::Models::CreateObjectStoreBucket] :object_storage_bucket The value to assign to the {#object_storage_bucket} property
    ...
    def hash
      [type, object_storage_bucket, source, target].hash
    end
