...
module OCI
  ...
  class DatabaseMigration::Models::CreateMigrationDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseMigration::Models::CreateMySqlMigrationDetails' if type == 'MYSQL'
      return 'OCI::DatabaseMigration::Models::CreateOracleMigrationDetails' if type == 'ORACLE'
    ...
    def hash
      [description, compartment_id, database_combination, type, display_name, source_database_connection_id, target_database_connection_id, freeform_tags, defined_tags].hash
    end
