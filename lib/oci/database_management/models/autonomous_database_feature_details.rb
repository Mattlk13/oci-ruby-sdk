...
module OCI
  ...
  class DatabaseManagement::Models::AutonomousDatabaseFeatureDetails
    FEATURE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::AutonomousDatabaseSqlWatchFeatureDetails' if type == 'SQLWATCH'
      return 'OCI::DatabaseManagement::Models::AutonomousDatabaseDiagnosticsAndManagementFeatureDetails' if type == 'DIAGNOSTICS_AND_MANAGEMENT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DatabaseManagement::Models::AutonomousDatabaseFeatureDetails'
    end
