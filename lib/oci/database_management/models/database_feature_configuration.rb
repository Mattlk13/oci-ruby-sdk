...
module OCI
  ...
  class DatabaseManagement::Models::DatabaseFeatureConfiguration
    FEATURE_ENUM = [
      ...
      FEATURE_DB_LIFECYCLE_MANAGEMENT = 'DB_LIFECYCLE_MANAGEMENT'.freeze,
      FEATURE_SQLWATCH = 'SQLWATCH'.freeze,
      FEATURE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    FEATURE_STATUS_ENUM = [
      ...
      FEATURE_STATUS_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::DatabaseLifecycleFeatureConfiguration' if type == 'DB_LIFECYCLE_MANAGEMENT'
      return 'OCI::DatabaseManagement::Models::DatabaseSqlWatchFeatureConfiguration' if type == 'SQLWATCH'
    ...
    def feature=(feature)
      ...
      if feature && !FEATURE_ENUM.include?(feature)
        OCI.logger.debug("Unknown value for 'feature' [" + feature + "]. Mapping to 'FEATURE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @feature = FEATURE_UNKNOWN_ENUM_VALUE
      else
        @feature = feature
      end
    ...
    def feature_status=(feature_status)
      # rubocop:disable Style/ConditionalAssignment
      if feature_status && !FEATURE_STATUS_ENUM.include?(feature_status)
        OCI.logger.debug("Unknown value for 'feature_status' [" + feature_status + "]. Mapping to 'FEATURE_STATUS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @feature_status = FEATURE_STATUS_UNKNOWN_ENUM_VALUE
      else
