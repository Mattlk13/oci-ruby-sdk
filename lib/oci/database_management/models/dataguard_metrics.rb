...
module OCI
  ...
  class DatabaseManagement::Models::DataguardMetrics
    DATABASE_TYPE_ENUM = [
    ...
    # **[Required]** The Fast-Start Failover status of the primary database.
    # @return [String]
    attr_accessor :fast_start_fail_over

    # **[Required]** The protection mode of the primary Database.
    # @return [String]
    attr_accessor :protection_mode

    # **[Required]** A list of primary or standby database metrics.
    # @return [Array<OCI::DatabaseManagement::Models::HaMetricDefinition>]
    attr_accessor :metrics

    # **[Required]** A list of standby databases and their metrics
    # @return [Array<OCI::DatabaseManagement::Models::StandByDatabaseDataguardMetrics>]
    attr_accessor :stand_by_databases
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'fast_start_fail_over': :'String',
        'protection_mode': :'String',
        'metrics': :'Array<OCI::DatabaseManagement::Models::HaMetricDefinition>',
        'stand_by_databases': :'Array<OCI::DatabaseManagement::Models::StandByDatabaseDataguardMetrics>',
        'db_id': :'String',
    ...
    # @option attributes [String] :fast_start_fail_over The value to assign to the {#fast_start_fail_over} property
    ...
    # @option attributes [Array<OCI::DatabaseManagement::Models::StandByDatabaseDataguardMetrics>] :stand_by_databases The value to assign to the {#stand_by_databases} property
    ...
    def initialize(attributes = {})
      ...
      self.fast_start_fail_over = attributes[:'fastStartFailOver'] if attributes[:'fastStartFailOver']

      raise 'You cannot provide both :fastStartFailOver and :fast_start_fail_over' if attributes.key?(:'fastStartFailOver') && attributes.key?(:'fast_start_fail_over')

      self.fast_start_fail_over = attributes[:'fast_start_fail_over'] if attributes[:'fast_start_fail_over']
      ...
      self.stand_by_databases = attributes[:'standByDatabases'] if attributes[:'standByDatabases']

      raise 'You cannot provide both :standByDatabases and :stand_by_databases' if attributes.key?(:'standByDatabases') && attributes.key?(:'stand_by_databases')

      self.stand_by_databases = attributes[:'stand_by_databases'] if attributes[:'stand_by_databases']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        fast_start_fail_over == other.fast_start_fail_over &&
        protection_mode == other.protection_mode &&
        metrics == other.metrics &&
        stand_by_databases == other.stand_by_databases &&
        db_id == other.db_id &&
    ...
    def hash
      [fast_start_fail_over, protection_mode, metrics, stand_by_databases, db_id, compartment_id, database_type, database_sub_type, deployment_type, database_version, workload_type, database_name, database_id, db_unique_name, db_role].hash
    end
