...
module OCI
  ...
  class DatabaseManagement::Models::DbManagementPrivateEndpoint
    ...
    # @return [BOOLEAN]
    attr_accessor :is_dns_resolution_enabled
    ...
    # @option attributes [BOOLEAN] :is_dns_resolution_enabled The value to assign to the {#is_dns_resolution_enabled} property
    ...
    def initialize(attributes = {})
      ...
      self.is_dns_resolution_enabled = attributes[:'isDnsResolutionEnabled'] unless attributes[:'isDnsResolutionEnabled'].nil?

      raise 'You cannot provide both :isDnsResolutionEnabled and :is_dns_resolution_enabled' if attributes.key?(:'isDnsResolutionEnabled') && attributes.key?(:'is_dns_resolution_enabled')

      self.is_dns_resolution_enabled = attributes[:'is_dns_resolution_enabled'] unless attributes[:'is_dns_resolution_enabled'].nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_dns_resolution_enabled == other.is_dns_resolution_enabled &&
        vcn_id == other.vcn_id &&
    ...
    def hash
      [id, name, compartment_id, is_cluster, is_dns_resolution_enabled, vcn_id, subnet_id, private_ip, description, time_created, lifecycle_state, nsg_ids, freeform_tags, defined_tags, system_tags].hash
    end
