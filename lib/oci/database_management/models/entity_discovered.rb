...
module OCI
  ...
  class DatabaseManagement::Models::EntityDiscovered
    ...
    def discover_status=(discover_status)
      ...
      if discover_status && !DISCOVER_STATUS_ENUM.include?(discover_status)
        OCI.logger.debug("Unknown value for 'discover_status' [" + discover_status + "]. Mapping to 'DISCOVER_STATUS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @discover_status = DISCOVER_STATUS_UNKNOWN_ENUM_VALUE
      else
