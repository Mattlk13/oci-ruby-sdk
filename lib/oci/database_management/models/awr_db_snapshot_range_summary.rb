...
module OCI
  ...
  class DatabaseManagement::Models::AwrDbSnapshotRangeSummary
    ...
    # @option attributes [String] :src_db_id The value to assign to the {#src_db_id} property
    # @option attributes [String] :src_db_name The value to assign to the {#src_db_name} property
    ...
    def initialize(attributes = {})
      ...
      self.src_db_id = attributes[:'srcDbId'] if attributes[:'srcDbId']

      raise 'You cannot provide both :srcDbId and :src_db_id' if attributes.key?(:'srcDbId') && attributes.key?(:'src_db_id')

      self.src_db_id = attributes[:'src_db_id'] if attributes[:'src_db_id']

      self.src_db_name = attributes[:'srcDbName'] if attributes[:'srcDbName']

      raise 'You cannot provide both :srcDbName and :src_db_name' if attributes.key?(:'srcDbName') && attributes.key?(:'src_db_name')

      self.src_db_name = attributes[:'src_db_name'] if attributes[:'src_db_name']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        src_db_id == other.src_db_id &&
        src_db_name == other.src_db_name &&
    ...
    def hash
      [awr_db_id, db_name, db_unique_name, src_db_id, src_db_name, instance_list, time_db_startup, time_first_snapshot_begin, time_latest_snapshot_end, first_snapshot_id, latest_snapshot_id, snapshot_count, snapshot_interval_in_min, container_id, db_version, snapshot_timezone].hash
    end
