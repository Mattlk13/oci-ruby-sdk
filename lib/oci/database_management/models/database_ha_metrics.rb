...
module OCI
  ...
  class DatabaseManagement::Models::DatabaseHaMetrics
    DATABASE_TYPE_ENUM = [
    ...
    def hash
      [is_dataguard_enabled, last_backup_summary, metrics, db_id, compartment_id, database_type, database_sub_type, deployment_type, database_version, workload_type, database_name, database_id, db_unique_name, db_role].hash
    end
