...
module OCI
  ...
  class DatabaseManagement::Models::DatabaseConnectionCredentials
    CREDENTIAL_TYPE_ENUM = [
      ...
      CREDENTIAL_TYPE_NAMED_CREDENTIALS = 'NAMED_CREDENTIALS'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DatabaseManagement::Models::DatabaseNamedCredentialConnectionDetails' if type == 'NAMED_CREDENTIAL'
