...
module OCI
  ...
  class DatabaseManagement::Models::CreateExternalMySqlDatabaseConnectorDetails
    # **[Required]** OCID of compartment for the External MySQL Database.
    # @return [String]
    attr_accessor :compartment_id

    # This attribute is required.
    # @return [OCI::DatabaseManagement::Models::CreateMySqlDatabaseConnectorDetails]
    ...
    def self.swagger_types
      {
        ...
        'connector_details': :'OCI::DatabaseManagement::Models::CreateMySqlDatabaseConnectorDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::DatabaseManagement::Models::CreateMySqlDatabaseConnectorDetails] :connector_details The value to assign to the {#connector_details} property
    ...
    def hash
      [compartment_id, connector_details].hash
    end
