...
module OCI
  ...
  class DatabaseManagement::Models::MySqlDataSummary
    ...
    # @option attributes [Integer] :max_controlled_memory The value to assign to the {#max_controlled_memory} property
    # @option attributes [Integer] :max_total_memory The value to assign to the {#max_total_memory} property
    # @option attributes [Integer] :sum_cpu_time The value to assign to the {#sum_cpu_time} property
    ...
    def initialize(attributes = {})
      ...
      self.max_controlled_memory = attributes[:'maxControlledMemory'] if attributes[:'maxControlledMemory']

      raise 'You cannot provide both :maxControlledMemory and :max_controlled_memory' if attributes.key?(:'maxControlledMemory') && attributes.key?(:'max_controlled_memory')

      self.max_controlled_memory = attributes[:'max_controlled_memory'] if attributes[:'max_controlled_memory']

      self.max_total_memory = attributes[:'maxTotalMemory'] if attributes[:'maxTotalMemory']

      raise 'You cannot provide both :maxTotalMemory and :max_total_memory' if attributes.key?(:'maxTotalMemory') && attributes.key?(:'max_total_memory')

      self.max_total_memory = attributes[:'max_total_memory'] if attributes[:'max_total_memory']

      self.sum_cpu_time = attributes[:'sumCpuTime'] if attributes[:'sumCpuTime']

      raise 'You cannot provide both :sumCpuTime and :sum_cpu_time' if attributes.key?(:'sumCpuTime') && attributes.key?(:'sum_cpu_time')

      self.sum_cpu_time = attributes[:'sum_cpu_time'] if attributes[:'sum_cpu_time']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        max_controlled_memory == other.max_controlled_memory &&
        max_total_memory == other.max_total_memory &&
        sum_cpu_time == other.sum_cpu_time &&
