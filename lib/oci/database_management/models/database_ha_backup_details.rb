...
module OCI
  ...
  class DatabaseManagement::Models::DatabaseHaBackupDetails
    DATABASE_TYPE_ENUM = [
    ...
    # @option attributes [String] :flash_back_on The value to assign to the {#flash_back_on} property
    # @option attributes [DateTime] :flash_back_time The value to assign to the {#flash_back_time} property
    # @option attributes [Integer] :recovery_window_goal_in_days The value to assign to the {#recovery_window_goal_in_days} property
    # @option attributes [OCI::DatabaseManagement::Models::DatabaseBackupSummary] :last_full_backup_summary The value to assign to the {#last_full_backup_summary} property
    # @option attributes [Array<OCI::DatabaseManagement::Models::DatabaseBackupSummary>] :backup_history The value to assign to the {#backup_history} property
    ...
    def initialize(attributes = {})
      ...
      self.flash_back_on = attributes[:'flashBackOn'] if attributes[:'flashBackOn']

      raise 'You cannot provide both :flashBackOn and :flash_back_on' if attributes.key?(:'flashBackOn') && attributes.key?(:'flash_back_on')

      self.flash_back_on = attributes[:'flash_back_on'] if attributes[:'flash_back_on']

      self.flash_back_time = attributes[:'flashBackTime'] if attributes[:'flashBackTime']

      raise 'You cannot provide both :flashBackTime and :flash_back_time' if attributes.key?(:'flashBackTime') && attributes.key?(:'flash_back_time')

      self.flash_back_time = attributes[:'flash_back_time'] if attributes[:'flash_back_time']

      self.recovery_window_goal_in_days = attributes[:'recoveryWindowGoalInDays'] if attributes[:'recoveryWindowGoalInDays']

      raise 'You cannot provide both :recoveryWindowGoalInDays and :recovery_window_goal_in_days' if attributes.key?(:'recoveryWindowGoalInDays') && attributes.key?(:'recovery_window_goal_in_days')

      self.recovery_window_goal_in_days = attributes[:'recovery_window_goal_in_days'] if attributes[:'recovery_window_goal_in_days']

      self.last_full_backup_summary = attributes[:'lastFullBackupSummary'] if attributes[:'lastFullBackupSummary']

      raise 'You cannot provide both :lastFullBackupSummary and :last_full_backup_summary' if attributes.key?(:'lastFullBackupSummary') && attributes.key?(:'last_full_backup_summary')

      self.last_full_backup_summary = attributes[:'last_full_backup_summary'] if attributes[:'last_full_backup_summary']

      self.backup_history = attributes[:'backupHistory'] if attributes[:'backupHistory']

      raise 'You cannot provide both :backupHistory and :backup_history' if attributes.key?(:'backupHistory') && attributes.key?(:'backup_history')

      self.backup_history = attributes[:'backup_history'] if attributes[:'backup_history']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        flash_back_on == other.flash_back_on &&
        flash_back_time == other.flash_back_time &&
        recovery_window_goal_in_days == other.recovery_window_goal_in_days &&
        last_full_backup_summary == other.last_full_backup_summary &&
        backup_history == other.backup_history &&
    ...
    def hash
      [flash_back_on, flash_back_time, recovery_window_goal_in_days, last_full_backup_summary, backup_history, metrics, db_id, compartment_id, database_type, database_sub_type, deployment_type, database_version, workload_type, database_name, database_id, db_unique_name, db_role].hash
    end
