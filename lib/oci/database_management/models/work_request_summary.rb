...
module OCI
  ...
  class DatabaseManagement::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_CHECK_EXTERNAL_MYSQL_CONNECTION = 'CHECK_EXTERNAL_MYSQL_CONNECTION'.freeze,
      OPERATION_TYPE_UPDATE_EXTERNAL_MYSQL_CREDENTIAL = 'UPDATE_EXTERNAL_MYSQL_CREDENTIAL'.freeze,
      OPERATION_TYPE_CREATE_EXTERNAL_MYSQL_CONNECTOR = 'CREATE_EXTERNAL_MYSQL_CONNECTOR'.freeze,
      OPERATION_TYPE_DELETE_EXTERNAL_MYSQL_CONNECTOR = 'DELETE_EXTERNAL_MYSQL_CONNECTOR'.freeze,
      OPERATION_TYPE_DELETE_EXTERNAL_MYSQL_DATABASE = 'DELETE_EXTERNAL_MYSQL_DATABASE'.freeze,
