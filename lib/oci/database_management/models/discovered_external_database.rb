...
module OCI
  ...
  class DatabaseManagement::Models::DiscoveredExternalDatabase < DatabaseManagement::Models::DiscoveredExternalDbSystemComponent
    ...
    # @return [BOOLEAN]
    attr_accessor :can_enable_all_current_pdbs
    ...
    # @option attributes [BOOLEAN] :can_enable_all_current_pdbs The value to assign to the {#can_enable_all_current_pdbs} property
    ...
    def hash
      [component_id, display_name, component_name, component_type, resource_id, is_selected_for_monitoring, status, associated_components, compartment_id, db_unique_name, db_type, is_cluster, db_edition, db_id, db_packs, db_role, db_version, pluggable_databases, connector, can_enable_all_current_pdbs, is_auto_enable_pluggable_database].hash
    end
