...
module OCI
  # Notifications
  class Dblm::Models::NotificationSummary
    ...
    # @option attributes [String] :notification_text The value to assign to the {#notification_text} property
    ...
    def notification_type=(notification_type)
      ...
      if notification_type && !NOTIFICATION_TYPE_ENUM.include?(notification_type)
        OCI.logger.debug("Unknown value for 'notification_type' [" + notification_type + "]. Mapping to 'NOTIFICATION_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @notification_type = NOTIFICATION_TYPE_UNKNOWN_ENUM_VALUE
      else
