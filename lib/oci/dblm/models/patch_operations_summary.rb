...
module OCI
  ...
  class Dblm::Models::PatchOperationsSummary
    # Total number of scheduled Patch operations.
    # @return [Integer]
    attr_accessor :scheduled_patch_ops_count

    # Total number of in progress Patch operations.
    # @return [Integer]
    attr_accessor :running_patch_ops_count

    # Total number of successful Patch operations.
    # @return [Integer]
    attr_accessor :successful_patch_ops_count

    # Total number of Patch operations that have warnings.
    # @return [Integer]
    attr_accessor :warnings_patch_ops_count

    # Total number of failed Patch operations.
    # @return [Integer]
    attr_accessor :failed_patch_ops_count
    ...
    # @option attributes [Integer] :scheduled_patch_ops_count The value to assign to the {#scheduled_patch_ops_count} property
    # @option attributes [Integer] :running_patch_ops_count The value to assign to the {#running_patch_ops_count} property
    # @option attributes [Integer] :successful_patch_ops_count The value to assign to the {#successful_patch_ops_count} property
    # @option attributes [Integer] :warnings_patch_ops_count The value to assign to the {#warnings_patch_ops_count} property
    # @option attributes [Integer] :failed_patch_ops_count The value to assign to the {#failed_patch_ops_count} property
