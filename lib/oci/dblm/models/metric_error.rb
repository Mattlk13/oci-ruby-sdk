...
module OCI
  ...
  class Dblm::Models::MetricError
    # **[Required]** Time the error record was generated
    # @return [DateTime]
    ...
    # @option attributes [String] :error_type The value to assign to the {#error_type} property
    ...
    def initialize(attributes = {})
      ...
      self.error_type = attributes[:'errorType'] if attributes[:'errorType']

      raise 'You cannot provide both :errorType and :error_type' if attributes.key?(:'errorType') && attributes.key?(:'error_type')

      self.error_type = attributes[:'error_type'] if attributes[:'error_type']
    ...
    def hash
      [time_generated, error_type, content_type, data, subject, level].hash
    end
