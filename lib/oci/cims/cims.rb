...
require 'oci/cims/models/cmos_user_group_info'
...
require 'oci/cims/models/services'
require 'oci/cims/models/sort_by'
require 'oci/cims/models/sort_order'
require 'oci/cims/models/status'
require 'oci/cims/models/sub_categories'
require 'oci/cims/models/sub_category'
require 'oci/cims/models/sub_components'
require 'oci/cims/models/subscription_info'
