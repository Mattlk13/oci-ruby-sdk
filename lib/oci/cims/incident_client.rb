...
module OCI
  ...
  class Cims::IncidentClient
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    # @option opts [String] :csi The Customer Support Identifier (CSI) number associated with the support account.
    ...
    def get_incident(incident_key, compartment_id, opts = {})
      ...
      raise "Missing the required parameter 'compartment_id' when calling get_incident." if compartment_id.nil?
    ...
    def update_incident(incident_key, update_incident_details, compartment_id, opts = {})
      ...
      raise "Missing the required parameter 'compartment_id' when calling update_incident." if compartment_id.nil?
      raise "Parameter value for 'incident_key' must not be blank" if OCI::Internal::Util.blank_string?(incident_key)
