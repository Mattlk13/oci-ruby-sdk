...
module OCI
  ...
  class Cims::Models::SubComponents
    # Subcategory list.
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'sub_category': :'Hash<String, String>',
        'schema': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Hash<String, String>] :sub_category The value to assign to the {#sub_category} property
