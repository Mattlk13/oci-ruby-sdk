...
module OCI
  ...
  class LoadBalancer::Models::CreateListenerDetails
    ...
    # **[Required]** The protocol on which the listener accepts connection requests. The supported protocols are HTTP, HTTP2, TCP, and GRPC.
    # You can also use the {#list_protocols list_protocols} operation to get a list of valid protocols.
    #
    # Example: `HTTP`
    #
    # @return [String]
