...
module OCI
  ...
  class LoadBalancer::Models::SSLConfiguration
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :has_session_resumption
    ...
    # @option attributes [BOOLEAN] :has_session_resumption The value to assign to the {#has_session_resumption} property
    ...
    def hash
      [verify_depth, verify_peer_certificate, has_session_resumption, trusted_certificate_authority_ids, certificate_ids, certificate_name, server_order_preference, cipher_suite_name, protocols].hash
    end
