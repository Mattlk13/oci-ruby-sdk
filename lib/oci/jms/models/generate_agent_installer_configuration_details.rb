...
module OCI
  ...
  class Jms::Models::GenerateAgentInstallerConfigurationDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the management agent install key for which to generate the configuration file.
    # @return [String]
    attr_accessor :install_key_id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the fleet for which to generate the configuration file.
    # @return [String]
