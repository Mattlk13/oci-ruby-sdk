...
module OCI
  ...
  class Jms::Models::DeployedApplicationInstallationUsageSummary
    ...
    def hash
      [application_installation_key, application_key, fleet_id, application_name, application_type, application_source_path, is_clustered, approximate_java_server_instance_count, approximate_library_count, time_start, time_end, time_first_seen, time_last_seen].hash
    end
