...
module OCI
  ...
  class Jms::Models::JavaFamily
    ...
    def hash
      [latest_release_artifacts, family_version, display_name, support_type, end_of_support_life_date, doc_url, latest_release_version, is_supported_version, release_date].hash
    end
