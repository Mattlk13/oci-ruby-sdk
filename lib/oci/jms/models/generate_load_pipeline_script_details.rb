...
module OCI
  ...
  class Jms::Models::GenerateLoadPipelineScriptDetails
    ...
    #
    # @return [Integer]
    attr_accessor :interval_minutes
    ...
    # @option attributes [Integer] :interval_minutes The value to assign to the {#interval_minutes} property
