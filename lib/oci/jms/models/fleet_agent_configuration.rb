...
module OCI
  ...
  class Jms::Models::FleetAgentConfiguration
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_collecting_managed_instance_metrics_enabled

    # Collect username for application invocations for all managed instances in the fleet.
    #
    # @return [BOOLEAN]
    attr_accessor :is_collecting_usernames_enabled
    ...
    def self.swagger_types
      {
        ...
        'is_collecting_managed_instance_metrics_enabled': :'BOOLEAN',
        'is_collecting_usernames_enabled': :'BOOLEAN',
    ...
    # @option attributes [BOOLEAN] :is_collecting_managed_instance_metrics_enabled The value to assign to the {#is_collecting_managed_instance_metrics_enabled} property
    # @option attributes [BOOLEAN] :is_collecting_usernames_enabled The value to assign to the {#is_collecting_usernames_enabled} property
    ...
    def initialize(attributes = {})
      ...
      self.is_collecting_managed_instance_metrics_enabled = attributes[:'isCollectingManagedInstanceMetricsEnabled'] unless attributes[:'isCollectingManagedInstanceMetricsEnabled'].nil?
      self.is_collecting_managed_instance_metrics_enabled = false if is_collecting_managed_instance_metrics_enabled.nil? && !attributes.key?(:'isCollectingManagedInstanceMetricsEnabled') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :isCollectingManagedInstanceMetricsEnabled and :is_collecting_managed_instance_metrics_enabled' if attributes.key?(:'isCollectingManagedInstanceMetricsEnabled') && attributes.key?(:'is_collecting_managed_instance_metrics_enabled')

      self.is_collecting_managed_instance_metrics_enabled = attributes[:'is_collecting_managed_instance_metrics_enabled'] unless attributes[:'is_collecting_managed_instance_metrics_enabled'].nil?
      self.is_collecting_managed_instance_metrics_enabled = false if is_collecting_managed_instance_metrics_enabled.nil? && !attributes.key?(:'isCollectingManagedInstanceMetricsEnabled') && !attributes.key?(:'is_collecting_managed_instance_metrics_enabled') # rubocop:disable Style/StringLiterals

      self.is_collecting_usernames_enabled = attributes[:'isCollectingUsernamesEnabled'] unless attributes[:'isCollectingUsernamesEnabled'].nil?
      self.is_collecting_usernames_enabled = true if is_collecting_usernames_enabled.nil? && !attributes.key?(:'isCollectingUsernamesEnabled') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :isCollectingUsernamesEnabled and :is_collecting_usernames_enabled' if attributes.key?(:'isCollectingUsernamesEnabled') && attributes.key?(:'is_collecting_usernames_enabled')

      self.is_collecting_usernames_enabled = attributes[:'is_collecting_usernames_enabled'] unless attributes[:'is_collecting_usernames_enabled'].nil?
      self.is_collecting_usernames_enabled = true if is_collecting_usernames_enabled.nil? && !attributes.key?(:'isCollectingUsernamesEnabled') && !attributes.key?(:'is_collecting_usernames_enabled') # rubocop:disable Style/StringLiterals
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_collecting_managed_instance_metrics_enabled == other.is_collecting_managed_instance_metrics_enabled &&
        is_collecting_usernames_enabled == other.is_collecting_usernames_enabled &&
    ...
    def hash
      [jre_scan_frequency_in_minutes, java_usage_tracker_processing_frequency_in_minutes, work_request_validity_period_in_days, agent_polling_interval_in_minutes, is_collecting_managed_instance_metrics_enabled, is_collecting_usernames_enabled, linux_configuration, windows_configuration, mac_os_configuration, time_last_modified].hash
    end
