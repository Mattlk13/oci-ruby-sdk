...
module OCI
  ...
  class Jms::Models::CreateJmsPluginDetails
    ...
    # **[Required]** The OMA/OCA agent's compartment [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).
    # @return [String]
    ...
    def hash
      [agent_id, compartment_id, fleet_id, defined_tags, freeform_tags].hash
    end
