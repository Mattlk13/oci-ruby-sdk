...
module OCI
  ...
  class Jms::Models::JavaServerInstanceUsage
    ...
    #
    # @return [Integer]
    attr_accessor :server_instance_port
    ...
    # @option attributes [Integer] :server_instance_port The value to assign to the {#server_instance_port} property
    ...
    def initialize(attributes = {})
      ...
      self.server_instance_port = attributes[:'serverInstancePort'] if attributes[:'serverInstancePort']

      raise 'You cannot provide both :serverInstancePort and :server_instance_port' if attributes.key?(:'serverInstancePort') && attributes.key?(:'server_instance_port')

      self.server_instance_port = attributes[:'server_instance_port'] if attributes[:'server_instance_port']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        server_instance_port == other.server_instance_port &&
    ...
    def hash
      [server_instance_key, fleet_id, server_instance_name, server_instance_port, server_key, server_name, server_version, managed_instance_id, host_name, jvm_key, jvm_vendor, jvm_distribution, jvm_version, jvm_security_status, approximate_deployed_application_count, time_start, time_end, time_first_seen, time_last_seen].hash
    end
