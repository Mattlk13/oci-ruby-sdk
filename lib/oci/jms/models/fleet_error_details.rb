...
module OCI
  ...
  class Jms::Models::FleetErrorDetails
    REASON_ENUM = [
      REASON_NO_MANAGED_INSTANCES = 'NO_MANAGED_INSTANCES'.freeze,
      REASON_INVENTORY_LOG = 'INVENTORY_LOG'.freeze,
      REASON_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The fleet error reason.
    # @return [String]
    attr_reader :reason
