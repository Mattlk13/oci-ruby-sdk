...
module OCI
  ...
  class Jms::Models::CryptoAnalysisResultSummary
    ...
    def hash
      [id, work_request_id, aggregation_mode, fleet_id, managed_instance_id, host_name, time_first_event, time_last_event, total_event_count, summarized_event_count, finding_count, non_compliant_finding_count, time_created, time_started, time_finished, crypto_roadmap_version, namespace, bucket_name, object_name].hash
    end
