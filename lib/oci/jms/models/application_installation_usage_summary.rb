...
module OCI
  ...
  class Jms::Models::ApplicationInstallationUsageSummary
    ...
    # @return [Integer]
    attr_accessor :approximate_library_count

    # Comma separated list of user names that invoked application installations.
    # @return [String]
    attr_accessor :application_invoked_by
    ...
    # @option attributes [Integer] :approximate_library_count The value to assign to the {#approximate_library_count} property
    # @option attributes [String] :application_invoked_by The value to assign to the {#application_invoked_by} property
    ...
    def hash
      [application_installation_key, application_key, display_name, application_type, installation_path, full_class_path, operating_systems, approximate_installation_count, approximate_jre_count, approximate_managed_instance_count, approximate_library_count, application_invoked_by, time_start, time_end, time_first_seen, time_last_seen].hash
    end
