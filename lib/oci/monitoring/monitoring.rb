...
require 'oci/monitoring/models/alarm_suppression_compartment_target'
...
require 'oci/monitoring/models/recurrence'
...
require 'oci/monitoring/models/suppression_condition'
