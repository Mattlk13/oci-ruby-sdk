...
module OCI
  ...
  class Monitoring::MonitoringClient
    ...
    #   request, please provide the complete request ID.
    #
    # @option opts [String] :alarm_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the alarm that is the target of the alarm suppression.
    ...
    #
    # @option opts [String] :level The level of this alarm suppression.
    ...
    #
    # @option opts [String] :compartment_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment for searching.
    ...
    #
    # @option opts [String] :target_type The target type to use when listing alarm suppressions.
    ...
    # @option opts [BOOLEAN] :is_all_suppressions Setting this parameter to true requires the query to specify the alarm (`alarmId`).
    #
