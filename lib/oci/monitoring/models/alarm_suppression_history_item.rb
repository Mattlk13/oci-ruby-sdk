...
module OCI
  ...
  class Monitoring::Models::AlarmSuppressionHistoryItem
    ...
    def hash
      [suppression_id, alarm_suppression_target, level, display_name, description, dimensions, time_effective_from, time_effective_until, suppression_conditions].hash
    end
