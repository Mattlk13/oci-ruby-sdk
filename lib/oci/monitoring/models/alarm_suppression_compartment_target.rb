...
module OCI
  ...
  class Monitoring::Models::AlarmSuppressionCompartmentTarget < Monitoring::Models::AlarmSuppressionTarget
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment or tenancy that is the
    ...
    def initialize(attributes = {})
      ...
      attributes['targetType'] = 'COMPARTMENT'
    ...
    def hash
      [target_type, compartment_id, compartment_id_in_subtree].hash
    end
