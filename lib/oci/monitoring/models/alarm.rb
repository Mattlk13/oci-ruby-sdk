...
module OCI
  ...
  class Monitoring::Models::Alarm
    ...
    #
    # @return [String]
    attr_accessor :evaluation_slack_duration
    ...
    # @option attributes [String] :notification_title The value to assign to the {#notification_title} property
    # @option attributes [String] :evaluation_slack_duration The value to assign to the {#evaluation_slack_duration} property
    ...
    def hash
      [id, display_name, compartment_id, metric_compartment_id, metric_compartment_id_in_subtree, namespace, resource_group, query, resolution, pending_duration, severity, body, is_notifications_per_metric_dimension_enabled, message_format, destinations, repeat_notification_duration, suppression, is_enabled, freeform_tags, defined_tags, overrides, rule_name, notification_version, notification_title, evaluation_slack_duration, alarm_summary, lifecycle_state, time_created, time_updated].hash
    end
