...
module OCI
  ...
  #
  class Opensearch::Models::UpdateOpensearchClusterPipelineDetails
    ...
    def hash
      [display_name, ocpu_count, memory_gb, node_count, node_shape, pipeline_configuration_body, data_prepper_configuration_body, vcn_id, subnet_id, vcn_compartment_id, subnet_compartment_id, nsg_id, reverse_connection_endpoints, freeform_tags, defined_tags].hash
    end
