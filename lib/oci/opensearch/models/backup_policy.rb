...
module OCI
  ...
  #
  class Opensearch::Models::BackupPolicy
    ...
    # @return [Integer]
    attr_accessor :frequency_in_hours
    ...
    # @option attributes [Integer] :frequency_in_hours The value to assign to the {#frequency_in_hours} property
