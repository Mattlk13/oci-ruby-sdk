...
module OCI
  ...
  class Opensearch::Models::MaintenanceNotificationFailure
    # **[Required]** IDs of clusters
    # @return [Array<String>]
    attr_accessor :cluster_ids

    # **[Required]** Tenant ID of the cluster
    # @return [String]
    ...
    def hash
      [cluster_ids, tenant_id, error_code, error_description].hash
    end
