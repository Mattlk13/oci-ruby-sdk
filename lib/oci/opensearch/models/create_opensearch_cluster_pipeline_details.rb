...
module OCI
  ...
  class Opensearch::Models::CreateOpensearchClusterPipelineDetails
    ...
    # **[Required]** The OCID of the compartment to create the pipeline in.
    # @return [String]
    ...
    def hash
      [display_name, ocpu_count, memory_gb, node_count, node_shape, pipeline_configuration_body, data_prepper_configuration_body, compartment_id, vcn_id, subnet_id, vcn_compartment_id, subnet_compartment_id, nsg_id, reverse_connection_endpoints, freeform_tags, defined_tags].hash
    end
