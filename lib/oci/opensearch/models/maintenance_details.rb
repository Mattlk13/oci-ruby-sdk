...
module OCI
  ...
  class Opensearch::Models::MaintenanceDetails
    STATE_ENUM = [
      STATE_SCHEDULED = 'SCHEDULED'.freeze,
      STATE_RESCHEDULED = 'RESCHEDULED'.freeze,
      STATE_TO_BE_SCHEDULED = 'TO_BE_SCHEDULED'.freeze,
    ...
    # @return [Array<String>]
    attr_accessor :notification_email_ids
    ...
    # @option attributes [Array<String>] :notification_email_ids The value to assign to the {#notification_email_ids} property
    def initialize(attributes = {})
      ...
      self.state = "TO_BE_SCHEDULED" if state.nil? && !attributes.key?(:'state') # rubocop:disable Style/StringLiterals
      ...
      self.notification_email_ids = attributes[:'notificationEmailIds'] if attributes[:'notificationEmailIds']

      raise 'You cannot provide both :notificationEmailIds and :notification_email_ids' if attributes.key?(:'notificationEmailIds') && attributes.key?(:'notification_email_ids')

      self.notification_email_ids = attributes[:'notification_email_ids'] if attributes[:'notification_email_ids']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        notification_email_ids == other.notification_email_ids
    end
    ...
    def hash
      [state, start_time, end_time, notification_email_ids].hash
    end
