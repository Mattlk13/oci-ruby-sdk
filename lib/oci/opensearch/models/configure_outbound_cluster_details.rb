...
module OCI
  ...
  class Opensearch::Models::ConfigureOutboundClusterDetails
    # **[Required]** List of inbound clusters that will be queried using cross cluster search
    # @return [Array<String>]
