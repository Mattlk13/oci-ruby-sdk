...
module OCI
  ...
  #
  class Opensearch::Models::OutboundClusterSummary
    MODE_ENUM = [
    ...
    # @option attributes [String] :ping_schedule The value to assign to the {#ping_schedule} property
    # @option attributes [BOOLEAN] :is_skip_unavailable The value to assign to the {#is_skip_unavailable} property
    # @option attributes [String] :seed_cluster_id The value to assign to the {#seed_cluster_id} property
