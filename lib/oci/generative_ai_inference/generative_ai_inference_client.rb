...
module OCI
  ...
  class GenerativeAiInference::GenerativeAiInferenceClient
    ...
    #
    # @param [OCI::GenerativeAiInference::Models::ApplyGuardrailsDetails] apply_guardrails_details Details for applying guardrails to the input text.
    ...
    # @return [Response] A Response object with data of type {OCI::GenerativeAiInference::Models::ApplyGuardrailsResult ApplyGuardrailsResult}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/generativeaiinference/apply_guardrails.rb.html) to see an example of how to use apply_guardrails API.
    def apply_guardrails(apply_guardrails_details, opts = {})
      logger.debug 'Calling operation GenerativeAiInferenceClient#apply_guardrails.' if logger

      raise "Missing the required parameter 'apply_guardrails_details' when calling apply_guardrails." if apply_guardrails_details.nil?
      ...
      post_body = @api_client.object_to_http_body(apply_guardrails_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'GenerativeAiInferenceClient#apply_guardrails') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          body: post_body,
          return_type: 'OCI::GenerativeAiInference::Models::ApplyGuardrailsResult'
        )
      end
    ...
    #
    # @param [OCI::GenerativeAiInference::Models::RerankTextDetails] rerank_text_details Details required for the rerank request.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    #
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::GenerativeAiInference::Models::RerankTextResult RerankTextResult}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/generativeaiinference/rerank_text.rb.html) to see an example of how to use rerank_text API.
    def rerank_text(rerank_text_details, opts = {})
      logger.debug 'Calling operation GenerativeAiInferenceClient#rerank_text.' if logger

      raise "Missing the required parameter 'rerank_text_details' when calling rerank_text." if rerank_text_details.nil?
      ...
      post_body = @api_client.object_to_http_body(rerank_text_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'GenerativeAiInferenceClient#rerank_text') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::GenerativeAiInference::Models::RerankTextResult'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
