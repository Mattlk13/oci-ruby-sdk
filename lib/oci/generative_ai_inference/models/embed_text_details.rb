...
module OCI
  ...
  class GenerativeAiInference::Models::EmbedTextDetails
    ...
    INPUT_TYPE_ENUM = [
      ...
      INPUT_TYPE_IMAGE = 'IMAGE'.freeze
    ].freeze

    # **[Required]** Provide a list of strings or one base64 encoded image with `input_type` setting to `IMAGE`. If text embedding, each string can be words, a phrase, or a paragraph. The maximum length of each string entry in the list is 512 tokens.
    # @return [Array<String>]
