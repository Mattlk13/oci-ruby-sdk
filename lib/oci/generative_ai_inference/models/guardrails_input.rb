...
module OCI
  ...
  class GenerativeAiInference::Models::GuardrailsInput
    TYPE_ENUM = [
      TYPE_TEXT = 'TEXT'.freeze
    ].freeze

    # **[Required]** The type of the input data.
    # @return [String]
    attr_reader :type
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GenerativeAiInference::Models::GuardrailsTextInput' if type == 'TEXT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GenerativeAiInference::Models::GuardrailsInput'
    end
