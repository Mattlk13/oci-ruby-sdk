...
require 'date'
require_relative 'guardrails_input'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Represents a single instance of text in the guardrails input.
  class GenerativeAiInference::Models::GuardrailsTextInput < GenerativeAiInference::Models::GuardrailsInput
    ...
    def hash
      [type, content, language_code].hash
    end
