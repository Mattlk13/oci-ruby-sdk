...
require 'date'
require_relative 'cohere_message'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # A message that represents a single chat dialog as TOOL role.
  class GenerativeAiInference::Models::CohereToolMessage < GenerativeAiInference::Models::CohereMessage
    # **[Required]** A list of results from invoking tools recommended by the model in the previous chat turn.
