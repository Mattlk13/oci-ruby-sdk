...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::UpdateAgentEndpointDetails
    ...
    def hash
      [display_name, description, content_moderation_config, guardrail_config, metadata, human_input_config, output_config, should_enable_trace, should_enable_citation, should_enable_multi_language, session_config, freeform_tags, defined_tags].hash
    end
