...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::DataSource
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the data source.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the parent KnowledgeBase.
    # @return [String]
    attr_accessor :knowledge_base_id

    # This attribute is required.
    # @return [OCI::GenerativeAiAgent::Models::DataSourceConfig]
    ...
    # **[Required]** The date and time the data source was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    # @option attributes [OCI::GenerativeAiAgent::Models::DataSourceConfig] :data_source_config The value to assign to the {#data_source_config} property
    ...
    def initialize(attributes = {})
      ...
      self.data_source_config = attributes[:'dataSourceConfig'] if attributes[:'dataSourceConfig']

      raise 'You cannot provide both :dataSourceConfig and :data_source_config' if attributes.key?(:'dataSourceConfig') && attributes.key?(:'data_source_config')

      self.data_source_config = attributes[:'data_source_config'] if attributes[:'data_source_config']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        data_source_config == other.data_source_config &&
    ...
    def hash
      [id, display_name, description, compartment_id, knowledge_base_id, data_source_config, metadata, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
