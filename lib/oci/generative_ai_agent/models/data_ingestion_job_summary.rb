...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::DataIngestionJobSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the data ingestion job.
    # @return [String]
    attr_accessor :id
    ...
    def hash
      [id, display_name, description, data_source_id, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
