...
require 'date'
require_relative 'api_schema_input_location'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The details of OCI Object Storage object location for Api schema.
  #
  class GenerativeAiAgent::Models::ApiSchemaObjectStorageInputLocation < GenerativeAiAgent::Models::ApiSchemaInputLocation
    # **[Required]** The namespace name of an object.
    # @return [String]
    attr_accessor :namespace_name

    # **[Required]** The bucket name of an object.
    # @return [String]
    attr_accessor :bucket_name

    # **[Required]** The location/name of object.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['apiSchemaInputLocationType'] = 'OBJECT_STORAGE_LOCATION'
    ...
    def hash
      [api_schema_input_location_type, namespace_name, bucket_name, object_name].hash
    end
