...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::DataIngestionJob
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DataIngestionJob.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the parent DataSource.
    # @return [String]
    ...
    # @return [OCI::GenerativeAiAgent::Models::DataIngestionJobStatistics]
    attr_accessor :data_ingestion_job_statistics

    # **[Required]** The date and time the data ingestion job was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    # **[Required]** The current state of the data ingestion job.
    # @return [String]
    ...
    def self.swagger_types
      {
        ...
        'data_ingestion_job_statistics': :'OCI::GenerativeAiAgent::Models::DataIngestionJobStatistics',
    ...
    # @option attributes [OCI::GenerativeAiAgent::Models::DataIngestionJobStatistics] :data_ingestion_job_statistics The value to assign to the {#data_ingestion_job_statistics} property
    ...
    def initialize(attributes = {})
      ...
      self.data_ingestion_job_statistics = attributes[:'dataIngestionJobStatistics'] if attributes[:'dataIngestionJobStatistics']

      raise 'You cannot provide both :dataIngestionJobStatistics and :data_ingestion_job_statistics' if attributes.key?(:'dataIngestionJobStatistics') && attributes.key?(:'data_ingestion_job_statistics')

      self.data_ingestion_job_statistics = attributes[:'data_ingestion_job_statistics'] if attributes[:'data_ingestion_job_statistics']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        data_ingestion_job_statistics == other.data_ingestion_job_statistics &&
    ...
    def hash
      [id, display_name, description, compartment_id, data_source_id, knowledge_base_id, data_ingestion_job_statistics, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
