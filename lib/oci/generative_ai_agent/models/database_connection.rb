...
module OCI
  ...
  class GenerativeAiAgent::Models::DatabaseConnection
    CONNECTION_TYPE_ENUM = [
      CONNECTION_TYPE_DATABASE_TOOL_CONNECTION = 'DATABASE_TOOL_CONNECTION'.freeze,
      CONNECTION_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The type of Database connection.
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GenerativeAiAgent::Models::DatabaseToolConnection' if type == 'DATABASE_TOOL_CONNECTION'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GenerativeAiAgent::Models::DatabaseConnection'
    end
