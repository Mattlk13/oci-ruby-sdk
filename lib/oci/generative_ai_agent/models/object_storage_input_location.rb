...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::ObjectStorageInputLocation < GenerativeAiAgent::Models::InputLocation
    ...
    def initialize(attributes = {})
      ...
      attributes['inputLocationType'] = 'OBJECT_STORAGE_PREFIX'
    ...
    def hash
      [input_location_type, namespace_name, bucket_name, prefix].hash
    end
