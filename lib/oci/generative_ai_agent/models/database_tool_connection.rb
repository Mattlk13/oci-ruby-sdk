...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::DatabaseToolConnection < GenerativeAiAgent::Models::DatabaseConnection
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Tools Connection.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['connectionType'] = 'DATABASE_TOOL_CONNECTION'
    ...
    def hash
      [connection_type, connection_id].hash
    end
