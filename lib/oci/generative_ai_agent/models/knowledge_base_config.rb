...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::KnowledgeBaseConfig
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the knowledgeBase this RAG Tool uses
    # @return [String]
