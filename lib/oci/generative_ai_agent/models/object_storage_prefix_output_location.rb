...
require 'date'
require_relative 'output_location'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The config of object storage.
  #
  class GenerativeAiAgent::Models::ObjectStoragePrefixOutputLocation < GenerativeAiAgent::Models::OutputLocation
    # **[Required]** The namespace of the object storage.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['outputLocationType'] = 'OBJECT_STORAGE_PREFIX'
      ...
      self.prefix = "" if prefix.nil? && !attributes.key?(:'prefix') # rubocop:disable Style/StringLiterals
    end
    ...
    def hash
      [output_location_type, namespace_name, bucket_name, prefix].hash
    end
