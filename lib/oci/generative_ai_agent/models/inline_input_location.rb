...
module OCI
  ...
  class GenerativeAiAgent::Models::InlineInputLocation < GenerativeAiAgent::Models::InputLocation
    ...
    def initialize(attributes = {})
      ...
      attributes['inputLocationType'] = 'INLINE'
    ...
    def hash
      [input_location_type, content].hash
    end
