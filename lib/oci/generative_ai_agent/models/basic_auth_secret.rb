...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::BasicAuthSecret < GenerativeAiAgent::Models::SecretDetail
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret for basic authentication.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['type'] = 'BASIC_AUTH_SECRET'
