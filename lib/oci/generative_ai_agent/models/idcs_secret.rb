...
require 'date'
require 'logger'
require_relative 'secret_detail'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The details of IDCS configured as OpenID setting in OpenSearch.
  #
  class GenerativeAiAgent::Models::IdcsSecret < GenerativeAiAgent::Models::SecretDetail
    # **[Required]** The URL represent authentication url of the IDCS.
    # @return [String]
    attr_accessor :idcs_url

    # **[Required]** The IDCS Connect clientId.
    # @return [String]
    attr_accessor :client_id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret for client secret.
    # @return [String]
    attr_accessor :vault_secret_id

    # **[Required]** Fully qualified scope url
    # @return [String]
    attr_accessor :scope_url
    ...
    # @option attributes [String] :idcs_url The value to assign to the {#idcs_url} property
    ...
    # @option attributes [String] :scope_url The value to assign to the {#scope_url} property
