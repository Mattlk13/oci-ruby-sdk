...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::DataSourceSummary
    ...
    def hash
      [id, display_name, description, knowledge_base_id, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
