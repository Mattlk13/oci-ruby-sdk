...
module OCI
  ...
  #
  class GenerativeAiAgent::Models::CreateDataIngestionJobDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to create the data ingestion job in.
    #
    # @return [String]
    ...
    def hash
      [display_name, description, data_source_id, compartment_id, freeform_tags, defined_tags].hash
    end
