...
require 'date'
require_relative 'task_details_response'
...
module OCI
  ...
  #
  class Sch::Models::FunctionTaskDetailsResponse < Sch::Models::TaskDetailsResponse
    ...
    # @option attributes [OCI::Sch::Models::PrivateEndpointMetadata] :private_endpoint_metadata The value to assign to the {OCI::Sch::Models::TaskDetailsResponse#private_endpoint_metadata #private_endpoint_metadata} proprety
    ...
    def hash
      [private_endpoint_metadata, kind, function_id, batch_size_in_kbs, batch_time_in_sec].hash
    end
