...
module OCI
  ...
  class Sch::Models::ServiceConnector
    ...
    # @return [OCI::Sch::Models::SourceDetailsResponse]
    attr_accessor :source

    # The list of tasks.
    #
    # @return [Array<OCI::Sch::Models::TaskDetailsResponse>]
    attr_accessor :tasks

    # @return [OCI::Sch::Models::TargetDetailsResponse]
    ...
    # @option attributes [OCI::Sch::Models::SourceDetailsResponse] :source The value to assign to the {#source} property
    # @option attributes [Array<OCI::Sch::Models::TaskDetailsResponse>] :tasks The value to assign to the {#tasks} property
    # @option attributes [OCI::Sch::Models::TargetDetailsResponse] :target The value to assign to the {#target} property
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, lifecyle_details, source, tasks, target, freeform_tags, defined_tags, system_tags].hash
    end
