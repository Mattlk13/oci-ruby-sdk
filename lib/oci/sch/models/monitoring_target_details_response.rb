...
module OCI
  ...
  #
  class Sch::Models::MonitoringTargetDetailsResponse < Sch::Models::TargetDetailsResponse
    ...
    def hash
      [private_endpoint_metadata, kind, compartment_id, metric_namespace, metric, dimensions].hash
    end
