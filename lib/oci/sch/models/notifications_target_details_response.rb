...
module OCI
  ...
  #
  class Sch::Models::NotificationsTargetDetailsResponse < Sch::Models::TargetDetailsResponse
    ...
    def hash
      [private_endpoint_metadata, kind, topic_id, enable_formatted_messaging].hash
    end
