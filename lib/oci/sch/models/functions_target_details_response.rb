...
module OCI
  ...
  #
  class Sch::Models::FunctionsTargetDetailsResponse < Sch::Models::TargetDetailsResponse
    ...
    def hash
      [private_endpoint_metadata, kind, function_id, batch_size_in_kbs, batch_size_in_num, batch_time_in_sec].hash
    end
