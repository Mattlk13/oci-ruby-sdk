...
require 'date'
require_relative 'target_details_response'
...
module OCI
  ...
  #
  class Sch::Models::ObjectStorageTargetDetailsResponse < Sch::Models::TargetDetailsResponse
    # The namespace.
    #
    # @return [String]
    ...
    # @option attributes [OCI::Sch::Models::PrivateEndpointMetadata] :private_endpoint_metadata The value to assign to the {OCI::Sch::Models::TargetDetailsResponse#private_endpoint_metadata #private_endpoint_metadata} proprety
    ...
    def hash
      [private_endpoint_metadata, kind, namespace, bucket_name, object_name_prefix, batch_rollover_size_in_mbs, batch_rollover_time_in_ms].hash
    end
