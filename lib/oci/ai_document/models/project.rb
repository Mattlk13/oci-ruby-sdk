...
module OCI
  ...
  class AiDocument::Models::Project
    ...
    # @return [Array<OCI::AiDocument::Models::ResourceLock>]
    attr_accessor :locks
    ...
    def self.swagger_types
      {
        ...
        'locks': :'Array<OCI::AiDocument::Models::ResourceLock>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::AiDocument::Models::ResourceLock>] :locks The value to assign to the {#locks} property
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags, locks].hash
    end
