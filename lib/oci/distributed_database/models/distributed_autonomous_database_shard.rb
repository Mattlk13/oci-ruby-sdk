...
module OCI
  ...
  class DistributedDatabase::Models::DistributedAutonomousDatabaseShard
    SOURCE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseShardWithDedicatedInfra' if type == 'ADB_D'
