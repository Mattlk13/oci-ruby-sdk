...
module OCI
  ...
  #
  class DistributedDatabase::Models::DistributedDbBackupConfig
    ...
    # @return [BOOLEAN]
    attr_accessor :is_auto_backup_enabled
    ...
    # @return [BOOLEAN]
    attr_accessor :can_run_immediate_full_backup
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_remote_backup_enabled
    ...
    # @return [Array<OCI::DistributedDatabase::Models::DistributedDbBackupDestination>]
    ...
    # @option attributes [BOOLEAN] :is_auto_backup_enabled The value to assign to the {#is_auto_backup_enabled} property
    ...
    # @option attributes [BOOLEAN] :can_run_immediate_full_backup The value to assign to the {#can_run_immediate_full_backup} property
    # @option attributes [BOOLEAN] :is_remote_backup_enabled The value to assign to the {#is_remote_backup_enabled} property
    # @option attributes [String] :remote_region The value to assign to the {#remote_region} property
    # @option attributes [Array<OCI::DistributedDatabase::Models::DistributedDbBackupDestination>] :backup_destination_details The value to assign to the {#backup_destination_details} property
