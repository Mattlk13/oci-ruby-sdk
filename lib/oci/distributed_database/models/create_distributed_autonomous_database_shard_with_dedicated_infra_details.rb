...
require 'date'
require_relative 'create_distributed_autonomous_database_shard_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Globally distributed autonomous database shard with dedicated autonomous infrastructure.
  class DistributedDatabase::Models::CreateDistributedAutonomousDatabaseShardWithDedicatedInfraDetails < DistributedDatabase::Models::CreateDistributedAutonomousDatabaseShardDetails
