...
module OCI
  ...
  class DistributedDatabase::Models::DistributedAutonomousDatabase
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Globally distributed autonomous database.
    # @return [String]
    attr_accessor :id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Globally distributed autonomous database compartment.
    # @return [String]
    ...
    # **[Required]** Lifecycle states for the Globally distributed autonomous database.
    # @return [String]
    ...
    # @return [OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseConnectionString]
    attr_accessor :connection_strings

    # **[Required]** Unique name prefix for the Globally distributed autonomous databases. Only alpha-numeric values are allowed. First character
    ...
    attr_accessor :latest_gsm_image
    ...
    # @return [Array<OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseShard>]
    attr_accessor :shard_details

    # Collection of catalogs associated with the Globally distributed autonomous database.
    # @return [Array<OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseCatalog>]
    attr_accessor :catalog_details

    # Collection of catalogs associated with the Globally distributed autonomous database.
    # @return [Array<OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseGsm>]
    ...
    def self.swagger_types
      {
        ...
        'latest_gsm_image': :'OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseGsmImage',
        'db_deployment_type': :'String',
        'shard_details': :'Array<OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseShard>',
        'catalog_details': :'Array<OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseCatalog>',
        'gsm_details': :'Array<OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseGsm>',
    ...
    # @option attributes [OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseConnectionString] :connection_strings The value to assign to the {#connection_strings} property
    ...
    # @option attributes [OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseGsmImage] :latest_gsm_image The value to assign to the {#latest_gsm_image} property
    # @option attributes [String] :db_deployment_type The value to assign to the {#db_deployment_type} property
    # @option attributes [Array<OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseShard>] :shard_details The value to assign to the {#shard_details} property
    # @option attributes [Array<OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseCatalog>] :catalog_details The value to assign to the {#catalog_details} property
    # @option attributes [Array<OCI::DistributedDatabase::Models::DistributedAutonomousDatabaseGsm>] :gsm_details The value to assign to the {#gsm_details} property
    ...
    def initialize(attributes = {})
      ...
      self.latest_gsm_image = attributes[:'latestGsmImage'] if attributes[:'latestGsmImage']

      raise 'You cannot provide both :latestGsmImage and :latest_gsm_image' if attributes.key?(:'latestGsmImage') && attributes.key?(:'latest_gsm_image')

      self.latest_gsm_image = attributes[:'latest_gsm_image'] if attributes[:'latest_gsm_image']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        latest_gsm_image == other.latest_gsm_image &&
    ...
    def hash
      [id, compartment_id, display_name, time_created, time_updated, database_version, lifecycle_state, lifecycle_details, connection_strings, prefix, private_endpoint_ids, sharding_method, db_workload, character_set, ncharacter_set, chunks, listener_port, listener_port_tls, ons_port_local, ons_port_remote, replication_method, replication_factor, replication_unit, latest_gsm_image, db_deployment_type, shard_details, catalog_details, gsm_details, metadata, freeform_tags, defined_tags, system_tags].hash
    end
