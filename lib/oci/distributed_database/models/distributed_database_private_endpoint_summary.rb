...
module OCI
  ...
  class DistributedDatabase::Models::DistributedDatabasePrivateEndpointSummary
    # **[Required]** DistributedDatabasePrivateEndpoint identifier
    # @return [String]
    attr_accessor :id
    ...
    def hash
      [id, description, compartment_id, subnet_id, vcn_id, display_name, nsg_ids, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
