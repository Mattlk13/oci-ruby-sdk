...
module OCI
  ...
  # single operation.
  #
  class DistributedDatabase::Models::PatchDistributedAutonomousDatabaseDetails
    # List of patch instructions.
    # @return [Array<OCI::DistributedDatabase::Models::PatchInstruction>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::DistributedDatabase::Models::PatchInstruction>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::DistributedDatabase::Models::PatchInstruction>] :items The value to assign to the {#items} property
