...
module OCI
  ...
  class DistributedDatabase::Models::CreateDistributedAutonomousDatabaseCatalogDetails
    SOURCE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DistributedDatabase::Models::CreateDistributedAutonomousDatabaseCatalogWithDedicatedInfraDetails' if type == 'ADB_D'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DistributedDatabase::Models::CreateDistributedAutonomousDatabaseCatalogDetails'
    end
