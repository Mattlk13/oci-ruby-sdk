...
module OCI
  ...
  class DistributedDatabase::Models::DistributedDbBackupDestination
    TYPE_ENUM = [
      TYPE_NFS = 'NFS'.freeze,
    ...
    def hash
      [type, id, vpc_user, vpc_password, is_zero_data_loss_enabled, internet_proxy, dbrs_policy_id, is_remote, remote_region].hash
    end
