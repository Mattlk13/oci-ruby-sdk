...
module OCI
  ...
  class DistributedDatabase::Models::DistributedAutonomousDatabaseCatalogWithDedicatedInfra < DistributedDatabase::Models::DistributedAutonomousDatabaseCatalog
    ...
    def hash
      [source, name, time_created, time_updated, compute_count, data_storage_size_in_gbs, is_auto_scaling_enabled, shard_group, cloud_autonomous_vm_cluster_id, peer_cloud_autonomous_vm_cluster_ids, vault_id, kms_key_id, kms_key_version_id, status, supporting_resource_id, container_database_id, peer_details, metadata].hash
    end
