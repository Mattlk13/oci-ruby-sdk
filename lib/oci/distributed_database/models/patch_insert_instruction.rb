...
module OCI
  ...
  #
  class DistributedDatabase::Models::PatchInsertInstruction < DistributedDatabase::Models::PatchInstruction
    ...
    # @option attributes [String] :selection The value to assign to the {OCI::DistributedDatabase::Models::PatchInstruction#selection #selection} proprety
