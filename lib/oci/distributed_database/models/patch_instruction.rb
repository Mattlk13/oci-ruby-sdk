...
module OCI
  ...
  class DistributedDatabase::Models::PatchInstruction
    OPERATION_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DistributedDatabase::Models::PatchRemoveInstruction' if type == 'REMOVE'
      return 'OCI::DistributedDatabase::Models::PatchInsertInstruction' if type == 'INSERT'
      return 'OCI::DistributedDatabase::Models::PatchMergeInstruction' if type == 'MERGE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DistributedDatabase::Models::PatchInstruction'
    end
