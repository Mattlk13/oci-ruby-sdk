...
module OCI
  ...
  class DistributedDatabase::Models::DistributedAutonomousDatabaseAssociatedWithPrivateEndpoint
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the distributed database.
    # @return [String]
    attr_accessor :id

    # **[Required]** The dbDeploymentType associated with the distributed autonomous database.
    # @return [String]
    attr_accessor :db_deployment_type
