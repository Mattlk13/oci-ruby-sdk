...
module OCI
  ...
  class DistributedDatabase::Models::DistributedDatabaseGsm
    STATUS_ENUM = [
    ...
    # **[Required]** Status of the gsm for the Globally ditributed database.
    # @return [String]
    attr_reader :status
    ...
    def self.swagger_types
      {
        ...
        'gsm_image_details': :'OCI::DistributedDatabase::Models::DistributedDbGsmImage',
    ...
    # @option attributes [OCI::DistributedDatabase::Models::DistributedDbGsmImage] :gsm_image_details The value to assign to the {#gsm_image_details} property
