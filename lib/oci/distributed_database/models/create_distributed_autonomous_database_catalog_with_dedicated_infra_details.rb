...
module OCI
  ...
  class DistributedDatabase::Models::CreateDistributedAutonomousDatabaseCatalogWithDedicatedInfraDetails < DistributedDatabase::Models::CreateDistributedAutonomousDatabaseCatalogDetails
    ...
    # The collection of [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the peer cloud Autonomous VM Clusters.
    # @return [Array<String>]
    ...
    def hash
      [source, admin_password, compute_count, data_storage_size_in_gbs, is_auto_scaling_enabled, cloud_autonomous_vm_cluster_id, peer_cloud_autonomous_vm_cluster_ids, vault_id, kms_key_id, kms_key_version_id].hash
    end
