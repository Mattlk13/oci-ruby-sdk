...
module OCI
  ...
  class DistributedDatabase::Models::CatalogPeerWithDedicatedInfra
    STATUS_ENUM = [
    ...
    def hash
      [cloud_autonomous_vm_cluster_id, shard_group, status, supporting_resource_id, container_database_id, time_created, time_updated, metadata].hash
    end
