...
module OCI
  ...
  class DistributedDatabase::Models::DistributedAutonomousDatabaseSummary
    ...
    def hash
      [id, compartment_id, display_name, time_created, time_updated, database_version, lifecycle_state, lifecycle_details, connection_strings, prefix, private_endpoint_ids, sharding_method, db_workload, character_set, ncharacter_set, chunks, listener_port, listener_port_tls, ons_port_local, ons_port_remote, replication_method, replication_factor, replication_unit, db_deployment_type, metadata, freeform_tags, defined_tags, system_tags].hash
    end
