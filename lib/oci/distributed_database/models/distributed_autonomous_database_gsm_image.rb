...
module OCI
  ...
  class DistributedDatabase::Models::DistributedAutonomousDatabaseGsmImage
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Global service manager software image.
    # @return [String]
    attr_accessor :id

    # **[Required]** The version number associated with the image identified by id.
    # @return [Integer]
