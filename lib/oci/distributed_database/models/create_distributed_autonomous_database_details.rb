...
module OCI
  ...
  class DistributedDatabase::Models::CreateDistributedAutonomousDatabaseDetails
    ...
    # @return [Array<OCI::DistributedDatabase::Models::CreateDistributedAutonomousDatabaseShardDetails>]
    attr_accessor :shard_details

    # **[Required]** Collection of catalog for the Globally distributed autonomous database.
    # @return [Array<OCI::DistributedDatabase::Models::CreateDistributedAutonomousDatabaseCatalogDetails>]
    ...
    # @option attributes [Array<OCI::DistributedDatabase::Models::CreateDistributedAutonomousDatabaseShardDetails>] :shard_details The value to assign to the {#shard_details} property
    # @option attributes [Array<OCI::DistributedDatabase::Models::CreateDistributedAutonomousDatabaseCatalogDetails>] :catalog_details The value to assign to the {#catalog_details} property
    ...
    def hash
      [compartment_id, display_name, database_version, prefix, private_endpoint_ids, sharding_method, db_workload, character_set, ncharacter_set, chunks, listener_port, listener_port_tls, ons_port_local, ons_port_remote, replication_method, replication_factor, replication_unit, db_deployment_type, shard_details, catalog_details, freeform_tags, defined_tags].hash
    end
