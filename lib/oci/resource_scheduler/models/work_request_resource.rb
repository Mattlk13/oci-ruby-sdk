...
module OCI
  ...
  class ResourceScheduler::Models::WorkRequestResource
    ACTION_TYPE_ENUM = [
    ...
    # **[Required]** This is the resource type that the work request affects.
    # @return [String]
    ...
    # **[Required]** This is an [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) or other unique identifier for the resource.
    # @return [String]
