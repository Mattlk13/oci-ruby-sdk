...
module OCI
  ...
  class ResourceScheduler::Models::UpdateScheduleDetails
    ACTION_ENUM = [
    ...
    def hash
      [display_name, description, action, recurrence_details, recurrence_type, resource_filters, resources, time_starts, time_ends, freeform_tags, defined_tags].hash
    end
