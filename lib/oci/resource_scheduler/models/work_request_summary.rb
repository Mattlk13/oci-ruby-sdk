...
module OCI
  ...
  class ResourceScheduler::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::ResourceScheduler::Models::WorkRequestResource>]
    ...
    # **[Required]** This is the date and time the work request was created, in the format defined by
    ...
    # @option attributes [Array<OCI::ResourceScheduler::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
