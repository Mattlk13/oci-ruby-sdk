...
module OCI
  ...
  #
  class ResourceScheduler::Models::Schedule
    ACTION_ENUM = [
    ...
    # **[Required]** This is the date and time the schedule was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    #
    # Example: `2016-08-25T21:10:29.600Z`
    #
    # @return [DateTime]
    ...
    # **[Required]** These are free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace.
    ...
    # **[Required]** These are defined tags for this resource. Each key is predefined and scoped to a namespace.
    # For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
    #
    ...
    def hash
      [id, compartment_id, display_name, description, action, recurrence_details, recurrence_type, resource_filters, resources, time_starts, time_ends, time_created, time_updated, time_last_run, time_next_run, last_run_status, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
