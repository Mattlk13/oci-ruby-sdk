...
module OCI
  ...
  class ResourceScheduler::Models::TimeCreatedResourceFilter < ResourceScheduler::Models::ResourceFilter
    CONDITION_ENUM = [
      CONDITION_EQUAL = 'EQUAL'.freeze,
      CONDITION_BEFORE = 'BEFORE'.freeze,
      CONDITION_AFTER = 'AFTER'.freeze,
    ...
    def initialize(attributes = {})
      ...
      attributes['attribute'] = 'TIME_CREATED'
