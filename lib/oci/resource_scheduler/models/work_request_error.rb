...
module OCI
  ...
  class ResourceScheduler::Models::WorkRequestError
    ...
    # **[Required]** This is a human-readable error message.
    # @return [String]
    attr_accessor :message

    # **[Required]** This is the date and time the error occurred, in the format defined by
