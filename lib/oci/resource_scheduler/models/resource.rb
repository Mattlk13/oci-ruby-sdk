...
module OCI
  ...
  #
  class ResourceScheduler::Models::Resource
    ...
    # }
    #
    # @return [Array<OCI::ResourceScheduler::Models::Parameter>]
    ...
    # @option attributes [Array<OCI::ResourceScheduler::Models::Parameter>] :parameters The value to assign to the {#parameters} property
