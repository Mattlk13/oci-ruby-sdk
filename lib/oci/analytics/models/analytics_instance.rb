...
module OCI
  ...
  class Analytics::Models::AnalyticsInstance
    ...
    UPDATE_CHANNEL_ENUM = [
      ...
      UPDATE_CHANNEL_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    FEATURE_BUNDLE_ENUM = [
      ...
      FEATURE_BUNDLE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @option attributes [String] :update_channel The value to assign to the {#update_channel} property
    ...
    # @option attributes [String] :feature_bundle The value to assign to the {#feature_bundle} property
    ...
    def initialize(attributes = {})
      ...
      self.update_channel = attributes[:'updateChannel'] if attributes[:'updateChannel']

      raise 'You cannot provide both :updateChannel and :update_channel' if attributes.key?(:'updateChannel') && attributes.key?(:'update_channel')

      self.update_channel = attributes[:'update_channel'] if attributes[:'update_channel']
      ...
      self.feature_bundle = attributes[:'featureBundle'] if attributes[:'featureBundle']

      raise 'You cannot provide both :featureBundle and :feature_bundle' if attributes.key?(:'featureBundle') && attributes.key?(:'feature_bundle')

      self.feature_bundle = attributes[:'feature_bundle'] if attributes[:'feature_bundle']
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] update_channel Object to be assigned
    def update_channel=(update_channel)
      # rubocop:disable Style/ConditionalAssignment
      if update_channel && !UPDATE_CHANNEL_ENUM.include?(update_channel)
        OCI.logger.debug("Unknown value for 'update_channel' [" + update_channel + "]. Mapping to 'UPDATE_CHANNEL_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @update_channel = UPDATE_CHANNEL_UNKNOWN_ENUM_VALUE
      else
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] feature_bundle Object to be assigned
    def feature_bundle=(feature_bundle)
      # rubocop:disable Style/ConditionalAssignment
      if feature_bundle && !FEATURE_BUNDLE_ENUM.include?(feature_bundle)
        OCI.logger.debug("Unknown value for 'feature_bundle' [" + feature_bundle + "]. Mapping to 'FEATURE_BUNDLE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @feature_bundle = FEATURE_BUNDLE_UNKNOWN_ENUM_VALUE
      else
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        update_channel == other.update_channel &&
        ...
        feature_bundle == other.feature_bundle &&
    ...
    def hash
      [id, name, description, compartment_id, lifecycle_state, feature_set, capacity, license_type, email_notification, update_channel, network_endpoint_details, private_access_channels, vanity_url_details, service_url, defined_tags, freeform_tags, system_tags, kms_key_id, time_created, time_updated, feature_bundle, domain_id].hash
    end
