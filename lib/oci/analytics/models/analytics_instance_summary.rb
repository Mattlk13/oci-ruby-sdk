...
module OCI
  ...
  class Analytics::Models::AnalyticsInstanceSummary
    ...
    def hash
      [id, name, description, compartment_id, lifecycle_state, feature_set, capacity, license_type, email_notification, network_endpoint_details, service_url, defined_tags, freeform_tags, system_tags, time_created, time_updated].hash
    end
