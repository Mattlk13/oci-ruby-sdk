...
module OCI
  ...
  class Analytics::Models::CreateAnalyticsInstanceDetails
    ...
    # @option attributes [String] :admin_user The value to assign to the {#admin_user} property
    ...
    def initialize(attributes = {})
      ...
      self.admin_user = attributes[:'adminUser'] if attributes[:'adminUser']

      raise 'You cannot provide both :adminUser and :admin_user' if attributes.key?(:'adminUser') && attributes.key?(:'admin_user')

      self.admin_user = attributes[:'admin_user'] if attributes[:'admin_user']
    ...
    def update_channel=(update_channel)
      raise "Invalid value for 'update_channel': this must be one of the values in UPDATE_CHANNEL_ENUM." if update_channel && !UPDATE_CHANNEL_ENUM.include?(update_channel)
    ...
    def feature_bundle=(feature_bundle)
      raise "Invalid value for 'feature_bundle': this must be one of the values in FEATURE_BUNDLE_ENUM." if feature_bundle && !FEATURE_BUNDLE_ENUM.include?(feature_bundle)
    ...
    def hash
      [name, description, compartment_id, feature_set, capacity, license_type, email_notification, network_endpoint_details, idcs_access_token, defined_tags, freeform_tags, update_channel, kms_key_id, domain_id, admin_user, feature_bundle].hash
    end
