...
module OCI
  ...
  class Analytics::AnalyticsClient
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/analytics/set_feature_bundle.rb.html) to see an example of how to use set_feature_bundle API.
