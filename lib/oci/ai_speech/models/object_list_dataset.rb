...
module OCI
  ...
  class AiSpeech::Models::ObjectListDataset < AiSpeech::Models::LocationDetails
    ...
    # **[Required]** Array of files (minimum 1, maximum 1024) which need to be processed in the bucket
    # @return [Array<String>]
    ...
    def hash
      [location_type, bucket_name, namespace_name, object_names].hash
    end
