...
module OCI
  ...
  class AiSpeech::Models::RealtimeModelDetails
    DOMAIN_ENUM = [
      DOMAIN_GENERIC = 'GENERIC'.freeze,
      DOMAIN_MEDICAL = 'MEDICAL'.freeze
    ].freeze
    ...
    def domain=(domain)
      raise "Invalid value for 'domain': this must be one of the values in DOMAIN_ENUM." if domain && !DOMAIN_ENUM.include?(domain)
