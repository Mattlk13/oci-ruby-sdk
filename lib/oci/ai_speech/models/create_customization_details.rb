...
module OCI
  ...
  class AiSpeech::Models::CreateCustomizationDetails
    ...
    def hash
      [compartment_id, _alias, display_name, description, model_details, training_dataset, freeform_tags, defined_tags].hash
    end
