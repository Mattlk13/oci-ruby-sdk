...
module OCI
  ...
  class AiSpeech::Models::CustomizationSummary
    ...
    def hash
      [id, display_name, compartment_id, _alias, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
