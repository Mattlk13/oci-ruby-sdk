...
module OCI
  ...
  class AiSpeech::Models::TtsAudioConfig
    CONFIG_TYPE_ENUM = [
      CONFIG_TYPE_BASE_AUDIO_CONFIG = 'BASE_AUDIO_CONFIG'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::AiSpeech::Models::TtsBaseAudioConfig' if type == 'BASE_AUDIO_CONFIG'
