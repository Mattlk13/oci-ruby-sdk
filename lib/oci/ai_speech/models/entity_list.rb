...
module OCI
  ...
  #
  class AiSpeech::Models::EntityList
    ...
    # @return [Array<OCI::AiSpeech::Models::Entity>]
    ...
    # @option attributes [Array<OCI::AiSpeech::Models::Entity>] :entities The value to assign to the {#entities} property
    ...
    def hash
      [_alias, id, entity_type, entities].hash
    end
