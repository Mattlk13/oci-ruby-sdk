...
module OCI
  ...
  class AiSpeech::Models::RealtimeMessageAckAudioDetails
    # **[Required]** Sequence number of the acknowledged packet.
    # @return [Integer]
    attr_accessor :number

    # **[Required]** Offset of the acknowledged packet.
    # @return [Integer]
    attr_accessor :offset

    # **[Required]** Length in bytes of the acknowledged packet.
    # @return [Integer]
    ...
    # @option attributes [Integer] :number The value to assign to the {#number} property
