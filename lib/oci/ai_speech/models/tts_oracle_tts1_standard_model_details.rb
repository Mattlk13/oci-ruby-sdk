...
require 'date'
require_relative 'tts_oracle_model_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Use this schema for specifying properties of TTS_1_STANDARD model from Oracle model family.
  class AiSpeech::Models::TtsOracleTts1StandardModelDetails < AiSpeech::Models::TtsOracleModelDetails
    # Speaker in whose voice the user wants the output speech to be in.
    # The possible values for `voiceId` can be obtained by calling {#list_voices list_voices} api.
    #
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['modelName'] = 'TTS_1_STANDARD'
