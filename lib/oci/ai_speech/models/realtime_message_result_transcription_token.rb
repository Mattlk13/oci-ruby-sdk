...
module OCI
  ...
  class AiSpeech::Models::RealtimeMessageResultTranscriptionToken
    TYPE_ENUM = [
      TYPE_WORD = 'WORD'.freeze,
      TYPE_PUNCTUATION = 'PUNCTUATION'.freeze
    ].freeze

    # **[Required]** Transcription token.
    # @return [String]
    attr_accessor :token

    # **[Required]** Start time in milliseconds for the transcription token.
    # @return [Integer]
    attr_accessor :start_time_in_ms

    # **[Required]** End time in milliseconds for the transcription token.
    # @return [Integer]
    attr_accessor :end_time_in_ms

    # **[Required]** Confidence score for the transcription token.
    # @return [Float]
    attr_accessor :confidence

    # **[Required]** Type of the transcription token.
    # @return [String]
    attr_reader :type
    ...
    def hash
      [token, start_time_in_ms, end_time_in_ms, confidence, type].hash
    end
