...
module OCI
  ...
  class AiSpeech::AIServiceSpeechClient
    ...
    # @param [String] customization_id Unique Customization training Job identifier.
    # @param [OCI::AiSpeech::Models::ChangeCustomizationCompartmentDetails] change_customization_compartment_details Details for changing the compartment of a Customization.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aispeech/change_customization_compartment.rb.html) to see an example of how to use change_customization_compartment API.
    def change_customization_compartment(customization_id, change_customization_compartment_details, opts = {})
      logger.debug 'Calling operation AIServiceSpeechClient#change_customization_compartment.' if logger

      raise "Missing the required parameter 'customization_id' when calling change_customization_compartment." if customization_id.nil?
      raise "Missing the required parameter 'change_customization_compartment_details' when calling change_customization_compartment." if change_customization_compartment_details.nil?
      raise "Parameter value for 'customization_id' must not be blank" if OCI::Internal::Util.blank_string?(customization_id)

      path = '/customizations/{customizationId}/actions/changeCompartment'.sub('{customizationId}', customization_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(change_customization_compartment_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceSpeechClient#change_customization_compartment') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [OCI::AiSpeech::Models::CreateCustomizationDetails] create_customization_details Details for the new Customization.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    #
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::AiSpeech::Models::Customization Customization}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aispeech/create_customization.rb.html) to see an example of how to use create_customization API.
    def create_customization(create_customization_details, opts = {})
      logger.debug 'Calling operation AIServiceSpeechClient#create_customization.' if logger

      raise "Missing the required parameter 'create_customization_details' when calling create_customization." if create_customization_details.nil?
      ...
      post_body = @api_client.object_to_http_body(create_customization_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceSpeechClient#create_customization') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::AiSpeech::Models::Customization'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @param [OCI::AiSpeech::Models::CreateRealtimeSessionTokenDetails] create_realtime_session_token_details An object containing the compartment ID for authorization purposes.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    #
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::AiSpeech::Models::RealtimeSessionToken RealtimeSessionToken}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aispeech/create_realtime_session_token.rb.html) to see an example of how to use create_realtime_session_token API.
    def create_realtime_session_token(create_realtime_session_token_details, opts = {})
      logger.debug 'Calling operation AIServiceSpeechClient#create_realtime_session_token.' if logger

      raise "Missing the required parameter 'create_realtime_session_token_details' when calling create_realtime_session_token." if create_realtime_session_token_details.nil?
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceSpeechClient#create_realtime_session_token') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::AiSpeech::Models::RealtimeSessionToken'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aispeech/delete_customization.rb.html) to see an example of how to use delete_customization API.
    def delete_customization(customization_id, opts = {})
      logger.debug 'Calling operation AIServiceSpeechClient#delete_customization.' if logger

      raise "Missing the required parameter 'customization_id' when calling delete_customization." if customization_id.nil?
      raise "Parameter value for 'customization_id' must not be blank" if OCI::Internal::Util.blank_string?(customization_id)

      path = '/customizations/{customizationId}'.sub('{customizationId}', customization_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceSpeechClient#delete_customization') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::AiSpeech::Models::Customization Customization}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aispeech/get_customization.rb.html) to see an example of how to use get_customization API.
    def get_customization(customization_id, opts = {})
      logger.debug 'Calling operation AIServiceSpeechClient#get_customization.' if logger

      raise "Missing the required parameter 'customization_id' when calling get_customization." if customization_id.nil?
      raise "Parameter value for 'customization_id' must not be blank" if OCI::Internal::Util.blank_string?(customization_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceSpeechClient#get_customization') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::AiSpeech::Models::CustomizationCollection CustomizationCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aispeech/list_customizations.rb.html) to see an example of how to use list_customizations API.
    def list_customizations(opts = {})
      logger.debug 'Calling operation AIServiceSpeechClient#list_customizations.' if logger


      if opts[:lifecycle_state] && !OCI::AiSpeech::Models::Customization::LIFECYCLE_STATE_ENUM.include?(opts[:lifecycle_state])
        raise 'Invalid value for "lifecycle_state", must be one of the values in OCI::AiSpeech::Models::Customization::LIFECYCLE_STATE_ENUM.'
      end
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceSpeechClient#list_customizations') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::AiSpeech::Models::CustomizationCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :compartment_id The ID of the compartment in which to list resources.
    # @option opts [String] :model_name The model the user wants to run the inference on.
    # @option opts [String] :display_name The name of the speaker voice in which the user wants tts inference to be.
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::AiSpeech::Models::VoiceCollection VoiceCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aispeech/list_voices.rb.html) to see an example of how to use list_voices API.
    def list_voices(opts = {})
      logger.debug 'Calling operation AIServiceSpeechClient#list_voices.' if logger


      if opts[:model_name] && !OCI::AiSpeech::Models::TtsOracleModelDetails::MODEL_NAME_ENUM.include?(opts[:model_name])
        raise 'Invalid value for "model_name", must be one of the values in OCI::AiSpeech::Models::TtsOracleModelDetails::MODEL_NAME_ENUM.'
      end
      ...
      query_params = {}
      query_params[:compartmentId] = opts[:compartment_id] if opts[:compartment_id]
      query_params[:modelName] = opts[:model_name] if opts[:model_name]
      query_params[:displayName] = opts[:display_name] if opts[:display_name]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceSpeechClient#list_voices') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::AiSpeech::Models::VoiceCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @param [OCI::AiSpeech::Models::SynthesizeSpeechDetails] synthesize_speech_details The request to be sent to the TTS service to get required inference audio.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aispeech/synthesize_speech.rb.html) to see an example of how to use synthesize_speech API.
    def synthesize_speech(synthesize_speech_details, opts = {}, &block)
      logger.debug 'Calling operation AIServiceSpeechClient#synthesize_speech.' if logger

      raise "Missing the required parameter 'synthesize_speech_details' when calling synthesize_speech." if synthesize_speech_details.nil?
      ...
      header_params[:accept] ||= 'audio/mpeg, audio/ogg, audio/pcm, audio/json'
      header_params[:'accept-encoding'] = opts[:accept_encoding] if opts[:accept_encoding]
      header_params[:'content-type'] = 'application/json'
      header_params[:'opc-request-id'] = opts[:opc_request_id] if opts[:opc_request_id]
      # rubocop:enable Style/NegatedIf

      post_body = @api_client.object_to_http_body(synthesize_speech_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceSpeechClient#synthesize_speech') do
        if !block.nil?
          @api_client.call_api(
            :POST,
            path,
    ...
    # @param [String] customization_id Unique Customization training Job identifier.
    # @param [OCI::AiSpeech::Models::UpdateCustomizationDetails] update_customization_details The information to be updated.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::AiSpeech::Models::Customization Customization}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aispeech/update_customization.rb.html) to see an example of how to use update_customization API.
    def update_customization(customization_id, update_customization_details, opts = {})
      logger.debug 'Calling operation AIServiceSpeechClient#update_customization.' if logger

      raise "Missing the required parameter 'customization_id' when calling update_customization." if customization_id.nil?
      raise "Missing the required parameter 'update_customization_details' when calling update_customization." if update_customization_details.nil?
      raise "Parameter value for 'customization_id' must not be blank" if OCI::Internal::Util.blank_string?(customization_id)
      ...
      post_body = @api_client.object_to_http_body(update_customization_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceSpeechClient#update_customization') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
