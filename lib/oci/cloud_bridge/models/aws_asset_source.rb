...
module OCI
  ...
  #
  class CloudBridge::Models::AwsAssetSource < CloudBridge::Models::AssetSource
    ...
    def hash
      [type, id, compartment_id, display_name, environment_id, inventory_id, assets_compartment_id, discovery_schedule_id, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags, discovery_credentials, replication_credentials, aws_region, aws_account_key, are_historical_metrics_collected, are_realtime_metrics_collected, is_cost_information_collected].hash
    end
