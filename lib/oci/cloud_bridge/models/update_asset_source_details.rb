...
module OCI
  ...
  class CloudBridge::Models::UpdateAssetSourceDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::CloudBridge::Models::UpdateAwsAssetSourceDetails' if type == 'AWS'
    ...
    def hash
      [type, display_name, assets_compartment_id, discovery_schedule_id, freeform_tags, defined_tags, system_tags].hash
    end
