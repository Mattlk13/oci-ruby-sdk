...
module OCI
  ...
  class CloudBridge::Models::AwsEbsAsset < CloudBridge::Models::Asset
    # This attribute is required.
    # @return [OCI::CloudBridge::Models::AwsEbsProperties]
    attr_accessor :aws_ebs
    ...
    def self.swagger_types
      {
        ...
        'aws_ebs': :'OCI::CloudBridge::Models::AwsEbsProperties'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::CloudBridge::Models::AwsEbsProperties] :aws_ebs The value to assign to the {#aws_ebs} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['assetType'] = 'AWS_EBS'
      ...
      self.aws_ebs = attributes[:'awsEbs'] if attributes[:'awsEbs']

      raise 'You cannot provide both :awsEbs and :aws_ebs' if attributes.key?(:'awsEbs') && attributes.key?(:'aws_ebs')

      self.aws_ebs = attributes[:'aws_ebs'] if attributes[:'aws_ebs']
    end
    ...
    def hash
      [display_name, inventory_id, id, compartment_id, source_key, external_asset_key, asset_type, time_created, time_updated, asset_source_ids, lifecycle_state, freeform_tags, defined_tags, system_tags, aws_ebs].hash
    end
