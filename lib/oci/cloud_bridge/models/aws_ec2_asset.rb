...
module OCI
  ...
  class CloudBridge::Models::AwsEc2Asset < CloudBridge::Models::Asset
    ...
    # This attribute is required.
    # @return [OCI::CloudBridge::Models::AwsEc2Properties]
    attr_accessor :aws_ec2

    # @return [OCI::CloudBridge::Models::MonthlyCostSummary]
    attr_accessor :aws_ec2_cost

    # @return [OCI::CloudBridge::Models::MonthlyCostSummary]
    attr_accessor :attached_ebs_volumes_cost
    ...
    def self.swagger_types
      {
        ...
        'aws_ec2': :'OCI::CloudBridge::Models::AwsEc2Properties',
        'aws_ec2_cost': :'OCI::CloudBridge::Models::MonthlyCostSummary',
        'attached_ebs_volumes_cost': :'OCI::CloudBridge::Models::MonthlyCostSummary'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::CloudBridge::Models::AwsEc2Properties] :aws_ec2 The value to assign to the {#aws_ec2} property
    # @option attributes [OCI::CloudBridge::Models::MonthlyCostSummary] :aws_ec2_cost The value to assign to the {#aws_ec2_cost} property
    # @option attributes [OCI::CloudBridge::Models::MonthlyCostSummary] :attached_ebs_volumes_cost The value to assign to the {#attached_ebs_volumes_cost} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['assetType'] = 'AWS_EC2'
      ...
      self.aws_ec2 = attributes[:'awsEc2'] if attributes[:'awsEc2']

      raise 'You cannot provide both :awsEc2 and :aws_ec2' if attributes.key?(:'awsEc2') && attributes.key?(:'aws_ec2')

      self.aws_ec2 = attributes[:'aws_ec2'] if attributes[:'aws_ec2']

      self.aws_ec2_cost = attributes[:'awsEc2Cost'] if attributes[:'awsEc2Cost']

      raise 'You cannot provide both :awsEc2Cost and :aws_ec2_cost' if attributes.key?(:'awsEc2Cost') && attributes.key?(:'aws_ec2_cost')

      self.aws_ec2_cost = attributes[:'aws_ec2_cost'] if attributes[:'aws_ec2_cost']

      self.attached_ebs_volumes_cost = attributes[:'attachedEbsVolumesCost'] if attributes[:'attachedEbsVolumesCost']

      raise 'You cannot provide both :attachedEbsVolumesCost and :attached_ebs_volumes_cost' if attributes.key?(:'attachedEbsVolumesCost') && attributes.key?(:'attached_ebs_volumes_cost')

      self.attached_ebs_volumes_cost = attributes[:'attached_ebs_volumes_cost'] if attributes[:'attached_ebs_volumes_cost']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        vm == other.vm &&
        aws_ec2 == other.aws_ec2 &&
        aws_ec2_cost == other.aws_ec2_cost &&
        attached_ebs_volumes_cost == other.attached_ebs_volumes_cost
    end
    ...
    def hash
      [display_name, inventory_id, id, compartment_id, source_key, external_asset_key, asset_type, time_created, time_updated, asset_source_ids, lifecycle_state, freeform_tags, defined_tags, system_tags, compute, vm, aws_ec2, aws_ec2_cost, attached_ebs_volumes_cost].hash
    end
