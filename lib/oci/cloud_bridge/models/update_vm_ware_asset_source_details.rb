...
module OCI
  ...
  class CloudBridge::Models::UpdateVmWareAssetSourceDetails < CloudBridge::Models::UpdateAssetSourceDetails
    ...
    def hash
      [type, display_name, assets_compartment_id, discovery_schedule_id, freeform_tags, defined_tags, system_tags, vcenter_endpoint, discovery_credentials, replication_credentials, are_historical_metrics_collected, are_realtime_metrics_collected].hash
    end
