...
module OCI
  ...
  class CloudBridge::Models::UpdateAwsAssetSourceDetails < CloudBridge::Models::UpdateAssetSourceDetails
    ...
    # @option attributes [String] :discovery_schedule_id The value to assign to the {OCI::CloudBridge::Models::UpdateAssetSourceDetails#discovery_schedule_id #discovery_schedule_id} proprety
    ...
    def hash
      [type, display_name, assets_compartment_id, discovery_schedule_id, freeform_tags, defined_tags, system_tags, discovery_credentials, replication_credentials, are_historical_metrics_collected, are_realtime_metrics_collected, is_cost_information_collected].hash
    end
