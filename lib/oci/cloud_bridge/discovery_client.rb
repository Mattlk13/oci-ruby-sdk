...
module OCI
  ...
  class CloudBridge::DiscoveryClient
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :asset_source_type The asset source type.
    # @option opts [String] :name_contains A filter to return only supported cloud regions which name contains given nameContains as sub-string.
    # @option opts [String] :sort_by The field to sort by. Only one sort order may be provided. By default, name is in ascending order.
    #    (default to name)
    ...
    # @option opts [String] :page A token representing the position at which to start retrieving results. This must come from the `opc-next-page` header field of a previous response.
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::CloudBridge::Models::SupportedCloudRegionCollection SupportedCloudRegionCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/cloudbridge/list_supported_cloud_regions.rb.html) to see an example of how to use list_supported_cloud_regions API.
    def list_supported_cloud_regions(opts = {})
      logger.debug 'Calling operation DiscoveryClient#list_supported_cloud_regions.' if logger


      if opts[:asset_source_type] && !OCI::CloudBridge::Models::ASSET_SOURCE_TYPE_ENUM.include?(opts[:asset_source_type])
        raise 'Invalid value for "asset_source_type", must be one of the values in OCI::CloudBridge::Models::ASSET_SOURCE_TYPE_ENUM.'
      end
      ...
      # Query Params
      query_params = {}
      query_params[:assetSourceType] = opts[:asset_source_type] if opts[:asset_source_type]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DiscoveryClient#list_supported_cloud_regions') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::CloudBridge::Models::SupportedCloudRegionCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
