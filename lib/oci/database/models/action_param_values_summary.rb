...
module OCI
  ...
  #
  class Database::Models::ActionParamValuesSummary
    PARAMETER_TYPE_ENUM = [
    ...
    # **[Required]** Whether this parameter is required or not for this action type.\u3001
    # @return [BOOLEAN]
    ...
    # @option attributes [Array<String>] :parameter_values The value to assign to the {#parameter_values} property
    ...
    def initialize(attributes = {})
      ...
      self.parameter_type = "STRING" if parameter_type.nil? && !attributes.key?(:'parameterType') # rubocop:disable Style/StringLiterals
      ...
      self.parameter_type = "STRING" if parameter_type.nil? && !attributes.key?(:'parameterType') && !attributes.key?(:'parameter_type') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [parameter_name, parameter_type, parameter_values, default_value, is_required].hash
    end
