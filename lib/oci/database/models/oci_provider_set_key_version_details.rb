...
require 'date'
require_relative 'set_key_version_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Used for setting KMS key versions
  class Database::Models::OciProviderSetKeyVersionDetails < Database::Models::SetKeyVersionDetails
    ...
    def hash
      [provider, kms_key_version_id].hash
    end
