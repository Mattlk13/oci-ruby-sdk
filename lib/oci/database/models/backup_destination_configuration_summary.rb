...
module OCI
  ...
  class Database::Models::BackupDestinationConfigurationSummary
    TYPE_ENUM = [
      TYPE_NFS = 'NFS'.freeze,
    ...
    attr_accessor :backup_destination_attach_history
    ...
    # @return [Integer]
    attr_accessor :space_utilized_in_gbs
    ...
    # @option attributes [Array<DateTime>] :backup_destination_attach_history The value to assign to the {#backup_destination_attach_history} property
    # @option attributes [Integer] :space_utilized_in_gbs The value to assign to the {#space_utilized_in_gbs} property
    ...
    def hash
      [recovery_window_in_days, backup_destination_attach_history, space_utilized_in_gbs, time_at_which_storage_details_are_updated, type, id, vpc_user, vpc_password, internet_proxy, dbrs_policy_id].hash
    end
