...
module OCI
  ...
  #
  class Database::Models::UndeleteAutonomousDatabaseDetails < Database::Models::CreateAutonomousDatabaseBase
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the Autonomous Database that you want to undelete.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['source'] = 'UNDELETE_ADB'
