...
module OCI
  ...
  #
  class Database::Models::CreateCrossTenancyDisasterRecoveryDetails < Database::Models::CreateAutonomousDatabaseBase
    ...
    # **[Required]** Indicates the disaster recovery (DR) type of the standby Autonomous Database Serverless instance.
    # Autonomous Data Guard (ADG) DR type provides business critical DR with a faster recovery time objective (RTO) during failover or switchover.
    # Backup-based DR type provides lower cost DR with a slower RTO during failover or switchover.
    #
    # @return [String]
    attr_accessor :disaster_recovery_type
    ...
    # @option attributes [String] :subscription_id The value to assign to the {OCI::Database::Models::CreateAutonomousDatabaseBase#subscription_id #subscription_id} proprety
    ...
    # @option attributes [OCI::Database::Models::AutonomousDatabaseEncryptionKeyDetails] :encryption_key The value to assign to the {OCI::Database::Models::CreateAutonomousDatabaseBase#encryption_key #encryption_key} proprety
    ...
    # @option attributes [Float] :byol_compute_count_limit The value to assign to the {OCI::Database::Models::CreateAutonomousDatabaseBase#byol_compute_count_limit #byol_compute_count_limit} proprety
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :security_attributes The value to assign to the {OCI::Database::Models::CreateAutonomousDatabaseBase#security_attributes #security_attributes} proprety
    ...
    # @option attributes [BOOLEAN] :is_backup_retention_locked The value to assign to the {OCI::Database::Models::CreateAutonomousDatabaseBase#is_backup_retention_locked #is_backup_retention_locked} proprety
    ...
    def initialize(attributes = {})
      ...
      attributes['source'] = 'CROSS_TENANCY_DISASTER_RECOVERY'
