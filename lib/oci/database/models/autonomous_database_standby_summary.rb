...
module OCI
  ...
  class Database::Models::AutonomousDatabaseStandbySummary
    ...
    def hash
      [lag_time_in_seconds, lifecycle_state, lifecycle_details, time_data_guard_role_changed, time_disaster_recovery_role_changed, time_maintenance_begin, time_maintenance_end, maintenance_target_component, availability_domain].hash
    end
