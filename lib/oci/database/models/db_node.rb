...
module OCI
  ...
  class Database::Models::DbNode
    ...
    # {#get_private_ip get_private_ip} or the {#get_public_ip_by_private_ip_id get_public_ip_by_private_ip_id} API to get the IPv4 address
    ...
    # {#get_ipv6 get_ipv6} API to get the IPv6 address needed to make a database connection.
    #
    # **Note:** Applies only to Exadata Cloud Service.
    #
    # @return [String]
    attr_accessor :host_ipv6_id
    ...
    # @option attributes [String] :host_ipv6_id The value to assign to the {#host_ipv6_id} property
    # @option attributes [String] :backup_ipv6_id The value to assign to the {#backup_ipv6_id} property
    ...
    # @option attributes [Integer] :total_cpu_core_count The value to assign to the {#total_cpu_core_count} property
