...
module OCI
  ...
  class Database::Models::ExadataInfrastructureSummary
    ...
    ADDITIONAL_COMPUTE_SYSTEM_MODEL_ENUM = [
      ...
      ADDITIONAL_COMPUTE_SYSTEM_MODEL_X11_M = 'X11M'.freeze,
    ...
    # @return [BOOLEAN]
    attr_accessor :is_scheduling_policy_associated

    # @return [OCI::Database::Models::ExascaleConfigDetails]
    ...
    # @option attributes [BOOLEAN] :is_scheduling_policy_associated The value to assign to the {#is_scheduling_policy_associated} property
    # @option attributes [OCI::Database::Models::ExascaleConfigDetails] :exascale_config The value to assign to the {#exascale_config} property
    # @option attributes [String] :database_server_type The value to assign to the {#database_server_type} property
    # @option attributes [String] :storage_server_type The value to assign to the {#storage_server_type} property
    ...
    def initialize(attributes = {})
      ...
      self.exascale_config = attributes[:'exascaleConfig'] if attributes[:'exascaleConfig']

      raise 'You cannot provide both :exascaleConfig and :exascale_config' if attributes.key?(:'exascaleConfig') && attributes.key?(:'exascale_config')

      self.exascale_config = attributes[:'exascale_config'] if attributes[:'exascale_config']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        exascale_config == other.exascale_config &&
