...
module OCI
  ...
  class Database::Models::CreateDataGuardAssociationDetails
    ...
    def hash
      [database_software_image_id, database_admin_password, source_encryption_key_location_details, protection_mode, transport_type, creation_type, is_active_data_guard_enabled, peer_db_unique_name, peer_sid_prefix].hash
    end
