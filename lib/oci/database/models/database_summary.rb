...
module OCI
  ...
  class Database::Models::DatabaseSummary
    ...
    # @return [OCI::Database::Models::DataGuardGroup]
    attr_accessor :data_guard_group
    ...
    # @option attributes [OCI::Database::Models::DataGuardGroup] :data_guard_group The value to assign to the {#data_guard_group} property
    ...
    def initialize(attributes = {})
      ...
      self.data_guard_group = attributes[:'dataGuardGroup'] if attributes[:'dataGuardGroup']

      raise 'You cannot provide both :dataGuardGroup and :data_guard_group' if attributes.key?(:'dataGuardGroup') && attributes.key?(:'data_guard_group')

      self.data_guard_group = attributes[:'data_guard_group'] if attributes[:'data_guard_group']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        data_guard_group == other.data_guard_group &&
