...
module OCI
  ...
  class Database::Models::Backup
    ...
    # @return [Array<String>]
    attr_accessor :secondary_kms_key_ids
    ...
    # @return [Integer]
    attr_accessor :retention_period_in_years

    # Expiration time of the long term database backup.
    # @return [DateTime]
    attr_accessor :time_expiry_scheduled
    ...
    # @return [String]
    attr_reader :backup_destination_type

    # @return [OCI::Database::Models::EncryptionKeyLocationDetails]
    attr_accessor :encryption_key_location_details
    ...
    # @option attributes [Array<String>] :secondary_kms_key_ids The value to assign to the {#secondary_kms_key_ids} property
    # @option attributes [Integer] :retention_period_in_days The value to assign to the {#retention_period_in_days} property
    # @option attributes [Integer] :retention_period_in_years The value to assign to the {#retention_period_in_years} property
    # @option attributes [DateTime] :time_expiry_scheduled The value to assign to the {#time_expiry_scheduled} property
    # @option attributes [BOOLEAN] :is_using_oracle_managed_keys The value to assign to the {#is_using_oracle_managed_keys} property
    # @option attributes [String] :backup_destination_type The value to assign to the {#backup_destination_type} property
    # @option attributes [OCI::Database::Models::EncryptionKeyLocationDetails] :encryption_key_location_details The value to assign to the {#encryption_key_location_details} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] backup_destination_type Object to be assigned
    def backup_destination_type=(backup_destination_type)
      # rubocop:disable Style/ConditionalAssignment
      if backup_destination_type && !BACKUP_DESTINATION_TYPE_ENUM.include?(backup_destination_type)
        OCI.logger.debug("Unknown value for 'backup_destination_type' [" + backup_destination_type + "]. Mapping to 'BACKUP_DESTINATION_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @backup_destination_type = BACKUP_DESTINATION_TYPE_UNKNOWN_ENUM_VALUE
      else
        @backup_destination_type = backup_destination_type
      end
      # rubocop:enable Style/ConditionalAssignment
    end
