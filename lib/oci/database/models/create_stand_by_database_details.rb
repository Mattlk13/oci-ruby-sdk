...
module OCI
  ...
  #
  class Database::Models::CreateStandByDatabaseDetails < Database::Models::CreateDatabaseBase
    # This attribute is required.
    # @return [OCI::Database::Models::CreateStandbyDetails]
    ...
    def self.swagger_types
      {
        ...
        'database': :'OCI::Database::Models::CreateStandbyDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Database::Models::CreateStandbyDetails] :database The value to assign to the {#database} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['source'] = 'DATAGUARD'
