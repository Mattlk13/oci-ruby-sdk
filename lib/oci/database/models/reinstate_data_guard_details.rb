...
module OCI
  ...
  #
  class Database::Models::ReinstateDataGuardDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the source (primary) database in the Data Guard group.
    # @return [String]
    ...
    def hash
      [database_admin_password, source_database_id].hash
    end
