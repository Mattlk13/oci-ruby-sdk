...
module OCI
  ...
  class Database::Models::BackupDestinationSummary
    ...
    # @option attributes [Integer] :utilized_storage_size_in_gbs The value to assign to the {#utilized_storage_size_in_gbs} property
    # @option attributes [DateTime] :time_at_which_storage_details_are_updated The value to assign to the {#time_at_which_storage_details_are_updated} property
    def initialize(attributes = {})
      ...
      self.utilized_storage_size_in_gbs = attributes[:'utilizedStorageSizeInGBs'] if attributes[:'utilizedStorageSizeInGBs']

      raise 'You cannot provide both :utilizedStorageSizeInGBs and :utilized_storage_size_in_gbs' if attributes.key?(:'utilizedStorageSizeInGBs') && attributes.key?(:'utilized_storage_size_in_gbs')

      self.utilized_storage_size_in_gbs = attributes[:'utilized_storage_size_in_gbs'] if attributes[:'utilized_storage_size_in_gbs']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        utilized_storage_size_in_gbs == other.utilized_storage_size_in_gbs &&
    ...
    def hash
      [id, display_name, compartment_id, type, associated_databases, connection_string, vpc_users, local_mount_point_path, nfs_mount_type, nfs_server, nfs_server_export, lifecycle_state, time_created, lifecycle_details, freeform_tags, defined_tags, total_storage_size_in_gbs, utilized_storage_size_in_gbs, time_at_which_storage_details_are_updated].hash
    end
