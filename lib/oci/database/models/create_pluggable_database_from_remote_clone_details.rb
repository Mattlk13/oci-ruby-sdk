...
module OCI
  ...
  class Database::Models::CreatePluggableDatabaseFromRemoteCloneDetails < Database::Models::CreatePluggableDatabaseCreationTypeDetails
    ...
    # @option attributes [BOOLEAN] :is_thin_clone The value to assign to the {#is_thin_clone} property
    def initialize(attributes = {})
      ...
      self.is_thin_clone = attributes[:'isThinClone'] unless attributes[:'isThinClone'].nil?

      raise 'You cannot provide both :isThinClone and :is_thin_clone' if attributes.key?(:'isThinClone') && attributes.key?(:'is_thin_clone')

      self.is_thin_clone = attributes[:'is_thin_clone'] unless attributes[:'is_thin_clone'].nil?
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_thin_clone == other.is_thin_clone
    end
    ...
    def hash
      [creation_type, dblink_username, dblink_user_password, source_pluggable_database_id, source_container_database_admin_password, refreshable_clone_details, is_thin_clone].hash
    end
