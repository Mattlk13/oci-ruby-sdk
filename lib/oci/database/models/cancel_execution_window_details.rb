...
module OCI
  ...
  #
  class Database::Models::CancelExecutionWindowDetails
    # **[Required]** New scheduled date and time of the execution window.
    # @return [DateTime]
    attr_accessor :time_scheduled_of_new_window
    ...
    # @option attributes [DateTime] :time_scheduled_of_new_window The value to assign to the {#time_scheduled_of_new_window} property
    # @option attributes [Integer] :window_duration_in_mins_of_new_window The value to assign to the {#window_duration_in_mins_of_new_window} property
    # @option attributes [BOOLEAN] :is_enforced_duration_of_new_window The value to assign to the {#is_enforced_duration_of_new_window} property
