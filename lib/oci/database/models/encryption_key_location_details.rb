...
module OCI
  ...
  class Database::Models::EncryptionKeyLocationDetails
    PROVIDER_TYPE_ENUM = [
      PROVIDER_TYPE_EXTERNAL = 'EXTERNAL'.freeze,
      PROVIDER_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Use 'EXTERNAL' for creating a new database or migrate database key with External HSM.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'providerType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::Database::Models::ExternalHsmEncryptionDetails' if type == 'EXTERNAL'
