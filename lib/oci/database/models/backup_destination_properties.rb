...
module OCI
  ...
  class Database::Models::BackupDestinationProperties
    ...
    def hash
      [backup_destination_attach_history, space_utilized_in_gbs, time_at_which_storage_details_are_updated].hash
    end
