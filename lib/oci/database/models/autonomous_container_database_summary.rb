...
module OCI
  ...
  class Database::Models::AutonomousContainerDatabaseSummary
    ...
    # @return [Array<OCI::Database::Models::BackupDestinationProperties>]
    attr_accessor :backup_destination_properties_list
    ...
    # @return [Array<OCI::Database::Models::BackupDestinationConfigurationSummary>]
    attr_accessor :associated_backup_configuration_details

    # @return [OCI::Database::Models::RecoveryApplianceDetails]
    attr_accessor :recovery_appliance_details
    ...
    #
    # @return [BOOLEAN]
    attr_accessor :is_multiple_standby
    ...
    # @return [OCI::Database::Models::AutonomousContainerDatabaseDataguard]
    attr_accessor :dataguard

    # Array of Dg associations.
    # @return [Array<OCI::Database::Models::AutonomousContainerDatabaseDataguard>]
    attr_accessor :dataguard_group_members
    ...
    # @option attributes [Array<OCI::Database::Models::BackupDestinationProperties>] :backup_destination_properties_list The value to assign to the {#backup_destination_properties_list} property
    # @option attributes [Array<OCI::Database::Models::BackupDestinationConfigurationSummary>] :associated_backup_configuration_details The value to assign to the {#associated_backup_configuration_details} property
    # @option attributes [OCI::Database::Models::RecoveryApplianceDetails] :recovery_appliance_details The value to assign to the {#recovery_appliance_details} property
    ...
    # @option attributes [BOOLEAN] :is_multiple_standby The value to assign to the {#is_multiple_standby} property
    # @option attributes [BOOLEAN] :is_data_guard_enabled The value to assign to the {#is_data_guard_enabled} property
    # @option attributes [OCI::Database::Models::AutonomousContainerDatabaseDataguard] :dataguard The value to assign to the {#dataguard} property
    # @option attributes [Array<OCI::Database::Models::AutonomousContainerDatabaseDataguard>] :dataguard_group_members The value to assign to the {#dataguard_group_members} property
