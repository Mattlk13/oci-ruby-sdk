...
module OCI
  ...
  #
  class Database::Models::DataGuardGroup
    ...
    # @return [Array<OCI::Database::Models::DataGuardGroupMember>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'members': :'Array<OCI::Database::Models::DataGuardGroupMember>',
    ...
    # @option attributes [Array<OCI::Database::Models::DataGuardGroupMember>] :members The value to assign to the {#members} property
