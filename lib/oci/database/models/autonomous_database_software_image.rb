...
module OCI
  ...
  class Database::Models::AutonomousDatabaseSoftwareImage
    ...
    def hash
      [id, compartment_id, database_version, display_name, lifecycle_state, lifecycle_details, time_created, release_update, freeform_tags, defined_tags, autonomous_dsi_one_off_patches, image_shape_family, dst_file_version].hash
    end
