...
module OCI
  ...
  class Database::Models::FlexComponentSummary
    HARDWARE_TYPE_ENUM = [
      HARDWARE_TYPE_COMPUTE = 'COMPUTE'.freeze,
      HARDWARE_TYPE_CELL = 'CELL'.freeze,
      HARDWARE_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @return [Integer]
    attr_accessor :runtime_minimum_core_count
    ...
    # @return [Integer]
    attr_accessor :available_local_storage_in_gbs
    ...
    # @return [String]
    attr_reader :hardware_type

    # The description summary for this Flex Component.
    # @return [String]
    attr_accessor :description_summary
    ...
    # @option attributes [Integer] :runtime_minimum_core_count The value to assign to the {#runtime_minimum_core_count} property
    ...
    # @option attributes [Integer] :available_local_storage_in_gbs The value to assign to the {#available_local_storage_in_gbs} property
    # @option attributes [String] :compute_model The value to assign to the {#compute_model} property
    # @option attributes [String] :hardware_type The value to assign to the {#hardware_type} property
    # @option attributes [String] :description_summary The value to assign to the {#description_summary} property
    def initialize(attributes = {})
      ...
      self.runtime_minimum_core_count = attributes[:'runtimeMinimumCoreCount'] if attributes[:'runtimeMinimumCoreCount']

      raise 'You cannot provide both :runtimeMinimumCoreCount and :runtime_minimum_core_count' if attributes.key?(:'runtimeMinimumCoreCount') && attributes.key?(:'runtime_minimum_core_count')

      self.runtime_minimum_core_count = attributes[:'runtime_minimum_core_count'] if attributes[:'runtime_minimum_core_count']
      ...
      self.available_local_storage_in_gbs = attributes[:'availableLocalStorageInGBs'] if attributes[:'availableLocalStorageInGBs']

      raise 'You cannot provide both :availableLocalStorageInGBs and :available_local_storage_in_gbs' if attributes.key?(:'availableLocalStorageInGBs') && attributes.key?(:'available_local_storage_in_gbs')

      self.available_local_storage_in_gbs = attributes[:'available_local_storage_in_gbs'] if attributes[:'available_local_storage_in_gbs']
      ...
      self.hardware_type = attributes[:'hardwareType'] if attributes[:'hardwareType']

      raise 'You cannot provide both :hardwareType and :hardware_type' if attributes.key?(:'hardwareType') && attributes.key?(:'hardware_type')

      self.hardware_type = attributes[:'hardware_type'] if attributes[:'hardware_type']

      self.description_summary = attributes[:'descriptionSummary'] if attributes[:'descriptionSummary']

      raise 'You cannot provide both :descriptionSummary and :description_summary' if attributes.key?(:'descriptionSummary') && attributes.key?(:'description_summary')

      self.description_summary = attributes[:'description_summary'] if attributes[:'description_summary']
    end
    ...
    def hardware_type=(hardware_type)
      ...
      if hardware_type && !HARDWARE_TYPE_ENUM.include?(hardware_type)
        OCI.logger.debug("Unknown value for 'hardware_type' [" + hardware_type + "]. Mapping to 'HARDWARE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @hardware_type = HARDWARE_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        runtime_minimum_core_count == other.runtime_minimum_core_count &&
        shape == other.shape &&
        available_memory_in_gbs == other.available_memory_in_gbs &&
        available_local_storage_in_gbs == other.available_local_storage_in_gbs &&
        compute_model == other.compute_model &&
        hardware_type == other.hardware_type &&
        description_summary == other.description_summary
    end
    ...
    def hash
      [name, minimum_core_count, available_core_count, available_db_storage_in_gbs, runtime_minimum_core_count, shape, available_memory_in_gbs, available_local_storage_in_gbs, compute_model, hardware_type, description_summary].hash
    end
