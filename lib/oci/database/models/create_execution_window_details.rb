...
module OCI
  ...
  #
  class Database::Models::CreateExecutionWindowDetails
    ...
    def hash
      [compartment_id, execution_resource_id, time_scheduled, window_duration_in_mins, is_enforced_duration, freeform_tags, defined_tags].hash
    end
