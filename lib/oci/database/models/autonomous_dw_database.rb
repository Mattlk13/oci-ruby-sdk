...
module OCI
  ...
  #
  class Database::Models::AutonomousDwDatabase
    ...
    # Key History Entry.
    # @return [Array<OCI::Database::Models::AutonomousDatabaseEncryptionKeyHistoryEntry>]
    attr_accessor :encryption_key_history_entry
    ...
    # @return [OCI::Database::Models::AutonomousDatabaseConnectionUrls]
    attr_accessor :public_connection_urls
    ...
    # @return [String]
    attr_accessor :maintenance_target_component
    ...
    attr_accessor :clone_table_space_list
    ...
    # @option attributes [Array<OCI::Database::Models::AutonomousDatabaseEncryptionKeyHistoryEntry>] :encryption_key_history_entry The value to assign to the {#encryption_key_history_entry} property
    ...
    # @option attributes [DateTime] :time_undeleted The value to assign to the {#time_undeleted} property
    ...
    # @option attributes [OCI::Database::Models::AutonomousDatabaseConnectionUrls] :public_connection_urls The value to assign to the {#public_connection_urls} property
    ...
    # @option attributes [String] :maintenance_target_component The value to assign to the {#maintenance_target_component} property
    ...
    # @option attributes [Array<Integer>] :clone_table_space_list The value to assign to the {#clone_table_space_list} property
    ...
    def infrastructure_type=(infrastructure_type)
      raise "Invalid value for 'infrastructure_type': this must be one of the values in INFRASTRUCTURE_TYPE_ENUM." if infrastructure_type && !INFRASTRUCTURE_TYPE_ENUM.include?(infrastructure_type)
    ...
    def data_safe_status=(data_safe_status)
      raise "Invalid value for 'data_safe_status': this must be one of the values in DATA_SAFE_STATUS_ENUM." if data_safe_status && !DATA_SAFE_STATUS_ENUM.include?(data_safe_status)
    ...
    def operations_insights_status=(operations_insights_status)
      raise "Invalid value for 'operations_insights_status': this must be one of the values in OPERATIONS_INSIGHTS_STATUS_ENUM." if operations_insights_status && !OPERATIONS_INSIGHTS_STATUS_ENUM.include?(operations_insights_status)
    ...
    def database_management_status=(database_management_status)
      raise "Invalid value for 'database_management_status': this must be one of the values in DATABASE_MANAGEMENT_STATUS_ENUM." if database_management_status && !DATABASE_MANAGEMENT_STATUS_ENUM.include?(database_management_status)
    ...
    def refreshable_status=(refreshable_status)
      raise "Invalid value for 'refreshable_status': this must be one of the values in REFRESHABLE_STATUS_ENUM." if refreshable_status && !REFRESHABLE_STATUS_ENUM.include?(refreshable_status)
    ...
    def dataguard_region_type=(dataguard_region_type)
      raise "Invalid value for 'dataguard_region_type': this must be one of the values in DATAGUARD_REGION_TYPE_ENUM." if dataguard_region_type && !DATAGUARD_REGION_TYPE_ENUM.include?(dataguard_region_type)
    ...
    def disaster_recovery_region_type=(disaster_recovery_region_type)
      raise "Invalid value for 'disaster_recovery_region_type': this must be one of the values in DISASTER_RECOVERY_REGION_TYPE_ENUM." if disaster_recovery_region_type && !DISASTER_RECOVERY_REGION_TYPE_ENUM.include?(disaster_recovery_region_type)
