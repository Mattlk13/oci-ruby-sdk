...
module OCI
  ...
  class Database::Models::ApplicationVipSummary
    ...
    def hash
      [id, cloud_vm_cluster_id, compartment_id, subnet_id, ip_address, ipv6_address, hostname_label, lifecycle_state, lifecycle_details, time_assigned, freeform_tags, defined_tags].hash
    end
