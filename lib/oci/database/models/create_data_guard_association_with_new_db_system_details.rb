...
module OCI
  ...
  class Database::Models::CreateDataGuardAssociationWithNewDbSystemDetails < Database::Models::CreateDataGuardAssociationDetails
    ...
    #
    # @return [Hash<String, Hash<String, Object>>]
    attr_accessor :db_system_security_attributes
    ...
    # @option attributes [OCI::Database::Models::EncryptionKeyLocationDetails] :source_encryption_key_location_details The value to assign to the {OCI::Database::Models::CreateDataGuardAssociationDetails#source_encryption_key_location_details #source_encryption_key_location_details} proprety
    ...
    # @option attributes [String] :private_ip_v6 The value to assign to the {#private_ip_v6} property
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :db_system_security_attributes The value to assign to the {#db_system_security_attributes} property
