...
module OCI
  ...
  #
  class Database::Models::ExadbVmClusterUpdateHistoryEntrySummary
    UPDATE_ACTION_ENUM = [
    ...
    def hash
      [id, update_id, update_action, update_type, lifecycle_state, lifecycle_details, time_started, time_completed, version].hash
    end
