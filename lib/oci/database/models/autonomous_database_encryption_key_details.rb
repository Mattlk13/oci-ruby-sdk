...
module OCI
  ...
  class Database::Models::AutonomousDatabaseEncryptionKeyDetails
    PROVIDER_ENUM = [
      PROVIDER_AWS = 'AWS'.freeze,
      PROVIDER_AZURE = 'AZURE'.freeze,
      PROVIDER_OCI = 'OCI'.freeze,
      PROVIDER_ORACLE_MANAGED = 'ORACLE_MANAGED'.freeze,
      PROVIDER_OKV = 'OKV'.freeze,
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'provider'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::Database::Models::OkvKeyDetails' if type == 'OKV'
      return 'OCI::Database::Models::AzureKeyDetails' if type == 'AZURE'
      return 'OCI::Database::Models::AwsKeyDetails' if type == 'AWS'
      return 'OCI::Database::Models::OciKeyDetails' if type == 'OCI'
      return 'OCI::Database::Models::OracleManagedKeyDetails' if type == 'ORACLE_MANAGED'
