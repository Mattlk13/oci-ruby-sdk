...
module OCI
  ...
  class Database::Models::AzureKeyDetails < Database::Models::AutonomousDatabaseEncryptionKeyDetails
    # **[Required]** Azure vault URI
    # @return [String]
    ...
    # @option attributes [String] :vault_uri The value to assign to the {#vault_uri} property
    ...
    def initialize(attributes = {})
      ...
      self.vault_uri = attributes[:'vaultUri'] if attributes[:'vaultUri']

      raise 'You cannot provide both :vaultUri and :vault_uri' if attributes.key?(:'vaultUri') && attributes.key?(:'vault_uri')

      self.vault_uri = attributes[:'vault_uri'] if attributes[:'vault_uri']
    ...
    def hash
      [provider, vault_uri, key_name].hash
    end
