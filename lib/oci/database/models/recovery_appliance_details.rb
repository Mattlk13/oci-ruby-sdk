...
module OCI
  ...
  class Database::Models::RecoveryApplianceDetails
    ...
    # @return [DateTime]
    attr_accessor :time_recovery_appliance_details_updated
    ...
    # @option attributes [DateTime] :time_recovery_appliance_details_updated The value to assign to the {#time_recovery_appliance_details_updated} property
