...
module OCI
  ...
  class Database::Models::MaintenanceRunSummary
    ...
    MAINTENANCE_SUBTYPE_ENUM = [
      ...
      MAINTENANCE_SUBTYPE_CUSTOM_DATABASE_SOFTWARE_IMAGE = 'CUSTOM_DATABASE_SOFTWARE_IMAGE'.freeze,
    ...
    # @return [Array<String>]
    attr_accessor :peer_maintenance_run_ids
    ...
    # @return [BOOLEAN]
    attr_accessor :is_maintenance_run_granular
    ...
    # @option attributes [Array<String>] :peer_maintenance_run_ids The value to assign to the {#peer_maintenance_run_ids} property
    ...
    # @option attributes [BOOLEAN] :is_maintenance_run_granular The value to assign to the {#is_maintenance_run_granular} property
    ...
    def initialize(attributes = {})
      ...
      self.peer_maintenance_run_ids = attributes[:'peerMaintenanceRunIds'] if attributes[:'peerMaintenanceRunIds']

      raise 'You cannot provide both :peerMaintenanceRunIds and :peer_maintenance_run_ids' if attributes.key?(:'peerMaintenanceRunIds') && attributes.key?(:'peer_maintenance_run_ids')

      self.peer_maintenance_run_ids = attributes[:'peer_maintenance_run_ids'] if attributes[:'peer_maintenance_run_ids']
      ...
      self.is_maintenance_run_granular = attributes[:'isMaintenanceRunGranular'] unless attributes[:'isMaintenanceRunGranular'].nil?

      raise 'You cannot provide both :isMaintenanceRunGranular and :is_maintenance_run_granular' if attributes.key?(:'isMaintenanceRunGranular') && attributes.key?(:'is_maintenance_run_granular')

      self.is_maintenance_run_granular = attributes[:'is_maintenance_run_granular'] unless attributes[:'is_maintenance_run_granular'].nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        peer_maintenance_run_ids == other.peer_maintenance_run_ids &&
        ...
        is_maintenance_run_granular == other.is_maintenance_run_granular &&
