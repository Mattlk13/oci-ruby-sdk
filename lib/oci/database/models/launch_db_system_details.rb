...
module OCI
  ...
  class Database::Models::LaunchDbSystemDetails < Database::Models::LaunchDbSystemBase
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :security_attributes The value to assign to the {OCI::Database::Models::LaunchDbSystemBase#security_attributes #security_attributes} proprety
    ...
    # @option attributes [String] :private_ip_v6 The value to assign to the {OCI::Database::Models::LaunchDbSystemBase#private_ip_v6 #private_ip_v6} proprety
