...
require 'oci/database/models/action_member'
require 'oci/database/models/action_order_details'
require 'oci/database/models/action_param_values_collection'
require 'oci/database/models/action_param_values_summary'
require 'oci/database/models/activate_exadata_infrastructure_details'
require 'oci/database/models/add_standby_autonomous_container_database_details'
...
require 'oci/database/models/autonomous_container_database_dataguard'
...
require 'oci/database/models/autonomous_database_encryption_key_details'
require 'oci/database/models/autonomous_database_encryption_key_history_entry'
...
require 'oci/database/models/autonomous_database_peer_collection'
require 'oci/database/models/autonomous_database_peer_summary'
...
require 'oci/database/models/autonomous_dw_database'
...
require 'oci/database/models/aws_key_details'
require 'oci/database/models/azure_key_details'
require 'oci/database/models/backup'
require 'oci/database/models/backup_destination'
require 'oci/database/models/backup_destination_configuration_summary'
require 'oci/database/models/backup_destination_details'
require 'oci/database/models/backup_destination_details_summary'
require 'oci/database/models/backup_destination_properties'
require 'oci/database/models/backup_destination_summary'
require 'oci/database/models/backup_summary'
require 'oci/database/models/cancel_execution_window_details'
require 'oci/database/models/change_autonomous_database_software_image_compartment_details'
require 'oci/database/models/change_autonomous_database_subscription_details'
...
require 'oci/database/models/change_cloud_exadata_infrastructure_subscription_details'
require 'oci/database/models/change_cloud_vm_cluster_compartment_details'
require 'oci/database/models/change_cloud_vm_cluster_subscription_details'
...
require 'oci/database/models/change_exadb_vm_cluster_compartment_details'
require 'oci/database/models/change_exadb_vm_cluster_subscription_details'
require 'oci/database/models/change_exascale_db_storage_vault_compartment_details'
require 'oci/database/models/change_exascale_db_storage_vault_subscription_details'
...
require 'oci/database/models/change_scheduling_plan_compartment_details'
require 'oci/database/models/change_scheduling_policy_compartment_details'
require 'oci/database/models/change_subscription_details'
require 'oci/database/models/change_vm_cluster_compartment_details'
require 'oci/database/models/cloud_automation_apply_update_time_preference'
require 'oci/database/models/cloud_automation_freeze_period'
require 'oci/database/models/cloud_automation_update_details'
...
require 'oci/database/models/configure_exascale_exadata_infrastructure_details'
...
require 'oci/database/models/convert_standby_autonomous_container_database_details'
...
require 'oci/database/models/convert_to_standalone_details'
...
require 'oci/database/models/create_cross_tenancy_disaster_recovery_details'
...
require 'oci/database/models/create_exadb_vm_cluster_details'
require 'oci/database/models/create_exascale_db_storage_vault_details'
require 'oci/database/models/create_execution_action_details'
require 'oci/database/models/create_execution_window_details'
...
require 'oci/database/models/create_scheduled_action_details'
require 'oci/database/models/create_scheduling_plan_details'
require 'oci/database/models/create_scheduling_policy_details'
require 'oci/database/models/create_scheduling_window_details'
require 'oci/database/models/create_stand_by_database_details'
require 'oci/database/models/create_standby_details'
...
require 'oci/database/models/data_guard_group'
require 'oci/database/models/data_guard_group_member'
...
require 'oci/database/models/db_node_details'
...
require 'oci/database/models/db_system_upgrade_summary'
...
require 'oci/database/models/edit_autonomous_container_database_dataguard_details'
...
require 'oci/database/models/encryption_key_location_details'
...
require 'oci/database/models/exadb_vm_cluster'
require 'oci/database/models/exadb_vm_cluster_storage_details'
require 'oci/database/models/exadb_vm_cluster_summary'
require 'oci/database/models/exadb_vm_cluster_update'
require 'oci/database/models/exadb_vm_cluster_update_history_entry'
require 'oci/database/models/exadb_vm_cluster_update_history_entry_summary'
require 'oci/database/models/exadb_vm_cluster_update_summary'
require 'oci/database/models/exascale_config_details'
require 'oci/database/models/exascale_db_storage_details'
require 'oci/database/models/exascale_db_storage_input_details'
require 'oci/database/models/exascale_db_storage_vault'
require 'oci/database/models/exascale_db_storage_vault_summary'
require 'oci/database/models/execution_action'
require 'oci/database/models/execution_action_member'
require 'oci/database/models/execution_action_summary'
require 'oci/database/models/execution_window'
require 'oci/database/models/execution_window_summary'
...
require 'oci/database/models/external_hsm_encryption_details'
...
require 'oci/database/models/failover_data_guard_details'
...
require 'oci/database/models/gi_minor_version_summary'
require 'oci/database/models/gi_version_summary'
require 'oci/database/models/granular_maintenance_history_details'
...
require 'oci/database/models/move_execution_action_member_details'
...
require 'oci/database/models/oci_key_details'
require 'oci/database/models/oci_provider_set_key_version_details'
require 'oci/database/models/okv_key_details'
...
require 'oci/database/models/oracle_managed_key_details'
...
require 'oci/database/models/recommended_scheduled_action_summary'
require 'oci/database/models/recommended_scheduled_actions_collection'
require 'oci/database/models/recovery_appliance_details'
...
require 'oci/database/models/reinstate_data_guard_details'
...
require 'oci/database/models/remove_virtual_machine_from_exadb_vm_cluster_details'
require 'oci/database/models/remove_virtual_machine_from_vm_cluster_details'
require 'oci/database/models/reorder_execution_action_details'
require 'oci/database/models/reorder_scheduled_actions_details'
...
require 'oci/database/models/rotate_autonomous_container_database_encryption_key_details'
require 'oci/database/models/rotate_autonomous_database_encryption_key_details'
...
require 'oci/database/models/scheduled_action'
require 'oci/database/models/scheduled_action_collection'
require 'oci/database/models/scheduled_action_summary'
require 'oci/database/models/scheduled_operation_details'
require 'oci/database/models/scheduling_plan'
require 'oci/database/models/scheduling_plan_collection'
require 'oci/database/models/scheduling_plan_summary'
require 'oci/database/models/scheduling_policy'
require 'oci/database/models/scheduling_policy_summary'
require 'oci/database/models/scheduling_window'
require 'oci/database/models/scheduling_window_summary'
require 'oci/database/models/self_mount_details'
require 'oci/database/models/set_key_version_details'
require 'oci/database/models/stack_monitoring_config'
require 'oci/database/models/storage_performance_details'
require 'oci/database/models/switch_over_data_guard_details'
...
require 'oci/database/models/system_version_minor_version_collection'
require 'oci/database/models/system_version_minor_version_summary'
require 'oci/database/models/system_version_summary'
require 'oci/database/models/undelete_autonomous_database_details'
...
require 'oci/database/models/update_backup_details'
...
require 'oci/database/models/update_data_guard_details'
...
require 'oci/database/models/update_exadb_vm_cluster_details'
require 'oci/database/models/update_exascale_db_storage_vault_details'
require 'oci/database/models/update_execution_action_details'
require 'oci/database/models/update_execution_window_details'
...
require 'oci/database/models/update_scheduled_action_details'
require 'oci/database/models/update_scheduling_policy_details'
require 'oci/database/models/update_scheduling_window_details'
...
require 'oci/database/models/window_preference_detail'
