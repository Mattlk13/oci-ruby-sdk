...
require 'oci/tenant_manager_control_plane/models/additional_assigned_region_collection'
...
require 'oci/tenant_manager_control_plane/models/classic_subscription_managed_by'
