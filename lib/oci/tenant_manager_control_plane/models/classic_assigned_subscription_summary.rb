...
module OCI
  ...
  class TenantManagerControlPlane::Models::ClassicAssignedSubscriptionSummary < TenantManagerControlPlane::Models::AssignedSubscriptionSummary
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :system_tags The value to assign to the {OCI::TenantManagerControlPlane::Models::AssignedSubscriptionSummary#system_tags #system_tags} proprety
    ...
    def hash
      [entity_version, id, compartment_id, service_name, time_created, time_updated, freeform_tags, defined_tags, system_tags, lifecycle_state, classic_subscription_id, is_classic_subscription, region_assignment, start_date, end_date, csi_number, managed_by].hash
    end
