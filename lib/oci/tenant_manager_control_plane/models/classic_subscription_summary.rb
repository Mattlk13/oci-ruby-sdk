...
module OCI
  ...
  class TenantManagerControlPlane::Models::ClassicSubscriptionSummary < TenantManagerControlPlane::Models::SubscriptionSummary
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :system_tags The value to assign to the {OCI::TenantManagerControlPlane::Models::SubscriptionSummary#system_tags #system_tags} proprety
    ...
    def hash
      [entity_version, id, compartment_id, service_name, time_created, time_updated, freeform_tags, defined_tags, system_tags, classic_subscription_id, is_classic_subscription, payment_model, region_assignment, lifecycle_state, start_date, end_date].hash
    end
