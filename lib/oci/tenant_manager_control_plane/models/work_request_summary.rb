...
module OCI
  ...
  class TenantManagerControlPlane::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_STANDALONE_TENANCY_TERMINATION_REQUEST = 'STANDALONE_TENANCY_TERMINATION_REQUEST'.freeze,
      OPERATION_TYPE_SELF_OPT_IN = 'SELF_OPT_IN'.freeze,
      OPERATION_TYPE_SELF_OPT_OUT = 'SELF_OPT_OUT'.freeze,
      OPERATION_TYPE_ORDER_PAYLOADS_BACKFILL_ETL = 'ORDER_PAYLOADS_BACKFILL_ETL'.freeze,
      OPERATION_TYPE_PUBLISH_TO_TOPIC = 'PUBLISH_TO_TOPIC'.freeze,
      OPERATION_TYPE_TERMINATE_LINK = 'TERMINATE_LINK'.freeze,
      OPERATION_TYPE_TRANSFER_SUBSCRIPTION = 'TRANSFER_SUBSCRIPTION'.freeze,
