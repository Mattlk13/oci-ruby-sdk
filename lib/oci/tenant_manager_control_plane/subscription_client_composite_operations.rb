...
module OCI
  ...
  class TenantManagerControlPlane::SubscriptionClientCompositeOperations
    ...
    # Calls {OCI::TenantManagerControlPlane::SubscriptionClient#create_subscription_mapping} and then waits for the {OCI::TenantManagerControlPlane::Models::SubscriptionMapping} acted upon
    ...
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::TenantManagerControlPlane::Models::SubscriptionMapping}
    def create_subscription_mapping_and_wait_for_state(create_subscription_mapping_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      ...
      begin
        waiter_result = @service_client.get_subscription_mapping(wait_for_resource_id).wait_until(
