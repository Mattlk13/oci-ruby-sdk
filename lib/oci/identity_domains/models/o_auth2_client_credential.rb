...
module OCI
  ...
  class IdentityDomains::Models::OAuth2ClientCredential
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, name, description, status, expires_on, is_reset_secret, secret, scopes, user, urn_ietf_params_scim_schemas_oracle_idcs_extension_self_change_user].hash
    end
