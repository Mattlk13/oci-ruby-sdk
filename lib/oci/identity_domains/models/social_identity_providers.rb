...
module OCI
  ...
  class IdentityDomains::Models::SocialIdentityProviders
    ...
    # @return [Array<OCI::IdentityDomains::Models::SocialIdentityProvider>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::SocialIdentityProvider>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::SocialIdentityProvider>] :resources The value to assign to the {#resources} property
