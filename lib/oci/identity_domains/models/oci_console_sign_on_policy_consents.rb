...
module OCI
  ...
  class IdentityDomains::Models::OciConsoleSignOnPolicyConsents
    ...
    # @return [Array<OCI::IdentityDomains::Models::OciConsoleSignOnPolicyConsent>]
    ...
    def self.swagger_types
      {
        ...
        'resources': :'Array<OCI::IdentityDomains::Models::OciConsoleSignOnPolicyConsent>',
        'start_index': :'Integer',
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::OciConsoleSignOnPolicyConsent>] :resources The value to assign to the {#resources} property
