...
module OCI
  ...
  class IdentityDomains::Models::ExtensionSocialIdentityProvider
    ...
    #  - type: complex
    #  - uniqueness: none
    # @return [Array<OCI::IdentityDomains::Models::IdentityProviderJitProvAssignedGroups>]
    ...
    # @option attributes [Array<OCI::IdentityDomains::Models::IdentityProviderJitProvAssignedGroups>] :jit_prov_assigned_groups The value to assign to the {#jit_prov_assigned_groups} property
    ...
    def hash
      [account_linking_enabled, auto_redirect_enabled, social_jit_provisioning_enabled, jit_prov_group_static_list_enabled, jit_prov_assigned_groups, registration_enabled, status, authz_url, access_token_url, relay_idp_param_mappings, profile_url, scope, admin_scope, consumer_key, consumer_secret, service_provider_name, clock_skew_in_seconds, redirect_url, discovery_url, client_credential_in_payload, id_attribute].hash
    end
