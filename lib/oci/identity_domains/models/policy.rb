...
module OCI
  ...
  class IdentityDomains::Models::Policy
    ...
    # @return [OCI::IdentityDomains::Models::PolicyExtensionOciconsolesignonpolicyconsentPolicy]
    ...
    def self.swagger_types
      {
        ...
        'urn_ietf_params_scim_schemas_oracle_idcs_extension_ociconsolesignonpolicyconsent_policy': :'OCI::IdentityDomains::Models::PolicyExtensionOciconsolesignonpolicyconsentPolicy'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::IdentityDomains::Models::PolicyExtensionOciconsolesignonpolicyconsentPolicy] :urn_ietf_params_scim_schemas_oracle_idcs_extension_ociconsolesignonpolicyconsent_policy The value to assign to the {#urn_ietf_params_scim_schemas_oracle_idcs_extension_ociconsolesignonpolicyconsent_policy} property
    ...
    def hash
      [id, ocid, schemas, meta, idcs_created_by, idcs_last_modified_by, idcs_prevented_operations, tags, delete_in_progress, idcs_last_upgraded_in_release, domain_ocid, compartment_ocid, tenancy_ocid, external_id, name, description, active, policy_groovy, rules, policy_type, urn_ietf_params_scim_schemas_oracle_idcs_extension_ociconsolesignonpolicyconsent_policy].hash
    end
