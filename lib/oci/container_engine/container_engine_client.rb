...
module OCI
  ...
  class ContainerEngine::ContainerEngineClient
    ...
    #   Oracle about a particular request, please provide the request ID.
    #
    # @option opts [String] :override_eviction_grace_duration_vnp Duration after which SKE will give up eviction of the pods on the node.
    ...
    #
    # @option opts [BOOLEAN] :is_force_deletion_after_override_grace_duration_vnp If the underlying virtual node should be force deleted if all the pods are not evicted in the evictionGraceDuration.
    # @return [Response] A Response object with data of type nil
    ...
    #   Oracle about a particular request, please provide the request ID.
    #
    # @option opts [BOOLEAN] :should_include_oidc_config_file Boolean value to determine if the OpenIdConnectAuth configuration file should be displayed for the provided cluster.
    #
    ...
    def get_cluster(cluster_id, opts = {})
      ...
      # Query Params
      query_params = {}
      query_params[:shouldIncludeOidcConfigFile] = opts[:should_include_oidc_config_file] if !opts[:should_include_oidc_config_file].nil?
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [Array<String>] :lifecycle_state A cluster lifecycle state to filter on. Can have multiple parameters of this name. For more information, see [Monitoring Clusters](https://docs.cloud.oracle.com/Content/ContEng/Tasks/contengmonitoringclusters.htm)
    ...
    #   Oracle about a particular request, please provide the request ID.
    #
    # @option opts [Array<String>] :lifecycle_state A list of nodepool lifecycle states on which to filter on, matching any of the list items (OR logic). eg. [ACTIVE, DELETING]. For more information, see [Monitoring Clusters](https://docs.cloud.oracle.com/Content/ContEng/Tasks/contengmonitoringclusters.htm)
    ...
    # @param [String] cluster_id The OCID of the cluster.
    # @param [String] node_id The OCID of the compute instance.
    # @param [OCI::ContainerEngine::Models::RebootClusterNodeDetails] reboot_cluster_node_details The fields to reboot a node.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/containerengine/reboot_cluster_node.rb.html) to see an example of how to use reboot_cluster_node API.
    def reboot_cluster_node(cluster_id, node_id, reboot_cluster_node_details, opts = {})
      logger.debug 'Calling operation ContainerEngineClient#reboot_cluster_node.' if logger

      raise "Missing the required parameter 'cluster_id' when calling reboot_cluster_node." if cluster_id.nil?
      raise "Missing the required parameter 'node_id' when calling reboot_cluster_node." if node_id.nil?
      raise "Missing the required parameter 'reboot_cluster_node_details' when calling reboot_cluster_node." if reboot_cluster_node_details.nil?
      raise "Parameter value for 'cluster_id' must not be blank" if OCI::Internal::Util.blank_string?(cluster_id)
      raise "Parameter value for 'node_id' must not be blank" if OCI::Internal::Util.blank_string?(node_id)

      path = '/clusters/{clusterId}/nodes/{nodeId}/actions/reboot'.sub('{clusterId}', cluster_id.to_s).sub('{nodeId}', node_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(reboot_cluster_node_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ContainerEngineClient#reboot_cluster_node') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [String] cluster_id The OCID of the cluster.
    # @param [String] node_id The OCID of the compute instance.
    # @param [OCI::ContainerEngine::Models::ReplaceBootVolumeClusterNodeDetails] replace_boot_volume_cluster_node_details The fields to replace boot volume of a node.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/containerengine/replace_boot_volume_cluster_node.rb.html) to see an example of how to use replace_boot_volume_cluster_node API.
    def replace_boot_volume_cluster_node(cluster_id, node_id, replace_boot_volume_cluster_node_details, opts = {})
      logger.debug 'Calling operation ContainerEngineClient#replace_boot_volume_cluster_node.' if logger

      raise "Missing the required parameter 'cluster_id' when calling replace_boot_volume_cluster_node." if cluster_id.nil?
      raise "Missing the required parameter 'node_id' when calling replace_boot_volume_cluster_node." if node_id.nil?
      raise "Missing the required parameter 'replace_boot_volume_cluster_node_details' when calling replace_boot_volume_cluster_node." if replace_boot_volume_cluster_node_details.nil?
      raise "Parameter value for 'cluster_id' must not be blank" if OCI::Internal::Util.blank_string?(cluster_id)
      raise "Parameter value for 'node_id' must not be blank" if OCI::Internal::Util.blank_string?(node_id)

      path = '/clusters/{clusterId}/nodes/{nodeId}/actions/replaceBootVolume'.sub('{clusterId}', cluster_id.to_s).sub('{nodeId}', node_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(replace_boot_volume_cluster_node_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ContainerEngineClient#replace_boot_volume_cluster_node') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
