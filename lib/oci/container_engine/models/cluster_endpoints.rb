...
module OCI
  ...
  class ContainerEngine::Models::ClusterEndpoints
    ...
    # @option attributes [String] :ipv6_endpoint The value to assign to the {#ipv6_endpoint} property
    def initialize(attributes = {})
      ...
      self.ipv6_endpoint = attributes[:'ipv6Endpoint'] if attributes[:'ipv6Endpoint']

      raise 'You cannot provide both :ipv6Endpoint and :ipv6_endpoint' if attributes.key?(:'ipv6Endpoint') && attributes.key?(:'ipv6_endpoint')

      self.ipv6_endpoint = attributes[:'ipv6_endpoint'] if attributes[:'ipv6_endpoint']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        ipv6_endpoint == other.ipv6_endpoint
    end
    ...
    def hash
      [kubernetes, public_endpoint, private_endpoint, vcn_hostname_endpoint, ipv6_endpoint].hash
    end
