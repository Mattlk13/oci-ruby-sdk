...
module OCI
  ...
  class ContainerEngine::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_CREATE_NAMESPACE = 'CREATE_NAMESPACE'.freeze,
      ...
      OPERATION_TYPE_CLUSTER_NODE_REBOOT = 'CLUSTER_NODE_REBOOT'.freeze,
      OPERATION_TYPE_CLUSTER_NODE_REPLACE_BOOT_VOLUME = 'CLUSTER_NODE_REPLACE_BOOT_VOLUME'.freeze,
