...
module OCI
  ...
  class ContainerEngine::Models::NodePoolCyclingDetails
    ...
    #
    # @return [Array<OCI::ContainerEngine::Models::CycleMode>]
    attr_accessor :cycle_modes
    ...
    def self.swagger_types
      {
        ...
        'cycle_modes': :'Array<OCI::ContainerEngine::Models::CycleMode>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::ContainerEngine::Models::CycleMode>] :cycle_modes The value to assign to the {#cycle_modes} property
    def initialize(attributes = {})
      ...
      self.cycle_modes = attributes[:'cycleModes'] if attributes[:'cycleModes']

      raise 'You cannot provide both :cycleModes and :cycle_modes' if attributes.key?(:'cycleModes') && attributes.key?(:'cycle_modes')

      self.cycle_modes = attributes[:'cycle_modes'] if attributes[:'cycle_modes']
    end
    ...
    def hash
      [maximum_unavailable, maximum_surge, is_node_cycling_enabled, cycle_modes].hash
    end
