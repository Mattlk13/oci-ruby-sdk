...
module OCI
  ...
  class VisualBuilder::Models::UpdateVbInstanceDetails
    ...
    # @return [OCI::VisualBuilder::Models::UpdateNetworkEndpointDetails]
    ...
    def self.swagger_types
      {
        ...
        'network_endpoint_details': :'OCI::VisualBuilder::Models::UpdateNetworkEndpointDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::VisualBuilder::Models::UpdateNetworkEndpointDetails] :network_endpoint_details The value to assign to the {#network_endpoint_details} property
    ...
    def hash
      [display_name, freeform_tags, defined_tags, idcs_open_id, node_count, is_visual_builder_enabled, custom_endpoint, alternate_custom_endpoints, network_endpoint_details].hash
    end
