...
require 'date'
require_relative 'update_network_endpoint_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Public endpoint configuration details (update).
  #
  class VisualBuilder::Models::UpdatePublicEndpointDetails < VisualBuilder::Models::UpdateNetworkEndpointDetails
    ...
    #
    # @return [Array<OCI::VisualBuilder::Models::VirtualCloudNetwork>]
    ...
    def self.swagger_types
      {
        ...
        'allowlisted_http_vcns': :'Array<OCI::VisualBuilder::Models::VirtualCloudNetwork>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::VisualBuilder::Models::VirtualCloudNetwork>] :allowlisted_http_vcns The value to assign to the {#allowlisted_http_vcns} property
    ...
    def hash
      [network_endpoint_type, allowlisted_http_ips, allowlisted_http_vcns].hash
    end
