...
module OCI
  ...
  #
  class VisualBuilder::Models::UpdatePrivateEndpointDetails < VisualBuilder::Models::UpdateNetworkEndpointDetails
    ...
    def hash
      [network_endpoint_type, subnet_id, network_security_group_ids].hash
    end
