...
module OCI
  ...
  class VisualBuilder::Models::CreateVbInstanceDetails
    ...
    def hash
      [display_name, compartment_id, freeform_tags, defined_tags, idcs_open_id, node_count, is_visual_builder_enabled, custom_endpoint, alternate_custom_endpoints, consumption_model, network_endpoint_details].hash
    end
