...
module OCI
  ...
  #
  class VisualBuilder::Models::PrivateEndpointDetails < VisualBuilder::Models::NetworkEndpointDetails
    ...
    def hash
      [network_endpoint_type, subnet_id, network_security_group_ids, private_endpoint_ip].hash
    end
