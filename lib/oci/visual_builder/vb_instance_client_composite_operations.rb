...
module OCI
  ...
  class VisualBuilder::VbInstanceClientCompositeOperations
    ...
    # Calls {OCI::VisualBuilder::VbInstanceClient#reconfigure_private_endpoint_vb_instance} and then waits for the {OCI::VisualBuilder::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] vb_instance_id Unique Vb Instance identifier.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::VisualBuilder::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::VisualBuilder::VbInstanceClient#reconfigure_private_endpoint_vb_instance}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::VisualBuilder::Models::WorkRequest}
    def reconfigure_private_endpoint_vb_instance_and_wait_for_state(vb_instance_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.reconfigure_private_endpoint_vb_instance(vb_instance_id, base_operation_opts)
      use_util = OCI::VisualBuilder::Util.respond_to?(:wait_on_work_request)
