...
module OCI
  ...
  #
  class StackMonitoring::Models::UpdateOnboardConfigDetails < StackMonitoring::Models::UpdateConfigDetails
    ...
    def hash
      [display_name, config_type, freeform_tags, defined_tags, version, is_manually_onboarded, policy_names, dynamic_groups, user_groups, additional_configurations].hash
    end
