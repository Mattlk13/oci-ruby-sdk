...
module OCI
  ...
  class StackMonitoring::Models::DiscoveryDetails
    RESOURCE_TYPE_ENUM = [
      ...
      RESOURCE_TYPE_MICROSOFT_IIS = 'MICROSOFT_IIS'.freeze,
      RESOURCE_TYPE_NGINX = 'NGINX'.freeze,
      RESOURCE_TYPE_JBOSS_SERVER = 'JBOSS_SERVER'.freeze,
      RESOURCE_TYPE_JBOSS_DOMAIN = 'JBOSS_DOMAIN'.freeze,
      RESOURCE_TYPE_ORACLE_JVM = 'ORACLE_JVM'.freeze,
