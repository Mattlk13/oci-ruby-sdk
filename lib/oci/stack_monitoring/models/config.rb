...
module OCI
  ...
  class StackMonitoring::Models::Config
    ...
    CONFIG_TYPE_ENUM = [
      ...
      CONFIG_TYPE_COMPUTE_AUTO_ACTIVATE_PLUGIN = 'COMPUTE_AUTO_ACTIVATE_PLUGIN'.freeze,
      ...
      CONFIG_TYPE_ONBOARD = 'ONBOARD'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::StackMonitoring::Models::OnboardConfigDetails' if type == 'ONBOARD'
      return 'OCI::StackMonitoring::Models::LicenseEnterpriseExtensibilityConfigDetails' if type == 'LICENSE_ENTERPRISE_EXTENSIBILITY'
      return 'OCI::StackMonitoring::Models::ComputeAutoActivatePluginConfigDetails' if type == 'COMPUTE_AUTO_ACTIVATE_PLUGIN'
