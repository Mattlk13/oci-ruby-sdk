...
module OCI
  ...
  #
  class StackMonitoring::Models::CollectdResourceNameConfigurationDetails
    ...
    # @return [Array<String>]
    attr_accessor :include_properties

    # List of property names to be excluded.
    # @return [Array<String>]
    attr_accessor :exclude_properties
    ...
    # @option attributes [Array<String>] :include_properties The value to assign to the {#include_properties} property
    # @option attributes [Array<String>] :exclude_properties The value to assign to the {#exclude_properties} property
