...
module OCI
  ...
  class StackMonitoring::Models::MaintenanceWindowSchedule
    SCHEDULE_TYPE_ENUM = [
      SCHEDULE_TYPE_ONE_TIME = 'ONE_TIME'.freeze,
      SCHEDULE_TYPE_RECURRENT = 'RECURRENT'.freeze,
      SCHEDULE_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Property to identify the type of the Maintenance Window.
    #
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::StackMonitoring::Models::RecurrentMaintenanceWindowSchedule' if type == 'RECURRENT'
      return 'OCI::StackMonitoring::Models::OneTimeMaintenanceWindowSchedule' if type == 'ONE_TIME'

      # TODO: Log a warning when the subtype is not found.
      'OCI::StackMonitoring::Models::MaintenanceWindowSchedule'
    end
