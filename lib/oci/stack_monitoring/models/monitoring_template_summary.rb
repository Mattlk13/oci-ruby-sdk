...
module OCI
  ...
  class StackMonitoring::Models::MonitoringTemplateSummary
    STATUS_ENUM = [
    ...
    def hash
      [id, display_name, tenant_id, compartment_id, description, status, lifecycle_state, destinations, members, total_alarm_conditions, total_applied_alarm_conditions, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
