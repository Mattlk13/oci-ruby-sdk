...
module OCI
  ...
  class StackMonitoring::Models::MemberReference
    TYPE_ENUM = [
      TYPE_RESOURCE_INSTANCE = 'RESOURCE_INSTANCE'.freeze,
      TYPE_RESOURCE_TYPE = 'RESOURCE_TYPE'.freeze,
      TYPE_RESOURCE_GROUP = 'RESOURCE_GROUP'.freeze,
      TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The OCID of the resourceInstance/resourceType/resourceGroup
    # @return [String]
    attr_accessor :id

    # **[Required]** Type of the member reference RESOURCE_INSTANCE, RESOURCE_TYPE, RESOURCE_GROUP
    # @return [String]
    attr_reader :type
