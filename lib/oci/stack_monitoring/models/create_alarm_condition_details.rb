...
module OCI
  ...
  class StackMonitoring::Models::CreateAlarmConditionDetails
    CONDITION_TYPE_ENUM = [
    ...
    def condition_type=(condition_type)
      raise "Invalid value for 'condition_type': this must be one of the values in CONDITION_TYPE_ENUM." if condition_type && !CONDITION_TYPE_ENUM.include?(condition_type)
    ...
    def hash
      [namespace, composite_type, resource_type, metric_name, condition_type, conditions, freeform_tags, defined_tags].hash
    end
