...
module OCI
  ...
  class StackMonitoring::Models::MonitoredResourceTask
    ...
    def hash
      [id, name, type, compartment_id, tenant_id, task_details, work_request_ids, time_created, time_updated, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
