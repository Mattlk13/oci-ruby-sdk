...
require 'date'
require_relative 'maintenance_window_schedule'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Schedule information for the Maintenance Window that is executed multiple times.
  #
  class StackMonitoring::Models::RecurrentMaintenanceWindowSchedule < StackMonitoring::Models::MaintenanceWindowSchedule
    ...
    # **[Required]** A RFC5545 formatted recurrence string which represents the Maintenance Window Recurrence.
    ...
    #
    # @return [String]
    attr_accessor :maintenance_window_recurrences
    ...
    # @option attributes [String] :maintenance_window_recurrences The value to assign to the {#maintenance_window_recurrences} property
    # @option attributes [String] :maintenance_window_duration The value to assign to the {#maintenance_window_duration} property
