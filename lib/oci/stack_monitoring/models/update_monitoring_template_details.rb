...
module OCI
  ...
  class StackMonitoring::Models::UpdateMonitoringTemplateDetails
    MESSAGE_FORMAT_ENUM = [
    ...
    def initialize(attributes = {})
      ...
      self.is_alarms_enabled = false if is_alarms_enabled.nil? && !attributes.key?(:'isAlarmsEnabled') # rubocop:disable Style/StringLiterals
      ...
      self.is_alarms_enabled = false if is_alarms_enabled.nil? && !attributes.key?(:'isAlarmsEnabled') && !attributes.key?(:'is_alarms_enabled') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [display_name, description, destinations, is_alarms_enabled, is_split_notification_enabled, members, repeat_notification_duration, message_format, freeform_tags, defined_tags].hash
    end
