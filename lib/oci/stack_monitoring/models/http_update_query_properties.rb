...
module OCI
  ...
  class StackMonitoring::Models::HttpUpdateQueryProperties < StackMonitoring::Models::MetricExtensionUpdateQueryProperties
    ...
    # @return [OCI::StackMonitoring::Models::UpdateHttpScriptFileDetails]
    ...
    # @option attributes [OCI::StackMonitoring::Models::UpdateHttpScriptFileDetails] :script_details The value to assign to the {#script_details} property
    ...
    def response_content_type=(response_content_type)
      raise "Invalid value for 'response_content_type': this must be one of the values in RESPONSE_CONTENT_TYPE_ENUM." if response_content_type && !RESPONSE_CONTENT_TYPE_ENUM.include?(response_content_type)
    ...
    def protocol_type=(protocol_type)
      raise "Invalid value for 'protocol_type': this must be one of the values in PROTOCOL_TYPE_ENUM." if protocol_type && !PROTOCOL_TYPE_ENUM.include?(protocol_type)
