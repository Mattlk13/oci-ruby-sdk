...
module OCI
  ...
  class StackMonitoring::Models::MonitoredResourceTypeSummary
    ...
    def hash
      [id, name, display_name, description, metric_namespace, compartment_id, availability_metrics_config, handler_config, is_system_defined, lifecycle_state, source_type, resource_category, metadata, additional_namespace_map, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
