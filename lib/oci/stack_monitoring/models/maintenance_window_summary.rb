...
module OCI
  ...
  class StackMonitoring::Models::MaintenanceWindowSummary
    ...
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_STOP = 'STOP'.freeze,
    ...
    # @option attributes [Integer] :number_of_resources The value to assign to the {#number_of_resources} property
    ...
    def initialize(attributes = {})
      ...
      self.number_of_resources = attributes[:'numberOfResources'] if attributes[:'numberOfResources']

      raise 'You cannot provide both :numberOfResources and :number_of_resources' if attributes.key?(:'numberOfResources') && attributes.key?(:'number_of_resources')

      self.number_of_resources = attributes[:'number_of_resources'] if attributes[:'number_of_resources']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        number_of_resources == other.number_of_resources &&
    ...
    def hash
      [id, name, compartment_id, number_of_resources, lifecycle_state, lifecycle_details, operation_type, operation_status, schedule, freeform_tags, defined_tags, system_tags].hash
    end
