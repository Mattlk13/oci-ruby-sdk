...
module OCI
  ...
  class StackMonitoring::Models::UpdateBaselineableMetricDetails
    ...
    def hash
      [id, lifecycle_state, tenancy_id, compartment_id, name, column, namespace, resource_group, resource_type, is_out_of_box, freeform_tags, defined_tags, system_tags].hash
    end
