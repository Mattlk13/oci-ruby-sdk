...
module OCI
  ...
  class StackMonitoring::Models::BaselineableMetric
    ...
    def hash
      [id, lifecycle_state, tenancy_id, compartment_id, name, column, namespace, resource_group, resource_type, is_out_of_box, created_by, last_updated_by, time_created, time_last_updated, freeform_tags, defined_tags, system_tags].hash
    end
