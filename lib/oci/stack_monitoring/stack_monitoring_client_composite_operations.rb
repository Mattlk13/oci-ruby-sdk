...
module OCI
  ...
  class StackMonitoring::StackMonitoringClientCompositeOperations
    ...
    # Calls {OCI::StackMonitoring::StackMonitoringClient#apply_monitoring_template} and then waits for the {OCI::StackMonitoring::Models::WorkRequest}
    ...
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::StackMonitoring::StackMonitoringClient#apply_monitoring_template}
    ...
    def apply_monitoring_template_and_wait_for_state(monitoring_template_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.apply_monitoring_template(monitoring_template_id, base_operation_opts)
    ...
    # Calls {OCI::StackMonitoring::StackMonitoringClient#create_alarm_condition} and then waits for the {OCI::StackMonitoring::Models::AlarmCondition} acted upon
    # to enter the given state(s).
    #
    ...
    # @param [String] monitoring_template_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the monitoring template.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::StackMonitoring::Models::AlarmCondition#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::StackMonitoring::StackMonitoringClient#create_alarm_condition}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::StackMonitoring::Models::AlarmCondition}
    def create_alarm_condition_and_wait_for_state(create_alarm_condition_details, monitoring_template_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_alarm_condition(create_alarm_condition_details, monitoring_template_id, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_alarm_condition(wait_for_resource_id).wait_until(
    ...
    # Calls {OCI::StackMonitoring::StackMonitoringClient#create_maintenance_window} and then waits for the {OCI::StackMonitoring::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::StackMonitoring::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::StackMonitoring::StackMonitoringClient#create_maintenance_window}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::StackMonitoring::StackMonitoringClient#create_monitoring_template} and then waits for the {OCI::StackMonitoring::Models::MonitoringTemplate} acted upon
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::StackMonitoring::Models::MonitoringTemplate#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::StackMonitoring::StackMonitoringClient#create_monitoring_template}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::StackMonitoring::Models::MonitoringTemplate}
    def create_monitoring_template_and_wait_for_state(create_monitoring_template_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_monitoring_template(create_monitoring_template_details, base_operation_opts)
      ...
      begin
        waiter_result = @service_client.get_monitoring_template(wait_for_resource_id).wait_until(
          eval_proc: ->(response) { response.data.respond_to?(:lifecycle_state) && lowered_wait_for_states.include?(response.data.lifecycle_state.downcase) },
          max_interval_seconds: waiter_opts.key?(:max_interval_seconds) ? waiter_opts[:max_interval_seconds] : 30,
          max_wait_seconds: waiter_opts.key?(:max_wait_seconds) ? waiter_opts[:max_wait_seconds] : 1200
        )
    ...
    # Calls {OCI::StackMonitoring::StackMonitoringClient#delete_maintenance_window} and then waits for the {OCI::StackMonitoring::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::StackMonitoring::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::StackMonitoring::StackMonitoringClient#delete_maintenance_window}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::StackMonitoring::StackMonitoringClient#delete_monitoring_template} and then waits for the {OCI::StackMonitoring::Models::MonitoringTemplate} acted upon
    # to enter the given state(s).
    #
    # @param [String] monitoring_template_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the monitoring template.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::StackMonitoring::Models::MonitoringTemplate#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::StackMonitoring::StackMonitoringClient#delete_monitoring_template}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type nil
    def delete_monitoring_template_and_wait_for_state(monitoring_template_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      initial_get_result = @service_client.get_monitoring_template(monitoring_template_id)
      operation_result = @service_client.delete_monitoring_template(monitoring_template_id, base_operation_opts)
    ...
    # Calls {OCI::StackMonitoring::StackMonitoringClient#retry_failed_maintenance_window_operation} and then waits for the {OCI::StackMonitoring::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] maintenance_window_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of maintenance window.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::StackMonitoring::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::StackMonitoring::StackMonitoringClient#retry_failed_maintenance_window_operation}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::StackMonitoring::Models::WorkRequest}
    def retry_failed_maintenance_window_operation_and_wait_for_state(maintenance_window_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.retry_failed_maintenance_window_operation(maintenance_window_id, base_operation_opts)
      use_util = OCI::StackMonitoring::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::StackMonitoring::StackMonitoringClient#stop_maintenance_window} and then waits for the {OCI::StackMonitoring::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] maintenance_window_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of maintenance window.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::StackMonitoring::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::StackMonitoring::StackMonitoringClient#stop_maintenance_window}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::StackMonitoring::Models::WorkRequest}
    def stop_maintenance_window_and_wait_for_state(maintenance_window_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.stop_maintenance_window(maintenance_window_id, base_operation_opts)
      use_util = OCI::StackMonitoring::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::StackMonitoring::StackMonitoringClient#unapply_monitoring_template} and then waits for the {OCI::StackMonitoring::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] monitoring_template_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the monitoring template.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::StackMonitoring::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::StackMonitoring::StackMonitoringClient#unapply_monitoring_template}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::StackMonitoring::Models::WorkRequest}
    def unapply_monitoring_template_and_wait_for_state(monitoring_template_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.unapply_monitoring_template(monitoring_template_id, base_operation_opts)
      use_util = OCI::StackMonitoring::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::StackMonitoring::StackMonitoringClient#update_alarm_condition} and then waits for the {OCI::StackMonitoring::Models::AlarmCondition} acted upon
    # to enter the given state(s).
    #
    ...
    # @param [String] monitoring_template_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the monitoring template.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::StackMonitoring::Models::AlarmCondition#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::StackMonitoring::StackMonitoringClient#update_alarm_condition}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::StackMonitoring::Models::AlarmCondition}
    def update_alarm_condition_and_wait_for_state(update_alarm_condition_details, alarm_condition_id, monitoring_template_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_alarm_condition(update_alarm_condition_details, alarm_condition_id, monitoring_template_id, base_operation_opts)
    ...
    # Calls {OCI::StackMonitoring::StackMonitoringClient#update_maintenance_window} and then waits for the {OCI::StackMonitoring::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] maintenance_window_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of maintenance window.
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::StackMonitoring::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::StackMonitoring::StackMonitoringClient#update_maintenance_window}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::StackMonitoring::StackMonitoringClient#update_monitoring_template} and then waits for the {OCI::StackMonitoring::Models::MonitoringTemplate} acted upon
    # to enter the given state(s).
    #
    # @param [String] monitoring_template_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the monitoring template.
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::StackMonitoring::Models::MonitoringTemplate#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::StackMonitoring::StackMonitoringClient#update_monitoring_template}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type {OCI::StackMonitoring::Models::MonitoringTemplate}
    def update_monitoring_template_and_wait_for_state(monitoring_template_id, update_monitoring_template_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_monitoring_template(monitoring_template_id, update_monitoring_template_details, base_operation_opts)
