...
module OCI
  ...
  class MarketplacePublisher::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_CREATE_OFFER = 'CREATE_OFFER'.freeze,
      OPERATION_TYPE_UPDATE_OFFER = 'UPDATE_OFFER'.freeze,
      OPERATION_TYPE_DELETE_OFFER = 'DELETE_OFFER'.freeze,
      OPERATION_TYPE_MOVE_OFFER = 'MOVE_OFFER'.freeze,
      OPERATION_TYPE_DELETE_OFFER_ATTACHMENT = 'DELETE_OFFER_ATTACHMENT'.freeze,
