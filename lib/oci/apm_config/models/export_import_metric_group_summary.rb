...
require 'date'
require_relative 'export_import_config_summary'
...
module OCI
  ...
  #
  class ApmConfig::Models::ExportImportMetricGroupSummary < ApmConfig::Models::ExportImportConfigSummary
    ...
    # @option attributes [String] :id The value to assign to the {OCI::ApmConfig::Models::ExportImportConfigSummary#id #id} proprety
    # @option attributes [Hash<String, String>] :freeform_tags The value to assign to the {OCI::ApmConfig::Models::ExportImportConfigSummary#freeform_tags #freeform_tags} proprety
    # @option attributes [Hash<String, Hash<String, Object>>] :defined_tags The value to assign to the {OCI::ApmConfig::Models::ExportImportConfigSummary#defined_tags #defined_tags} proprety
    ...
    def hash
      [id, config_type, freeform_tags, defined_tags, display_name, filter_id, namespace, dimensions, metrics].hash
    end
