...
module OCI
  ...
  class ApmConfig::Models::CopyConfigurationDetails
    # **[Required]** Simple key-value pair that has parameters related to the import process (EnableOcidSubstitution, DestinationDomainID, \u2026) and more.
