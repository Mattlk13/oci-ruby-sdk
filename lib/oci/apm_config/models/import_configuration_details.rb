...
module OCI
  ...
  class ApmConfig::Models::ImportConfigurationDetails
    # **[Required]** A list of Configurations Details .
    # @return [Array<OCI::ApmConfig::Models::ExportImportConfigSummary>]
    attr_accessor :configuration_items

    # **[Required]** Simple key-value pair that has parameters related to the import process (EnableOcidSubstitution, Skip, \u2026) and more.
    ...
    # @option attributes [Array<OCI::ApmConfig::Models::ExportImportConfigSummary>] :configuration_items The value to assign to the {#configuration_items} property
