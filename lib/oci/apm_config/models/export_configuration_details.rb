...
module OCI
  ...
  class ApmConfig::Models::ExportConfigurationDetails
    # **[Required]** Simple key-value pair that has parameters related to the export process (ConfigurationId, Skip, \u2026) and more.
