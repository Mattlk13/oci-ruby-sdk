...
module OCI
  ...
  class ApmConfig::Models::ExportImportConfigSummary
    CONFIG_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::ApmConfig::Models::ExportImportOptionsSummary' if type == 'OPTIONS'
      return 'OCI::ApmConfig::Models::ExportImportApdexRulesSummary' if type == 'APDEX'
      return 'OCI::ApmConfig::Models::ExportImportSpanFilterSummary' if type == 'SPAN_FILTER'
      return 'OCI::ApmConfig::Models::ExportImportMetricGroupSummary' if type == 'METRIC_GROUP'
    ...
    def hash
      [id, config_type, freeform_tags, defined_tags].hash
    end
