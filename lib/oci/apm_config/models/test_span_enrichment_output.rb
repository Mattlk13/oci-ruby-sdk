...
module OCI
  ...
  class ApmConfig::Models::TestSpanEnrichmentOutput < ApmConfig::Models::TestOutput
    ...
    # @option attributes [Array<BOOLEAN>] :filters The value to assign to the {#filters} property
