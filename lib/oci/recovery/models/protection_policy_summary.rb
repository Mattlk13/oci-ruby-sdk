...
module OCI
  ...
  class Recovery::Models::ProtectionPolicySummary
    ...
    # @return [BOOLEAN]
    attr_accessor :must_enforce_cloud_locality
    ...
    # @option attributes [BOOLEAN] :must_enforce_cloud_locality The value to assign to the {#must_enforce_cloud_locality} property
    ...
    def hash
      [id, display_name, compartment_id, backup_retention_period_in_days, is_predefined_policy, policy_locked_date_time, must_enforce_cloud_locality, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
