...
module OCI
  ...
  class Desktops::DesktopServiceClient
    ...
    # @option opts [String] :if_match For optimistic concurrency control.
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request.
    # @option opts [BOOLEAN] :is_soft_stop Force a STOP(power off) of the desktop if set to false
    # @return [Response] A Response object with data of type nil
    ...
    def stop_desktop(desktop_id, opts = {})
      ...
      # Query Params
      query_params = {}
      query_params[:isSoftStop] = opts[:is_soft_stop] if !opts[:is_soft_stop].nil?
