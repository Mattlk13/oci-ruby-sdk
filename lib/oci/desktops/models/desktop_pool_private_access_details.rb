...
module OCI
  ...
  #
  class Desktops::Models::DesktopPoolPrivateAccessDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the customer VCN.
    #
    # @return [String]
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the subnet in the customer VCN where the
    ...
    def hash
      [vcn_id, endpoint_fqdn, subnet_id, nsg_ids, private_ip].hash
    end
