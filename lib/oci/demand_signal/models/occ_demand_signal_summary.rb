...
module OCI
  ...
  class DemandSignal::Models::OccDemandSignalSummary
    ...
    def hash
      [id, display_name, compartment_id, is_active, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
