...
module OCI
  ...
  #
  class DemandSignal::Models::OccDemandSignal
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the OccDemandSignal.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The OccDemandSignal data.
    # @return [Array<OCI::DemandSignal::Models::OccDemandSignalData>]
    attr_accessor :occ_demand_signals

    # **[Required]** Indicator of whether to share the data with Oracle.
    # @return [BOOLEAN]
    attr_accessor :is_active

    # **[Required]** The current state of the OccDemandSignal.
    # @return [String]
    attr_reader :lifecycle_state

    # **[Required]** The date and time the OccDemandSignal was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    def self.swagger_types
      {
        ...
        'display_name': :'String',
        'occ_demand_signals': :'Array<OCI::DemandSignal::Models::OccDemandSignalData>',
        'is_active': :'BOOLEAN',
    ...
    # @option attributes [Array<OCI::DemandSignal::Models::OccDemandSignalData>] :occ_demand_signals The value to assign to the {#occ_demand_signals} property
    ...
    def initialize(attributes = {})
      ...
      self.occ_demand_signals = attributes[:'occDemandSignals'] if attributes[:'occDemandSignals']

      raise 'You cannot provide both :occDemandSignals and :occ_demand_signals' if attributes.key?(:'occDemandSignals') && attributes.key?(:'occ_demand_signals')

      self.occ_demand_signals = attributes[:'occ_demand_signals'] if attributes[:'occ_demand_signals']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        occ_demand_signals == other.occ_demand_signals &&
    ...
    def hash
      [id, compartment_id, display_name, occ_demand_signals, is_active, lifecycle_state, time_created, time_updated, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
