...
module OCI
  ...
  class DemandSignal::Models::OccDemandSignalValue
    # **[Required]** The date of the Demand Signal Value.
    # @return [DateTime]
    attr_accessor :time_expected
    ...
    # @option attributes [DateTime] :time_expected The value to assign to the {#time_expected} property
    ...
    def initialize(attributes = {})
      ...
      self.time_expected = attributes[:'timeExpected'] if attributes[:'timeExpected']

      raise 'You cannot provide both :timeExpected and :time_expected' if attributes.key?(:'timeExpected') && attributes.key?(:'time_expected')

      self.time_expected = attributes[:'time_expected'] if attributes[:'time_expected']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        time_expected == other.time_expected &&
        value == other.value &&
    ...
    def hash
      [time_expected, value, comments].hash
    end
