...
module OCI
  ...
  class Email::EmailClientCompositeOperations
    ...
    # Calls {OCI::Email::EmailClient#create_email_return_path} and then waits for the {OCI::Email::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Email::Models::CreateEmailReturnPathDetails] create_email_return_path_details The email return path to create.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Email::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Email::EmailClient#create_email_return_path}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Email::Models::WorkRequest}
    def create_email_return_path_and_wait_for_state(create_email_return_path_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_email_return_path(create_email_return_path_details, base_operation_opts)
      use_util = OCI::Email::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Email::EmailClient#delete_email_return_path} and then waits for the {OCI::Email::Models::WorkRequest}
    # to enter the given state(s).
    #
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Email::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Email::EmailClient#delete_email_return_path}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Email::Models::WorkRequest}
    def delete_email_return_path_and_wait_for_state(email_return_path_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_email_return_path(email_return_path_id, base_operation_opts)
      use_util = OCI::Email::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Email::EmailClient#update_email_return_path} and then waits for the {OCI::Email::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] email_return_path_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this email return path.
    ...
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Email::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Email::EmailClient#update_email_return_path}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Email::Models::WorkRequest}
    def update_email_return_path_and_wait_for_state(email_return_path_id, update_email_return_path_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_email_return_path(email_return_path_id, update_email_return_path_details, base_operation_opts)
      use_util = OCI::Email::Util.respond_to?(:wait_on_work_request)
