...
require 'oci/email/models/create_email_return_path_details'
...
require 'oci/email/models/domain_verification_status_type'
...
require 'oci/email/models/email_return_path'
require 'oci/email/models/email_return_path_collection'
require 'oci/email/models/email_return_path_summary'
...
require 'oci/email/models/update_email_return_path_details'
