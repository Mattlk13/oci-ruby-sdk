...
module OCI
  ...
  #
  class Email::Models::EmailReturnPathSummary
    ...
    def hash
      [name, id, parent_resource_id, compartment_id, lifecycle_state, description, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
