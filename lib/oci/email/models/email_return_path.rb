...
module OCI
  ...
  #
  class Email::Models::EmailReturnPath
    ...
    # **[Required]** The email return path domain in the Internet Domain Name System (DNS).
    #
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the email return path.
    #
    # @return [String]
    attr_accessor :id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the EmailDomain
    ...
    def hash
      [name, id, parent_resource_id, compartment_id, lifecycle_state, lifecycle_details, description, dns_subdomain_name, cname_record_value, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
