...
module OCI
  ...
  class Email::EmailClient
    ...
    # @param [OCI::Email::Models::CreateEmailReturnPathDetails] create_email_return_path_details The email return path to create.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The request ID for tracing from the system
    ...
    #   might be rejected.
    #
    # @return [Response] A Response object with data of type {OCI::Email::Models::EmailReturnPath EmailReturnPath}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/create_email_return_path.rb.html) to see an example of how to use create_email_return_path API.
    def create_email_return_path(create_email_return_path_details, opts = {})
      logger.debug 'Calling operation EmailClient#create_email_return_path.' if logger

      raise "Missing the required parameter 'create_email_return_path_details' when calling create_email_return_path." if create_email_return_path_details.nil?
      ...
      post_body = @api_client.object_to_http_body(create_email_return_path_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#create_email_return_path') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Email::Models::EmailReturnPath'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @param [String] email_return_path_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this email return path.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match Used for optimistic concurrency control. In the update or delete call for a resource, set the `if-match`
    ...
    # @option opts [String] :opc_request_id The request ID for tracing from the system
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/delete_email_return_path.rb.html) to see an example of how to use delete_email_return_path API.
    def delete_email_return_path(email_return_path_id, opts = {})
      logger.debug 'Calling operation EmailClient#delete_email_return_path.' if logger

      raise "Missing the required parameter 'email_return_path_id' when calling delete_email_return_path." if email_return_path_id.nil?
      raise "Parameter value for 'email_return_path_id' must not be blank" if OCI::Internal::Util.blank_string?(email_return_path_id)

      path = '/emailReturnPaths/{emailReturnPathId}'.sub('{emailReturnPathId}', email_return_path_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#delete_email_return_path') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id The request ID for tracing from the system
    # @return [Response] A Response object with data of type {OCI::Email::Models::EmailReturnPath EmailReturnPath}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/get_email_return_path.rb.html) to see an example of how to use get_email_return_path API.
    def get_email_return_path(email_return_path_id, opts = {})
      logger.debug 'Calling operation EmailClient#get_email_return_path.' if logger

      raise "Missing the required parameter 'email_return_path_id' when calling get_email_return_path." if email_return_path_id.nil?
      raise "Parameter value for 'email_return_path_id' must not be blank" if OCI::Internal::Util.blank_string?(email_return_path_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#get_email_return_path') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The request ID for tracing from the system
    # @option opts [String] :compartment_id The OCID for the compartment.
    # @option opts [String] :parent_resource_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Email Domain to which this Email Return Path belongs.
    #
    # @option opts [String] :id A filter to only return resources that match the given id exactly.
    #
    # @option opts [String] :name A filter to only return resources that match the given name exactly.
    ...
    # @option opts [String] :lifecycle_state Filter returned list by specified lifecycle state. This parameter is case-insensitive.
    #
    # @option opts [String] :sort_by Specifies the attribute with which to sort the return paths.
    #
    #   Default: `TIMECREATED`
    #
    #   * **TIMECREATED:** Sorts by timeCreated.
    ...
    #    (default to TIMECREATED)
    #   Allowed values are: TIMECREATED, ID, NAME
    # @return [Response] A Response object with data of type {OCI::Email::Models::EmailReturnPathCollection EmailReturnPathCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/list_email_return_paths.rb.html) to see an example of how to use list_email_return_paths API.
    def list_email_return_paths(opts = {})
      logger.debug 'Calling operation EmailClient#list_email_return_paths.' if logger
      ...
      if opts[:lifecycle_state] && !OCI::Email::Models::EmailReturnPath::LIFECYCLE_STATE_ENUM.include?(opts[:lifecycle_state])
        raise 'Invalid value for "lifecycle_state", must be one of the values in OCI::Email::Models::EmailReturnPath::LIFECYCLE_STATE_ENUM.'
      end
      ...
      query_params[:parentResourceId] = opts[:parent_resource_id] if opts[:parent_resource_id]
      query_params[:id] = opts[:id] if opts[:id]
      query_params[:name] = opts[:name] if opts[:name]
      query_params[:limit] = opts[:limit] if opts[:limit]
      query_params[:page] = opts[:page] if opts[:page]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#list_email_return_paths') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Email::Models::EmailReturnPathCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @param [String] email_return_path_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this email return path.
    # @param [OCI::Email::Models::UpdateEmailReturnPathDetails] update_email_return_path_details The new email return path attributes to apply.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match Used for optimistic concurrency control. In the update or delete call for a resource, set the `if-match`
    ...
    # @option opts [String] :opc_request_id The request ID for tracing from the system
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/email/update_email_return_path.rb.html) to see an example of how to use update_email_return_path API.
    def update_email_return_path(email_return_path_id, update_email_return_path_details, opts = {})
      logger.debug 'Calling operation EmailClient#update_email_return_path.' if logger

      raise "Missing the required parameter 'email_return_path_id' when calling update_email_return_path." if email_return_path_id.nil?
      raise "Missing the required parameter 'update_email_return_path_details' when calling update_email_return_path." if update_email_return_path_details.nil?
      raise "Parameter value for 'email_return_path_id' must not be blank" if OCI::Internal::Util.blank_string?(email_return_path_id)
      ...
      post_body = @api_client.object_to_http_body(update_email_return_path_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'EmailClient#update_email_return_path') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
