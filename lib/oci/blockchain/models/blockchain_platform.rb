...
module OCI
  ...
  class Blockchain::Models::BlockchainPlatform
    ...
    COMPUTE_SHAPE_ENUM = [
      ...
      COMPUTE_SHAPE_DIGITAL_ASSETS_MEDIUM = 'DIGITAL_ASSETS_MEDIUM'.freeze,
      COMPUTE_SHAPE_DIGITAL_ASSETS_LARGE = 'DIGITAL_ASSETS_LARGE'.freeze,
      COMPUTE_SHAPE_DIGITAL_ASSETS_EXTRA_LARGE = 'DIGITAL_ASSETS_EXTRA_LARGE'.freeze,
    ...
    # **[Required]** Compute shape - STANDARD or ENTERPRISE_SMALL or ENTERPRISE_MEDIUM or ENTERPRISE_LARGE or ENTERPRISE_EXTRA_LARGE or ENTERPRISE_CUSTOM or DIGITAL_ASSETS_MEDIUM or DIGITAL_ASSETS_LARGE or DIGITAL_ASSETS_EXTRA_LARGE
    # @return [String]
