...
module OCI
  ...
  class Opsi::OperationsInsightsClientCompositeOperations
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#change_external_mysql_database_insight_connection} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] database_insight_id Unique database insight identifier
    # @param [OCI::Opsi::Models::ChangeExternalMysqlDatabaseInsightConnectionDetails] change_external_mysql_database_insight_connection_details The information to be updated.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#change_external_mysql_database_insight_connection}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def change_external_mysql_database_insight_connection_and_wait_for_state(database_insight_id, change_external_mysql_database_insight_connection_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_external_mysql_database_insight_connection(database_insight_id, change_external_mysql_database_insight_connection_details, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#change_macs_managed_cloud_database_insight_connection} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] database_insight_id Unique database insight identifier
    # @param [OCI::Opsi::Models::ChangeMacsManagedCloudDatabaseInsightConnectionDetails] change_macs_managed_cloud_database_insight_connection_details The information to be updated.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#change_macs_managed_cloud_database_insight_connection}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def change_macs_managed_cloud_database_insight_connection_and_wait_for_state(database_insight_id, change_macs_managed_cloud_database_insight_connection_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_macs_managed_cloud_database_insight_connection(database_insight_id, change_macs_managed_cloud_database_insight_connection_details, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
    ...
    # to enter the given state(s).
    #
    # @param [String] operations_insights_warehouse_id Unique Ops Insights Warehouse identifier
    ...
    # to enter the given state(s).
    #
    # @param [OCI::Opsi::Models::CreateHostInsightDetails] create_host_insight_details Details for the host for which a Host Insight resource will be created in Ops Insights.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    ...
    # to enter the given state(s).
    #
    # @param [OCI::Opsi::Models::CreateNewsReportDetails] create_news_report_details Details for the news report that will be created in Ops Insights.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    ...
    # to enter the given state(s).
    #
    # @param [OCI::Opsi::Models::CreateOperationsInsightsWarehouseDetails] create_operations_insights_warehouse_details Details using which an Ops Insights Warehouse resource will be created in Ops Insights.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    ...
    # to enter the given state(s).
    #
    # @param [OCI::Opsi::Models::EnableHostInsightDetails] enable_host_insight_details Details for the host to be enabled in Ops Insights.
    # @param [String] host_insight_id Unique host insight identifier
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    ...
    # Calls {OCI::Opsi::OperationsInsightsClient#test_macs_managed_cloud_database_insight_connection} and then waits for the {OCI::Opsi::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::Opsi::Models::TestMacsManagedCloudDatabaseInsightConnectionDetails] test_macs_managed_cloud_database_insight_connection_details The database connection information for the Cloud MACS-managed database.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::Opsi::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::Opsi::OperationsInsightsClient#test_macs_managed_cloud_database_insight_connection}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::Opsi::Models::WorkRequest}
    def test_macs_managed_cloud_database_insight_connection_and_wait_for_state(test_macs_managed_cloud_database_insight_connection_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.test_macs_managed_cloud_database_insight_connection(test_macs_managed_cloud_database_insight_connection_details, base_operation_opts)
      use_util = OCI::Opsi::Util.respond_to?(:wait_on_work_request)
