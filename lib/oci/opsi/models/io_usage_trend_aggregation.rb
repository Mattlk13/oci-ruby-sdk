...
module OCI
  ...
  class Opsi::Models::IoUsageTrendAggregation
    # **[Required]** Mount point is specialized NTFS filesystem object.
    # @return [String]
    attr_accessor :mount_point

    # **[Required]** List of usage data samples for a IO interface.
    # @return [Array<OCI::Opsi::Models::IoUsageTrend>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'mount_point': :'String',
        'usage_data': :'Array<OCI::Opsi::Models::IoUsageTrend>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::IoUsageTrend>] :usage_data The value to assign to the {#usage_data} property
