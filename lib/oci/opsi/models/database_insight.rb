...
module OCI
  ...
  class Opsi::Models::DatabaseInsight
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::MacsManagedCloudDatabaseInsight' if type == 'MACS_MANAGED_CLOUD_DATABASE'
      return 'OCI::Opsi::Models::ExternalMysqlDatabaseInsight' if type == 'EXTERNAL_MYSQL_DATABASE_SYSTEM'
      return 'OCI::Opsi::Models::AutonomousDatabaseInsight' if type == 'AUTONOMOUS_DATABASE'
      return 'OCI::Opsi::Models::MdsMySqlDatabaseInsight' if type == 'MDS_MYSQL_DATABASE_SYSTEM'
