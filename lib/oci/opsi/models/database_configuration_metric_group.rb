...
module OCI
  ...
  class Opsi::Models::DatabaseConfigurationMetricGroup
    METRIC_NAME_ENUM = [
      ...
      METRIC_NAME_DB_CONNECTION_STATUS = 'DB_CONNECTION_STATUS'.freeze,
      METRIC_NAME_HOST_RESOURCE_ALLOCATION = 'HOST_RESOURCE_ALLOCATION'.freeze,
      METRIC_NAME_ASM_ENTITY = 'ASM_ENTITY'.freeze,
      METRIC_NAME_EXADATA_CELL_CONFIG = 'EXADATA_CELL_CONFIG'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::DBConnectionStatus' if type == 'DB_CONNECTION_STATUS'
      return 'OCI::Opsi::Models::HostAllocation' if type == 'HOST_RESOURCE_ALLOCATION'
      return 'OCI::Opsi::Models::ExadataCellConfig' if type == 'EXADATA_CELL_CONFIG'
      return 'OCI::Opsi::Models::DBExternalProperties' if type == 'DB_EXTERNAL_PROPERTIES'
      return 'OCI::Opsi::Models::ExadataAsmEntity' if type == 'ASM_ENTITY'
