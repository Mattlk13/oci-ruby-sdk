...
module OCI
  ...
  class Opsi::Models::OperationsInsightsWarehouse
    ...
    # **[Required]** User-friedly name of Ops Insights Warehouse that does not have to be unique.
    # @return [String]
    attr_accessor :display_name

    # **[Required]** Number of CPUs allocated to OPSI Warehouse ADW.
    #
    # @return [Float]
    ...
    def initialize(attributes = {})
      ...
      self.compute_model = "OCPU" if compute_model.nil? && !attributes.key?(:'computeModel') # rubocop:disable Style/StringLiterals
      ...
      self.compute_model = "OCPU" if compute_model.nil? && !attributes.key?(:'computeModel') && !attributes.key?(:'compute_model') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [id, compartment_id, display_name, cpu_allocated, compute_model, cpu_used, storage_allocated_in_gbs, storage_used_in_gbs, dynamic_group_id, operations_insights_tenancy_id, time_last_wallet_rotated, freeform_tags, defined_tags, system_tags, time_created, time_updated, lifecycle_state, lifecycle_details].hash
    end
