...
module OCI
  ...
  class Opsi::Models::CreateMacsManagedCloudExadataClusterDetails
    VM_CLUSTER_TYPE_ENUM = [
      VM_CLUSTER_TYPE_VM_CLUSTER = 'vmCluster'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'vmClusterType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::Opsi::Models::CreateMacsManagedCloudExadataVmclusterDetails' if type == 'vmCluster'
    ...
    def hash
      [vm_cluster_type, vmcluster_id, compartment_id].hash
    end
