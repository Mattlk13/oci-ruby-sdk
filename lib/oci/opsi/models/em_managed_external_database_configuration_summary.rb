...
module OCI
  ...
  class Opsi::Models::EmManagedExternalDatabaseConfigurationSummary < Opsi::Models::DatabaseConfigurationSummary
    ...
    def hash
      [database_insight_id, entity_source, compartment_id, database_name, database_display_name, database_type, database_version, cdb_name, defined_tags, freeform_tags, processor_count, enterprise_manager_identifier, enterprise_manager_bridge_id, instances, exadata_details, enterprise_manager_entity_identifier, enterprise_manager_console_url, enterprise_manager_oms_ver, enterprise_manager_entity_type].hash
    end
