...
module OCI
  ...
  class Opsi::Models::DatabaseConfigurationSummary
    ...
    # **[Required]** Ops Insights internal representation of the database type.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::ExternalMysqlDatabaseConfigurationSummary' if type == 'EXTERNAL_MYSQL_DATABASE_SYSTEM'
      ...
      return 'OCI::Opsi::Models::MacsManagedCloudDatabaseConfigurationSummary' if type == 'MACS_MANAGED_CLOUD_DATABASE'
      return 'OCI::Opsi::Models::MdsMysqlDatabaseConfigurationSummary' if type == 'MDS_MYSQL_DATABASE_SYSTEM'
