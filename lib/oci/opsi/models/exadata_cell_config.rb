...
module OCI
  ...
  #
  class Opsi::Models::ExadataCellConfig < Opsi::Models::DatabaseConfigurationMetricGroup
    # Cell name
    # @return [String]
    ...
    # Cell configs
    # @return [String]
    attr_accessor :cell_configs

    # Cell disk counts
    # @return [String]
    attr_accessor :disk_counts
    ...
    # @option attributes [String] :cell_name The value to assign to the {#cell_name} property
    # @option attributes [String] :cell_hash The value to assign to the {#cell_hash} property
    # @option attributes [String] :cell_properties The value to assign to the {#cell_properties} property
    # @option attributes [String] :cell_configs The value to assign to the {#cell_configs} property
    # @option attributes [String] :disk_counts The value to assign to the {#disk_counts} property
