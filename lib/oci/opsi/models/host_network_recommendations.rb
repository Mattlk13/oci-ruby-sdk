...
module OCI
  ...
  #
  class Opsi::Models::HostNetworkRecommendations < Opsi::Models::HostInsightHostRecommendations
    ...
    def initialize(attributes = {})
      ...
      attributes['metricRecommendationName'] = 'HOST_NETWORK_RECOMMENDATIONS'
