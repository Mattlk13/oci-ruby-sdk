...
module OCI
  ...
  class Opsi::Models::IoUsageTrend
    ...
    # **[Required]** MBs Read.
    # @return [Float]
    attr_accessor :disk_bytes_read_in_mbs

    # **[Required]** MBs Written.
    # @return [Float]
    attr_accessor :disk_bytes_written_in_mbs
    ...
    # @option attributes [Float] :disk_bytes_read_in_mbs The value to assign to the {#disk_bytes_read_in_mbs} property
    # @option attributes [Float] :disk_bytes_written_in_mbs The value to assign to the {#disk_bytes_written_in_mbs} property
