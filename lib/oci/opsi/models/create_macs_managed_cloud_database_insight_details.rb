...
module OCI
  ...
  class Opsi::Models::CreateMacsManagedCloudDatabaseInsightDetails < Opsi::Models::CreateDatabaseInsightDetails
    DEPLOYMENT_TYPE_ENUM = [
      DEPLOYMENT_TYPE_VIRTUAL_MACHINE = 'VIRTUAL_MACHINE'.freeze,
      DEPLOYMENT_TYPE_BARE_METAL = 'BARE_METAL'.freeze,
      DEPLOYMENT_TYPE_EXACC = 'EXACC'.freeze,
    ...
    # **[Required]** Database Deployment Type (EXACS will be supported in the future)
    # @return [String]
    ...
    def hash
      [entity_source, compartment_id, freeform_tags, defined_tags, database_id, management_agent_id, connection_details, connection_credential_details, database_resource_type, deployment_type, system_tags].hash
    end
