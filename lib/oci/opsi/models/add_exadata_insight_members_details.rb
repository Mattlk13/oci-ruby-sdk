...
module OCI
  ...
  class Opsi::Models::AddExadataInsightMembersDetails
    ENTITY_SOURCE_ENUM = [
      ...
      ENTITY_SOURCE_MACS_MANAGED_CLOUD_EXADATA = 'MACS_MANAGED_CLOUD_EXADATA'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::AddMacsManagedCloudExadataInsightMembersDetails' if type == 'MACS_MANAGED_CLOUD_EXADATA'
