...
module OCI
  ...
  #
  class Opsi::Models::HostAllocation < Opsi::Models::DatabaseConfigurationMetricGroup
    ...
    # @option attributes [Integer] :resource_value The value to assign to the {#resource_value} property
    def initialize(attributes = {})
      ...
      self.resource_value = attributes[:'resourceValue'] if attributes[:'resourceValue']

      raise 'You cannot provide both :resourceValue and :resource_value' if attributes.key?(:'resourceValue') && attributes.key?(:'resource_value')

      self.resource_value = attributes[:'resource_value'] if attributes[:'resource_value']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        resource_value == other.resource_value
    end
    ...
    def hash
      [metric_name, time_collected, resource_name, resource_value].hash
    end
