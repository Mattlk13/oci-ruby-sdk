...
module OCI
  ...
  class Opsi::Models::SummarizeHostInsightIoUsageTrendAggregationCollection
    ...
    # **[Required]** Collection of Usage Data with time stamps for all IO interfaces.
    # @return [Array<OCI::Opsi::Models::IoUsageTrendAggregation>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        ...
        'items': :'Array<OCI::Opsi::Models::IoUsageTrendAggregation>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Opsi::Models::IoUsageTrendAggregation>] :items The value to assign to the {#items} property
    ...
    def hash
      [time_interval_start, time_interval_end, item_duration_in_ms, items].hash
    end
