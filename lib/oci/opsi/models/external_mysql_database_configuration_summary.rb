...
module OCI
  ...
  class Opsi::Models::ExternalMysqlDatabaseConfigurationSummary < Opsi::Models::DatabaseConfigurationSummary
    ...
    # **[Required]** The DBM owned database connector [OCID](https://docs.cloud.oracle.com/iaas/database-management/doc/view-connector-details.html) mapping to the database credentials and connection details.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['entitySource'] = 'EXTERNAL_MYSQL_DATABASE_SYSTEM'
    ...
    def hash
      [database_insight_id, entity_source, compartment_id, database_name, database_display_name, database_type, database_version, cdb_name, defined_tags, freeform_tags, processor_count, database_id, agent_id, database_connector_id].hash
    end
