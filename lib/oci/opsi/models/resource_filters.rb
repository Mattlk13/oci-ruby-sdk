...
module OCI
  ...
  class Opsi::Models::ResourceFilters
    ...
    # @option attributes [Array<String>] :resource_status The value to assign to the {#resource_status} property
    ...
    def resource_status=(resource_status)
      ...
      if resource_status.nil?
        ...
        resource_status.each do |item|
          raise "Invalid value for 'resource_status': this must be one of the values in RESOURCE_STATUS_ENUM." unless RESOURCE_STATUS_ENUM.include?(item)
        end
    ...
    def hash
      [defined_tag_equals, freeform_tag_equals, defined_tag_exists, freeform_tag_exists, compartment_id_in_subtree, resource_status].hash
    end
