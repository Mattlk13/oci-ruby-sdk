...
module OCI
  ...
  class Opsi::Models::HostPerformanceMetricGroup
    METRIC_NAME_ENUM = [
      ...
      METRIC_NAME_HOST_GPU_USAGE = 'HOST_GPU_USAGE'.freeze,
      METRIC_NAME_HOST_GPU_PROCESSES = 'HOST_GPU_PROCESSES'.freeze,
      METRIC_NAME_HOST_IO_USAGE = 'HOST_IO_USAGE'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Opsi::Models::HostGpuUsage' if type == 'HOST_GPU_USAGE'
      return 'OCI::Opsi::Models::HostGpuProcesses' if type == 'HOST_GPU_PROCESSES'
      return 'OCI::Opsi::Models::HostFilesystemUsage' if type == 'HOST_FILESYSTEM_USAGE'
      return 'OCI::Opsi::Models::HostIoUsage' if type == 'HOST_IO_USAGE'
