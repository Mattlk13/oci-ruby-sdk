...
module OCI
  ...
  class Opsi::Models::MacsManagedCloudDatabaseInsight < Opsi::Models::DatabaseInsight
    ...
    def initialize(attributes = {})
      ...
      attributes['entitySource'] = 'MACS_MANAGED_CLOUD_DATABASE'
    ...
    def hash
      [entity_source, id, compartment_id, status, database_type, database_version, processor_count, freeform_tags, defined_tags, system_tags, time_created, time_updated, lifecycle_state, lifecycle_details, database_connection_status_details, management_agent_id, connection_details, connection_credential_details, database_id, database_name, database_display_name, database_resource_type, db_additional_details, parent_id, root_id].hash
    end
