...
module OCI
  ...
  class Opsi::Models::SummarizeExadataInsightResourceUtilizationInsightAggregation
    ...
    def hash
      [time_interval_start, time_interval_end, high_utilization_threshold, low_utilization_threshold, exadata_resource_metric, exadata_resource_type, utilization].hash
    end
