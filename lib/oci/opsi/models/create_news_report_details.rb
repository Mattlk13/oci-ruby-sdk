...
module OCI
  ...
  class Opsi::Models::CreateNewsReportDetails
    ...
    def match_rule=(match_rule)
      raise "Invalid value for 'match_rule': this must be one of the values in MATCH_RULE_ENUM." if match_rule && !MATCH_RULE_ENUM.include?(match_rule)
    ...
    def hash
      [name, news_frequency, description, ons_topic_id, compartment_id, freeform_tags, defined_tags, content_types, locale, status, day_of_week, are_child_compartments_included, tag_filters, match_rule].hash
    end
