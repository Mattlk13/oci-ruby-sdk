...
module OCI
  ...
  class Opsi::Models::EnableMacsManagedCloudDatabaseInsightDetails < Opsi::Models::EnableDatabaseInsightDetails
    # **[Required]** The compartment [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the External Database.
    # @return [String]
    ...
    def hash
      [entity_source, compartment_id, management_agent_id, connection_details, connection_credential_details, freeform_tags, defined_tags, system_tags].hash
    end
