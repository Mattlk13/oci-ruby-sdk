...
module OCI
  ...
  #
  class Opsi::Models::HostStorageRecommendations < Opsi::Models::HostInsightHostRecommendations
    ...
    def initialize(attributes = {})
      ...
      attributes['metricRecommendationName'] = 'HOST_STORAGE_RECOMMENDATIONS'
    ...
    def hash
      [metric_recommendation_name, unused_instance, is_abandoned_instance].hash
    end
