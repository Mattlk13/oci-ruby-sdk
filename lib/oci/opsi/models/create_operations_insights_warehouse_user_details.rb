...
module OCI
  ...
  class Opsi::Models::CreateOperationsInsightsWarehouseUserDetails
    ...
    # **[Required]** Username for schema which would have access to AWR Data,  Enterprise Manager Data and Ops Insights OPSI Hub.
    # @return [String]
    attr_accessor :name

    # **[Required]** User provided connection password for the AWR Data,  Enterprise Manager Data and Ops Insights OPSI Hub.
    # @return [String]
