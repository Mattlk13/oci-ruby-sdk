...
module OCI
  ...
  class Opsi::Models::ExadataDatabaseMachineConfigurationSummary < Opsi::Models::ExadataConfigurationSummary
    ...
    def hash
      [exadata_insight_id, entity_source, compartment_id, exadata_name, exadata_display_name, exadata_type, exadata_rack_type, defined_tags, freeform_tags, vmcluster_details, enterprise_manager_identifier, enterprise_manager_bridge_id, enterprise_manager_entity_identifier, enterprise_manager_console_url, enterprise_manager_oms_ver, enterprise_manager_entity_type].hash
    end
