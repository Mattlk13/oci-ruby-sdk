...
module OCI
  ...
  class Opsi::Models::CreateMdsMySqlDatabaseInsightDetails < Opsi::Models::CreateDatabaseInsightDetails
    ...
    def hash
      [entity_source, compartment_id, freeform_tags, defined_tags, database_id].hash
    end
