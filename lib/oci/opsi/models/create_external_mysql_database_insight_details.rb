...
module OCI
  ...
  class Opsi::Models::CreateExternalMysqlDatabaseInsightDetails < Opsi::Models::CreateDatabaseInsightDetails
    ...
    def hash
      [entity_source, compartment_id, freeform_tags, defined_tags, database_id, database_connector_id].hash
    end
