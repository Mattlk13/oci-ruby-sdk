...
module OCI
  ...
  class Opsi::Models::AwrQueryResult
    AWR_RESULT_TYPE_ENUM = [
      ...
      AWR_RESULT_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    def awr_result_type=(awr_result_type)
      ...
      if awr_result_type && !AWR_RESULT_TYPE_ENUM.include?(awr_result_type)
        OCI.logger.debug("Unknown value for 'awr_result_type' [" + awr_result_type + "]. Mapping to 'AWR_RESULT_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @awr_result_type = AWR_RESULT_TYPE_UNKNOWN_ENUM_VALUE
      else
