...
module OCI
  ...
  class Opsi::Models::ResourceStatistics
    ...
    def hash
      [usage, capacity, base_capacity, is_auto_scaling_enabled, utilization_percent, usage_change_percent, instance_metrics, total_host_capacity, is_heat_wave_cluster_attached, is_highly_available].hash
    end
