...
module OCI
  ...
  #
  class Opsi::Models::HostIoUsage < Opsi::Models::HostPerformanceMetricGroup
    # Mount point
    # @return [String]
    ...
    # Bytes Read
    # @return [Float]
    attr_accessor :disk_bytes_read

    # Bytes Written
    # @return [Float]
    attr_accessor :disk_bytes_written

    # Read transactions per second
    # @return [Float]
    attr_accessor :disk_iops_read

    # Write transactions per second
    # @return [Float]
    attr_accessor :disk_iops_written
    ...
    # @option attributes [Float] :disk_bytes_read The value to assign to the {#disk_bytes_read} property
    # @option attributes [Float] :disk_bytes_written The value to assign to the {#disk_bytes_written} property
    # @option attributes [Float] :disk_iops_read The value to assign to the {#disk_iops_read} property
    # @option attributes [Float] :disk_iops_written The value to assign to the {#disk_iops_written} property
    # @option attributes [Float] :disk_iops The value to assign to the {#disk_iops} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['metricName'] = 'HOST_IO_USAGE'
    ...
    def hash
      [metric_name, time_collected, mount_point, disk_bytes_read, disk_bytes_written, disk_iops_read, disk_iops_written, disk_iops].hash
    end
