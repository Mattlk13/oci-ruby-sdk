...
module OCI
  ...
  class Opsi::Models::ExternalMysqlDatabaseInsight < Opsi::Models::DatabaseInsight
    ...
    def hash
      [entity_source, id, compartment_id, status, database_type, database_version, processor_count, freeform_tags, defined_tags, system_tags, time_created, time_updated, lifecycle_state, lifecycle_details, database_connection_status_details, database_id, database_name, database_display_name].hash
    end
