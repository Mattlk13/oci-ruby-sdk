...
module OCI
  module Opsi::Models
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_CHANGE_MACS_MANAGED_CLOUD_DATABASE_INSIGHT_CONNECTION_DETAILS = 'CHANGE_MACS_MANAGED_CLOUD_DATABASE_INSIGHT_CONNECTION_DETAILS'.freeze,
      OPERATION_TYPE_TEST_MACS_MANAGED_CLOUD_DATABASE_INSIGHT_CONNECTION_DETAILS = 'TEST_MACS_MANAGED_CLOUD_DATABASE_INSIGHT_CONNECTION_DETAILS'.freeze,
      OPERATION_TYPE_CHANGE_EXTERNAL_MYSQL_DATABASE_INSIGHT_CONNECTION_DETAILS = 'CHANGE_EXTERNAL_MYSQL_DATABASE_INSIGHT_CONNECTION_DETAILS'.freeze
    ].freeze
  end
end
