...
module OCI
  ...
  class Queue::Models::GetMessage
    ...
    # @option attributes [DateTime] :created_at The value to assign to the {#created_at} property
    ...
    def hash
      [id, content, receipt, delivery_count, visible_after, expire_after, created_at, metadata].hash
    end
