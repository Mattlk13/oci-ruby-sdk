...
module OCI
  ...
  class Mysql::Models::CreateDbSystemDetails
    ...
    # @return [OCI::Mysql::Models::CreateRestDetails]
    attr_accessor :rest
    ...
    # @return [OCI::Mysql::Models::DataStorageDetails]
    ...
    #
    # @return [Array<OCI::Mysql::Models::CustomerContact>]
    attr_accessor :customer_contacts

    # @return [OCI::Mysql::Models::CreateReadEndpointDetails]
    ...
    # @option attributes [OCI::Mysql::Models::CreateRestDetails] :rest The value to assign to the {#rest} property
    ...
    # @option attributes [OCI::Mysql::Models::DataStorageDetails] :data_storage The value to assign to the {#data_storage} property
    ...
    # @option attributes [String] :access_mode The value to assign to the {#access_mode} property
    # @option attributes [Array<OCI::Mysql::Models::CustomerContact>] :customer_contacts The value to assign to the {#customer_contacts} property
    # @option attributes [OCI::Mysql::Models::CreateReadEndpointDetails] :read_endpoint The value to assign to the {#read_endpoint} property
    def initialize(attributes = {})
      ...
      self.database_mode = "READ_WRITE" if database_mode.nil? && !attributes.key?(:'databaseMode') # rubocop:disable Style/StringLiterals
      ...
      self.database_mode = "READ_WRITE" if database_mode.nil? && !attributes.key?(:'databaseMode') && !attributes.key?(:'database_mode') # rubocop:disable Style/StringLiterals

      self.access_mode = attributes[:'accessMode'] if attributes[:'accessMode']
      self.access_mode = "UNRESTRICTED" if access_mode.nil? && !attributes.key?(:'accessMode') # rubocop:disable Style/StringLiterals
      ...
      self.access_mode = "UNRESTRICTED" if access_mode.nil? && !attributes.key?(:'accessMode') && !attributes.key?(:'access_mode') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [display_name, description, compartment_id, rest, is_highly_available, availability_domain, fault_domain, configuration_id, shape_name, mysql_version, subnet_id, nsg_ids, admin_username, admin_password, data_storage_size_in_gbs, data_storage, hostname_label, ip_address, port, port_x, backup_policy, source, maintenance, freeform_tags, defined_tags, deletion_policy, crash_recovery, database_management, secure_connections, database_mode, access_mode, customer_contacts, read_endpoint].hash
    end
