...
module OCI
  ...
  class Mysql::Models::CreateDeletionPolicyDetails
    ...
    def initialize(attributes = {})
      ...
      self.automatic_backup_retention = "RETAIN" if automatic_backup_retention.nil? && !attributes.key?(:'automaticBackupRetention') # rubocop:disable Style/StringLiterals
      ...
      self.automatic_backup_retention = "RETAIN" if automatic_backup_retention.nil? && !attributes.key?(:'automaticBackupRetention') && !attributes.key?(:'automatic_backup_retention') # rubocop:disable Style/StringLiterals
