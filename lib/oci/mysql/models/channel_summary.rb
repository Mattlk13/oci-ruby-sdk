...
module OCI
  ...
  class Mysql::Models::ChannelSummary
    ...
    def hash
      [id, compartment_id, is_enabled, source, target, lifecycle_state, lifecycle_details, display_name, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
