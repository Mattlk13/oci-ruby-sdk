...
module OCI
  ...
  class Mysql::Models::ReplicaSummary
    ...
    def hash
      [id, db_system_id, compartment_id, display_name, description, lifecycle_state, lifecycle_details, time_created, time_updated, mysql_version, availability_domain, fault_domain, nsg_ids, ip_address, port, port_x, freeform_tags, defined_tags, is_delete_protected, shape_name, configuration_id, replica_overrides].hash
    end
