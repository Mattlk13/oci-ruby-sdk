...
module OCI
  ...
  class Mysql::Models::Channel
    ...
    def hash
      [id, compartment_id, display_name, is_enabled, source, target, description, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
