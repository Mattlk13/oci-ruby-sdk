...
module OCI
  ...
  class Mysql::Models::Configuration
    ...
    def hash
      [id, compartment_id, description, display_name, shape_name, type, time_created, time_updated, lifecycle_state, init_variables, variables, parent_configuration_id, freeform_tags, defined_tags, system_tags].hash
    end
