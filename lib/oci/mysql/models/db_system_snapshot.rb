...
module OCI
  ...
  class Mysql::Models::DbSystemSnapshot
    ...
    def hash
      [id, display_name, description, compartment_id, subnet_id, nsg_ids, availability_domain, fault_domain, shape_name, mysql_version, admin_username, backup_policy, configuration_id, data_storage_size_in_gbs, data_storage, hostname_label, ip_address, port, port_x, rest, is_highly_available, endpoints, maintenance, deletion_policy, freeform_tags, defined_tags, crash_recovery, database_management, secure_connections, region, read_endpoint].hash
    end
