...
module OCI
  ...
  class Mysql::Models::DbSystemSummary
    ...
    # **[Required]** The database mode indicating the types of statements that are allowed to run in the DB system.
    ...
    def hash
      [id, display_name, description, compartment_id, rest, is_highly_available, current_placement, is_heat_wave_cluster_attached, heat_wave_cluster, availability_domain, fault_domain, endpoints, lifecycle_state, mysql_version, time_created, time_updated, deletion_policy, freeform_tags, defined_tags, system_tags, backup_policy, shape_name, crash_recovery, database_management, database_mode, access_mode, read_endpoint].hash
    end
