...
module OCI
  ...
  class Mysql::Models::UpdateDbSystemDetails
    ...
    # @return [OCI::Mysql::Models::UpdateRestDetails]
    attr_accessor :rest
    ...
    # @return [OCI::Mysql::Models::UpdateReadEndpointDetails]
    ...
    # @option attributes [OCI::Mysql::Models::UpdateRestDetails] :rest The value to assign to the {#rest} property
    ...
    # @option attributes [OCI::Mysql::Models::UpdateReadEndpointDetails] :read_endpoint The value to assign to the {#read_endpoint} property
    ...
    def hash
      [display_name, description, subnet_id, nsg_ids, database_mode, access_mode, rest, is_highly_available, availability_domain, fault_domain, shape_name, mysql_version, configuration_id, admin_username, admin_password, data_storage_size_in_gbs, data_storage, hostname_label, ip_address, port, port_x, backup_policy, maintenance, freeform_tags, defined_tags, deletion_policy, crash_recovery, database_management, secure_connections, customer_contacts, read_endpoint].hash
    end
