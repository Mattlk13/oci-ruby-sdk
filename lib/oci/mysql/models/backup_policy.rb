...
module OCI
  ...
  class Mysql::Models::BackupPolicy
    ...
    #
    # @return [Array<OCI::Mysql::Models::CopyPolicy>]
    attr_accessor :copy_policies
    ...
    # @option attributes [Array<OCI::Mysql::Models::CopyPolicy>] :copy_policies The value to assign to the {#copy_policies} property
