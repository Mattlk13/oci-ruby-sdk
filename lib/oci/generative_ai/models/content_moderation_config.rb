...
module OCI
  ...
  class GenerativeAi::Models::ContentModerationConfig
    MODE_ENUM = [
      MODE_INFORM = 'INFORM'.freeze,
      MODE_BLOCK = 'BLOCK'.freeze,
    ...
    def initialize(attributes = {})
      ...
      self.mode = "INFORM" if mode.nil? && !attributes.key?(:'mode') # rubocop:disable Style/StringLiterals
