...
module OCI
  ...
  class GenerativeAi::Models::DedicatedAiCluster
    ...
    UNIT_SHAPE_ENUM = [
      ...
      UNIT_SHAPE_SMALL_COHERE_V2 = 'SMALL_COHERE_V2'.freeze,
      UNIT_SHAPE_SMALL_COHERE_4 = 'SMALL_COHERE_4'.freeze,
      UNIT_SHAPE_EMBED_COHERE = 'EMBED_COHERE'.freeze,
      UNIT_SHAPE_LLAMA2_70 = 'LLAMA2_70'.freeze,
      UNIT_SHAPE_LARGE_GENERIC = 'LARGE_GENERIC'.freeze,
      UNIT_SHAPE_LARGE_COHERE_V2_2 = 'LARGE_COHERE_V2_2'.freeze,
      UNIT_SHAPE_LARGE_GENERIC_4 = 'LARGE_GENERIC_4'.freeze,
      UNIT_SHAPE_SMALL_GENERIC_V2 = 'SMALL_GENERIC_V2'.freeze,
      UNIT_SHAPE_LARGE_GENERIC_2 = 'LARGE_GENERIC_2'.freeze,
      UNIT_SHAPE_LARGE_GENERIC_V2 = 'LARGE_GENERIC_V2'.freeze,
      UNIT_SHAPE_LARGE_COHERE_V3 = 'LARGE_COHERE_V3'.freeze,
      UNIT_SHAPE_RERANK_COHERE = 'RERANK_COHERE'.freeze,
