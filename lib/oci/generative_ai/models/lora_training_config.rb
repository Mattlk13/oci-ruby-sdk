...
module OCI
  ...
  class GenerativeAi::Models::LoraTrainingConfig < GenerativeAi::Models::TrainingConfig
    ...
    # @option attributes [Integer] :lora_r The value to assign to the {#lora_r} property
    # @option attributes [Integer] :lora_alpha The value to assign to the {#lora_alpha} property
    # @option attributes [Float] :lora_dropout The value to assign to the {#lora_dropout} property
