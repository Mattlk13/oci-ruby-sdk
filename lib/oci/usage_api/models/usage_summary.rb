...
module OCI
  ...
  class UsageApi::Models::UsageSummary
    ...
    # @option attributes [String] :attributed_cost The value to assign to the {#attributed_cost} property
    # @option attributes [String] :attributed_usage The value to assign to the {#attributed_usage} property
    ...
    def initialize(attributes = {})
      ...
      self.attributed_cost = attributes[:'attributedCost'] if attributes[:'attributedCost']

      raise 'You cannot provide both :attributedCost and :attributed_cost' if attributes.key?(:'attributedCost') && attributes.key?(:'attributed_cost')

      self.attributed_cost = attributes[:'attributed_cost'] if attributes[:'attributed_cost']

      self.attributed_usage = attributes[:'attributedUsage'] if attributes[:'attributedUsage']

      raise 'You cannot provide both :attributedUsage and :attributed_usage' if attributes.key?(:'attributedUsage') && attributes.key?(:'attributed_usage')

      self.attributed_usage = attributes[:'attributed_usage'] if attributes[:'attributed_usage']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        attributed_cost == other.attributed_cost &&
        attributed_usage == other.attributed_usage &&
