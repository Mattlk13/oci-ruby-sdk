...
module OCI
  ...
  class UsageApi::Models::ScheduledRun
    ...
    # **[Required]** The OCID representing a unique shedule run.
    # @return [String]
    attr_accessor :id
    ...
    # **[Required]** The time the schedule started executing.
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** The time the schedule finished executing.
    # @return [DateTime]
    attr_accessor :time_finished

    # **[Required]** Specifies whether or not the schedule job was successfully run.
    # @return [String]
    attr_reader :lifecycle_state

    # **[Required]** Additional details about the scheduled run.
    # @return [String]
