...
module OCI
  ...
  class FleetAppsManagement::Models::CompliancePatchDetail
    SEVERITY_ENUM = [
    ...
    # Patch Description.
    # @return [String]
    attr_accessor :patch_description
    ...
    # @return [OCI::FleetAppsManagement::Models::ComplianceDetailProduct]
    ...
    # @option attributes [String] :patch_description The value to assign to the {#patch_description} property
    ...
    # @option attributes [OCI::FleetAppsManagement::Models::ComplianceDetailProduct] :product The value to assign to the {#product} property
    def initialize(attributes = {})
      ...
      self.patch_description = attributes[:'patchDescription'] if attributes[:'patchDescription']

      raise 'You cannot provide both :patchDescription and :patch_description' if attributes.key?(:'patchDescription') && attributes.key?(:'patch_description')

      self.patch_description = attributes[:'patch_description'] if attributes[:'patch_description']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        patch_description == other.patch_description &&
    ...
    def hash
      [patch_id, patch_name, patch_description, time_released, patch_type, severity, product].hash
    end
