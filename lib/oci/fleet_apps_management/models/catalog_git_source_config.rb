...
module OCI
  ...
  #
  class FleetAppsManagement::Models::CatalogGitSourceConfig < FleetAppsManagement::Models::CatalogSourcePayload
    # branch Name
    #
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['configSourceType'] = 'GIT_CATALOG_SOURCE'
    ...
    def hash
      [config_source_type, working_directory, branch_name, configuration_source_provider_id, repository_url].hash
    end
