...
module OCI
  ...
  #
  class FleetAppsManagement::Models::AssociatedSharedTaskDetails < FleetAppsManagement::Models::AssociatedTaskDetails
    # **[Required]** The ID of taskRecord.
    # @return [String]
