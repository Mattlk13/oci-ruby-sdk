...
require 'date'
require_relative 'catalog_result_payload'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Catalog GIT result config.
  #
  class FleetAppsManagement::Models::CatalogGitResultConfig < FleetAppsManagement::Models::CatalogResultPayload
    # branch Name
    #
    # @return [String]
    ...
    # @option attributes [String] :working_directory The value to assign to the {OCI::FleetAppsManagement::Models::CatalogResultPayload#working_directory #working_directory} proprety
    ...
    def initialize(attributes = {})
      ...
      attributes['configResultType'] = 'GIT_RESULT_CONFIG'
    ...
    def hash
      [config_result_type, working_directory, branch_name, configuration_source_provider_id, repository_url].hash
    end
