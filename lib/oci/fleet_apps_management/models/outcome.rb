...
module OCI
  # Execution Outcome.
  class FleetAppsManagement::Models::Outcome
    # **[Required]** A shortened version of Execution output.
    # @return [String]
    ...
    # @option attributes [String] :output The value to assign to the {#output} property
    # @option attributes [String] :error The value to assign to the {#error} property
    # @option attributes [String] :exit_code The value to assign to the {#exit_code} property
