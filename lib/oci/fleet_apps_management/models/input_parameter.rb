...
module OCI
  ...
  class FleetAppsManagement::Models::InputParameter
    # **[Required]** stepName for which the input parameters are provided
    # @return [String]
    attr_accessor :step_name

    # Arguments for the Task
    # @return [Array<OCI::FleetAppsManagement::Models::TaskArgument>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'step_name': :'String',
        'arguments': :'Array<OCI::FleetAppsManagement::Models::TaskArgument>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::FleetAppsManagement::Models::TaskArgument>] :arguments The value to assign to the {#arguments} property
