...
module OCI
  ...
  class FleetAppsManagement::Models::CreateRunbookVersionDetails
    ...
    def hash
      [runbook_id, tasks, groups, execution_workflow_details, rollback_workflow_details, freeform_tags, defined_tags].hash
    end
