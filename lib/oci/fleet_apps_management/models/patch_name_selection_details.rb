...
module OCI
  ...
  #
  class FleetAppsManagement::Models::PatchNameSelectionDetails < FleetAppsManagement::Models::PatchSelectionDetails
    # **[Required]** Patch Name.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['selectionType'] = 'PATCH_NAME'
    ...
    def hash
      [selection_type, patch_name].hash
    end
