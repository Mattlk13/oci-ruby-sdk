...
module OCI
  ...
  class FleetAppsManagement::Models::PatchSelectionDetails
    SELECTION_TYPE_ENUM = [
      SELECTION_TYPE_PATCH_LEVEL = 'PATCH_LEVEL'.freeze,
      SELECTION_TYPE_PATCH_NAME = 'PATCH_NAME'.freeze,
      SELECTION_TYPE_PATCH_RELEASE_DATE = 'PATCH_RELEASE_DATE'.freeze,
      SELECTION_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Selection type for the Patch.
    #
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'selectionType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::FleetAppsManagement::Models::PatchLevelSelectionDetails' if type == 'PATCH_LEVEL'
      return 'OCI::FleetAppsManagement::Models::PatchReleaseDateSelectionDetails' if type == 'PATCH_RELEASE_DATE'
      return 'OCI::FleetAppsManagement::Models::PatchNameSelectionDetails' if type == 'PATCH_NAME'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetAppsManagement::Models::PatchSelectionDetails'
    end
