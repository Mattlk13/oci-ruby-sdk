...
module OCI
  ...
  class FleetAppsManagement::Models::SchedulerDefinition
    ...
    # @return [DateTime]
    attr_accessor :time_of_next_run

    # @return [OCI::FleetAppsManagement::Models::Schedule]
    ...
    # @return [Array<OCI::FleetAppsManagement::Models::ActionGroup>]
    attr_accessor :action_groups

    # Runbooks.
    # @return [Array<OCI::FleetAppsManagement::Models::OperationRunbook>]
    attr_accessor :run_books
    ...
    # @option attributes [DateTime] :time_of_next_run The value to assign to the {#time_of_next_run} property
    # @option attributes [OCI::FleetAppsManagement::Models::Schedule] :schedule The value to assign to the {#schedule} property
    ...
    # @option attributes [Array<OCI::FleetAppsManagement::Models::ActionGroup>] :action_groups The value to assign to the {#action_groups} property
    # @option attributes [Array<OCI::FleetAppsManagement::Models::OperationRunbook>] :run_books The value to assign to the {#run_books} property
    ...
    def initialize(attributes = {})
      ...
      self.run_books = attributes[:'runBooks'] if attributes[:'runBooks']

      raise 'You cannot provide both :runBooks and :run_books' if attributes.key?(:'runBooks') && attributes.key?(:'run_books')

      self.run_books = attributes[:'run_books'] if attributes[:'run_books']
