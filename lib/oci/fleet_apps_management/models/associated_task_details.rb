...
module OCI
  ...
  class FleetAppsManagement::Models::AssociatedTaskDetails
    SCOPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'scope'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::FleetAppsManagement::Models::AssociatedLocalTaskDetails' if type == 'LOCAL'
      return 'OCI::FleetAppsManagement::Models::AssociatedSharedTaskDetails' if type == 'SHARED'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetAppsManagement::Models::AssociatedTaskDetails'
    end
