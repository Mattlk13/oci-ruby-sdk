...
module OCI
  # Rule condition
  class FleetAppsManagement::Models::Condition
    # **[Required]** Attribute Group. Provide a Tag namespace if the rule is based on a tag.
    # Provide resource type if the rule is based on a resource property.
    #
    # @return [String]
    attr_accessor :attr_group

    # **[Required]** Attribute Key.Provide Tag key if the rule is based on a tag.
    # Provide resource property name if the rule is based on a resource property.
    #
    # @return [String]
    attr_accessor :attr_key

    # **[Required]** Attribute Value.Provide Tag value if the rule is based on a tag.
    ...
    # @option attributes [String] :attr_group The value to assign to the {#attr_group} property
    # @option attributes [String] :attr_key The value to assign to the {#attr_key} property
    # @option attributes [String] :attr_value The value to assign to the {#attr_value} property
