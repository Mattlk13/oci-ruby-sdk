...
module OCI
  ...
  class FleetAppsManagement::Models::StepSummary
    STATUS_ENUM = [
    ...
    def hash
      [task_record_id, step_name, sequence, status, time_started, time_ended, is_rollback_task, description, system_tags].hash
    end
