...
module OCI
  ...
  class FleetAppsManagement::Models::CreateCatalogItemDetails
    ...
    def hash
      [compartment_id, config_source_type, description, version_description, short_description, time_released, display_name, catalog_source_payload, listing_id, listing_version, package_type, freeform_tags, defined_tags].hash
    end
