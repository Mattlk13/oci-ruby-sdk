...
module OCI
  ...
  #
  class FleetAppsManagement::Models::EnvironmentConfigCategoryDetails < FleetAppsManagement::Models::ConfigCategoryDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['configCategory'] = 'ENVIRONMENT'
