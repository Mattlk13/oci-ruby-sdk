...
module OCI
  ...
  class FleetAppsManagement::Models::ComplianceReportProduct
    # **[Required]** Product Name.
    # @return [String]
    attr_accessor :product_name

    # Managed Targets associated with the Product.
    # @return [Array<OCI::FleetAppsManagement::Models::ComplianceReportTarget>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'product_name': :'String',
        'targets': :'Array<OCI::FleetAppsManagement::Models::ComplianceReportTarget>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::FleetAppsManagement::Models::ComplianceReportTarget>] :targets The value to assign to the {#targets} property
