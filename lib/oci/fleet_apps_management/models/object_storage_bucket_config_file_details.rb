...
require 'date'
require_relative 'config_file_details'
...
module OCI
  ...
  #
  class FleetAppsManagement::Models::ObjectStorageBucketConfigFileDetails < FleetAppsManagement::Models::ConfigFileDetails
    # **[Required]** Namespace.
    # @return [String]
