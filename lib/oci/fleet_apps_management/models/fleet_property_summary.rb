...
module OCI
  ...
  class FleetAppsManagement::Models::FleetPropertySummary
    VALUE_TYPE_ENUM = [
    ...
    def hash
      [id, compartment_id, property_id, display_name, time_created, time_updated, value, value_type, lifecycle_state, system_tags].hash
    end
