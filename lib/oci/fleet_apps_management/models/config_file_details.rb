...
module OCI
  ...
  class FleetAppsManagement::Models::ConfigFileDetails
    SOURCE_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetAppsManagement::Models::ObjectStorageBucketConfigFileDetails' if type == 'OBJECT_STORAGE_BUCKET'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetAppsManagement::Models::ConfigFileDetails'
    end
