...
module OCI
  ...
  class FleetAppsManagement::Models::PatchSummary
    SEVERITY_ENUM = [
    ...
    def hash
      [id, name, description, type, patch_type, severity, time_released, artifact_details, product, compartment_id, lifecycle_state, lifecycle_details, time_created, time_updated, resource_region, freeform_tags, defined_tags, system_tags].hash
    end
