...
module OCI
  ...
  class FleetAppsManagement::Models::RunbookVersion
    ...
    def hash
      [id, runbook_id, compartment_id, tasks, groups, execution_workflow_details, rollback_workflow_details, name, lifecycle_state, lifecycle_details, time_created, time_updated, freeform_tags, defined_tags, system_tags].hash
    end
