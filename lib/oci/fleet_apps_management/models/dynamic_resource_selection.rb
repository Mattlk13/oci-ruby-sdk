...
require 'date'
require_relative 'resource_selection'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Dynamic Resource Selection Type
  class FleetAppsManagement::Models::DynamicResourceSelection < FleetAppsManagement::Models::ResourceSelection
    ...
    def initialize(attributes = {})
      ...
      attributes['resourceSelectionType'] = 'DYNAMIC'
    ...
    def hash
      [resource_selection_type, rule_selection_criteria].hash
    end
