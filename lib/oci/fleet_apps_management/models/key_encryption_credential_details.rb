...
module OCI
  ...
  class FleetAppsManagement::Models::KeyEncryptionCredentialDetails < FleetAppsManagement::Models::CredentialDetails
    ...
    # @option attributes [String] :key_version The value to assign to the {#key_version} property
    # @option attributes [String] :vault_id The value to assign to the {#vault_id} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['credentialType'] = 'KEY_ENCRYPTION'
      ...
      self.key_version = attributes[:'keyVersion'] if attributes[:'keyVersion']

      raise 'You cannot provide both :keyVersion and :key_version' if attributes.key?(:'keyVersion') && attributes.key?(:'key_version')

      self.key_version = attributes[:'key_version'] if attributes[:'key_version']
    ...
    def hash
      [credential_type, value, key_id, key_version, vault_id].hash
    end
