...
module OCI
  ...
  class FleetAppsManagement::Models::UpdateCatalogItemDetails
    ...
    def hash
      [description, version_description, short_description, display_name, freeform_tags, defined_tags].hash
    end
