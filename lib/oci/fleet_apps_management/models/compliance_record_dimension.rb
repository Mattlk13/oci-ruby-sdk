...
module OCI
  ...
  class FleetAppsManagement::Models::ComplianceRecordDimension
    ...
    # @option attributes [String] :compliance_level The value to assign to the {#compliance_level} property
    ...
    def compliance_level=(compliance_level)
      # rubocop:disable Style/ConditionalAssignment
      if compliance_level && !COMPLIANCE_LEVEL_ENUM.include?(compliance_level)
        OCI.logger.debug("Unknown value for 'compliance_level' [" + compliance_level + "]. Mapping to 'COMPLIANCE_LEVEL_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @compliance_level = COMPLIANCE_LEVEL_UNKNOWN_ENUM_VALUE
      else
