...
module OCI
  ...
  class FleetAppsManagement::Models::InstanceSummary
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance.
    # @return [String]
    attr_accessor :id

    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which instance is deployed.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** Instance lifecycle state
    # @return [String]
    attr_accessor :state
