...
module OCI
  ...
  class FleetAppsManagement::Models::CloneCatalogItemDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to clone the CatalogItem to
    #
    # @return [String]
    ...
    def hash
      [compartment_id, version_description].hash
    end
