...
module OCI
  ...
  class FleetAppsManagement::Models::TaskRecordSummary
    ...
    # **[Required]** The current state of the task record.
    # @return [String]
    ...
    # @return [OCI::FleetAppsManagement::Models::Details]
    ...
    def self.swagger_types
      {
        ...
        'details': :'OCI::FleetAppsManagement::Models::Details',
    ...
    # @option attributes [OCI::FleetAppsManagement::Models::Details] :details The value to assign to the {#details} property
    ...
    def hash
      [id, display_name, description, type, lifecycle_state, time_created, time_updated, details, lifecycle_details, version, compartment_id, resource_region, freeform_tags, defined_tags, system_tags].hash
    end
