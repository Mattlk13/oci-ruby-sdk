...
module OCI
  ...
  class FleetAppsManagement::Models::CreateCompliancePolicyRuleDetails
    SEVERITY_ENUM = [
    ...
    def severity=(severity)
      ...
      if severity.nil?
        ...
        severity.each do |item|
          raise "Invalid value for 'severity': this must be one of the values in SEVERITY_ENUM." unless SEVERITY_ENUM.include?(item)
        end
        @severity = severity
      end
    ...
    def hash
      [display_name, compliance_policy_id, product_version, patch_type_id, severity, patch_selection, grace_period, freeform_tags, defined_tags].hash
    end
