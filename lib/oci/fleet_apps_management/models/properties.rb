...
module OCI
  ...
  class FleetAppsManagement::Models::Properties
    # **[Required]** The number of retries allowed.
    # @return [Integer]
    attr_accessor :num_retries

    # **[Required]** The timeout in seconds for the task.
    # @return [Integer]
    ...
    # @option attributes [Integer] :num_retries The value to assign to the {#num_retries} property
    ...
    def initialize(attributes = {})
      ...
      self.num_retries = attributes[:'numRetries'] if attributes[:'numRetries']

      raise 'You cannot provide both :numRetries and :num_retries' if attributes.key?(:'numRetries') && attributes.key?(:'num_retries')

      self.num_retries = attributes[:'num_retries'] if attributes[:'num_retries']
    ...
    def hash
      [num_retries, timeout_in_seconds].hash
    end
