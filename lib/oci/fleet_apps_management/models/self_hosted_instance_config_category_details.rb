...
module OCI
  ...
  #
  class FleetAppsManagement::Models::SelfHostedInstanceConfigCategoryDetails < FleetAppsManagement::Models::ConfigCategoryDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['configCategory'] = 'SELF_HOSTED_INSTANCE'
    ...
    def hash
      [config_category, instance_id, instance_name].hash
    end
