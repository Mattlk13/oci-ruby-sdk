...
module OCI
  ...
  class FleetAppsManagement::Models::ComplianceReportResource
    ...
    #
    # @return [Array<OCI::FleetAppsManagement::Models::ComplianceReportProduct>]
    ...
    # @option attributes [Array<OCI::FleetAppsManagement::Models::ComplianceReportProduct>] :products The value to assign to the {#products} property
