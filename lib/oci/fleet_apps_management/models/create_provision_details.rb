...
module OCI
  ...
  class FleetAppsManagement::Models::CreateProvisionDetails
    ...
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to create the FamProvision in.
    #
    # @return [String]
    ...
    def hash
      [display_name, provision_description, compartment_id, package_catalog_item_id, config_catalog_item_id, fleet_id, tf_variable_tenancy_id, tf_variable_region_id, tf_variable_current_user_id, tf_variable_compartment_id, freeform_tags, defined_tags].hash
    end
