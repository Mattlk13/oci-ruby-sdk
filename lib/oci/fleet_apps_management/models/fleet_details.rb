...
module OCI
  ...
  class FleetAppsManagement::Models::FleetDetails
    FLEET_TYPE_ENUM = [
    ...
    # @param [Object] fleet_type Object to be assigned
    def fleet_type=(fleet_type)
      # rubocop:disable Style/ConditionalAssignment
      if fleet_type && !FLEET_TYPE_ENUM.include?(fleet_type)
        OCI.logger.debug("Unknown value for 'fleet_type' [" + fleet_type + "]. Mapping to 'FLEET_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @fleet_type = FLEET_TYPE_UNKNOWN_ENUM_VALUE
      else
