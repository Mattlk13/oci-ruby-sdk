...
module OCI
  # Runbook
  class FleetAppsManagement::Models::OperationRunbook
    # **[Required]** The ID of the Runbook
    # @return [String]
    attr_accessor :runbook_id

    # **[Required]** The runbook version name
    # @return [String]
    attr_accessor :runbook_version_name

    # Input Parameters for the Task
    # @return [Array<OCI::FleetAppsManagement::Models::InputParameter>]
    ...
    def self.swagger_types
      {
        ...
        'input_parameters': :'Array<OCI::FleetAppsManagement::Models::InputParameter>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::FleetAppsManagement::Models::InputParameter>] :input_parameters The value to assign to the {#input_parameters} property
    def initialize(attributes = {})
      ...
      self.input_parameters = attributes[:'inputParameters'] if attributes[:'inputParameters']

      raise 'You cannot provide both :inputParameters and :input_parameters' if attributes.key?(:'inputParameters') && attributes.key?(:'input_parameters')

      self.input_parameters = attributes[:'input_parameters'] if attributes[:'input_parameters']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        input_parameters == other.input_parameters
    end
    ...
    def hash
      [runbook_id, runbook_version_name, input_parameters].hash
    end
