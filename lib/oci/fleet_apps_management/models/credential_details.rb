...
module OCI
  ...
  class FleetAppsManagement::Models::CredentialDetails
    CREDENTIAL_TYPE_ENUM = [
      CREDENTIAL_TYPE_PLAIN_TEXT = 'PLAIN_TEXT'.freeze,
      CREDENTIAL_TYPE_VAULT_SECRET = 'VAULT_SECRET'.freeze,
      CREDENTIAL_TYPE_KEY_ENCRYPTION = 'KEY_ENCRYPTION'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetAppsManagement::Models::PlainTextCredentialDetails' if type == 'PLAIN_TEXT'
      return 'OCI::FleetAppsManagement::Models::KeyEncryptionCredentialDetails' if type == 'KEY_ENCRYPTION'
      return 'OCI::FleetAppsManagement::Models::VaultSecretCredentialDetails' if type == 'VAULT_SECRET'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetAppsManagement::Models::CredentialDetails'
    end
