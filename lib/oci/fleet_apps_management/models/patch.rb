...
module OCI
  ...
  class FleetAppsManagement::Models::Patch
    TYPE_ENUM = [
    ...
    # **[Required]** A user-friendly name. Should be unique within the tenancy, and cannot be changed after creation.
    ...
    def hash
      [id, name, description, type, patch_type, severity, time_released, artifact_details, product, dependent_patches, lifecycle_state, time_created, time_updated, lifecycle_details, compartment_id, resource_region, freeform_tags, defined_tags, system_tags].hash
    end
