...
require 'date'
require_relative 'input_file_content_details'
...
module OCI
  ...
  #
  class FleetAppsManagement::Models::InputFileObjectStorageBucketContentDetails < FleetAppsManagement::Models::InputFileContentDetails
    # **[Required]** Namespace.
    # @return [String]
    ...
    # **[Required]** md5 checksum of the artifact.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['sourceType'] = 'OBJECT_STORAGE_BUCKET'
    ...
    def hash
      [source_type, namespace_name, bucket_name, object_name, checksum].hash
    end
