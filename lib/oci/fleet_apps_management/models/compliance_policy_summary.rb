...
module OCI
  ...
  class FleetAppsManagement::Models::CompliancePolicySummary
    ...
    # **[Required]** The date and time the CompliancePolicy was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    def hash
      [id, display_name, product_id, compartment_id, type, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
