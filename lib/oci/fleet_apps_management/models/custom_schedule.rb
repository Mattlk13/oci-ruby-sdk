...
module OCI
  ...
  class FleetAppsManagement::Models::CustomSchedule < FleetAppsManagement::Models::Schedule
    # Recurrence rule specification if recurring
    # @return [String]
    attr_accessor :recurrences

    # **[Required]** Duration of the schedule.
    # @return [String]
    ...
    def hash
      [type, execution_startdate, recurrences, duration].hash
    end
