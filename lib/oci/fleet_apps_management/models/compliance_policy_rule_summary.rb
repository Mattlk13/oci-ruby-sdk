...
module OCI
  ...
  class FleetAppsManagement::Models::CompliancePolicyRuleSummary
    SEVERITY_ENUM = [
    ...
    # @return [OCI::FleetAppsManagement::Models::ProductVersionDetails]
    ...
    # **[Required]** The date and time the CompliancePolicyRule was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
    #
    ...
    # @option attributes [OCI::FleetAppsManagement::Models::ProductVersionDetails] :product_version The value to assign to the {#product_version} property
    # @option attributes [Array<String>] :patch_type_id The value to assign to the {#patch_type_id} property
    # @option attributes [Array<String>] :severity The value to assign to the {#severity} property
    ...
    def severity=(severity)
      ...
      if severity.nil?
        ...
        @severity =
          severity.collect do |item|
            if SEVERITY_ENUM.include?(item)
              item
            else
              OCI.logger.debug("Unknown value for 'severity' [#{item}]. Mapping to 'SEVERITY_UNKNOWN_ENUM_VALUE'") if OCI.logger
              SEVERITY_UNKNOWN_ENUM_VALUE
            end
          end
      end
