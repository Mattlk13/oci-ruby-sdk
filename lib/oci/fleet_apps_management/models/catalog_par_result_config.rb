...
module OCI
  ...
  #
  class FleetAppsManagement::Models::CatalogParResultConfig < FleetAppsManagement::Models::CatalogResultPayload
    # package url
    #
    # @return [String]
    ...
    # @option attributes [String] :package_url The value to assign to the {#package_url} property
