...
require 'date'
require_relative 'workflow_component'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Workflow Group Component Details.
  class FleetAppsManagement::Models::WorkflowGroupComponent < FleetAppsManagement::Models::WorkflowComponent
    ...
    # @option attributes [Array<String>] :steps The value to assign to the {#steps} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['type'] = 'PARALLEL_TASK_GROUP'
