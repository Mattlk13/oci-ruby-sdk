...
module OCI
  ...
  class FleetAppsManagement::Models::ComplianceDetailProduct
    # Product Stack.
    # @return [String]
    ...
    # @option attributes [String] :product_version The value to assign to the {#product_version} property
    ...
    def hash
      [product_stack, product_name, product_version].hash
    end
