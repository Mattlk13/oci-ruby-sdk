...
module OCI
  ...
  class FleetAppsManagement::Models::FleetCredentialSummary
    ...
    # @return [OCI::FleetAppsManagement::Models::CredentialEntitySpecificDetails]
    attr_accessor :entity_specifics

    # @return [OCI::FleetAppsManagement::Models::CredentialDetails]
    attr_accessor :user
    ...
    # @option attributes [OCI::FleetAppsManagement::Models::CredentialEntitySpecificDetails] :entity_specifics The value to assign to the {#entity_specifics} property
    # @option attributes [OCI::FleetAppsManagement::Models::CredentialDetails] :user The value to assign to the {#user} property
    # @option attributes [OCI::FleetAppsManagement::Models::CredentialDetails] :password The value to assign to the {#password} property
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, entity_specifics, user, password, lifecycle_state, lifecycle_details, system_tags].hash
    end
