...
require 'date'
require_relative 'user_action_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Details for a user action to be performed on an action group.
  #
  class FleetAppsManagement::Models::ActionGroupBasedUserActionDetails < FleetAppsManagement::Models::UserActionDetails
    ...
    # @option attributes [String] :action The value to assign to the {OCI::FleetAppsManagement::Models::UserActionDetails#action #action} proprety
    # @option attributes [String] :action_group_id The value to assign to the {#action_group_id} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['level'] = 'ACTION_GROUP'
    ...
    def hash
      [level, action, action_group_id].hash
    end
