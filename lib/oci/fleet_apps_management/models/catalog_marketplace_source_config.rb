...
module OCI
  ...
  #
  class FleetAppsManagement::Models::CatalogMarketplaceSourceConfig < FleetAppsManagement::Models::CatalogSourcePayload
    ...
    def initialize(attributes = {})
      ...
      attributes['configSourceType'] = 'MARKETPLACE_CATALOG_SOURCE'
    ...
    def hash
      [config_source_type, working_directory, listing_id, version].hash
    end
