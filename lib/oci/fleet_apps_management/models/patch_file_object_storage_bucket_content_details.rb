...
require 'date'
require_relative 'patch_file_content_details'
...
module OCI
  ...
  #
  class FleetAppsManagement::Models::PatchFileObjectStorageBucketContentDetails < FleetAppsManagement::Models::PatchFileContentDetails
    # **[Required]** Namespace.
    # @return [String]
