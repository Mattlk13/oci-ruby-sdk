...
module OCI
  ...
  class FleetAppsManagement::Models::PropertySummary
    SELECTION_ENUM = [
      SELECTION_SINGLE_CHOICE = 'SINGLE_CHOICE'.freeze,
      SELECTION_MULTI_CHOICE = 'MULTI_CHOICE'.freeze,
      SELECTION_DEFAULT_TEXT = 'DEFAULT_TEXT'.freeze,
      SELECTION_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    SCOPE_ENUM = [
      SCOPE_TAXONOMY = 'TAXONOMY'.freeze,
      SCOPE_PLATFORM_CONFIG = 'PLATFORM_CONFIG'.freeze,
    ...
    def selection=(selection)
      ...
      if selection && !SELECTION_ENUM.include?(selection)
        OCI.logger.debug("Unknown value for 'selection' [" + selection + "]. Mapping to 'SELECTION_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @selection = SELECTION_UNKNOWN_ENUM_VALUE
      else
        @selection = selection
      end
    ...
    def hash
      [id, compartment_id, display_name, time_created, time_updated, resource_region, lifecycle_state, lifecycle_details, selection, value_type, values, scope, type, freeform_tags, defined_tags, system_tags].hash
    end
