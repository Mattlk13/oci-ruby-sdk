...
module OCI
  ...
  class FleetAppsManagement::Models::ApiBasedExecutionDetails < FleetAppsManagement::Models::ExecutionDetails
    # **[Required]** Endpoint to be invoked.
    # @return [String]
