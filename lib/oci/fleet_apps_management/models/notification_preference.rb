...
module OCI
  ...
  class FleetAppsManagement::Models::NotificationPreference
    ...
    # @return [OCI::FleetAppsManagement::Models::Preferences]
    ...
    # @option attributes [OCI::FleetAppsManagement::Models::Preferences] :preferences The value to assign to the {#preferences} property
    def initialize(attributes = {})
      ...
      self.preferences = attributes[:'preferences'] if attributes[:'preferences']
    end
    ...
    def hash
      [topic_id, compartment_id, preferences].hash
    end
