...
module OCI
  ...
  class FleetAppsManagement::Models::RunbookSummary
    OS_TYPE_ENUM = [
    ...
    def hash
      [id, display_name, description, type, operation, os_type, platform, is_default, estimated_time, latest_version, has_draft_version, lifecycle_state, lifecycle_details, time_created, time_updated, compartment_id, resource_region, freeform_tags, defined_tags, system_tags].hash
    end
