...
require 'date'
require_relative 'pause_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Time-based pause details.
  class FleetAppsManagement::Models::TimeBasedPauseDetails < FleetAppsManagement::Models::PauseDetails
    # **[Required]** Time in minutes to apply Pause.
    # @return [Integer]
