...
module OCI
  ...
  class FleetAppsManagement::Models::ContentDetails
    SOURCE_TYPE_ENUM = [
      SOURCE_TYPE_OBJECT_STORAGE_BUCKET = 'OBJECT_STORAGE_BUCKET'.freeze,
      SOURCE_TYPE_CATALOG = 'CATALOG'.freeze,
      SOURCE_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Content Source type details.
    #
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetAppsManagement::Models::CatalogContentDetails' if type == 'CATALOG'
      return 'OCI::FleetAppsManagement::Models::ObjectStorageBucketContentDetails' if type == 'OBJECT_STORAGE_BUCKET'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetAppsManagement::Models::ContentDetails'
    end
