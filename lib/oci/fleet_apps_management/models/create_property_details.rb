...
module OCI
  ...
  class FleetAppsManagement::Models::CreatePropertyDetails
    SELECTION_ENUM = [
    ...
    def selection=(selection)
      raise "Invalid value for 'selection': this must be one of the values in SELECTION_ENUM." if selection && !SELECTION_ENUM.include?(selection)
    ...
    def hash
      [compartment_id, display_name, selection, value_type, values].hash
    end
