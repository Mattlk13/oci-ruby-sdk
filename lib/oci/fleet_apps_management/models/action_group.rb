...
module OCI
  ...
  class FleetAppsManagement::Models::ActionGroup
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetAppsManagement::Models::FleetBasedActionGroup' if type == 'FLEET_USING_RUNBOOK'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetAppsManagement::Models::ActionGroup'
    end
