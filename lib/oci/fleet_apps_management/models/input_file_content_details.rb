...
module OCI
  ...
  class FleetAppsManagement::Models::InputFileContentDetails
    SOURCE_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetAppsManagement::Models::InputFileObjectStorageBucketContentDetails' if type == 'OBJECT_STORAGE_BUCKET'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetAppsManagement::Models::InputFileContentDetails'
    end
