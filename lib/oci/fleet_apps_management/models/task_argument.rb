...
module OCI
  ...
  class FleetAppsManagement::Models::TaskArgument
    KIND_ENUM = [
      KIND_STRING = 'STRING'.freeze,
      KIND_FILE = 'FILE'.freeze,
      KIND_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Task argument kind
    # @return [String]
    attr_reader :kind

    # **[Required]** Name of the input variable
    # @return [String]
    attr_accessor :name
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetAppsManagement::Models::StringTaskArgument' if type == 'STRING'
      return 'OCI::FleetAppsManagement::Models::FileTaskArgument' if type == 'FILE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::FleetAppsManagement::Models::TaskArgument'
    end
