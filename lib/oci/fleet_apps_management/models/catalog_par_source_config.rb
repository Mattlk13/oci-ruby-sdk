...
require 'date'
require_relative 'catalog_source_payload'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Catalog par source config.
  #
  class FleetAppsManagement::Models::CatalogParSourceConfig < FleetAppsManagement::Models::CatalogSourcePayload
    # nameSpace
    #
    # @return [String]
    ...
    # @option attributes [String] :working_directory The value to assign to the {OCI::FleetAppsManagement::Models::CatalogSourcePayload#working_directory #working_directory} proprety
    ...
    def initialize(attributes = {})
      ...
      attributes['configSourceType'] = 'PAR_CATALOG_SOURCE'
    ...
    def hash
      [config_source_type, working_directory, namespace_name, bucket_name, object_name, access_uri, time_expires].hash
    end
