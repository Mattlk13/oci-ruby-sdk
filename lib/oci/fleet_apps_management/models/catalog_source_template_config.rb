...
module OCI
  ...
  #
  class FleetAppsManagement::Models::CatalogSourceTemplateConfig < FleetAppsManagement::Models::CatalogSourcePayload
    ...
    # @option attributes [String] :template_display_name The value to assign to the {#template_display_name} property
