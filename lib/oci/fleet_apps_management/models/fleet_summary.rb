...
module OCI
  ...
  #
  class FleetAppsManagement::Models::FleetSummary
    ...
    def hash
      [id, compartment_id, resource_region, display_name, time_created, time_updated, details, environment_type, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
