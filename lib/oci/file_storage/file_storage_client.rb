...
module OCI
  ...
  class FileStorage::FileStorageClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/add_export_lock.rb.html) to see an example of how to use add_export_lock API.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/add_file_system_lock.rb.html) to see an example of how to use add_file_system_lock API.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/add_filesystem_snapshot_policy_lock.rb.html) to see an example of how to use add_filesystem_snapshot_policy_lock API.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/add_mount_target_lock.rb.html) to see an example of how to use add_mount_target_lock API.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/add_outbound_connector_lock.rb.html) to see an example of how to use add_outbound_connector_lock API.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/add_replication_lock.rb.html) to see an example of how to use add_replication_lock API.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/add_snapshot_lock.rb.html) to see an example of how to use add_snapshot_lock API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::MountTarget MountTarget}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/cancel_downgrade_shape_mount_target.rb.html) to see an example of how to use cancel_downgrade_shape_mount_target API.
    ...
    #
    # @param [OCI::FileStorage::Models::CreateQuotaRuleDetails] create_quota_rule_details Details for adding a new quota rule.
    # @param [String] file_system_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the file system.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #   might be rejected.
    #    (default to none)
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::QuotaRule QuotaRule}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/create_quota_rule.rb.html) to see an example of how to use create_quota_rule API.
    ...
    #
    # @option opts [BOOLEAN] :is_lock_override Whether to override locks (if any exist). (default to false)
    # @option opts [BOOLEAN] :can_detach_child_file_system If the value is set to true, then the file system will be deleted by detaching its child file system, turning
    ...
    #
    # @param [String] file_system_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the file system.
    # @param [String] quota_rule_id The identifier of the quota rule. It is the base64 encoded string of the tuple <principalId, principalType, isHardQuota>.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/delete_quota_rule.rb.html) to see an example of how to use delete_quota_rule API.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/detach_clone.rb.html) to see an example of how to use detach_clone API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::QuotaRule QuotaRule}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/get_quota_rule.rb.html) to see an example of how to use get_quota_rule API.
    ...
    #
    # @param [String] file_system_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the file system.
    # @param [String] principal_type The type of the owner of this quota rule and usage.
    #
    ...
    #   see [List Pagination](https://docs.cloud.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    #    (default to none)
    # @option opts [Integer] :principal_id An identifier for the user or the group associated with quota rule and usage. UNIX-like operating systems use this integer value to
    #   identify a user or group to manage access control.
    #
    # @option opts [BOOLEAN] :are_violators_only An option to display only the users or groups that violate their quota rules.
    ...
    #   If you need to contact Oracle about a particular request, please provide the request ID.
    #
    # @return [Response] A Response object with data of type Array<{OCI::FileStorage::Models::QuotaRuleSummary QuotaRuleSummary}>
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/list_quota_rules.rb.html) to see an example of how to use list_quota_rules API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::Export Export}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/remove_export_lock.rb.html) to see an example of how to use remove_export_lock API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::FileSystem FileSystem}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/remove_file_system_lock.rb.html) to see an example of how to use remove_file_system_lock API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::FilesystemSnapshotPolicy FilesystemSnapshotPolicy}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/remove_filesystem_snapshot_policy_lock.rb.html) to see an example of how to use remove_filesystem_snapshot_policy_lock API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::MountTarget MountTarget}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/remove_mount_target_lock.rb.html) to see an example of how to use remove_mount_target_lock API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::OutboundConnector OutboundConnector}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/remove_outbound_connector_lock.rb.html) to see an example of how to use remove_outbound_connector_lock API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::Replication Replication}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/remove_replication_lock.rb.html) to see an example of how to use remove_replication_lock API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::Snapshot Snapshot}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/remove_snapshot_lock.rb.html) to see an example of how to use remove_snapshot_lock API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::MountTarget MountTarget}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/schedule_downgrade_shape_mount_target.rb.html) to see an example of how to use schedule_downgrade_shape_mount_target API.
    ...
    #
    # @param [String] file_system_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the file system.
    # @param [OCI::FileStorage::Models::ToggleQuotaRulesDetails] toggle_quota_rules_details Details for toggling quota enforcement in the file system.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/toggle_quota_rules.rb.html) to see an example of how to use toggle_quota_rules API.
    ...
    #
    # @param [OCI::FileStorage::Models::UpdateQuotaRuleDetails] update_quota_rule_details Details for editing a quota rule.
    # @param [String] file_system_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the file system.
    # @param [String] quota_rule_id The identifier of the quota rule. It is the base64 encoded string of the tuple <principalId, principalType, isHardQuota>.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::QuotaRule QuotaRule}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/update_quota_rule.rb.html) to see an example of how to use update_quota_rule API.
    ...
    #
    # @return [Response] A Response object with data of type {OCI::FileStorage::Models::MountTarget MountTarget}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/filestorage/upgrade_shape_mount_target.rb.html) to see an example of how to use upgrade_shape_mount_target API.
