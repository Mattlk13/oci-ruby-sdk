...
module OCI
  ...
  #
  class FileStorage::Models::QuotaRule
    PRINCIPAL_TYPE_ENUM = [
    ...
    # **[Required]** The date and time the quota rule was created, expressed in
    ...
    # **[Required]** The date and time the quota rule was last updated, expressed in
    # [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.
    #
    # Example: `2016-08-25T21:10:29.600Z`
    #
    ...
    def hash
      [id, file_system_id, principal_type, principal_id, is_hard_quota, display_name, quota_limit_in_gigabytes, time_created, time_updated].hash
    end
