...
module OCI
  ...
  class FileStorage::Models::LdapBindAccount < FileStorage::Models::OutboundConnector
    ...
    # @option attributes [Array<OCI::FileStorage::Models::ResourceLock>] :locks The value to assign to the {OCI::FileStorage::Models::OutboundConnector#locks #locks} proprety
    ...
    # @option attributes [Hash<String, Hash<String, Object>>] :system_tags The value to assign to the {OCI::FileStorage::Models::OutboundConnector#system_tags #system_tags} proprety
    ...
    def hash
      [availability_domain, compartment_id, id, lifecycle_state, display_name, time_created, connector_type, locks, freeform_tags, defined_tags, system_tags, endpoints, bind_distinguished_name, password_secret_id, password_secret_version].hash
    end
