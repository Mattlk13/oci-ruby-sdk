...
module OCI
  ...
  class FileStorage::Models::ReplicationTarget
    ...
    def hash
      [availability_domain, compartment_id, id, lifecycle_state, display_name, time_created, source_id, target_id, replication_id, last_snapshot_id, recovery_point_time, delta_status, delta_progress, freeform_tags, defined_tags, system_tags, lifecycle_details].hash
    end
