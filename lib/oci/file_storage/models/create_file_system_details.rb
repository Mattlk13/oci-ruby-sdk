...
module OCI
  ...
  class FileStorage::Models::CreateFileSystemDetails
    ...
    def clone_attach_status=(clone_attach_status)
      raise "Invalid value for 'clone_attach_status': this must be one of the values in CLONE_ATTACH_STATUS_ENUM." if clone_attach_status && !CLONE_ATTACH_STATUS_ENUM.include?(clone_attach_status)
