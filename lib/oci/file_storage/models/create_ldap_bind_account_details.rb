...
module OCI
  ...
  class FileStorage::Models::CreateLdapBindAccountDetails < FileStorage::Models::CreateOutboundConnectorDetails
    ...
    # @option attributes [Array<OCI::FileStorage::Models::ResourceLock>] :locks The value to assign to the {OCI::FileStorage::Models::CreateOutboundConnectorDetails#locks #locks} proprety
    ...
    def hash
      [availability_domain, compartment_id, display_name, connector_type, freeform_tags, defined_tags, locks, endpoints, bind_distinguished_name, password_secret_id, password_secret_version].hash
    end
