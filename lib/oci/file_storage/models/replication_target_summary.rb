...
module OCI
  ...
  class FileStorage::Models::ReplicationTargetSummary
    ...
    def hash
      [availability_domain, compartment_id, id, lifecycle_state, display_name, time_created, freeform_tags, defined_tags, system_tags, lifecycle_details, recovery_point_time].hash
    end
