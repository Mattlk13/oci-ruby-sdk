...
module OCI
  ...
  class FileStorage::Models::ReplicationSummary
    ...
    def hash
      [availability_domain, compartment_id, id, lifecycle_state, display_name, time_created, locks, replication_interval, freeform_tags, defined_tags, system_tags, lifecycle_details, recovery_point_time].hash
    end
