...
module OCI
  ...
  class FileStorage::Models::FilesystemSnapshotPolicy
    ...
    def hash
      [compartment_id, availability_domain, id, lifecycle_state, time_created, display_name, policy_prefix, schedules, locks, freeform_tags, defined_tags, system_tags].hash
    end
