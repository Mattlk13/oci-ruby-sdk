...
module OCI
  ...
  class FileStorage::Models::SnapshotSummary
    ...
    def hash
      [file_system_id, id, lifecycle_state, name, time_created, locks, snapshot_type, snapshot_time, expiration_time, provenance_id, is_clone_source, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
