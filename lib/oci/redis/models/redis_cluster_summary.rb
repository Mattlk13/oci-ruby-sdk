...
module OCI
  ...
  class Redis::Models::RedisClusterSummary
    ...
    def hash
      [id, display_name, compartment_id, lifecycle_state, lifecycle_details, node_count, node_memory_in_gbs, primary_fqdn, primary_endpoint_ip_address, replicas_fqdn, replicas_endpoint_ip_address, software_version, subnet_id, time_created, time_updated, cluster_mode, shard_count, nsg_ids, freeform_tags, defined_tags, system_tags].hash
    end
