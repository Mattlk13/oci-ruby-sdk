...
module OCI
  ...
  class Redis::RedisClusterClient
    ...
    # @param [String] redis_cluster_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm#Oracle) of the cluster.
    ...
    #
    # @param [OCI::Redis::Models::CreateRedisClusterDetails] create_redis_cluster_details Details for the new cluster.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::Redis::Models::RedisNodeCollection RedisNodeCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/redis/list_redis_cluster_nodes.rb.html) to see an example of how to use list_redis_cluster_nodes API.
    def list_redis_cluster_nodes(redis_cluster_id, opts = {})
      logger.debug 'Calling operation RedisClusterClient#list_redis_cluster_nodes.' if logger

      raise "Missing the required parameter 'redis_cluster_id' when calling list_redis_cluster_nodes." if redis_cluster_id.nil?
      ...
      path = '/redisClusters/{redisClusterId}/nodes'.sub('{redisClusterId}', redis_cluster_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'RedisClusterClient#list_redis_cluster_nodes') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Redis::Models::RedisNodeCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :display_name A filter to return only resources that match the entire display name given.
    # @option opts [String] :id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm#Oracle) of the cluster.
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page A token representing the position at which to start retrieving results. This must come from the `opc-next-page` header field of a previous response.
    # @option opts [String] :sort_order The sort order to use, either 'ASC' or 'DESC'.
    # @option opts [String] :sort_by The field to sort by. Only one sort order may be provided. Default order for timeCreated is descending. Default order for displayName is ascending.
