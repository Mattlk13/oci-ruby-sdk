...
module OCI
  ...
  class AiVision::AIServiceVisionClient
    ...
    #
    # @param [String] video_job_id Video job id.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aivision/cancel_video_job.rb.html) to see an example of how to use cancel_video_job API.
    def cancel_video_job(video_job_id, opts = {})
      logger.debug 'Calling operation AIServiceVisionClient#cancel_video_job.' if logger

      raise "Missing the required parameter 'video_job_id' when calling cancel_video_job." if video_job_id.nil?
      raise "Parameter value for 'video_job_id' must not be blank" if OCI::Internal::Util.blank_string?(video_job_id)

      path = '/videoJobs/{videoJobId}/actions/cancel'.sub('{videoJobId}', video_job_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceVisionClient#cancel_video_job') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [OCI::AiVision::Models::CreateVideoJobDetails] create_video_job_details Details about the video analysis.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or
    ...
    #
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::AiVision::Models::VideoJob VideoJob}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aivision/create_video_job.rb.html) to see an example of how to use create_video_job API.
    def create_video_job(create_video_job_details, opts = {})
      logger.debug 'Calling operation AIServiceVisionClient#create_video_job.' if logger

      raise "Missing the required parameter 'create_video_job_details' when calling create_video_job." if create_video_job_details.nil?
      ...
      post_body = @api_client.object_to_http_body(create_video_job_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceVisionClient#create_video_job') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::AiVision::Models::VideoJob'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::AiVision::Models::VideoJob VideoJob}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/aivision/get_video_job.rb.html) to see an example of how to use get_video_job API.
    def get_video_job(video_job_id, opts = {})
      logger.debug 'Calling operation AIServiceVisionClient#get_video_job.' if logger

      raise "Missing the required parameter 'video_job_id' when calling get_video_job." if video_job_id.nil?
      raise "Parameter value for 'video_job_id' must not be blank" if OCI::Internal::Util.blank_string?(video_job_id)

      path = '/videoJobs/{videoJobId}'.sub('{videoJobId}', video_job_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AIServiceVisionClient#get_video_job') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
