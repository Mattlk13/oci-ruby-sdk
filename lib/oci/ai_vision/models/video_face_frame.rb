...
module OCI
  # A face frame.
  class AiVision::Models::VideoFaceFrame
    # **[Required]** Time offset(Milliseconds) in the video.
    # @return [Integer]
    ...
    def hash
      [time_offset_ms, confidence, quality_score, bounding_polygon, landmarks].hash
    end
