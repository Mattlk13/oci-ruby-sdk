...
module OCI
  ...
  class AiVision::Models::CreateVideoJobDetails
    # This attribute is required.
    # @return [OCI::AiVision::Models::InputLocation]
    attr_accessor :input_location

    # **[Required]** a list of video analysis features.
    ...
    def hash
      [input_location, features, output_location, compartment_id, display_name, freeform_tags, defined_tags].hash
    end
