...
module OCI
  ...
  class AiVision::Models::VideoTrackingFrame
    # **[Required]** Time offset(Milliseconds) of the frame.
    # @return [Integer]
    ...
    # @return [Array<OCI::AiVision::Models::ObjectProperty>]
    ...
    def self.swagger_types
      {
        ...
        'properties': :'Array<OCI::AiVision::Models::ObjectProperty>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Integer] :time_offset_ms The value to assign to the {#time_offset_ms} property
    ...
    # @option attributes [Array<OCI::AiVision::Models::ObjectProperty>] :properties The value to assign to the {#properties} property
    def initialize(attributes = {})
      ...
      self.time_offset_ms = attributes[:'timeOffsetMs'] if attributes[:'timeOffsetMs']

      raise 'You cannot provide both :timeOffsetMs and :time_offset_ms' if attributes.key?(:'timeOffsetMs') && attributes.key?(:'time_offset_ms')

      self.time_offset_ms = attributes[:'time_offset_ms'] if attributes[:'time_offset_ms']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        time_offset_ms == other.time_offset_ms &&
    ...
    def hash
      [time_offset_ms, confidence, bounding_polygon, properties].hash
    end
