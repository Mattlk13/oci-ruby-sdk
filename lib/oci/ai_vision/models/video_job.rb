...
module OCI
  ...
  class AiVision::Models::VideoJob
    ...
    # **[Required]** a list of document analysis features.
    # @return [Array<OCI::AiVision::Models::VideoFeature>]
    ...
    def self.swagger_types
      {
        ...
        'display_name': :'String',
        'features': :'Array<OCI::AiVision::Models::VideoFeature>',
    ...
    # @option attributes [Array<OCI::AiVision::Models::VideoFeature>] :features The value to assign to the {#features} property
    ...
    def hash
      [id, compartment_id, display_name, features, input_location, time_accepted, time_started, time_finished, percent_complete, output_location, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
