...
module OCI
  ...
  class DataFlow::DataFlowClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/dataflow/cascading_delete_application.rb.html) to see an example of how to use cascading_delete_application API.
    def cascading_delete_application(application_id, opts = {})
      logger.debug 'Calling operation DataFlowClient#cascading_delete_application.' if logger

      raise "Missing the required parameter 'application_id' when calling cascading_delete_application." if application_id.nil?
      raise "Parameter value for 'application_id' must not be blank" if OCI::Internal::Util.blank_string?(application_id)

      path = '/applications/{applicationId}/actions/cascadingDeleteApplication'.sub('{applicationId}', application_id.to_s)
      ...
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DataFlowClient#cascading_delete_application') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/dataflow/start_sql_endpoint.rb.html) to see an example of how to use start_sql_endpoint API.
    def start_sql_endpoint(sql_endpoint_id, opts = {})
      logger.debug 'Calling operation DataFlowClient#start_sql_endpoint.' if logger

      raise "Missing the required parameter 'sql_endpoint_id' when calling start_sql_endpoint." if sql_endpoint_id.nil?
      raise "Parameter value for 'sql_endpoint_id' must not be blank" if OCI::Internal::Util.blank_string?(sql_endpoint_id)

      path = '/sqlEndpoints/{sqlEndpointId}/actions/start'.sub('{sqlEndpointId}', sql_endpoint_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DataFlowClient#start_sql_endpoint') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/dataflow/stop_sql_endpoint.rb.html) to see an example of how to use stop_sql_endpoint API.
    def stop_sql_endpoint(sql_endpoint_id, opts = {})
      logger.debug 'Calling operation DataFlowClient#stop_sql_endpoint.' if logger

      raise "Missing the required parameter 'sql_endpoint_id' when calling stop_sql_endpoint." if sql_endpoint_id.nil?
      raise "Parameter value for 'sql_endpoint_id' must not be blank" if OCI::Internal::Util.blank_string?(sql_endpoint_id)

      path = '/sqlEndpoints/{sqlEndpointId}/actions/stop'.sub('{sqlEndpointId}', sql_endpoint_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DataFlowClient#stop_sql_endpoint') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
