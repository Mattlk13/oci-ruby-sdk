...
module OCI
  ...
  class DataFlow::DataFlowClientCompositeOperations
    ...
    # Calls {OCI::DataFlow::DataFlowClient#cascading_delete_application} and then waits for the {OCI::DataFlow::Models::WorkRequest}
    ...
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataFlow::DataFlowClient#cascading_delete_application}
    ...
    # Calls {OCI::DataFlow::DataFlowClient#start_sql_endpoint} and then waits for the {OCI::DataFlow::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] sql_endpoint_id The unique id of the SQL Endpoint.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataFlow::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataFlow::DataFlowClient#start_sql_endpoint}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    ...
    # Calls {OCI::DataFlow::DataFlowClient#stop_sql_endpoint} and then waits for the {OCI::DataFlow::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] sql_endpoint_id The unique id of the SQL Endpoint.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataFlow::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataFlow::DataFlowClient#stop_sql_endpoint}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
