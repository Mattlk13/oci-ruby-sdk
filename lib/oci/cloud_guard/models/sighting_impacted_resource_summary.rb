...
module OCI
  ...
  class CloudGuard::Models::SightingImpactedResourceSummary
    ...
    def hash
      [id, resource_id, sighting_id, problem_id, compartment_id, resource_name, resource_type, region, time_identified, time_first_detected, time_last_detected, time_first_occurred, time_last_occurred].hash
    end
