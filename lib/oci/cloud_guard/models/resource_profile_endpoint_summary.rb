...
module OCI
  ...
  class CloudGuard::Models::ResourceProfileEndpointSummary
    ...
    def hash
      [id, resource_profile_id, problem_id, sighting_type, sighting_type_display_name, ip_address, ip_address_type, ip_classification_type, country, latitude, longitude, asn_number, regions, services, time_first_detected, time_last_detected, time_first_occurred, time_last_occurred].hash
    end
