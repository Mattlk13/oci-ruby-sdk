...
module OCI
  ...
  class CloudGuard::Models::SightingEndpointSummary
    ...
    def hash
      [id, sighting_id, problem_id, ip_address, ip_address_type, ip_classification_type, country, latitude, longitude, asn_number, regions, services, time_first_detected, time_last_detected, time_first_occurred, time_last_occurred].hash
    end
