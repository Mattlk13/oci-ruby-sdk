...
module OCI
  ...
  class Integration::Models::IntegrationInstanceSummary
    ...
    def hash
      [id, display_name, compartment_id, integration_instance_type, time_created, time_updated, lifecycle_state, lifecycle_details, state_message, is_byol, instance_url, instance_design_time_url, message_packs, is_file_server_enabled, is_visual_builder_enabled, custom_endpoint, alternate_custom_endpoints, consumption_model, network_endpoint_details, freeform_tags, defined_tags, system_tags, shape, private_endpoint_outbound_connection, is_disaster_recovery_enabled, data_retention_period].hash
    end
