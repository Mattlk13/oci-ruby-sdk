...
module OCI
  ...
  class Integration::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_EXTEND_DATA_RETENTION = 'EXTEND_DATA_RETENTION'.freeze,
      OPERATION_TYPE_DISASTER_RECOVERY_FAILOVER = 'DISASTER_RECOVERY_FAILOVER'.freeze,
      OPERATION_TYPE_CREATE_CUSTOM_ENDPOINT = 'CREATE_CUSTOM_ENDPOINT'.freeze,
      OPERATION_TYPE_DELETE_CUSTOM_ENDPOINT = 'DELETE_CUSTOM_ENDPOINT'.freeze,
