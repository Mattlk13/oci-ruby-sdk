...
module OCI
  ...
  class Integration::Models::AddOracleManagedCustomEndpointDetails
    DNS_TYPE_ENUM = [
      DNS_TYPE_OCI = 'OCI'.freeze
    ].freeze

    # **[Required]** Oracle managed custom hostname
    # @return [String]
    ...
    def dns_type=(dns_type)
      raise "Invalid value for 'dns_type': this must be one of the values in DNS_TYPE_ENUM." if dns_type && !DNS_TYPE_ENUM.include?(dns_type)
    ...
    def hash
      [hostname, dns_type, dns_zone_name].hash
    end
