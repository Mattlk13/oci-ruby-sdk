...
module OCI
  ...
  class Integration::IntegrationInstanceClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/integration/add_oracle_managed_custom_endpoint.rb.html) to see an example of how to use add_oracle_managed_custom_endpoint API.
    def add_oracle_managed_custom_endpoint(add_oracle_managed_custom_endpoint_details, integration_instance_id, opts = {})
      logger.debug 'Calling operation IntegrationInstanceClient#add_oracle_managed_custom_endpoint.' if logger

      raise "Missing the required parameter 'add_oracle_managed_custom_endpoint_details' when calling add_oracle_managed_custom_endpoint." if add_oracle_managed_custom_endpoint_details.nil?
      raise "Missing the required parameter 'integration_instance_id' when calling add_oracle_managed_custom_endpoint." if integration_instance_id.nil?
      ...
      path = '/integrationInstances/{integrationInstanceId}/actions/addOracleManagedCustomEndpoint'.sub('{integrationInstanceId}', integration_instance_id.to_s)
      ...
      post_body = @api_client.object_to_http_body(add_oracle_managed_custom_endpoint_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'IntegrationInstanceClient#add_oracle_managed_custom_endpoint') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/integration/disaster_recovery_failover.rb.html) to see an example of how to use disaster_recovery_failover API.
    def disaster_recovery_failover(integration_instance_id, opts = {})
      logger.debug 'Calling operation IntegrationInstanceClient#disaster_recovery_failover.' if logger

      raise "Missing the required parameter 'integration_instance_id' when calling disaster_recovery_failover." if integration_instance_id.nil?
      raise "Parameter value for 'integration_instance_id' must not be blank" if OCI::Internal::Util.blank_string?(integration_instance_id)

      path = '/integrationInstances/{integrationInstanceId}/actions/failover'.sub('{integrationInstanceId}', integration_instance_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'IntegrationInstanceClient#disaster_recovery_failover') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/integration/extend_data_retention.rb.html) to see an example of how to use extend_data_retention API.
    def extend_data_retention(integration_instance_id, extend_data_retention_details, opts = {})
      logger.debug 'Calling operation IntegrationInstanceClient#extend_data_retention.' if logger

      raise "Missing the required parameter 'integration_instance_id' when calling extend_data_retention." if integration_instance_id.nil?
      raise "Missing the required parameter 'extend_data_retention_details' when calling extend_data_retention." if extend_data_retention_details.nil?
      raise "Parameter value for 'integration_instance_id' must not be blank" if OCI::Internal::Util.blank_string?(integration_instance_id)

      path = '/integrationInstances/{integrationInstanceId}/actions/extendDataRetention'.sub('{integrationInstanceId}', integration_instance_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(extend_data_retention_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'IntegrationInstanceClient#extend_data_retention') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/integration/remove_oracle_managed_custom_endpoint.rb.html) to see an example of how to use remove_oracle_managed_custom_endpoint API.
    def remove_oracle_managed_custom_endpoint(integration_instance_id, opts = {})
      logger.debug 'Calling operation IntegrationInstanceClient#remove_oracle_managed_custom_endpoint.' if logger

      raise "Missing the required parameter 'integration_instance_id' when calling remove_oracle_managed_custom_endpoint." if integration_instance_id.nil?
      raise "Parameter value for 'integration_instance_id' must not be blank" if OCI::Internal::Util.blank_string?(integration_instance_id)

      path = '/integrationInstances/{integrationInstanceId}/actions/removeOracleManagedCustomEndpoint'.sub('{integrationInstanceId}', integration_instance_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'IntegrationInstanceClient#remove_oracle_managed_custom_endpoint') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
