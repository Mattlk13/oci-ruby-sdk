...
module OCI
  ...
  #
  class ObjectStorage::Models::AccessTargetDetails
    ...
    # **[Required]** The name of the bucket. Avoid entering confidential information. Wildcards ('*') are allowed. If value is '*', it means all buckets in the specified namespace and compartment can be accessed. It cannot be a regex.
    ...
    def hash
      [namespace, compartment_id, bucket].hash
    end
