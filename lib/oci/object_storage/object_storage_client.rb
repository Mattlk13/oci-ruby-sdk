...
module OCI
  ...
  class ObjectStorage::ObjectStorageClient
    ...
    #   Management service to generate a data encryption key or to encrypt or decrypt a data encryption key.
    #
    # @option opts [String] :opc_checksum_algorithm The optional checksum algorithm to use to compute and store the checksum of the body of the HTTP request (or the parts in case of multipart uploads),
    ...
    # @option opts [String] :opc_client_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/objectstorage/create_private_endpoint.rb.html) to see an example of how to use create_private_endpoint API.
    ...
    # @option opts [String] :opc_client_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/objectstorage/delete_private_endpoint.rb.html) to see an example of how to use delete_private_endpoint API.
    ...
    #
    # @option opts [String] :opc_client_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::ObjectStorage::Models::PrivateEndpoint PrivateEndpoint}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/objectstorage/get_private_endpoint.rb.html) to see an example of how to use get_private_endpoint API.
    ...
    # @option opts [String] :start Returns object names which are lexicographically greater than or equal to this parameter.
    # @option opts [String] :_end Returns object names which are lexicographically strictly less than this parameter.
    # @option opts [Integer] :limit For list pagination. The maximum number of results per page, or items to return in a paginated
    #   \"List\" call. For important details about how pagination works, see
    #   [List Pagination](https://docs.cloud.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    #
    ...
    # @option opts [String] :opc_client_request_id The client request ID for tracing.
    # @option opts [String] :start_after Returns object names which are lexicographically strictly greater than this parameter.
    # @option opts [String] :page For list pagination. The value of the `opc-next-page` response header from the previous \"List\" call. For important
    #   details about how pagination works, see [List Pagination](https://docs.cloud.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    #
    ...
    #   details about how pagination works, see [List Pagination](https://docs.cloud.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    #
    # @option opts [Array<String>] :fields PrivateEndpoint summary in list of PrivateEndpoints includes the 'namespace', 'name', 'compartmentId',
    ...
    # @return [Response] A Response object with data of type Array<{OCI::ObjectStorage::Models::PrivateEndpointSummary PrivateEndpointSummary}>
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/objectstorage/list_private_endpoints.rb.html) to see an example of how to use list_private_endpoints API.
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :private_endpoint_name The name of the privateEndpoint for which to list work requests.
    # @option opts [String] :opc_client_request_id The client request ID for tracing.
    # @option opts [String] :page For list pagination. The value of the `opc-next-page` response header from the previous \"List\" call. For important
    #   details about how pagination works, see [List Pagination](https://docs.cloud.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    #
    ...
    #
    # @option opts [String] :content_md5 The optional header that defines the base64-encoded MD5 hash of the body. If the optional Content-MD5 header is present, Object
    ...
    #   in addition to the default MD5 checksum.
    #
    # @option opts [String] :opc_content_crc32c Applicable only if CRC32C is specified in the opc-checksum-algorithm request header.
    #
    ...
    #
    # @option opts [String] :opc_content_sha256 Applicable only if SHA256 is specified in the opc-checksum-algorithm request header.
    #
    ...
    #
    # @option opts [String] :opc_content_sha384 Applicable only if SHA384 is specified in the opc-checksum-algorithm request header.
    #
    ...
    #   Example: `my-new-bucket1`
    #
    # @param [OCI::ObjectStorage::Models::RestoreObjectsDetails] restore_objects_details Request to restore object.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_client_request_id The client request ID for tracing.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/objectstorage/update_private_endpoint.rb.html) to see an example of how to use update_private_endpoint API.
