...
module OCI
  ...
  class DisasterRecovery::DisasterRecoveryClient
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    #
    # @option opts [String] :lifecycle_sub_state A filter to return only DR plans that match the given lifecycle sub-state.
    #
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/disasterrecovery/refresh_dr_plan.rb.html) to see an example of how to use refresh_dr_plan API.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/disasterrecovery/verify_dr_plan.rb.html) to see an example of how to use verify_dr_plan API.
