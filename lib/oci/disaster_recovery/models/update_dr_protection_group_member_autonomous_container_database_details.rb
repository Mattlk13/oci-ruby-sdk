...
module OCI
  ...
  class DisasterRecovery::Models::UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails < DisasterRecovery::Models::UpdateDrProtectionGroupMemberDetails
    ...
    def connection_string_type=(connection_string_type)
      raise "Invalid value for 'connection_string_type': this must be one of the values in CONNECTION_STRING_TYPE_ENUM." if connection_string_type && !CONNECTION_STRING_TYPE_ENUM.include?(connection_string_type)
