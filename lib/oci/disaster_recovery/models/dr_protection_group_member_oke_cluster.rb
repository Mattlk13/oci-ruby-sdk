...
module OCI
  ...
  class DisasterRecovery::Models::DrProtectionGroupMemberOkeCluster < DisasterRecovery::Models::DrProtectionGroupMember
    ...
    # @return [OCI::DisasterRecovery::Models::OkeBackupLocation]
    attr_accessor :backup_location

    # @return [OCI::DisasterRecovery::Models::OkeClusterBackupConfig]
    ...
    #
    # @return [Array<OCI::DisasterRecovery::Models::OkeClusterLoadBalancerMapping>]
    ...
    # This property applies to the OKE cluster member in primary region.
    #
    # @return [Array<OCI::DisasterRecovery::Models::OkeClusterNetworkLoadBalancerMapping>]
    attr_accessor :network_load_balancer_mappings

    # The list of source-to-destination vault mappings required for DR operations.
    # This property applies to the OKE cluster member in primary region.
    #
    # @return [Array<OCI::DisasterRecovery::Models::OkeClusterVaultMapping>]
    attr_accessor :vault_mappings

    # The list of node pools with configurations for minimum and maximum node counts.
    # This property applies to the OKE cluster member in both the primary and standby region.
    #
    # @return [Array<OCI::DisasterRecovery::Models::OkeClusterManagedNodePoolConfiguration>]
    attr_accessor :managed_node_pool_configs

    # The list of node pools with configurations for minimum and maximum node counts.
    # This property applies to the OKE cluster member in both the primary and standby region.
    #
    # @return [Array<OCI::DisasterRecovery::Models::OkeClusterVirtualNodePoolConfiguration>]
    ...
    # @option attributes [OCI::DisasterRecovery::Models::OkeBackupLocation] :backup_location The value to assign to the {#backup_location} property
    # @option attributes [OCI::DisasterRecovery::Models::OkeClusterBackupConfig] :backup_config The value to assign to the {#backup_config} property
    # @option attributes [Array<OCI::DisasterRecovery::Models::OkeClusterLoadBalancerMapping>] :load_balancer_mappings The value to assign to the {#load_balancer_mappings} property
    # @option attributes [Array<OCI::DisasterRecovery::Models::OkeClusterNetworkLoadBalancerMapping>] :network_load_balancer_mappings The value to assign to the {#network_load_balancer_mappings} property
    # @option attributes [Array<OCI::DisasterRecovery::Models::OkeClusterVaultMapping>] :vault_mappings The value to assign to the {#vault_mappings} property
    # @option attributes [Array<OCI::DisasterRecovery::Models::OkeClusterManagedNodePoolConfiguration>] :managed_node_pool_configs The value to assign to the {#managed_node_pool_configs} property
    # @option attributes [Array<OCI::DisasterRecovery::Models::OkeClusterVirtualNodePoolConfiguration>] :virtual_node_pool_configs The value to assign to the {#virtual_node_pool_configs} property
