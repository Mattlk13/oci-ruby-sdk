...
module OCI
  ...
  class DisasterRecovery::Models::UpdateDrProtectionGroupMemberComputeInstanceNonMovableDetails < DisasterRecovery::Models::UpdateDrProtectionGroupMemberDetails
    ...
    # @return [OCI::DisasterRecovery::Models::UpdateComputeInstanceNonMovableBlockVolumeAttachAndMountOperationsDetails]
    ...
    # @option attributes [OCI::DisasterRecovery::Models::UpdateComputeInstanceNonMovableBlockVolumeAttachAndMountOperationsDetails] :block_volume_attach_and_mount_operations The value to assign to the {#block_volume_attach_and_mount_operations} property
