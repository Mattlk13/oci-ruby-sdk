...
module OCI
  ...
  class DisasterRecovery::Models::DrPlanSummary
    ...
    def hash
      [id, compartment_id, display_name, type, dr_protection_group_id, peer_dr_protection_group_id, peer_region, time_created, time_updated, lifecycle_state, lifecycle_sub_state, life_cycle_details, freeform_tags, defined_tags, system_tags].hash
    end
