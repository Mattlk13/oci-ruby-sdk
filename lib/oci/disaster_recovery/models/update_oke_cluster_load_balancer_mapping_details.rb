...
module OCI
  ...
  class DisasterRecovery::Models::UpdateOkeClusterLoadBalancerMappingDetails
    # **[Required]** The OCID of the source Load Balancer .
    #
    #  Example: `ocid1.loadbalancer.oc1..uniqueID`
    #
    # @return [String]
    attr_accessor :source_load_balancer_id

    # **[Required]** The OCID of the destination Load Balancer.
    #
    # Example: `ocid1.loadbalancer.oc1..uniqueID`
    #
    # @return [String]
    ...
    # @option attributes [String] :source_load_balancer_id The value to assign to the {#source_load_balancer_id} property
    ...
    def initialize(attributes = {})
      ...
      self.source_load_balancer_id = attributes[:'sourceLoadBalancerId'] if attributes[:'sourceLoadBalancerId']

      raise 'You cannot provide both :sourceLoadBalancerId and :source_load_balancer_id' if attributes.key?(:'sourceLoadBalancerId') && attributes.key?(:'source_load_balancer_id')

      self.source_load_balancer_id = attributes[:'source_load_balancer_id'] if attributes[:'source_load_balancer_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        source_load_balancer_id == other.source_load_balancer_id &&
    ...
    def hash
      [source_load_balancer_id, destination_load_balancer_id].hash
    end
