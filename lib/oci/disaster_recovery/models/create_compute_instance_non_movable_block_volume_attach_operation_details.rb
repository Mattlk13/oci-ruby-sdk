...
module OCI
  ...
  #
  class DisasterRecovery::Models::CreateComputeInstanceNonMovableBlockVolumeAttachOperationDetails
    ...
    def hash
      [block_volume_id, volume_attachment_reference_instance_id].hash
    end
