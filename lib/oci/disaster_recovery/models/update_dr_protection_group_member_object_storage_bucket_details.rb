...
module OCI
  ...
  class DisasterRecovery::Models::UpdateDrProtectionGroupMemberObjectStorageBucketDetails < DisasterRecovery::Models::UpdateDrProtectionGroupMemberDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['memberType'] = 'OBJECT_STORAGE_BUCKET'
    ...
    def hash
      [member_id, member_type, namespace_name, bucket_name].hash
    end
