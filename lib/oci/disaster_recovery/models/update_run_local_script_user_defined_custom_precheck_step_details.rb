...
module OCI
  ...
  #
  class DisasterRecovery::Models::UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails < DisasterRecovery::Models::UpdateDrPlanUserDefinedStepDetails
    # **[Required]** The OCID of the instance on which this precheck script or command should be executed.
    #
    ...
    def initialize(attributes = {})
      ...
      attributes['stepType'] = 'RUN_LOCAL_SCRIPT_USER_DEFINED_CUSTOM_PRECHECK'
