...
module OCI
  ...
  class DisasterRecovery::Models::RefreshDrPlanDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DisasterRecovery::Models::RefreshDrPlanDefaultDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DisasterRecovery::Models::RefreshDrPlanDetails'
    end
