...
module OCI
  ...
  class DisasterRecovery::Models::DrPlan
    ...
    LIFECYCLE_SUB_STATE_ENUM = [
      LIFECYCLE_SUB_STATE_NEEDS_REFRESH = 'NEEDS_REFRESH'.freeze,
      LIFECYCLE_SUB_STATE_NEEDS_VERIFICATION = 'NEEDS_VERIFICATION'.freeze,
      LIFECYCLE_SUB_STATE_REFRESHING = 'REFRESHING'.freeze,
      LIFECYCLE_SUB_STATE_VERIFYING = 'VERIFYING'.freeze,
    ...
    # @option attributes [String] :source_plan_id The value to assign to the {#source_plan_id} property
    ...
    def initialize(attributes = {})
      ...
      self.source_plan_id = attributes[:'sourcePlanId'] if attributes[:'sourcePlanId']

      raise 'You cannot provide both :sourcePlanId and :source_plan_id' if attributes.key?(:'sourcePlanId') && attributes.key?(:'source_plan_id')

      self.source_plan_id = attributes[:'source_plan_id'] if attributes[:'source_plan_id']
    ...
    def hash
      [id, display_name, compartment_id, type, time_created, time_updated, dr_protection_group_id, peer_dr_protection_group_id, peer_region, source_plan_id, plan_groups, lifecycle_state, lifecycle_sub_state, life_cycle_details, freeform_tags, defined_tags, system_tags].hash
    end
