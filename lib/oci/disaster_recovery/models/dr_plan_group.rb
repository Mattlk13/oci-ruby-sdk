...
module OCI
  ...
  class DisasterRecovery::Models::DrPlanGroup
    ...
    REFRESH_STATUS_ENUM = [
      REFRESH_STATUS_GROUP_ADDED = 'GROUP_ADDED'.freeze,
      REFRESH_STATUS_GROUP_DELETED = 'GROUP_DELETED'.freeze,
      REFRESH_STATUS_GROUP_MODIFIED = 'GROUP_MODIFIED'.freeze,
    ...
    def hash
      [id, type, refresh_status, display_name, is_pause_enabled, steps].hash
    end
