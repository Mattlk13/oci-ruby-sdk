...
module OCI
  ...
  class DisasterRecovery::Models::CreateOkeClusterManagedNodePoolConfigurationDetails
    # **[Required]** The OCID of the managed node pool in OKE cluster.
    #
    # @return [String]
    attr_accessor :id
    ...
    # @option attributes [Integer] :minimum The value to assign to the {#minimum} property
    # @option attributes [Integer] :maximum The value to assign to the {#maximum} property
