...
module OCI
  ...
  class DisasterRecovery::Models::CreateDrProtectionGroupMemberAutonomousContainerDatabaseDetails < DisasterRecovery::Models::CreateDrProtectionGroupMemberDetails
