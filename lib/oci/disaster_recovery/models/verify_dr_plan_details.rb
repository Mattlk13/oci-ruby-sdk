...
module OCI
  ...
  class DisasterRecovery::Models::VerifyDrPlanDetails
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DisasterRecovery::Models::VerifyDrPlanDefaultDetails' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DisasterRecovery::Models::VerifyDrPlanDetails'
    end
