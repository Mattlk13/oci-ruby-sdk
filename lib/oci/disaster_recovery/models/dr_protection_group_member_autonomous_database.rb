...
module OCI
  ...
  class DisasterRecovery::Models::DrProtectionGroupMemberAutonomousDatabase < DisasterRecovery::Models::DrProtectionGroupMember
    ...
    def autonomous_database_standby_type_for_dr_drills=(autonomous_database_standby_type_for_dr_drills)
      ...
      if autonomous_database_standby_type_for_dr_drills && !AUTONOMOUS_DATABASE_STANDBY_TYPE_FOR_DR_DRILLS_ENUM.include?(autonomous_database_standby_type_for_dr_drills)
        OCI.logger.debug("Unknown value for 'autonomous_database_standby_type_for_dr_drills' [" + autonomous_database_standby_type_for_dr_drills + "]. Mapping to 'AUTONOMOUS_DATABASE_STANDBY_TYPE_FOR_DR_DRILLS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @autonomous_database_standby_type_for_dr_drills = AUTONOMOUS_DATABASE_STANDBY_TYPE_FOR_DR_DRILLS_UNKNOWN_ENUM_VALUE
      else
