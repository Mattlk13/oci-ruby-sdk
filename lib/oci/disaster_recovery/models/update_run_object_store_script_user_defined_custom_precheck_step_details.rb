...
module OCI
  ...
  #
  class DisasterRecovery::Models::UpdateRunObjectStoreScriptUserDefinedCustomPrecheckStepDetails < DisasterRecovery::Models::UpdateDrPlanUserDefinedStepDetails
    # **[Required]** The OCID of the instance on which this precjeck script or command should be executed.
    #
    ...
    def initialize(attributes = {})
      ...
      attributes['stepType'] = 'RUN_OBJECTSTORE_SCRIPT_USER_DEFINED_CUSTOM_PRECHECK'
