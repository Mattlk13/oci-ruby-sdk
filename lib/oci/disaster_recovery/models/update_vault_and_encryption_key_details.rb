...
module OCI
  ...
  #
  class DisasterRecovery::Models::UpdateVaultAndEncryptionKeyDetails
    ...
    # @option attributes [String] :encryption_key_id The value to assign to the {#encryption_key_id} property
    def initialize(attributes = {})
      ...
      self.encryption_key_id = attributes[:'encryptionKeyId'] if attributes[:'encryptionKeyId']

      raise 'You cannot provide both :encryptionKeyId and :encryption_key_id' if attributes.key?(:'encryptionKeyId') && attributes.key?(:'encryption_key_id')

      self.encryption_key_id = attributes[:'encryption_key_id'] if attributes[:'encryption_key_id']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        encryption_key_id == other.encryption_key_id
    end
    ...
    def hash
      [vault_id, encryption_key_id].hash
    end
