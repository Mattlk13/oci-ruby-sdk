...
module OCI
  ...
  class DisasterRecovery::Models::UpdateDrProtectionGroupMemberDetails
    MEMBER_TYPE_ENUM = [
      ...
      MEMBER_TYPE_AUTONOMOUS_CONTAINER_DATABASE = 'AUTONOMOUS_CONTAINER_DATABASE'.freeze,
      ...
      MEMBER_TYPE_OKE_CLUSTER = 'OKE_CLUSTER'.freeze,
      MEMBER_TYPE_OBJECT_STORAGE_BUCKET = 'OBJECT_STORAGE_BUCKET'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DisasterRecovery::Models::UpdateDrProtectionGroupMemberOkeClusterDetails' if type == 'OKE_CLUSTER'
      ...
      return 'OCI::DisasterRecovery::Models::UpdateDrProtectionGroupMemberAutonomousContainerDatabaseDetails' if type == 'AUTONOMOUS_CONTAINER_DATABASE'
      return 'OCI::DisasterRecovery::Models::UpdateDrProtectionGroupMemberLoadBalancerDetails' if type == 'LOAD_BALANCER'
      return 'OCI::DisasterRecovery::Models::UpdateDrProtectionGroupMemberObjectStorageBucketDetails' if type == 'OBJECT_STORAGE_BUCKET'
