...
module OCI
  ...
  #
  class DisasterRecovery::Models::DrProtectionGroupMemberAutonomousContainerDatabase < DisasterRecovery::Models::DrProtectionGroupMember
    CONNECTION_STRING_TYPE_ENUM = [
      ...
      CONNECTION_STRING_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    #
    # @return [String]
    attr_reader :connection_string_type
    ...
    # @option attributes [String] :connection_string_type The value to assign to the {#connection_string_type} property
    ...
    # @param [Object] connection_string_type Object to be assigned
    def connection_string_type=(connection_string_type)
      # rubocop:disable Style/ConditionalAssignment
      if connection_string_type && !CONNECTION_STRING_TYPE_ENUM.include?(connection_string_type)
        OCI.logger.debug("Unknown value for 'connection_string_type' [" + connection_string_type + "]. Mapping to 'CONNECTION_STRING_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @connection_string_type = CONNECTION_STRING_TYPE_UNKNOWN_ENUM_VALUE
      else
        @connection_string_type = connection_string_type
      end
