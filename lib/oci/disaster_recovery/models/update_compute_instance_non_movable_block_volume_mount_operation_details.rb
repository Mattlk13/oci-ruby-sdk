...
module OCI
  ...
  #
  class DisasterRecovery::Models::UpdateComputeInstanceNonMovableBlockVolumeMountOperationDetails
    # **[Required]** The physical mount point where the file system is mounted on the block volume.
    #
