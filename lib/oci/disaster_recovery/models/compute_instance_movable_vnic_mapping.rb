...
module OCI
  ...
  class DisasterRecovery::Models::ComputeInstanceMovableVnicMapping
    ...
    #
    # @return [String]
    attr_accessor :destination_reserved_public_ip_id
    ...
    # @option attributes [String] :destination_reserved_public_ip_id The value to assign to the {#destination_reserved_public_ip_id} property
    ...
    def initialize(attributes = {})
      ...
      self.destination_reserved_public_ip_id = attributes[:'destinationReservedPublicIpId'] if attributes[:'destinationReservedPublicIpId']

      raise 'You cannot provide both :destinationReservedPublicIpId and :destination_reserved_public_ip_id' if attributes.key?(:'destinationReservedPublicIpId') && attributes.key?(:'destination_reserved_public_ip_id')

      self.destination_reserved_public_ip_id = attributes[:'destination_reserved_public_ip_id'] if attributes[:'destination_reserved_public_ip_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        destination_reserved_public_ip_id == other.destination_reserved_public_ip_id &&
    ...
    def hash
      [source_vnic_id, destination_subnet_id, destination_primary_private_ip_address, destination_primary_private_ip_hostname_label, destination_reserved_public_ip_id, destination_nsg_id_list].hash
    end
