...
module OCI
  ...
  class DisasterRecovery::Models::DrPlanStep
    ...
    REFRESH_STATUS_ENUM = [
      REFRESH_STATUS_STEP_ADDED = 'STEP_ADDED'.freeze,
      REFRESH_STATUS_STEP_DELETED = 'STEP_DELETED'.freeze,
      REFRESH_STATUS_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @option attributes [String] :refresh_status The value to assign to the {#refresh_status} property
    ...
    def initialize(attributes = {})
      ...
      self.refresh_status = attributes[:'refreshStatus'] if attributes[:'refreshStatus']

      raise 'You cannot provide both :refreshStatus and :refresh_status' if attributes.key?(:'refreshStatus') && attributes.key?(:'refresh_status')

      self.refresh_status = attributes[:'refresh_status'] if attributes[:'refresh_status']
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] refresh_status Object to be assigned
    def refresh_status=(refresh_status)
      # rubocop:disable Style/ConditionalAssignment
      if refresh_status && !REFRESH_STATUS_ENUM.include?(refresh_status)
        OCI.logger.debug("Unknown value for 'refresh_status' [" + refresh_status + "]. Mapping to 'REFRESH_STATUS_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @refresh_status = REFRESH_STATUS_UNKNOWN_ENUM_VALUE
      else
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        type == other.type &&
        refresh_status == other.refresh_status &&
    ...
    def hash
      [id, group_id, member_id, type, refresh_status, display_name, type_display_name, error_mode, timeout, is_enabled, user_defined_step].hash
    end
