...
module OCI
  ...
  class DisasterRecovery::DisasterRecoveryClientCompositeOperations
    ...
    # Calls {OCI::DisasterRecovery::DisasterRecoveryClient#refresh_dr_plan} and then waits for the {OCI::DisasterRecovery::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DisasterRecovery::Models::RefreshDrPlanDetails] refresh_dr_plan_details Details for refreshing a DR plan.
    # @param [String] dr_plan_id The OCID of the DR plan.
    #
    #   Example: `ocid1.drplan.oc1..uniqueID`
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DisasterRecovery::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DisasterRecovery::DisasterRecoveryClient#refresh_dr_plan}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DisasterRecovery::Models::WorkRequest}
    def refresh_dr_plan_and_wait_for_state(refresh_dr_plan_details, dr_plan_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.refresh_dr_plan(refresh_dr_plan_details, dr_plan_id, base_operation_opts)
      use_util = OCI::DisasterRecovery::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DisasterRecovery::DisasterRecoveryClient#verify_dr_plan} and then waits for the {OCI::DisasterRecovery::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DisasterRecovery::Models::VerifyDrPlanDetails] verify_dr_plan_details Details for verifying a DR plan.
    # @param [String] dr_plan_id The OCID of the DR plan.
    #
    #   Example: `ocid1.drplan.oc1..uniqueID`
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DisasterRecovery::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DisasterRecovery::DisasterRecoveryClient#verify_dr_plan}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DisasterRecovery::Models::WorkRequest}
    def verify_dr_plan_and_wait_for_state(verify_dr_plan_details, dr_plan_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.verify_dr_plan(verify_dr_plan_details, dr_plan_id, base_operation_opts)
      use_util = OCI::DisasterRecovery::Util.respond_to?(:wait_on_work_request)
