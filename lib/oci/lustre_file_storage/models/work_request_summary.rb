...
module OCI
  ...
  class LustreFileStorage::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
    ...
    # @return [Array<OCI::LustreFileStorage::Models::WorkRequestResource>]
    ...
    # @option attributes [Array<OCI::LustreFileStorage::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
