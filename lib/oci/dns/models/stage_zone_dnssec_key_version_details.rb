...
module OCI
  ...
  #
  class Dns::Models::StageZoneDnssecKeyVersionDetails
    # **[Required]** The UUID of the `DnssecKeyVersion` for which a new successor should be generated.
    #
    # @return [String]
    ...
    def hash
      [predecessor_dnssec_key_version_uuid].hash
    end
