...
module OCI
  ...
  class Dns::Models::ZoneSummary
    ...
    def hash
      [name, zone_type, compartment_id, view_id, scope, freeform_tags, defined_tags, dnssec_state, self_uri, id, time_created, version, serial, lifecycle_state, is_protected, dnssec_config].hash
    end
