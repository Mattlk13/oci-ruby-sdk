...
module OCI
  ...
  class Dns::Models::Zone
    ...
    DNSSEC_STATE_ENUM = [
      ...
      DNSSEC_STATE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @return [OCI::Dns::Models::DnssecConfig]
    ...
    # @option attributes [OCI::Dns::Models::DnssecConfig] :dnssec_config The value to assign to the {#dnssec_config} property
    ...
    def initialize(attributes = {})
      ...
      self.dnssec_config = attributes[:'dnssecConfig'] if attributes[:'dnssecConfig']

      raise 'You cannot provide both :dnssecConfig and :dnssec_config' if attributes.key?(:'dnssecConfig') && attributes.key?(:'dnssec_config')

      self.dnssec_config = attributes[:'dnssec_config'] if attributes[:'dnssec_config']
    ...
    def dnssec_state=(dnssec_state)
      # rubocop:disable Style/ConditionalAssignment
      if dnssec_state && !DNSSEC_STATE_ENUM.include?(dnssec_state)
        OCI.logger.debug("Unknown value for 'dnssec_state' [" + dnssec_state + "]. Mapping to 'DNSSEC_STATE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @dnssec_state = DNSSEC_STATE_UNKNOWN_ENUM_VALUE
      else
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        dnssec_config == other.dnssec_config &&
    ...
    def hash
      [name, zone_type, compartment_id, view_id, scope, freeform_tags, defined_tags, dnssec_state, external_masters, external_downstreams, self_uri, id, time_created, version, serial, lifecycle_state, is_protected, dnssec_config, nameservers, zone_transfer_servers].hash
    end
