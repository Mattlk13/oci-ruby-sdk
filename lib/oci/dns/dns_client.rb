...
module OCI
  ...
  class Dns::DnsClient
    ...
    #
    # @option opts [String] :dnssec_state Search for zones that have the given `DnssecState`.
    #
    ...
    def list_zones(compartment_id, opts = {})
      ...
      if opts[:dnssec_state] && !OCI::Dns::Models::ZONE_DNSSEC_STATE_ENUM.include?(opts[:dnssec_state])
        raise 'Invalid value for "dnssec_state", must be one of the values in OCI::Dns::Models::ZONE_DNSSEC_STATE_ENUM.'
      end
      ...
      query_params[:dnssecState] = opts[:dnssec_state] if opts[:dnssec_state]
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/dns/promote_zone_dnssec_key_version.rb.html) to see an example of how to use promote_zone_dnssec_key_version API.
    def promote_zone_dnssec_key_version(zone_id, promote_zone_dnssec_key_version_details, opts = {})
      logger.debug 'Calling operation DnsClient#promote_zone_dnssec_key_version.' if logger

      raise "Missing the required parameter 'zone_id' when calling promote_zone_dnssec_key_version." if zone_id.nil?
      raise "Missing the required parameter 'promote_zone_dnssec_key_version_details' when calling promote_zone_dnssec_key_version." if promote_zone_dnssec_key_version_details.nil?
      ...
      path = '/zones/{zoneId}/actions/promoteDnssecKeyVersion'.sub('{zoneId}', zone_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(promote_zone_dnssec_key_version_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DnsClient#promote_zone_dnssec_key_version') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/dns/stage_zone_dnssec_key_version.rb.html) to see an example of how to use stage_zone_dnssec_key_version API.
    def stage_zone_dnssec_key_version(zone_id, stage_zone_dnssec_key_version_details, opts = {})
      logger.debug 'Calling operation DnsClient#stage_zone_dnssec_key_version.' if logger

      raise "Missing the required parameter 'zone_id' when calling stage_zone_dnssec_key_version." if zone_id.nil?
      raise "Missing the required parameter 'stage_zone_dnssec_key_version_details' when calling stage_zone_dnssec_key_version." if stage_zone_dnssec_key_version_details.nil?
      ...
      path = '/zones/{zoneId}/actions/stageDnssecKeyVersion'.sub('{zoneId}', zone_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(stage_zone_dnssec_key_version_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DnsClient#stage_zone_dnssec_key_version') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
