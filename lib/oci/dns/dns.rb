...
require 'oci/dns/models/dnssec_config'
require 'oci/dns/models/dnssec_digest_type'
require 'oci/dns/models/dnssec_key_version_ds_data'
require 'oci/dns/models/dnssec_signing_algorithm'
...
require 'oci/dns/models/ksk_dnssec_key_version'
...
require 'oci/dns/models/promote_zone_dnssec_key_version_details'
...
require 'oci/dns/models/stage_zone_dnssec_key_version_details'
...
require 'oci/dns/models/zone_dnssec_state'
require 'oci/dns/models/zone_summary'
require 'oci/dns/models/zone_transfer_server'
require 'oci/dns/models/zsk_dnssec_key_version'
