...
module OCI
  ...
  #
  class GenerativeAiAgentRuntime::Models::OciOpenSearchSourceLocation < GenerativeAiAgentRuntime::Models::SourceLocation
    ...
    def initialize(attributes = {})
      ...
      attributes['sourceLocationType'] = 'OCI_OPEN_SEARCH'
    ...
    def hash
      [source_location_type, id, index_name, url].hash
    end
