...
module OCI
  ...
  #
  class GenerativeAiAgentRuntime::Models::Message
    ROLE_ENUM = [
      ROLE_USER = 'USER'.freeze,
      ROLE_AGENT = 'AGENT'.freeze,
      ROLE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The role of the sender of this message.
    # @return [String]
    attr_reader :role

    # This attribute is required.
    # @return [OCI::GenerativeAiAgentRuntime::Models::MessageContent]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'role': :'String',
        'content': :'OCI::GenerativeAiAgentRuntime::Models::MessageContent',
    ...
    # @option attributes [OCI::GenerativeAiAgentRuntime::Models::MessageContent] :content The value to assign to the {#content} property
    ...
    def hash
      [role, content, time_created].hash
    end
