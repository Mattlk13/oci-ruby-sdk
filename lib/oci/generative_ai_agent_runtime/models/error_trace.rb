...
module OCI
  ...
  #
  class GenerativeAiAgentRuntime::Models::ErrorTrace < GenerativeAiAgentRuntime::Models::Trace
    ...
    def initialize(attributes = {})
      ...
      attributes['traceType'] = 'ERROR_TRACE'
    ...
    def hash
      [time_created, trace_type, error_message].hash
    end
