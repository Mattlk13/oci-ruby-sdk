...
module OCI
  ...
  #
  class GenerativeAiAgentRuntime::Models::MetadataFilter
    # **[Required]** The name of the field to filter on
    # @return [String]
    attr_accessor :field_name

    # **[Required]** The value to filter for in the specified field
    # @return [String]
    attr_accessor :value
