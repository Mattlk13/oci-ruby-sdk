...
module OCI
  ...
  #
  class GenerativeAiAgentRuntime::Models::OciDatabaseSourceLocation < GenerativeAiAgentRuntime::Models::SourceLocation
    ...
    def initialize(attributes = {})
      ...
      attributes['sourceLocationType'] = 'OCI_DATABASE'
    ...
    def hash
      [source_location_type, id, function_name, url].hash
    end
