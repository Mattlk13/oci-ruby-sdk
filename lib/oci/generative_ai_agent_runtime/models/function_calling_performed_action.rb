...
module OCI
  ...
  #
  class GenerativeAiAgentRuntime::Models::FunctionCallingPerformedAction < GenerativeAiAgentRuntime::Models::PerformedAction
    # **[Required]** The result or output of the function call.
    # @return [String]
    attr_accessor :function_call_output
    ...
    # @option attributes [String] :function_call_output The value to assign to the {#function_call_output} property
