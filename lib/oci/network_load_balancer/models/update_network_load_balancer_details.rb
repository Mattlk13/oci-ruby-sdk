...
module OCI
  ...
  class NetworkLoadBalancer::Models::UpdateNetworkLoadBalancerDetails
    ...
    def hash
      [display_name, is_preserve_source_destination, is_symmetric_hash_enabled, nlb_ip_version, subnet_ipv6_cidr, assigned_ipv6, freeform_tags, defined_tags, security_attributes].hash
    end
