...
module OCI
  ...
  class NetworkLoadBalancer::Models::NetworkLoadBalancer
    ...
    def hash
      [id, compartment_id, display_name, lifecycle_state, lifecycle_details, nlb_ip_version, time_created, time_updated, ip_addresses, is_private, is_preserve_source_destination, is_symmetric_hash_enabled, subnet_id, network_security_group_ids, listeners, backend_sets, freeform_tags, security_attributes, defined_tags, system_tags].hash
    end
