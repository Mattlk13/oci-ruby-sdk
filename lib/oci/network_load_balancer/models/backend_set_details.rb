...
module OCI
  ...
  class NetworkLoadBalancer::Models::BackendSetDetails
    ...
    def hash
      [policy, ip_version, is_preserve_source, is_fail_open, is_instant_failover_enabled, is_instant_failover_tcp_reset_enabled, are_operationally_active_backends_preferred, backends, health_checker].hash
    end
