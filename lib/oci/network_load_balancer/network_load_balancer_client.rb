...
module OCI
  ...
  class NetworkLoadBalancer::NetworkLoadBalancerClient
    ...
    # @param [String] network_load_balancer_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the network load balancer to update.
    # @param [String] backend_set_name The name of the backend set associated with the backend server for which to retrieve the operational status.
    #
    #   Example: `example_backend_set`
    #
    # @param [String] backend_name The name of the backend server to retrieve health status for.
    ...
    #   particular request, then provide the request identifier.
    #
    # @return [Response] A Response object with data of type {OCI::NetworkLoadBalancer::Models::BackendOperationalStatus BackendOperationalStatus}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/networkloadbalancer/get_backend_operational_status.rb.html) to see an example of how to use get_backend_operational_status API.
    def get_backend_operational_status(network_load_balancer_id, backend_set_name, backend_name, opts = {})
      logger.debug 'Calling operation NetworkLoadBalancerClient#get_backend_operational_status.' if logger

      raise "Missing the required parameter 'network_load_balancer_id' when calling get_backend_operational_status." if network_load_balancer_id.nil?
      raise "Missing the required parameter 'backend_set_name' when calling get_backend_operational_status." if backend_set_name.nil?
      raise "Missing the required parameter 'backend_name' when calling get_backend_operational_status." if backend_name.nil?
      raise "Parameter value for 'network_load_balancer_id' must not be blank" if OCI::Internal::Util.blank_string?(network_load_balancer_id)
      raise "Parameter value for 'backend_set_name' must not be blank" if OCI::Internal::Util.blank_string?(backend_set_name)
      raise "Parameter value for 'backend_name' must not be blank" if OCI::Internal::Util.blank_string?(backend_name)

      path = '/networkLoadBalancers/{networkLoadBalancerId}/backendSets/{backendSetName}/backends/{backendName}/operationalStatus'.sub('{networkLoadBalancerId}', network_load_balancer_id.to_s).sub('{backendSetName}', backend_set_name.to_s).sub('{backendName}', backend_name.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'NetworkLoadBalancerClient#get_backend_operational_status') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::NetworkLoadBalancer::Models::BackendOperationalStatus'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
