...
module OCI
  ...
  class OsManagementHub::SoftwareSourceClient
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/get_software_source_manifest.rb.html) to see an example of how to use get_software_source_manifest API.
    def get_software_source_manifest(software_source_id, opts = {}, &block)
      logger.debug 'Calling operation SoftwareSourceClient#get_software_source_manifest.' if logger

      raise "Missing the required parameter 'software_source_id' when calling get_software_source_manifest." if software_source_id.nil?
      raise "Parameter value for 'software_source_id' must not be blank" if OCI::Internal::Util.blank_string?(software_source_id)

      path = '/softwareSources/{softwareSourceId}/manifest'.sub('{softwareSourceId}', software_source_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'SoftwareSourceClient#get_software_source_manifest') do
        if !block.nil?
          @api_client.call_api(
            :GET,
            path,
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    # @return [Response] A Response object with data of type {OCI::OsManagementHub::Models::SoftwarePackageCollection SoftwarePackageCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/list_available_software_packages.rb.html) to see an example of how to use list_available_software_packages API.
    def list_available_software_packages(software_source_id, opts = {})
      logger.debug 'Calling operation SoftwareSourceClient#list_available_software_packages.' if logger

      raise "Missing the required parameter 'software_source_id' when calling list_available_software_packages." if software_source_id.nil?
      ...
      path = '/softwareSources/{softwareSourceId}/availableSoftwarePackages'.sub('{softwareSourceId}', software_source_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'SoftwareSourceClient#list_available_software_packages') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :csi A filter to return entitlements that match the given customer support identifier (CSI).
    ...
    # @option opts [Array<String>] :availability The availability of the software source in a non-OCI environment for a tenancy.
    #   Allowed values are: AVAILABLE, SELECTED, RESTRICTED, UNAVAILABLE
    # @option opts [Array<String>] :availability_at_oci The availability of the software source in an OCI environment for a tenancy.
    #   Allowed values are: AVAILABLE, SELECTED, RESTRICTED, UNAVAILABLE
    # @option opts [Array<String>] :availability_anywhere The availability of the software source. Use this query parameter to filter across availabilities in different environments.
    #   Allowed values are: AVAILABLE, SELECTED, RESTRICTED, UNAVAILABLE
    # @option opts [String] :display_name A filter to return resources that match the given user-friendly name.
    # @option opts [String] :display_name_contains A filter to return resources that may partially match the given display name.
    # @option opts [Integer] :limit For list pagination. The maximum number of results per page, or items to return in a paginated \"List\" call.
    ...
    def list_software_package_software_sources(software_package_name, compartment_id, opts = {})
      ...
      software_source_type_allowable_values = %w[VENDOR CUSTOM VERSIONED PRIVATE THIRD_PARTY]
      if opts[:software_source_type] && !opts[:software_source_type].empty?
        opts[:software_source_type].each do |val_to_check|
          unless software_source_type_allowable_values.include?(val_to_check)
            raise 'Invalid value for "software_source_type", must be one of VENDOR, CUSTOM, VERSIONED, PRIVATE, THIRD_PARTY.'
          end
        end
      end
    ...
    # @option opts [BOOLEAN] :is_mirror_sync_allowed A filter to return software sources which can be synced to a management station.
    # @option opts [String] :display_name A filter to return resources that match the given user-friendly name.
    # @option opts [String] :display_name_contains A filter to return resources that may partially match the given display name.
    ...
    def list_software_sources(opts = {})
      ...
      query_params[:isMirrorSyncAllowed] = opts[:is_mirror_sync_allowed] if !opts[:is_mirror_sync_allowed].nil?
      query_params[:displayName] = opts[:display_name] if opts[:display_name]
      query_params[:displayNameContains] = opts[:display_name_contains] if opts[:display_name_contains]
    ...
    #
    # @param [String] software_source_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the software source.
    # @param [OCI::OsManagementHub::Models::RemovePackagesFromSoftwareSourceDetails] remove_packages_from_software_source_details A list of packages to be removed from the software source.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/remove_packages_from_software_source.rb.html) to see an example of how to use remove_packages_from_software_source API.
    def remove_packages_from_software_source(software_source_id, remove_packages_from_software_source_details, opts = {})
      logger.debug 'Calling operation SoftwareSourceClient#remove_packages_from_software_source.' if logger
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'SoftwareSourceClient#remove_packages_from_software_source') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [String] software_source_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the software source.
    # @param [OCI::OsManagementHub::Models::ReplacePackagesInSoftwareSourceDetails] replace_packages_in_software_source_details A list of packages that will replace the existing packages in the software source.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/replace_packages_in_software_source.rb.html) to see an example of how to use replace_packages_in_software_source API.
    def replace_packages_in_software_source(software_source_id, replace_packages_in_software_source_details, opts = {})
      logger.debug 'Calling operation SoftwareSourceClient#replace_packages_in_software_source.' if logger

      raise "Missing the required parameter 'software_source_id' when calling replace_packages_in_software_source." if software_source_id.nil?
      raise "Missing the required parameter 'replace_packages_in_software_source_details' when calling replace_packages_in_software_source." if replace_packages_in_software_source_details.nil?
      raise "Parameter value for 'software_source_id' must not be blank" if OCI::Internal::Util.blank_string?(software_source_id)

      path = '/softwareSources/{softwareSourceId}/actions/replacePackages'.sub('{softwareSourceId}', software_source_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(replace_packages_in_software_source_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'SoftwareSourceClient#replace_packages_in_software_source') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/software_source_generate_metadata.rb.html) to see an example of how to use software_source_generate_metadata API.
    def software_source_generate_metadata(software_source_id, opts = {})
      logger.debug 'Calling operation SoftwareSourceClient#software_source_generate_metadata.' if logger

      raise "Missing the required parameter 'software_source_id' when calling software_source_generate_metadata." if software_source_id.nil?
      raise "Parameter value for 'software_source_id' must not be blank" if OCI::Internal::Util.blank_string?(software_source_id)

      path = '/softwareSources/{softwareSourceId}/actions/generateMetadata'.sub('{softwareSourceId}', software_source_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'SoftwareSourceClient#software_source_generate_metadata') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [String, IO] update_software_source_manifest_details Provides the document used to update the package list of the software source.
    # @param [String] software_source_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the software source.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #
    # @return [Response] A Response object with data of type {OCI::OsManagementHub::Models::SoftwareSource SoftwareSource}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/update_software_source_manifest.rb.html) to see an example of how to use update_software_source_manifest API.
    def update_software_source_manifest(update_software_source_manifest_details, software_source_id, opts = {})
      logger.debug 'Calling operation SoftwareSourceClient#update_software_source_manifest.' if logger

      raise "Missing the required parameter 'update_software_source_manifest_details' when calling update_software_source_manifest." if update_software_source_manifest_details.nil?
      raise "Missing the required parameter 'software_source_id' when calling update_software_source_manifest." if software_source_id.nil?
      raise "Parameter value for 'software_source_id' must not be blank" if OCI::Internal::Util.blank_string?(software_source_id)
      ...
      post_body = @api_client.object_to_http_body(update_software_source_manifest_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'SoftwareSourceClient#update_software_source_manifest') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
