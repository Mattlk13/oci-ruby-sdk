...
module OCI
  ...
  class OsManagementHub::OnboardingClient
    ...
    # @param [OCI::OsManagementHub::Models::AttachLifecycleStageToProfileDetails] attach_lifecycle_stage_to_profile_details The lifecycle stage [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to attach to the profile
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/attach_lifecycle_stage_to_profile.rb.html) to see an example of how to use attach_lifecycle_stage_to_profile API.
    def attach_lifecycle_stage_to_profile(profile_id, attach_lifecycle_stage_to_profile_details, opts = {})
      logger.debug 'Calling operation OnboardingClient#attach_lifecycle_stage_to_profile.' if logger

      raise "Missing the required parameter 'profile_id' when calling attach_lifecycle_stage_to_profile." if profile_id.nil?
      raise "Missing the required parameter 'attach_lifecycle_stage_to_profile_details' when calling attach_lifecycle_stage_to_profile." if attach_lifecycle_stage_to_profile_details.nil?
      raise "Parameter value for 'profile_id' must not be blank" if OCI::Internal::Util.blank_string?(profile_id)

      path = '/profiles/{profileId}/actions/attachLifecycleStage'.sub('{profileId}', profile_id.to_s)
      ...
      post_body = @api_client.object_to_http_body(attach_lifecycle_stage_to_profile_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'OnboardingClient#attach_lifecycle_stage_to_profile') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [String] profile_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the registration profile.
    # @param [OCI::OsManagementHub::Models::AttachManagedInstanceGroupToProfileDetails] attach_managed_instance_group_to_profile_details The managed instance group [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to attach to the profile
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/attach_managed_instance_group_to_profile.rb.html) to see an example of how to use attach_managed_instance_group_to_profile API.
    def attach_managed_instance_group_to_profile(profile_id, attach_managed_instance_group_to_profile_details, opts = {})
      logger.debug 'Calling operation OnboardingClient#attach_managed_instance_group_to_profile.' if logger

      raise "Missing the required parameter 'profile_id' when calling attach_managed_instance_group_to_profile." if profile_id.nil?
      raise "Missing the required parameter 'attach_managed_instance_group_to_profile_details' when calling attach_managed_instance_group_to_profile." if attach_managed_instance_group_to_profile_details.nil?
      raise "Parameter value for 'profile_id' must not be blank" if OCI::Internal::Util.blank_string?(profile_id)

      path = '/profiles/{profileId}/actions/attachManagedInstanceGroup'.sub('{profileId}', profile_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(attach_managed_instance_group_to_profile_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'OnboardingClient#attach_managed_instance_group_to_profile') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [String] profile_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the registration profile.
    # @param [OCI::OsManagementHub::Models::AttachManagementStationToProfileDetails] attach_management_station_to_profile_details The management station [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to attach to the profile
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/attach_management_station_to_profile.rb.html) to see an example of how to use attach_management_station_to_profile API.
    def attach_management_station_to_profile(profile_id, attach_management_station_to_profile_details, opts = {})
      logger.debug 'Calling operation OnboardingClient#attach_management_station_to_profile.' if logger

      raise "Missing the required parameter 'profile_id' when calling attach_management_station_to_profile." if profile_id.nil?
      raise "Missing the required parameter 'attach_management_station_to_profile_details' when calling attach_management_station_to_profile." if attach_management_station_to_profile_details.nil?
      raise "Parameter value for 'profile_id' must not be blank" if OCI::Internal::Util.blank_string?(profile_id)

      path = '/profiles/{profileId}/actions/attachManagementStation'.sub('{profileId}', profile_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(attach_management_station_to_profile_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'OnboardingClient#attach_management_station_to_profile') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [String] profile_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the registration profile.
    # @param [OCI::OsManagementHub::Models::AttachSoftwareSourcesToProfileDetails] attach_software_sources_to_profile_details The software source [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to attach to the profile
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/attach_software_sources_to_profile.rb.html) to see an example of how to use attach_software_sources_to_profile API.
    def attach_software_sources_to_profile(profile_id, attach_software_sources_to_profile_details, opts = {})
      logger.debug 'Calling operation OnboardingClient#attach_software_sources_to_profile.' if logger

      raise "Missing the required parameter 'profile_id' when calling attach_software_sources_to_profile." if profile_id.nil?
      raise "Missing the required parameter 'attach_software_sources_to_profile_details' when calling attach_software_sources_to_profile." if attach_software_sources_to_profile_details.nil?
      raise "Parameter value for 'profile_id' must not be blank" if OCI::Internal::Util.blank_string?(profile_id)

      path = '/profiles/{profileId}/actions/attachSoftwareSources'.sub('{profileId}', profile_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'OnboardingClient#attach_software_sources_to_profile') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [String] profile_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the registration profile.
    # @param [OCI::OsManagementHub::Models::DetachSoftwareSourcesFromProfileDetails] detach_software_sources_from_profile_details The software source [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to detach from the profile
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/detach_software_sources_from_profile.rb.html) to see an example of how to use detach_software_sources_from_profile API.
    def detach_software_sources_from_profile(profile_id, detach_software_sources_from_profile_details, opts = {})
      logger.debug 'Calling operation OnboardingClient#detach_software_sources_from_profile.' if logger

      raise "Missing the required parameter 'profile_id' when calling detach_software_sources_from_profile." if profile_id.nil?
      raise "Missing the required parameter 'detach_software_sources_from_profile_details' when calling detach_software_sources_from_profile." if detach_software_sources_from_profile_details.nil?
      raise "Parameter value for 'profile_id' must not be blank" if OCI::Internal::Util.blank_string?(profile_id)

      path = '/profiles/{profileId}/actions/detachSoftwareSources'.sub('{profileId}', profile_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'OnboardingClient#detach_software_sources_from_profile') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [String] profile_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the registration profile.
    # @param [String] profile_version The version of the registration profile.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    # @return [Response] A Response object with data of type {OCI::OsManagementHub::Models::ProfileVersion ProfileVersion}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/get_profile_version.rb.html) to see an example of how to use get_profile_version API.
    def get_profile_version(profile_id, profile_version, opts = {})
      logger.debug 'Calling operation OnboardingClient#get_profile_version.' if logger

      raise "Missing the required parameter 'profile_id' when calling get_profile_version." if profile_id.nil?
      raise "Missing the required parameter 'profile_version' when calling get_profile_version." if profile_version.nil?
      raise "Parameter value for 'profile_id' must not be blank" if OCI::Internal::Util.blank_string?(profile_id)
      raise "Parameter value for 'profile_version' must not be blank" if OCI::Internal::Util.blank_string?(profile_version)

      path = '/profiles/{profileId}/version/{profileVersion}'.sub('{profileId}', profile_id.to_s).sub('{profileVersion}', profile_version.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'OnboardingClient#get_profile_version') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::OsManagementHub::Models::ProfileVersion'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/list_profile_available_software_sources.rb.html) to see an example of how to use list_profile_available_software_sources API.
    def list_profile_available_software_sources(profile_id, opts = {})
      logger.debug 'Calling operation OnboardingClient#list_profile_available_software_sources.' if logger

      raise "Missing the required parameter 'profile_id' when calling list_profile_available_software_sources." if profile_id.nil?
      ...
      path = '/profiles/{profileId}/availableSoftwareSources'.sub('{profileId}', profile_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'OnboardingClient#list_profile_available_software_sources') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @option opts [BOOLEAN] :is_default_profile A filter to return only default profiles.
    #
    ...
    #   station [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    #
    # @option opts [String] :profile_version The version of the registration profile.
    ...
    def list_profiles(opts = {})
      ...
      query_params[:profileVersion] = opts[:profile_version] if opts[:profile_version]
