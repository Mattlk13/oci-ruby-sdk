...
require 'oci/os_management_hub/models/associate_managed_instances_with_management_station_details'
require 'oci/os_management_hub/models/attach_lifecycle_stage_to_profile_details'
require 'oci/os_management_hub/models/attach_managed_instance_group_to_profile_details'
...
require 'oci/os_management_hub/models/attach_management_station_to_profile_details'
...
require 'oci/os_management_hub/models/attach_software_sources_to_profile_details'
...
require 'oci/os_management_hub/models/create_private_software_source_details'
...
require 'oci/os_management_hub/models/create_third_party_software_source_details'
...
require 'oci/os_management_hub/models/create_windows_stand_alone_profile_details'
...
require 'oci/os_management_hub/models/detach_software_sources_from_profile_details'
...
require 'oci/os_management_hub/models/peer_management_station'
require 'oci/os_management_hub/models/private_software_source'
require 'oci/os_management_hub/models/private_software_source_summary'
...
require 'oci/os_management_hub/models/profile_version'
...
require 'oci/os_management_hub/models/reboot_event'
require 'oci/os_management_hub/models/reboot_event_data'
require 'oci/os_management_hub/models/reboot_lifecycle_stage_details'
require 'oci/os_management_hub/models/reboot_managed_instance_details'
require 'oci/os_management_hub/models/reboot_managed_instance_group_details'
...
require 'oci/os_management_hub/models/remove_packages_from_software_source_details'
require 'oci/os_management_hub/models/replace_packages_in_software_source_details'
require 'oci/os_management_hub/models/rerun_work_request_details'
...
require 'oci/os_management_hub/models/software_source_sub_type'
...
require 'oci/os_management_hub/models/sysadmin_event'
require 'oci/os_management_hub/models/sysadmin_event_data'
require 'oci/os_management_hub/models/system_details'
require 'oci/os_management_hub/models/target_resource_entity_type'
require 'oci/os_management_hub/models/third_party_software_source'
require 'oci/os_management_hub/models/third_party_software_source_summary'
...
require 'oci/os_management_hub/models/update_private_software_source_details'
...
require 'oci/os_management_hub/models/update_third_party_software_source_details'
...
require 'oci/os_management_hub/work_request_client_composite_operations'
