...
module OCI
  ...
  class OsManagementHub::Models::CreatePrivateSoftwareSourceDetails < OsManagementHub::Models::CreateSoftwareSourceDetails
    OS_FAMILY_ENUM = [
    ...
    # **[Required]** The OS family for the private software source.
    # @return [String]
    attr_reader :os_family

    # **[Required]** The architecture type supported by the private software source.
    # @return [String]
    attr_reader :arch_type

    # **[Required]** URL for the private software source.
    # @return [String]
    attr_accessor :url
