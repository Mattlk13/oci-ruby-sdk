...
module OCI
  ...
  class OsManagementHub::Models::CreateProfileDetails
    ...
    # **[Required]** A user-friendly name. Does not have to be unique and you can change the name later. Avoid entering
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::OsManagementHub::Models::CreateWindowsStandAloneProfileDetails' if type == 'WINDOWS_STANDALONE'
