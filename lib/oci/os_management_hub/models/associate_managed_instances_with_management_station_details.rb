...
module OCI
  ...
  class OsManagementHub::Models::AssociateManagedInstancesWithManagementStationDetails
    # **[Required]** List of managed instance [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to associate to the management station.
    # @return [Array<String>]
