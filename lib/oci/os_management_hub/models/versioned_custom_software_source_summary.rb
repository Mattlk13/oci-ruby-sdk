...
module OCI
  ...
  class OsManagementHub::Models::VersionedCustomSoftwareSourceSummary < OsManagementHub::Models::SoftwareSourceSummary
    ...
    def hash
      [id, compartment_id, display_name, repo_id, url, time_created, time_updated, description, software_source_type, availability, availability_at_oci, os_family, arch_type, package_count, lifecycle_state, size, freeform_tags, defined_tags, system_tags, vendor_software_sources, software_source_version, software_source_sub_type].hash
    end
