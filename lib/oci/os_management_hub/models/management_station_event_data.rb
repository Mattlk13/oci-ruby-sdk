...
module OCI
  ...
  class OsManagementHub::Models::ManagementStationEventData
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_SET_MANAGEMENT_STATION_HEALTH_STATE = 'SET_MANAGEMENT_STATION_HEALTH_STATE'.freeze,
    ...
    def hash
      [operation_type, health_state, status, additional_details].hash
    end
