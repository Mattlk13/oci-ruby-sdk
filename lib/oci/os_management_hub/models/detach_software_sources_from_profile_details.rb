...
module OCI
  ...
  class OsManagementHub::Models::DetachSoftwareSourcesFromProfileDetails
    # **[Required]** List of software source [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to detach from the profile.
    # @return [Array<String>]
