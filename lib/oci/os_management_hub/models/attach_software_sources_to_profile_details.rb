...
module OCI
  ...
  class OsManagementHub::Models::AttachSoftwareSourcesToProfileDetails
    # **[Required]** List of software source [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to attach to the profile.
    # @return [Array<String>]
