...
module OCI
  ...
  class OsManagementHub::Models::CreateSoftwareSourceDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::OsManagementHub::Models::CreatePrivateSoftwareSourceDetails' if type == 'PRIVATE'
      return 'OCI::OsManagementHub::Models::CreateVersionedCustomSoftwareSourceDetails' if type == 'VERSIONED'
      return 'OCI::OsManagementHub::Models::CreateThirdPartySoftwareSourceDetails' if type == 'THIRD_PARTY'
