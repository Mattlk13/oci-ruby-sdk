...
module OCI
  ...
  class OsManagementHub::Models::PackageSummary
    ...
    def package_classification=(package_classification)
      # rubocop:disable Style/ConditionalAssignment
      if package_classification && !PACKAGE_CLASSIFICATION_ENUM.include?(package_classification)
        OCI.logger.debug("Unknown value for 'package_classification' [" + package_classification + "]. Mapping to 'PACKAGE_CLASSIFICATION_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @package_classification = PACKAGE_CLASSIFICATION_UNKNOWN_ENUM_VALUE
      else
