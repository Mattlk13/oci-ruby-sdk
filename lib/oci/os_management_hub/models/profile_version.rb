...
module OCI
  ...
  class OsManagementHub::Models::ProfileVersion
    PROFILE_TYPE_ENUM = [
    ...
    # @option attributes [String] :profile_version The value to assign to the {#profile_version} property
    ...
    def initialize(attributes = {})
      ...
      self.profile_version = attributes[:'profileVersion'] if attributes[:'profileVersion']

      raise 'You cannot provide both :profileVersion and :profile_version' if attributes.key?(:'profileVersion') && attributes.key?(:'profile_version')

      self.profile_version = attributes[:'profile_version'] if attributes[:'profile_version']
    ...
    def hash
      [id, compartment_id, display_name, description, management_station_id, software_sources, managed_instance_group, lifecycle_environment, lifecycle_stage, profile_type, vendor_name, os_family, arch_type, time_created, time_modified, profile_version, lifecycle_state, registration_type, is_default_profile, is_service_provided_profile].hash
    end
