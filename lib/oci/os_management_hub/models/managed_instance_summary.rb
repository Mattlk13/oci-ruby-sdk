...
module OCI
  ...
  class OsManagementHub::Models::ManagedInstanceSummary
    ...
    def hash
      [id, display_name, description, tenancy_id, compartment_id, location, architecture, os_family, status, managed_instance_group, lifecycle_environment, lifecycle_stage, is_reboot_required, updates_available, is_management_station, notification_topic_id, autonomous_settings, is_managed_by_autonomous_linux, agent_version].hash
    end
