...
module OCI
  ...
  class OsManagementHub::Models::ManagementStation
    ...
    # @return [BOOLEAN]
    attr_accessor :is_auto_config_enabled

    # **[Required]** A list of other management stations that are behind the same load balancer within a high availability configuration. Stations are identified as peers if they have the same hostname and compartment.
    # @return [Array<OCI::OsManagementHub::Models::PeerManagementStation>]
    attr_accessor :peer_management_stations
    ...
    # @return [Integer]
    attr_accessor :mirror_storage_available_size

    # Total mirror storage size in bytes.
    # @return [Integer]
    attr_accessor :mirror_storage_size
    ...
    # @return [Integer]
    attr_accessor :mirror_unique_package_count

    # The total number of all packages within the mirrored software sources.
    # @return [Integer]
    attr_accessor :mirror_package_count
    ...
    def self.swagger_types
      {
        ...
        'is_auto_config_enabled': :'BOOLEAN',
        'peer_management_stations': :'Array<OCI::OsManagementHub::Models::PeerManagementStation>',
        'location': :'String',
        'mirror_storage_available_size': :'Integer',
        'mirror_storage_size': :'Integer',
        'mirror_size': :'Integer',
        'mirror_unique_package_count': :'Integer',
        'mirror_package_count': :'Integer',
    ...
    # @option attributes [BOOLEAN] :is_auto_config_enabled The value to assign to the {#is_auto_config_enabled} property
    # @option attributes [Array<OCI::OsManagementHub::Models::PeerManagementStation>] :peer_management_stations The value to assign to the {#peer_management_stations} property
    # @option attributes [String] :location The value to assign to the {#location} property
    # @option attributes [Integer] :mirror_storage_available_size The value to assign to the {#mirror_storage_available_size} property
    # @option attributes [Integer] :mirror_storage_size The value to assign to the {#mirror_storage_size} property
    # @option attributes [Integer] :mirror_size The value to assign to the {#mirror_size} property
    # @option attributes [Integer] :mirror_unique_package_count The value to assign to the {#mirror_unique_package_count} property
    # @option attributes [Integer] :mirror_package_count The value to assign to the {#mirror_package_count} property
    ...
    def initialize(attributes = {})
      ...
      self.is_auto_config_enabled = attributes[:'isAutoConfigEnabled'] unless attributes[:'isAutoConfigEnabled'].nil?

      raise 'You cannot provide both :isAutoConfigEnabled and :is_auto_config_enabled' if attributes.key?(:'isAutoConfigEnabled') && attributes.key?(:'is_auto_config_enabled')

      self.is_auto_config_enabled = attributes[:'is_auto_config_enabled'] unless attributes[:'is_auto_config_enabled'].nil?

      self.peer_management_stations = attributes[:'peerManagementStations'] if attributes[:'peerManagementStations']

      raise 'You cannot provide both :peerManagementStations and :peer_management_stations' if attributes.key?(:'peerManagementStations') && attributes.key?(:'peer_management_stations')

      self.peer_management_stations = attributes[:'peer_management_stations'] if attributes[:'peer_management_stations']

      self.location = attributes[:'location'] if attributes[:'location']

      self.mirror_storage_available_size = attributes[:'mirrorStorageAvailableSize'] if attributes[:'mirrorStorageAvailableSize']

      raise 'You cannot provide both :mirrorStorageAvailableSize and :mirror_storage_available_size' if attributes.key?(:'mirrorStorageAvailableSize') && attributes.key?(:'mirror_storage_available_size')

      self.mirror_storage_available_size = attributes[:'mirror_storage_available_size'] if attributes[:'mirror_storage_available_size']

      self.mirror_storage_size = attributes[:'mirrorStorageSize'] if attributes[:'mirrorStorageSize']

      raise 'You cannot provide both :mirrorStorageSize and :mirror_storage_size' if attributes.key?(:'mirrorStorageSize') && attributes.key?(:'mirror_storage_size')

      self.mirror_storage_size = attributes[:'mirror_storage_size'] if attributes[:'mirror_storage_size']

      self.mirror_size = attributes[:'mirrorSize'] if attributes[:'mirrorSize']

      raise 'You cannot provide both :mirrorSize and :mirror_size' if attributes.key?(:'mirrorSize') && attributes.key?(:'mirror_size')

      self.mirror_size = attributes[:'mirror_size'] if attributes[:'mirror_size']

      self.mirror_unique_package_count = attributes[:'mirrorUniquePackageCount'] if attributes[:'mirrorUniquePackageCount']

      raise 'You cannot provide both :mirrorUniquePackageCount and :mirror_unique_package_count' if attributes.key?(:'mirrorUniquePackageCount') && attributes.key?(:'mirror_unique_package_count')

      self.mirror_unique_package_count = attributes[:'mirror_unique_package_count'] if attributes[:'mirror_unique_package_count']

      self.mirror_package_count = attributes[:'mirrorPackageCount'] if attributes[:'mirrorPackageCount']

      raise 'You cannot provide both :mirrorPackageCount and :mirror_package_count' if attributes.key?(:'mirrorPackageCount') && attributes.key?(:'mirror_package_count')

      self.mirror_package_count = attributes[:'mirror_package_count'] if attributes[:'mirror_package_count']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_auto_config_enabled == other.is_auto_config_enabled &&
        peer_management_stations == other.peer_management_stations &&
        location == other.location &&
        mirror_storage_available_size == other.mirror_storage_available_size &&
        mirror_storage_size == other.mirror_storage_size &&
        mirror_size == other.mirror_size &&
        mirror_unique_package_count == other.mirror_unique_package_count &&
        mirror_package_count == other.mirror_package_count &&
    ...
    def hash
      [id, managed_instance_id, compartment_id, scheduled_job_id, profile_id, display_name, description, hostname, overall_state, overall_percentage, mirror_capacity, total_mirrors, mirror_sync_status, proxy, mirror, health, lifecycle_state, is_auto_config_enabled, peer_management_stations, location, mirror_storage_available_size, mirror_storage_size, mirror_size, mirror_unique_package_count, mirror_package_count, freeform_tags, defined_tags, system_tags].hash
    end
