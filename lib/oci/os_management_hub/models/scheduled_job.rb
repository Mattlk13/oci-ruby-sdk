...
module OCI
  ...
  class OsManagementHub::Models::ScheduledJob
    ...
    def hash
      [id, display_name, compartment_id, description, schedule_type, locations, time_next_execution, time_last_execution, recurring_rule, managed_instance_ids, managed_instance_group_ids, managed_compartment_ids, lifecycle_stage_ids, is_subcompartment_included, operations, work_request_ids, time_created, time_updated, lifecycle_state, is_managed_by_autonomous_linux, freeform_tags, defined_tags, system_tags, is_restricted, retry_intervals, work_request_id].hash
    end
