...
module OCI
  ...
  class OsManagementHub::Models::WorkRequestSummary
    ...
    def hash
      [operation_type, status, id, description, display_name, message, parent_id, children_id, compartment_id, percent_complete, time_created, time_scheduled, is_managed_by_autonomous_linux, reboot_timeout_in_mins].hash
    end
