...
module OCI
  ...
  class OsManagementHub::Models::CreateCustomSoftwareSourceDetails < OsManagementHub::Models::CreateSoftwareSourceDetails
    ...
    def software_source_sub_type=(software_source_sub_type)
      raise "Invalid value for 'software_source_sub_type': this must be one of the values in SOFTWARE_SOURCE_SUB_TYPE_ENUM." if software_source_sub_type && !SOFTWARE_SOURCE_SUB_TYPE_ENUM.include?(software_source_sub_type)
    ...
    def hash
      [compartment_id, display_name, description, software_source_type, freeform_tags, defined_tags, vendor_software_sources, custom_software_source_filter, is_automatically_updated, is_auto_resolve_dependencies, is_created_from_package_list, is_latest_content_only, packages, software_source_sub_type].hash
    end
