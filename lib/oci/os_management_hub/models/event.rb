...
module OCI
  ...
  class OsManagementHub::Models::Event
    TYPE_ENUM = [
      ...
      TYPE_SYSADMIN = 'SYSADMIN'.freeze,
      TYPE_REBOOT = 'REBOOT'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::OsManagementHub::Models::SysadminEvent' if type == 'SYSADMIN'
      return 'OCI::OsManagementHub::Models::RebootEvent' if type == 'REBOOT'
