...
module OCI
  ...
  class OsManagementHub::Models::ManagementStationSummary
    ...
    HEALTH_STATE_ENUM = [
      ...
      HEALTH_STATE_UNAVAILABLE = 'UNAVAILABLE'.freeze,
    ...
    def hash
      [id, managed_instance_id, compartment_id, profile_id, scheduled_job_id, time_next_execution, display_name, description, hostname, overall_state, health_state, overall_percentage, mirror_capacity, lifecycle_state, location, freeform_tags, defined_tags, system_tags].hash
    end
