...
module OCI
  ...
  class OsManagementHub::ManagedInstanceGroupClient
    ...
    #
    # @param [String] managed_instance_group_id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed instance group.
    # @param [OCI::OsManagementHub::Models::RebootManagedInstanceGroupDetails] reboot_managed_instance_group_details Provides the information used to reboot managed instances in a group.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/osmanagementhub/reboot_managed_instance_group.rb.html) to see an example of how to use reboot_managed_instance_group API.
    def reboot_managed_instance_group(managed_instance_group_id, reboot_managed_instance_group_details, opts = {})
      logger.debug 'Calling operation ManagedInstanceGroupClient#reboot_managed_instance_group.' if logger

      raise "Missing the required parameter 'managed_instance_group_id' when calling reboot_managed_instance_group." if managed_instance_group_id.nil?
      raise "Missing the required parameter 'reboot_managed_instance_group_details' when calling reboot_managed_instance_group." if reboot_managed_instance_group_details.nil?
      raise "Parameter value for 'managed_instance_group_id' must not be blank" if OCI::Internal::Util.blank_string?(managed_instance_group_id)

      path = '/managedInstanceGroups/{managedInstanceGroupId}/actions/reboot'.sub('{managedInstanceGroupId}', managed_instance_group_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(reboot_managed_instance_group_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'ManagedInstanceGroupClient#reboot_managed_instance_group') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
