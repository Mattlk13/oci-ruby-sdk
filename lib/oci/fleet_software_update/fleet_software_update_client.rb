...
module OCI
  ...
  class FleetSoftwareUpdate::FleetSoftwareUpdateClient
    ...
    #
    # @param [OCI::FleetSoftwareUpdate::Models::CreateFsuCycleDetails] create_fsu_cycle_details Details for the new Exadata Fleet Update Maintenance Cycle.
    ...
    # @param [String] fsu_collection_id Unique Exadata Fleet Update Collection identifier.
    #
    # @param [String] target_id Target resource OCID.
    #
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/fleetsoftwareupdate/delete_fsu_collection_target.rb.html) to see an example of how to use delete_fsu_collection_target API.
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    #
    # @return [Response] A Response object with data of type {OCI::FleetSoftwareUpdate::Models::FsuCollectionTarget FsuCollectionTarget}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/fleetsoftwareupdate/get_fsu_collection_target.rb.html) to see an example of how to use get_fsu_collection_target API.
