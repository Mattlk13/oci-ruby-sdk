...
module OCI
  ...
  class FleetSoftwareUpdate::FleetSoftwareUpdateClientCompositeOperations
    ...
    # Calls {OCI::FleetSoftwareUpdate::FleetSoftwareUpdateClient#delete_fsu_collection_target} and then waits for the {OCI::FleetSoftwareUpdate::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] fsu_collection_id Unique Exadata Fleet Update Collection identifier.
    #
    ...
    #
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::FleetSoftwareUpdate::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::FleetSoftwareUpdate::FleetSoftwareUpdateClient#delete_fsu_collection_target}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::FleetSoftwareUpdate::Models::WorkRequest}
    def delete_fsu_collection_target_and_wait_for_state(fsu_collection_id, target_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_fsu_collection_target(fsu_collection_id, target_id, base_operation_opts)
      use_util = OCI::FleetSoftwareUpdate::Util.respond_to?(:wait_on_work_request)
