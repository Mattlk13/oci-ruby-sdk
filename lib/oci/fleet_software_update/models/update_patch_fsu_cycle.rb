...
module OCI
  ...
  class FleetSoftwareUpdate::Models::UpdatePatchFsuCycle < FleetSoftwareUpdate::Models::UpdateFsuCycleDetails
    ...
    # @option attributes [OCI::FleetSoftwareUpdate::Models::DiagnosticsCollectionDetails] :diagnostics_collection The value to assign to the {OCI::FleetSoftwareUpdate::Models::UpdateFsuCycleDetails#diagnostics_collection #diagnostics_collection} proprety
    ...
    def hash
      [display_name, type, goal_version_details, batching_strategy, diagnostics_collection, freeform_tags, defined_tags, is_ignore_patches, is_ignore_missing_patches, max_drain_timeout_in_seconds, is_keep_placement].hash
    end
