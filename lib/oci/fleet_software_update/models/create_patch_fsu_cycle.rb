...
module OCI
  ...
  class FleetSoftwareUpdate::Models::CreatePatchFsuCycle < FleetSoftwareUpdate::Models::CreateFsuCycleDetails
    ...
    # @option attributes [OCI::FleetSoftwareUpdate::Models::DiagnosticsCollectionDetails] :diagnostics_collection The value to assign to the {OCI::FleetSoftwareUpdate::Models::CreateFsuCycleDetails#diagnostics_collection #diagnostics_collection} proprety
    ...
    def hash
      [display_name, compartment_id, type, fsu_collection_id, goal_version_details, batching_strategy, stage_action_schedule, apply_action_schedule, diagnostics_collection, freeform_tags, defined_tags, is_ignore_patches, is_ignore_missing_patches, max_drain_timeout_in_seconds, is_keep_placement].hash
    end
