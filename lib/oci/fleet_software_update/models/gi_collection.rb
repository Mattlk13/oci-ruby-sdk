...
module OCI
  ...
  class FleetSoftwareUpdate::Models::GiCollection < FleetSoftwareUpdate::Models::FsuCollection
    SOURCE_MAJOR_VERSION_ENUM = [
      ...
      SOURCE_MAJOR_VERSION_GI_23 = 'GI_23'.freeze,
    ...
    # @option attributes [String] :last_completed_fsu_cycle_id The value to assign to the {OCI::FleetSoftwareUpdate::Models::FsuCollection#last_completed_fsu_cycle_id #last_completed_fsu_cycle_id} proprety
    ...
    def hash
      [id, display_name, type, service_type, compartment_id, active_fsu_cycle, target_count, time_created, time_updated, lifecycle_state, lifecycle_details, last_completed_fsu_cycle_id, freeform_tags, defined_tags, system_tags, source_major_version, fleet_discovery].hash
    end
