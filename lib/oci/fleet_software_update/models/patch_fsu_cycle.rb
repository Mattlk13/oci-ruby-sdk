...
module OCI
  ...
  class FleetSoftwareUpdate::Models::PatchFsuCycle < FleetSoftwareUpdate::Models::FsuCycle
    ...
    # @option attributes [String] :last_completed_action_id The value to assign to the {OCI::FleetSoftwareUpdate::Models::FsuCycle#last_completed_action_id #last_completed_action_id} proprety
    # @option attributes [String] :rollback_cycle_state The value to assign to the {OCI::FleetSoftwareUpdate::Models::FsuCycle#rollback_cycle_state #rollback_cycle_state} proprety
    ...
    # @option attributes [OCI::FleetSoftwareUpdate::Models::DiagnosticsCollectionDetails] :diagnostics_collection The value to assign to the {OCI::FleetSoftwareUpdate::Models::FsuCycle#diagnostics_collection #diagnostics_collection} proprety
