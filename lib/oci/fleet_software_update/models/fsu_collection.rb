...
module OCI
  ...
  class FleetSoftwareUpdate::Models::FsuCollection
    ...
    #
    # @return [String]
    attr_accessor :last_completed_fsu_cycle_id
    ...
    def self.swagger_types
      {
        ...
        'last_completed_fsu_cycle_id': :'String',
    ...
    # @option attributes [String] :last_completed_fsu_cycle_id The value to assign to the {#last_completed_fsu_cycle_id} property
    ...
    def initialize(attributes = {})
      ...
      self.last_completed_fsu_cycle_id = attributes[:'lastCompletedFsuCycleId'] if attributes[:'lastCompletedFsuCycleId']

      raise 'You cannot provide both :lastCompletedFsuCycleId and :last_completed_fsu_cycle_id' if attributes.key?(:'lastCompletedFsuCycleId') && attributes.key?(:'last_completed_fsu_cycle_id')

      self.last_completed_fsu_cycle_id = attributes[:'last_completed_fsu_cycle_id'] if attributes[:'last_completed_fsu_cycle_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        last_completed_fsu_cycle_id == other.last_completed_fsu_cycle_id &&
    ...
    def hash
      [id, display_name, type, service_type, compartment_id, active_fsu_cycle, target_count, time_created, time_updated, lifecycle_state, lifecycle_details, last_completed_fsu_cycle_id, freeform_tags, defined_tags, system_tags].hash
    end
