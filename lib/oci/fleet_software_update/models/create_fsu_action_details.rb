...
module OCI
  ...
  class FleetSoftwareUpdate::Models::CreateFsuActionDetails
    TYPE_ENUM = [
      ...
      TYPE_ROLLBACK_MAINTENANCE_CYCLE = 'ROLLBACK_MAINTENANCE_CYCLE'.freeze
    ].freeze
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::FleetSoftwareUpdate::Models::CreateRollbackCycleApplyActionDetails' if type == 'ROLLBACK_MAINTENANCE_CYCLE'
