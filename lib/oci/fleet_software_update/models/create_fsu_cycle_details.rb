...
module OCI
  ...
  class FleetSoftwareUpdate::Models::CreateFsuCycleDetails
    ...
    def hash
      [display_name, compartment_id, type, fsu_collection_id, goal_version_details, batching_strategy, stage_action_schedule, apply_action_schedule, diagnostics_collection, freeform_tags, defined_tags].hash
    end
