...
module OCI
  ...
  class MarketplacePrivateOffer::Models::UpdateOfferDetails
    # Offers Identifier
    # @return [String]
    ...
    # @return [Array<OCI::MarketplacePrivateOffer::Models::CustomField>]
    ...
    # @option attributes [Array<OCI::MarketplacePrivateOffer::Models::CustomField>] :custom_fields The value to assign to the {#custom_fields} property
    ...
    def hash
      [display_name, buyer_compartment_id, description, internal_notes, time_start_date, duration, time_accept_by, pricing, buyer_information, seller_information, resource_bundles, custom_fields, freeform_tags, defined_tags].hash
    end
