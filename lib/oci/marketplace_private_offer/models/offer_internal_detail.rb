...
module OCI
  ...
  class MarketplacePrivateOffer::Models::OfferInternalDetail
    # **[Required]** A list of key value pairs specified by the seller
    # @return [Array<OCI::MarketplacePrivateOffer::Models::CustomField>]
    attr_accessor :custom_fields

    # **[Required]** Internal notes only intended for the Publisher of the Offer
    # @return [String]
    ...
    def hash
      [custom_fields, internal_notes].hash
    end
