...
module OCI
  ...
  class MarketplacePrivateOffer::Models::SellerInformation
    # @return [OCI::MarketplacePrivateOffer::Models::Contact]
    attr_accessor :primary_contact

    # the additional contacts associated with the seller
    # @return [Array<OCI::MarketplacePrivateOffer::Models::Contact>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'primary_contact': :'OCI::MarketplacePrivateOffer::Models::Contact',
        'additional_contacts': :'Array<OCI::MarketplacePrivateOffer::Models::Contact>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::MarketplacePrivateOffer::Models::Contact] :primary_contact The value to assign to the {#primary_contact} property
    # @option attributes [Array<OCI::MarketplacePrivateOffer::Models::Contact>] :additional_contacts The value to assign to the {#additional_contacts} property
    ...
    def hash
      [primary_contact, additional_contacts].hash
    end
