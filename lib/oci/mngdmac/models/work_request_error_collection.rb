...
module OCI
  ...
  class Mngdmac::Models::WorkRequestErrorCollection
    # **[Required]** A list of work request errors.
    # @return [Array<OCI::Mngdmac::Models::WorkRequestError>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Mngdmac::Models::WorkRequestError>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Mngdmac::Models::WorkRequestError>] :items The value to assign to the {#items} property
