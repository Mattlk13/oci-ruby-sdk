...
module OCI
  ...
  class Mngdmac::Models::CreateNodeConfigDetails
    ...
    def hash
      [serial_number, mac_address, mac_order_id, switch_hostname, switch_eth_port, ip_kvm_hostname, ip_kvm_port_number, pdu_hostname, pdu_port, build_vlan_id, build_ip_address, prod_vlan_id, prod_ip_address, rack_location, chip_set, os_version, tenancy_id].hash
    end
