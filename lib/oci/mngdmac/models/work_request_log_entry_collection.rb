...
module OCI
  ...
  class Mngdmac::Models::WorkRequestLogEntryCollection
    # **[Required]** A list of work request log entries.
    # @return [Array<OCI::Mngdmac::Models::WorkRequestLogEntry>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Mngdmac::Models::WorkRequestLogEntry>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Mngdmac::Models::WorkRequestLogEntry>] :items The value to assign to the {#items} property
