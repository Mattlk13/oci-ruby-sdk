...
module OCI
  ...
  class Mngdmac::Models::WorkRequestSummaryCollection
    # **[Required]** A list of work requests.
    # @return [Array<OCI::Mngdmac::Models::WorkRequestSummary>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Mngdmac::Models::WorkRequestSummary>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::Mngdmac::Models::WorkRequestSummary>] :items The value to assign to the {#items} property
