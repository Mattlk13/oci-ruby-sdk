...
module OCI
  ...
  class Mngdmac::Models::MacOrderSummary
    ...
    # **[Required]** The requested shape for Macs in this MacOrder.
    # @return [String]
    attr_accessor :shape
    ...
    # **[Required]** Enum indicating the agreed commitment term on the MacOrder.
    # @return [String]
    ...
    def hash
      [id, compartment_id, display_name, order_description, order_size, ip_range, is_docusigned, shape, time_created, time_updated, commitment_term, time_billing_started, time_billing_ended, order_status, lifecycle_state, lifecycle_details].hash
    end
