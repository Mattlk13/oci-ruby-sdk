...
module OCI
  ...
  class AnnouncementsService::AnnouncementClient
    ...
    #   a particular request, please provide the complete request ID.
    #
    # @return [Response] A Response object with data of type {OCI::AnnouncementsService::Models::AnnouncementCompartment AnnouncementCompartment}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/announcementsservice/get_announcement_compartment.rb.html) to see an example of how to use get_announcement_compartment API.
    def get_announcement_compartment(announcement_id, opts = {})
      logger.debug 'Calling operation AnnouncementClient#get_announcement_compartment.' if logger

      raise "Missing the required parameter 'announcement_id' when calling get_announcement_compartment." if announcement_id.nil?
      raise "Parameter value for 'announcement_id' must not be blank" if OCI::Internal::Util.blank_string?(announcement_id)

      path = '/announcements/{announcementId}/compartment'.sub('{announcementId}', announcement_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'AnnouncementClient#get_announcement_compartment') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::AnnouncementsService::Models::AnnouncementCompartment'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
