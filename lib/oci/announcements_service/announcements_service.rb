...
require 'oci/announcements_service/models/announcement_compartment'
...
require 'oci/announcements_service/models/base_service'
require 'oci/announcements_service/models/change_announcement_subscription_compartment_details'
require 'oci/announcements_service/models/comms_manager_name'
...
require 'oci/announcements_service/models/notifications_summary'
require 'oci/announcements_service/models/platform_type'
require 'oci/announcements_service/models/property'
require 'oci/announcements_service/models/service'
require 'oci/announcements_service/models/service_summary'
require 'oci/announcements_service/models/services_collection'
...
require 'oci/announcements_service/service_client'
