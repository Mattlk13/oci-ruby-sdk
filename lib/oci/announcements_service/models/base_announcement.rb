...
module OCI
  ...
  class AnnouncementsService::Models::BaseAnnouncement
    ...
    def time_one_type=(time_one_type)
      ...
      if time_one_type && !TIME_ONE_TYPE_ENUM.include?(time_one_type)
        OCI.logger.debug("Unknown value for 'time_one_type' [" + time_one_type + "]. Mapping to 'TIME_ONE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @time_one_type = TIME_ONE_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def time_two_type=(time_two_type)
      # rubocop:disable Style/ConditionalAssignment
      if time_two_type && !TIME_TWO_TYPE_ENUM.include?(time_two_type)
        OCI.logger.debug("Unknown value for 'time_two_type' [" + time_two_type + "]. Mapping to 'TIME_TWO_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @time_two_type = TIME_TWO_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def announcement_type=(announcement_type)
      # rubocop:disable Style/ConditionalAssignment
      if announcement_type && !ANNOUNCEMENT_TYPE_ENUM.include?(announcement_type)
        OCI.logger.debug("Unknown value for 'announcement_type' [" + announcement_type + "]. Mapping to 'ANNOUNCEMENT_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @announcement_type = ANNOUNCEMENT_TYPE_UNKNOWN_ENUM_VALUE
      else
