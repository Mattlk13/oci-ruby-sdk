...
module OCI
  ...
  class CapacityManagement::CapacityManagementClient
    ...
    # Create customer.
    # @param [OCI::CapacityManagement::Models::CreateOccCustomerDetails] create_occ_customer_details The request details for creating a customer.
    #
    ...
    #   underscore, and dash.
    #
    # @return [Response] A Response object with data of type {OCI::CapacityManagement::Models::OccCustomer OccCustomer}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/create_occ_customer.rb.html) to see an example of how to use create_occ_customer API.
    ...
    # @param [OCI::CapacityManagement::Models::CreateOccCustomerGroupDetails] create_occ_customer_group_details The request details for creating a customer group.
    #
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/create_occ_customer_group.rb.html) to see an example of how to use create_occ_customer_group API.
    ...
    # @param [String] occ_customer_group_id The OCID of the customer group.
    #
    # @param [String] occ_customer_id The tenancy id of the customer.
    #
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/delete_occ_customer.rb.html) to see an example of how to use delete_occ_customer API.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/delete_occ_customer_group.rb.html) to see an example of how to use delete_occ_customer_group API.
    ...
    #
    # @param [String] namespace The namespace by which we would filter the list.
    ...
    # @option opts [DateTime] :from The month corresponding to this date would be considered as the starting point of the time period against which we would like to perform an aggregation.
    # @option opts [DateTime] :to The month corresponding to this date would be considered as the ending point of the time period against which we would like to perform an aggregation.
    ...
    # @option opts [String] :sort_by The field to sort by. Only one sort order may be provided. The default order for periodValue is chronological order(latest month item at the end).
    #    (default to periodValue)
    #   Allowed values are: periodValue
    # @return [Response] A Response object with data of type {OCI::CapacityManagement::Models::OccOverviewCollection OccOverviewCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/list_internal_namespace_occ_overviews.rb.html) to see an example of how to use list_internal_namespace_occ_overviews API.
    ...
    #
    # @param [String] occ_handover_resource_block_id The OCID of the OccHandoverResource which is a required query parameter for listing OccHandoverResourceDetails.
    #
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :host_id This fiter is applicable only for COMPUTE namespace. It helps in fetching of all resource block details for which the hostId is equal to the one provided in this query param.
    #
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page A token representing the position at which to start retrieving results. This must come from `opc-next-page` header field of a previous response.
    # @option opts [String] :opc_request_id The client request ID for tracing. The only valid characters for request IDs are letters, numbers,
    ...
    #    (default to handoverDate)
    #   Allowed values are: handoverDate
    # @return [Response] A Response object with data of type {OCI::CapacityManagement::Models::OccHandoverResourceBlockDetailCollection OccHandoverResourceBlockDetailCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/list_internal_occ_handover_resource_block_details.rb.html) to see an example of how to use list_internal_occ_handover_resource_block_details API.
    ...
    #
    # @param [String] namespace The namespace enum value that needs to be passed as a required query parameter.
    #
    # @param [String] compartment_id The ocid of the compartment or tenancy in which resources are to be listed. This will also be used for authorization purposes.
    # @param [String] occ_customer_group_id The customer group ocid by which we would filter the list.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :handover_resource_name A filter to return only the list of resources that match the name provided in this filter.
    #
    # @option opts [DateTime] :handover_date_greater_than_or_equal_to This filter helps in fetching all handed over resources for which the recordDate is greater than or equal to the startDate.
    #
    # @option opts [DateTime] :handover_date_less_than_or_equal_to This filter helps in fetching all handed over resources for which the recordDate is less than or equal to the endDate.
    #
    # @option opts [String] :occ_handover_resource_block_id This filter helps in fetching the handed over resource for which the occHandoverResourceId is equal to the one provided here.
    #
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page A token representing the position at which to start retrieving results. This must come from `opc-next-page` header field of a previous response.
    # @option opts [String] :opc_request_id The client request ID for tracing. The only valid characters for request IDs are letters, numbers,
    ...
    #    (default to handoverDate)
    #   Allowed values are: handoverDate
    # @return [Response] A Response object with data of type {OCI::CapacityManagement::Models::OccHandoverResourceBlockCollection OccHandoverResourceBlockCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/list_internal_occ_handover_resource_blocks.rb.html) to see an example of how to use list_internal_occ_handover_resource_blocks API.
    ...
    # @option opts [String] :namespace The namespace by which we would filter the list.
    # @option opts [String] :request_type A filter to return only the resources that match the request type. The match is not case sensitive.
    # @option opts [String] :display_name A filter to return only the resources that match the entire display name. The match is not case sensitive.
    ...
    #   Allowed values are: handoverDate
    # @return [Response] A Response object with data of type {OCI::CapacityManagement::Models::OccHandoverResourceBlockDetailCollection OccHandoverResourceBlockDetailCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/list_occ_handover_resource_block_details.rb.html) to see an example of how to use list_occ_handover_resource_block_details API.
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :namespace The namespace by which we would filter the list.
    # @option opts [String] :compartment_id The OCID of the compartment or tenancy in which resources are to be listed.
    # @option opts [String] :handover_resource_name A filter to return only the list of resources that match the name provided in this filter.
    #
    # @option opts [DateTime] :handover_date_greater_than_or_equal_to This filter helps in fetching all handed over resources for which the recordDate is greater than or equal to the startDate.
    #
    ...
    #   Allowed values are: handoverDate
    # @return [Response] A Response object with data of type {OCI::CapacityManagement::Models::OccHandoverResourceBlockCollection OccHandoverResourceBlockCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/list_occ_handover_resource_blocks.rb.html) to see an example of how to use list_occ_handover_resource_blocks API.
    ...
    #   Allowed values are: periodValue
    # @return [Response] A Response object with data of type {OCI::CapacityManagement::Models::OccOverviewCollection OccOverviewCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/list_occ_overviews.rb.html) to see an example of how to use list_occ_overviews API.
    ...
    # @param [OCI::CapacityManagement::Models::PatchOccCapacityRequestDetails] patch_occ_capacity_request_details Request to update the details of the capacity request.
    # @param [String] occ_capacity_request_id The OCID of the capacity request.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    ...
    #
    # @return [Response] A Response object with data of type {OCI::CapacityManagement::Models::OccCapacityRequest OccCapacityRequest}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/patch_internal_occ_capacity_request.rb.html) to see an example of how to use patch_internal_occ_capacity_request API.
    ...
    # @param [OCI::CapacityManagement::Models::UpdateOccCustomerDetails] update_occ_customer_details Request to update the properties of the customer group.
    # @param [String] occ_customer_group_id The OCID of the customer group.
    #
    # @param [String] occ_customer_id The tenancy id of the customer.
    #
    ...
    #
    # @return [Response] A Response object with data of type {OCI::CapacityManagement::Models::OccCustomer OccCustomer}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/update_occ_customer.rb.html) to see an example of how to use update_occ_customer API.
    ...
    # @param [OCI::CapacityManagement::Models::UpdateOccCustomerGroupDetails] update_occ_customer_group_details Request to update the properties of the customer group.
    # @param [String] occ_customer_group_id The OCID of the customer group.
    #
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    ...
    #
    # @return [Response] A Response object with data of type {OCI::CapacityManagement::Models::OccCustomerGroup OccCustomerGroup}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/capacitymanagement/update_occ_customer_group.rb.html) to see an example of how to use update_occ_customer_group API.
