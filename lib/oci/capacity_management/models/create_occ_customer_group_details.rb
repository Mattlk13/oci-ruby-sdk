...
module OCI
  ...
  #
  class CapacityManagement::Models::CreateOccCustomerGroupDetails
    STATUS_ENUM = [
    ...
    # @return [Array<OCI::CapacityManagement::Models::CreateOccCustomerDetails>]
    ...
    # @option attributes [Array<OCI::CapacityManagement::Models::CreateOccCustomerDetails>] :customers_list The value to assign to the {#customers_list} property
    ...
    def hash
      [compartment_id, display_name, description, freeform_tags, defined_tags, lifecycle_details, status, customers_list].hash
    end
