...
module OCI
  ...
  #
  class CapacityManagement::Models::CreateInternalOccmDemandSignalDeliveryDetails
    ...
    def hash
      [compartment_id, occ_customer_group_id, demand_signal_id, demand_signal_item_id, accepted_quantity, justification, notes, freeform_tags, defined_tags].hash
    end
