...
module OCI
  ...
  #
  class CapacityManagement::Models::OccmDemandSignal
    LIFECYCLE_DETAILS_ENUM = [
      ...
      LIFECYCLE_DETAILS_REJECTED = 'REJECTED'.freeze,
    ...
    def hash
      [id, compartment_id, lifecycle_details, display_name, description, lifecycle_state, freeform_tags, defined_tags, system_tags, time_created, time_updated].hash
    end
