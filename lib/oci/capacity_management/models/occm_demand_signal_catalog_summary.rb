...
module OCI
  ...
  #
  class CapacityManagement::Models::OccmDemandSignalCatalogSummary
    # **[Required]** compartment id from where demand signal catalog is created.
    #
    # @return [String]
    ...
    # **[Required]** displayName of demand signal catalog.
    #
    # @return [String]
    ...
    # **[Required]** The current lifecycle state of the demand signal catalog.
    #
    # @return [String]
    ...
    # **[Required]** The time when the demand signal catalog was created.
    #
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** The time when the demand signal catalog was last updated.
    #
    # @return [DateTime]
    ...
    def hash
      [compartment_id, occ_customer_group_id, id, display_name, description, lifecycle_state, freeform_tags, defined_tags, system_tags, time_created, time_updated].hash
    end
