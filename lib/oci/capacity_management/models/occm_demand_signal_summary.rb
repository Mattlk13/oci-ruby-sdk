...
module OCI
  ...
  #
  class CapacityManagement::Models::OccmDemandSignalSummary
    ...
    def hash
      [id, compartment_id, display_name, lifecycle_details, description, lifecycle_state, freeform_tags, defined_tags, system_tags, time_created, time_updated].hash
    end
