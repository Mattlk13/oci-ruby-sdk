...
module OCI
  ...
  class CapacityManagement::Models::OccCapacityRequest
    ...
    REQUEST_TYPE_ENUM = [
      REQUEST_TYPE_NEW = 'NEW'.freeze,
      REQUEST_TYPE_TRANSFER = 'TRANSFER'.freeze,
    ...
    def initialize(attributes = {})
      ...
      self.request_type = "NEW" if request_type.nil? && !attributes.key?(:'requestType') # rubocop:disable Style/StringLiterals
      ...
      self.request_type = "NEW" if request_type.nil? && !attributes.key?(:'requestType') && !attributes.key?(:'request_type') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [id, compartment_id, occ_availability_catalog_id, display_name, description, namespace, occ_customer_group_id, request_type, region, availability_domain, date_expected_capacity_handover, request_state, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags, details].hash
    end
