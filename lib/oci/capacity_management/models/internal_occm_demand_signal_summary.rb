...
module OCI
  ...
  #
  class CapacityManagement::Models::InternalOccmDemandSignalSummary
    ...
    def hash
      [occ_customer_group_id, id, compartment_id, display_name, lifecycle_details, description, lifecycle_state, freeform_tags, defined_tags, system_tags, time_created, time_updated].hash
    end
