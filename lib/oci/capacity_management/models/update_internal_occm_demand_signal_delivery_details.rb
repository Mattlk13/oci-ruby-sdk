...
module OCI
  ...
  #
  class CapacityManagement::Models::UpdateInternalOccmDemandSignalDeliveryDetails
    ...
    def hash
      [accepted_quantity, lifecycle_details, time_delivered, justification, notes, freeform_tags, defined_tags].hash
    end
