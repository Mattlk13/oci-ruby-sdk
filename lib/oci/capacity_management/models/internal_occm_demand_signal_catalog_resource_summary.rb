...
module OCI
  ...
  #
  class CapacityManagement::Models::InternalOccmDemandSignalCatalogResourceSummary
    NAMESPACE_ENUM = [
    ...
    # **[Required]** The OCID of the tenancy from which the request to create the demand signal catalog was made.
    #
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** The OCID of the customerGroup.
    #
    # @return [String]
    attr_accessor :occ_customer_group_id

    # **[Required]** This OCID of the demand signal catalog
    #
    # @return [String]
    attr_accessor :occm_demand_signal_catalog_id
    ...
    # **[Required]** The current lifecycle state of the demand signal catalog resource.
    #
    # @return [String]
    ...
    # @option attributes [String] :occm_demand_signal_catalog_id The value to assign to the {#occm_demand_signal_catalog_id} property
    ...
    def initialize(attributes = {})
      ...
      self.occm_demand_signal_catalog_id = attributes[:'occmDemandSignalCatalogId'] if attributes[:'occmDemandSignalCatalogId']

      raise 'You cannot provide both :occmDemandSignalCatalogId and :occm_demand_signal_catalog_id' if attributes.key?(:'occmDemandSignalCatalogId') && attributes.key?(:'occm_demand_signal_catalog_id')

      self.occm_demand_signal_catalog_id = attributes[:'occm_demand_signal_catalog_id'] if attributes[:'occm_demand_signal_catalog_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        occm_demand_signal_catalog_id == other.occm_demand_signal_catalog_id &&
    ...
    def hash
      [id, compartment_id, occ_customer_group_id, occm_demand_signal_catalog_id, namespace, name, target_compartment_id, region, availability_domain, resource_properties, resource_property_constraints, lifecycle_state, freeform_tags, defined_tags, system_tags, time_created, time_updated].hash
    end
