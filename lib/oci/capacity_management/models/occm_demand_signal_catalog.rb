...
module OCI
  ...
  #
  class CapacityManagement::Models::OccmDemandSignalCatalog
    ...
    def hash
      [id, compartment_id, occ_customer_group_id, display_name, description, lifecycle_state, freeform_tags, defined_tags, system_tags, time_created, time_updated].hash
    end
