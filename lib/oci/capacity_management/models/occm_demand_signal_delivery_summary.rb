...
module OCI
  ...
  #
  class CapacityManagement::Models::OccmDemandSignalDeliverySummary
    ...
    def hash
      [id, compartment_id, demand_signal_id, demand_signal_item_id, accepted_quantity, lifecycle_state, lifecycle_details, justification, time_delivered, freeform_tags, defined_tags, system_tags].hash
    end
