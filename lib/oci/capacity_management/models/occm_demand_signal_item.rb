...
module OCI
  ...
  #
  class CapacityManagement::Models::OccmDemandSignalItem
    DEMAND_SIGNAL_NAMESPACE_ENUM = [
      DEMAND_SIGNAL_NAMESPACE_COMPUTE = 'COMPUTE'.freeze,
      DEMAND_SIGNAL_NAMESPACE_NETWORK = 'NETWORK'.freeze,
      DEMAND_SIGNAL_NAMESPACE_GPU = 'GPU'.freeze,
      DEMAND_SIGNAL_NAMESPACE_STORAGE = 'STORAGE'.freeze,
      DEMAND_SIGNAL_NAMESPACE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # **[Required]** The OCID of the demand signal item.
    #
    # @return [String]
    attr_accessor :id
    ...
    #
    # @return [String]
    attr_reader :demand_signal_namespace
    ...
    # @option attributes [String] :demand_signal_namespace The value to assign to the {#demand_signal_namespace} property
    ...
    def initialize(attributes = {})
      ...
      self.demand_signal_namespace = attributes[:'demandSignalNamespace'] if attributes[:'demandSignalNamespace']

      raise 'You cannot provide both :demandSignalNamespace and :demand_signal_namespace' if attributes.key?(:'demandSignalNamespace') && attributes.key?(:'demand_signal_namespace')

      self.demand_signal_namespace = attributes[:'demand_signal_namespace'] if attributes[:'demand_signal_namespace']
    ...
    # @param [Object] demand_signal_namespace Object to be assigned
    def demand_signal_namespace=(demand_signal_namespace)
      # rubocop:disable Style/ConditionalAssignment
      if demand_signal_namespace && !DEMAND_SIGNAL_NAMESPACE_ENUM.include?(demand_signal_namespace)
        OCI.logger.debug("Unknown value for 'demand_signal_namespace' [" + demand_signal_namespace + "]. Mapping to 'DEMAND_SIGNAL_NAMESPACE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @demand_signal_namespace = DEMAND_SIGNAL_NAMESPACE_UNKNOWN_ENUM_VALUE
      else
        @demand_signal_namespace = demand_signal_namespace
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        demand_signal_namespace == other.demand_signal_namespace &&
    ...
    def hash
      [id, compartment_id, demand_signal_id, demand_signal_namespace, demand_signal_catalog_resource_id, request_type, resource_name, region, availability_domain, target_compartment_id, demand_quantity, time_needed_before, resource_properties, notes, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
