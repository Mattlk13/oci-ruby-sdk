...
module OCI
  ...
  class CapacityManagement::Models::OccCapacityRequestSummary
    ...
    def hash
      [id, compartment_id, occ_availability_catalog_id, display_name, description, namespace, occ_customer_group_id, region, availability_domain, date_expected_capacity_handover, request_state, request_type, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
