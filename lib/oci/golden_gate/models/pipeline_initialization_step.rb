...
module OCI
  ...
  #
  class GoldenGate::Models::PipelineInitializationStep
    STATUS_ENUM = [
    ...
    # **[Required]** Status of the steps in a recipe. This option applies during pipeline initialization.
    #
    # @return [String]
    attr_reader :status

    # **[Required]** Shows the percentage complete of each recipe step during pipeline initialization.
    #
    # @return [Integer]
    ...
    # **[Required]** The date and time the request was finished. The format is defined by
    # [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
    #
    # @return [DateTime]
    ...
    #
    # @return [Array<OCI::GoldenGate::Models::StepMessage>]
    ...
    def self.swagger_types
      {
        ...
        'messages': :'Array<OCI::GoldenGate::Models::StepMessage>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::GoldenGate::Models::StepMessage>] :messages The value to assign to the {#messages} property
    ...
    def hash
      [name, status, percent_complete, time_started, time_finished, messages].hash
    end
