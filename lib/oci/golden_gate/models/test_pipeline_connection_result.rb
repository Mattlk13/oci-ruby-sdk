...
module OCI
  ...
  #
  class GoldenGate::Models::TestPipelineConnectionResult
    RESULT_TYPE_ENUM = [
    ...
    # **[Required]** Type of result, either Succeeded, Failed, or Timed out.
    #
    # @return [String]
    attr_reader :result_type

    # @return [OCI::GoldenGate::Models::TestPipelineConnectionError]
    attr_accessor :error
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'result_type': :'String',
        'error': :'OCI::GoldenGate::Models::TestPipelineConnectionError'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::GoldenGate::Models::TestPipelineConnectionError] :error The value to assign to the {#error} property
