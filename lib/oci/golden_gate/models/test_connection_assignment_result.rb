...
module OCI
  ...
  class GoldenGate::Models::TestConnectionAssignmentResult
    ...
    #
    # @return [Array<OCI::GoldenGate::Models::TestConnectionAssignmentError>]
    ...
    def self.swagger_types
      {
        ...
        'errors': :'Array<OCI::GoldenGate::Models::TestConnectionAssignmentError>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::GoldenGate::Models::TestConnectionAssignmentError>] :errors The value to assign to the {#errors} property
