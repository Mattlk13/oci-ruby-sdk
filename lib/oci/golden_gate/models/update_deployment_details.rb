...
module OCI
  ...
  class GoldenGate::Models::UpdateDeploymentDetails
    ...
    # @return [OCI::GoldenGate::Models::UpdateBackupScheduleDetails]
    ...
    def self.swagger_types
      {
        ...
        'backup_schedule': :'OCI::GoldenGate::Models::UpdateBackupScheduleDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::GoldenGate::Models::UpdateBackupScheduleDetails] :backup_schedule The value to assign to the {#backup_schedule} property
    ...
    def hash
      [display_name, license_model, environment_type, description, freeform_tags, defined_tags, nsg_ids, subnet_id, load_balancer_subnet_id, is_public, fqdn, cpu_core_count, is_auto_scaling_enabled, placements, ogg_data, maintenance_window, maintenance_configuration, backup_schedule].hash
    end
