...
module OCI
  ...
  #
  class GoldenGate::Models::GooglePubSubConnectionSummary < GoldenGate::Models::ConnectionSummary
    # **[Required]** The Google PubSub technology type.
    # @return [String]
    ...
    #
    # @return [String]
    attr_accessor :service_account_key_file_secret_id
    ...
    # @option attributes [String] :service_account_key_file_secret_id The value to assign to the {#service_account_key_file_secret_id} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['connectionType'] = 'GOOGLE_PUBSUB'
      ...
      self.service_account_key_file_secret_id = attributes[:'serviceAccountKeyFileSecretId'] if attributes[:'serviceAccountKeyFileSecretId']

      raise 'You cannot provide both :serviceAccountKeyFileSecretId and :service_account_key_file_secret_id' if attributes.key?(:'serviceAccountKeyFileSecretId') && attributes.key?(:'service_account_key_file_secret_id')

      self.service_account_key_file_secret_id = attributes[:'service_account_key_file_secret_id'] if attributes[:'service_account_key_file_secret_id']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        service_account_key_file_secret_id == other.service_account_key_file_secret_id
    end
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, locks, does_use_secret_ids, technology_type, service_account_key_file_secret_id].hash
    end
