...
module OCI
  ...
  class GoldenGate::Models::Pipeline
    RECIPE_TYPE_ENUM = [
    ...
    # @return [OCI::GoldenGate::Models::PipelineDiagnosticData]
    attr_accessor :pipeline_diagnostic_data
    ...
    # @option attributes [OCI::GoldenGate::Models::PipelineDiagnosticData] :pipeline_diagnostic_data The value to assign to the {#pipeline_diagnostic_data} property
