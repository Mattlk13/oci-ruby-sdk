...
module OCI
  ...
  class GoldenGate::Models::SnowflakeConnection < GoldenGate::Models::Connection
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, locks, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, does_use_secret_ids, technology_type, connection_url, authentication_type, username, password_secret_id, private_key_file_secret_id, private_key_passphrase_secret_id].hash
    end
