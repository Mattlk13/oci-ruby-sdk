...
module OCI
  ...
  class GoldenGate::Models::UpdateConnectionDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::UpdateMicrosoftFabricConnectionDetails' if type == 'MICROSOFT_FABRIC'
      ...
      return 'OCI::GoldenGate::Models::UpdateDatabricksConnectionDetails' if type == 'DATABRICKS'
      ...
      return 'OCI::GoldenGate::Models::UpdateGooglePubSubConnectionDetails' if type == 'GOOGLE_PUBSUB'
      ...
      return 'OCI::GoldenGate::Models::UpdateDb2ConnectionDetails' if type == 'DB2'
    ...
    def hash
      [connection_type, display_name, description, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, routing_method, does_use_secret_ids].hash
    end
