...
module OCI
  ...
  class GoldenGate::Models::CreateOggDeploymentDetails
    ...
    # @return [OCI::GoldenGate::Models::GroupToRolesMappingDetails]
    attr_accessor :group_to_roles_mapping
    ...
    def self.swagger_types
      {
        ...
        'key': :'String',
        'ogg_version': :'String',
        'group_to_roles_mapping': :'OCI::GoldenGate::Models::GroupToRolesMappingDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::GoldenGate::Models::GroupToRolesMappingDetails] :group_to_roles_mapping The value to assign to the {#group_to_roles_mapping} property
    def initialize(attributes = {})
      ...
      self.group_to_roles_mapping = attributes[:'groupToRolesMapping'] if attributes[:'groupToRolesMapping']

      raise 'You cannot provide both :groupToRolesMapping and :group_to_roles_mapping' if attributes.key?(:'groupToRolesMapping') && attributes.key?(:'group_to_roles_mapping')

      self.group_to_roles_mapping = attributes[:'group_to_roles_mapping'] if attributes[:'group_to_roles_mapping']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        group_to_roles_mapping == other.group_to_roles_mapping
    end
    ...
    def hash
      [deployment_name, credential_store, identity_domain_id, password_secret_id, admin_username, admin_password, certificate, key, ogg_version, group_to_roles_mapping].hash
    end
