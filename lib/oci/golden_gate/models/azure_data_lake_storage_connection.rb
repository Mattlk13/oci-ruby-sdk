...
module OCI
  ...
  class GoldenGate::Models::AzureDataLakeStorageConnection < GoldenGate::Models::Connection
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, locks, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, does_use_secret_ids, technology_type, authentication_type, account_name, azure_tenant_id, client_id, endpoint, account_key_secret_id, sas_token_secret_id, client_secret_secret_id].hash
    end
