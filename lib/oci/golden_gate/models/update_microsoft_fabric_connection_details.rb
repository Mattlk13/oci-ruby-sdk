...
module OCI
  ...
  #
  class GoldenGate::Models::UpdateMicrosoftFabricConnectionDetails < GoldenGate::Models::UpdateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, freeform_tags, defined_tags, vault_id, key_id, nsg_ids, subnet_id, routing_method, does_use_secret_ids, tenant_id, client_id, client_secret, client_secret_secret_id, endpoint].hash
    end
