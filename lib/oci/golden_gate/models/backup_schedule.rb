...
module OCI
  ...
  #
  class GoldenGate::Models::BackupSchedule
    FREQUENCY_BACKUP_SCHEDULED_ENUM = [
      ...
      FREQUENCY_BACKUP_SCHEDULED_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    def frequency_backup_scheduled=(frequency_backup_scheduled)
      ...
      if frequency_backup_scheduled && !FREQUENCY_BACKUP_SCHEDULED_ENUM.include?(frequency_backup_scheduled)
        OCI.logger.debug("Unknown value for 'frequency_backup_scheduled' [" + frequency_backup_scheduled + "]. Mapping to 'FREQUENCY_BACKUP_SCHEDULED_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @frequency_backup_scheduled = FREQUENCY_BACKUP_SCHEDULED_UNKNOWN_ENUM_VALUE
      else
