...
module OCI
  ...
  #
  class GoldenGate::Models::StepMessage
    SEVERITY_ENUM = [
    ...
    # **[Required]** The status message of the steps in a recipe during pipeline initialization.
    ...
    # **[Required]** Date and time of a message issued by steps in a recipe during pipeline initialization.
    # The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2024-07-25T21:10:29.600Z`.
    #
    # @return [DateTime]
    attr_accessor :timestamp

    # **[Required]** The severity returned when calling GoldenGate API messages for a step in a recipe during pipeline initialization.
    # https://docs.oracle.com/en/middleware/goldengate/core/23/oggra/rest-endpoints.html
    #
    # @return [String]
    ...
    def hash
      [message, code, timestamp, severity].hash
    end
