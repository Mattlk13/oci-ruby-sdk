...
require 'date'
require_relative 'test_pipeline_connection_details'
...
module OCI
  ...
  #
  class GoldenGate::Models::DefaultTestPipelineConnectionDetails < GoldenGate::Models::TestPipelineConnectionDetails
