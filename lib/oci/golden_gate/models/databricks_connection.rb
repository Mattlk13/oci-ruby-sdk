...
module OCI
  ...
  #
  class GoldenGate::Models::DatabricksConnection < GoldenGate::Models::Connection
    ...
    AUTHENTICATION_TYPE_ENUM = [
      AUTHENTICATION_TYPE_PERSONAL_ACCESS_TOKEN = 'PERSONAL_ACCESS_TOKEN'.freeze,
      AUTHENTICATION_TYPE_OAUTH_M2_M = 'OAUTH_M2M'.freeze,
    ...
    #
    # @return [String]
    attr_accessor :storage_credential_name
    ...
    # @option attributes [String] :storage_credential_name The value to assign to the {#storage_credential_name} property
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, locks, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, does_use_secret_ids, technology_type, authentication_type, connection_url, password_secret_id, client_id, client_secret_secret_id, storage_credential_name].hash
    end
