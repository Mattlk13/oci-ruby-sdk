...
module OCI
  ...
  class GoldenGate::Models::OracleConnection < GoldenGate::Models::Connection
    ...
    AUTHENTICATION_MODE_ENUM = [
      AUTHENTICATION_MODE_TLS = 'TLS'.freeze,
      AUTHENTICATION_MODE_MTLS = 'MTLS'.freeze,
      AUTHENTICATION_MODE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    #
    # @return [String]
    attr_reader :authentication_mode
    ...
    def authentication_mode=(authentication_mode)
      # rubocop:disable Style/ConditionalAssignment
      if authentication_mode && !AUTHENTICATION_MODE_ENUM.include?(authentication_mode)
        OCI.logger.debug("Unknown value for 'authentication_mode' [" + authentication_mode + "]. Mapping to 'AUTHENTICATION_MODE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @authentication_mode = AUTHENTICATION_MODE_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, locks, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, does_use_secret_ids, technology_type, username, connection_string, authentication_mode, session_mode, private_ip, database_id, password_secret_id, wallet_secret_id].hash
    end
