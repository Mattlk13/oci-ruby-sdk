...
module OCI
  ...
  class GoldenGate::Models::AzureDataLakeStorageConnectionSummary < GoldenGate::Models::ConnectionSummary
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, locks, does_use_secret_ids, technology_type, authentication_type, account_name, azure_tenant_id, client_id, endpoint, account_key_secret_id, sas_token_secret_id, client_secret_secret_id].hash
    end
