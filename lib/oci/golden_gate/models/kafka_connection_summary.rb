...
module OCI
  ...
  class GoldenGate::Models::KafkaConnectionSummary < GoldenGate::Models::ConnectionSummary
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, locks, does_use_secret_ids, technology_type, stream_pool_id, bootstrap_servers, security_protocol, username, password_secret_id, trust_store_secret_id, trust_store_password_secret_id, key_store_secret_id, key_store_password_secret_id, ssl_key_password_secret_id].hash
    end
