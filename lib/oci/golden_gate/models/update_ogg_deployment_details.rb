...
module OCI
  ...
  class GoldenGate::Models::UpdateOggDeploymentDetails
    ...
    # @return [OCI::GoldenGate::Models::UpdateGroupToRolesMappingDetails]
    ...
    def self.swagger_types
      {
        ...
        'certificate': :'String',
        'key': :'String',
        'group_to_roles_mapping': :'OCI::GoldenGate::Models::UpdateGroupToRolesMappingDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::GoldenGate::Models::UpdateGroupToRolesMappingDetails] :group_to_roles_mapping The value to assign to the {#group_to_roles_mapping} property
    ...
    def hash
      [credential_store, identity_domain_id, password_secret_id, admin_username, admin_password, certificate, key, group_to_roles_mapping].hash
    end
