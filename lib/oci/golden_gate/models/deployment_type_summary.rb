...
module OCI
  ...
  class GoldenGate::Models::DeploymentTypeSummary
    ...
    CONNECTION_TYPES_ENUM = [
      ...
      CONNECTION_TYPES_DB2 = 'DB2'.freeze,
      ...
      CONNECTION_TYPES_DATABRICKS = 'DATABRICKS'.freeze,
    ...
    SUPPORTED_CAPABILITIES_ENUM = [
      ...
      SUPPORTED_CAPABILITIES_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # @option attributes [Array<String>] :supported_capabilities The value to assign to the {#supported_capabilities} property
    def initialize(attributes = {})
      ...
      self.supported_capabilities = attributes[:'supportedCapabilities'] if attributes[:'supportedCapabilities']

      raise 'You cannot provide both :supportedCapabilities and :supported_capabilities' if attributes.key?(:'supportedCapabilities') && attributes.key?(:'supported_capabilities')

      self.supported_capabilities = attributes[:'supported_capabilities'] if attributes[:'supported_capabilities']
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] supported_capabilities Object to be assigned
    def supported_capabilities=(supported_capabilities)
      # rubocop:disable Style/ConditionalAssignment
      if supported_capabilities.nil?
        @supported_capabilities = nil
      else
        @supported_capabilities =
          supported_capabilities.collect do |item|
            if SUPPORTED_CAPABILITIES_ENUM.include?(item)
              item
            else
              OCI.logger.debug("Unknown value for 'supported_capabilities' [#{item}]. Mapping to 'SUPPORTED_CAPABILITIES_UNKNOWN_ENUM_VALUE'") if OCI.logger
              SUPPORTED_CAPABILITIES_UNKNOWN_ENUM_VALUE
            end
          end
      end
      # rubocop:enable Style/ConditionalAssignment
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        supported_capabilities == other.supported_capabilities
    end
    ...
    def hash
      [category, display_name, deployment_type, connection_types, source_technologies, target_technologies, ogg_version, supported_technologies_url, default_username, supported_capabilities].hash
    end
