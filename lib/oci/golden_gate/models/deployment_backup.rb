...
module OCI
  ...
  class GoldenGate::Models::DeploymentBackup
    ...
    #
    # @return [String]
    attr_reader :backup_source_type
    ...
    # @option attributes [String] :backup_source_type The value to assign to the {#backup_source_type} property
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] backup_source_type Object to be assigned
    def backup_source_type=(backup_source_type)
      # rubocop:disable Style/ConditionalAssignment
      if backup_source_type && !BACKUP_SOURCE_TYPE_ENUM.include?(backup_source_type)
        OCI.logger.debug("Unknown value for 'backup_source_type' [" + backup_source_type + "]. Mapping to 'BACKUP_SOURCE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @backup_source_type = BACKUP_SOURCE_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [id, deployment_id, deployment_type, compartment_id, display_name, is_automatic, backup_source_type, lifecycle_state, lifecycle_details, time_of_backup, time_backup_finished, size_in_bytes, backup_type, ogg_version, namespace_name, bucket_name, object_name, time_created, time_updated, freeform_tags, defined_tags, system_tags, is_metadata_only, locks].hash
    end
