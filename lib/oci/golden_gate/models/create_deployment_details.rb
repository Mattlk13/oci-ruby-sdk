...
module OCI
  ...
  class GoldenGate::Models::CreateDeploymentDetails
    ...
    #
    # @return [Array<OCI::GoldenGate::Models::DeploymentPlacementDetails>]
    ...
    # @return [OCI::GoldenGate::Models::CreateBackupScheduleDetails]
    ...
    def self.swagger_types
      {
        ...
        'fault_domain': :'String',
        'placements': :'Array<OCI::GoldenGate::Models::DeploymentPlacementDetails>',
        ...
        'backup_schedule': :'OCI::GoldenGate::Models::CreateBackupScheduleDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::GoldenGate::Models::DeploymentPlacementDetails>] :placements The value to assign to the {#placements} property
    ...
    # @option attributes [OCI::GoldenGate::Models::CreateBackupScheduleDetails] :backup_schedule The value to assign to the {#backup_schedule} property
    ...
    def hash
      [display_name, license_model, environment_type, description, compartment_id, source_deployment_id, availability_domain, fault_domain, placements, freeform_tags, defined_tags, locks, deployment_backup_id, subnet_id, load_balancer_subnet_id, fqdn, nsg_ids, is_public, cpu_core_count, is_auto_scaling_enabled, deployment_type, ogg_data, maintenance_window, maintenance_configuration, backup_schedule].hash
    end
