...
module OCI
  ...
  class GoldenGate::Models::UpdatePipelineDetails
    RECIPE_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::UpdateZeroEtlPipelineDetails' if type == 'ZERO_ETL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::GoldenGate::Models::UpdatePipelineDetails'
    end
    ...
    def hash
      [recipe_type, display_name, description, license_model, freeform_tags, defined_tags].hash
    end
