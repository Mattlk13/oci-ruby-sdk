...
module OCI
  ...
  class GoldenGate::Models::Connection
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::GoldenGate::Models::MicrosoftFabricConnection' if type == 'MICROSOFT_FABRIC'
      return 'OCI::GoldenGate::Models::DatabricksConnection' if type == 'DATABRICKS'
      ...
      return 'OCI::GoldenGate::Models::GooglePubSubConnection' if type == 'GOOGLE_PUBSUB'
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, locks, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, does_use_secret_ids].hash
    end
