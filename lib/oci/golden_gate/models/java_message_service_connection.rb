...
module OCI
  ...
  class GoldenGate::Models::JavaMessageServiceConnection < GoldenGate::Models::Connection
    ...
    #
    # @return [String]
    attr_accessor :jndi_security_credentials_secret_id
    ...
    # @option attributes [String] :jndi_security_credentials_secret_id The value to assign to the {#jndi_security_credentials_secret_id} property
    ...
    def initialize(attributes = {})
      ...
      self.jndi_security_credentials_secret_id = attributes[:'jndiSecurityCredentialsSecretId'] if attributes[:'jndiSecurityCredentialsSecretId']

      raise 'You cannot provide both :jndiSecurityCredentialsSecretId and :jndi_security_credentials_secret_id' if attributes.key?(:'jndiSecurityCredentialsSecretId') && attributes.key?(:'jndi_security_credentials_secret_id')

      self.jndi_security_credentials_secret_id = attributes[:'jndi_security_credentials_secret_id'] if attributes[:'jndi_security_credentials_secret_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        jndi_security_credentials_secret_id == other.jndi_security_credentials_secret_id &&
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, locks, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, does_use_secret_ids, technology_type, should_use_jndi, jndi_connection_factory, jndi_provider_url, jndi_initial_context_factory, jndi_security_principal, connection_url, connection_factory, security_protocol, authentication_type, username, private_ip, jndi_security_credentials_secret_id, password_secret_id, trust_store_secret_id, trust_store_password_secret_id, key_store_secret_id, key_store_password_secret_id, ssl_key_password_secret_id].hash
    end
