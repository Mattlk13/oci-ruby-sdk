...
module OCI
  ...
  #
  class GoldenGate::Models::PipelineRunningProcessSummary
    PROCESS_TYPE_ENUM = [
    ...
    #
    # @return [Float]
    attr_accessor :last_record_lag_in_seconds

    # **[Required]** The date and time the last record was processed by an Extract or Replicat. This option applies when retrieving running processes.
    # The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2024-07-25T21:10:29.600Z`.
    #
    # @return [DateTime]
    attr_accessor :time_last_processed
    ...
    # @option attributes [String] :process_type The value to assign to the {#process_type} property
    # @option attributes [String] :status The value to assign to the {#status} property
    # @option attributes [Float] :last_record_lag_in_seconds The value to assign to the {#last_record_lag_in_seconds} property
    # @option attributes [DateTime] :time_last_processed The value to assign to the {#time_last_processed} property
    ...
    def process_type=(process_type)
      ...
      if process_type && !PROCESS_TYPE_ENUM.include?(process_type)
        OCI.logger.debug("Unknown value for 'process_type' [" + process_type + "]. Mapping to 'PROCESS_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @process_type = PROCESS_TYPE_UNKNOWN_ENUM_VALUE
      else
