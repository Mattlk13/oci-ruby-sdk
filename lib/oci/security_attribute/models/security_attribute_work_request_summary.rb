...
module OCI
  ...
  #
  class SecurityAttribute::Models::SecurityAttributeWorkRequestSummary
    OPERATION_TYPE_ENUM = [
      OPERATION_TYPE_DELETE_SECURITY_ATTRIBUTE_DEFINITION = 'DELETE_SECURITY_ATTRIBUTE_DEFINITION'.freeze,
      OPERATION_TYPE_DELETE_NON_EMPTY_SECURITY_ATTRIBUTE_NAMESPACE = 'DELETE_NON_EMPTY_SECURITY_ATTRIBUTE_NAMESPACE'.freeze,
      OPERATION_TYPE_BULK_DELETE_SECURITY_ATTRIBUTES = 'BULK_DELETE_SECURITY_ATTRIBUTES'.freeze,
      OPERATION_TYPE_BULK_EDIT_OF_SECURITY_ATTRIBUTES = 'BULK_EDIT_OF_SECURITY_ATTRIBUTES'.freeze,
    ...
    #
    # @return [Array<OCI::SecurityAttribute::Models::WorkRequestResource>]
    ...
    def self.swagger_types
      {
        ...
        'status': :'String',
        'resources': :'Array<OCI::SecurityAttribute::Models::WorkRequestResource>',
    ...
    # @option attributes [Array<OCI::SecurityAttribute::Models::WorkRequestResource>] :resources The value to assign to the {#resources} property
