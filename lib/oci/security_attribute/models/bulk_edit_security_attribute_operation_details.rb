...
module OCI
  ...
  class SecurityAttribute::Models::BulkEditSecurityAttributeOperationDetails
    OPERATION_TYPE_ENUM = [
    ...
    # **[Required]** Security attributes for this resource. Each key is predefined and scoped to a namespace.
    ...
    def hash
      [operation_type, security_attributes].hash
    end
