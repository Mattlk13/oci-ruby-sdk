...
module OCI
  ...
  #
  class SecurityAttribute::Models::SecurityAttributeNamespaceSummary
    ...
    # @option attributes [Array<String>] :mode The value to assign to the {#mode} property
    ...
    def hash
      [id, compartment_id, name, description, freeform_tags, defined_tags, system_tags, is_retired, mode, lifecycle_state, time_created].hash
    end
