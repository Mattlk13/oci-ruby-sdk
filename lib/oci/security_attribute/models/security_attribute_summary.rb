...
module OCI
  ...
  #
  class SecurityAttribute::Models::SecurityAttributeSummary
    ...
    def hash
      [compartment_id, security_attribute_namespace_id, security_attribute_namespace_name, id, name, description, type, is_retired, lifecycle_state, time_created].hash
    end
