...
module OCI
  ...
  class SecurityAttribute::Models::BaseSecurityAttributeValidator
    VALIDATOR_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::SecurityAttribute::Models::EnumSecurityAttributeValidator' if type == 'ENUM'
      return 'OCI::SecurityAttribute::Models::DefaultSecurityAttributeValidator' if type == 'DEFAULT'

      # TODO: Log a warning when the subtype is not found.
      'OCI::SecurityAttribute::Models::BaseSecurityAttributeValidator'
    end
