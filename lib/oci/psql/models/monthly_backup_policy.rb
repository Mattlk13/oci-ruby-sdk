...
module OCI
  ...
  class Psql::Models::MonthlyBackupPolicy < Psql::Models::BackupPolicy
    ...
    # @option attributes [OCI::Psql::Models::BackupCopyPolicy] :copy_policy The value to assign to the {OCI::Psql::Models::BackupPolicy#copy_policy #copy_policy} proprety
    ...
    def hash
      [kind, retention_days, copy_policy, backup_start, days_of_the_month].hash
    end
