...
module OCI
  ...
  class Psql::Models::DefaultConfiguration
    ...
    def hash
      [id, display_name, description, time_created, lifecycle_state, lifecycle_details, db_version, shape, is_flexible, instance_ocpu_count, instance_memory_size_in_gbs, configuration_details].hash
    end
