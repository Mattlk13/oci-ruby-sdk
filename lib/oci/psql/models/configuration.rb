...
module OCI
  ...
  class Psql::Models::Configuration
    ...
    CONFIG_TYPE_ENUM = [
      CONFIG_TYPE_DEFAULT = 'DEFAULT'.freeze,
      CONFIG_TYPE_CUSTOM = 'CUSTOM'.freeze,
      CONFIG_TYPE_COPIED = 'COPIED'.freeze,
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, lifecycle_state, lifecycle_details, db_version, config_type, shape, is_flexible, instance_ocpu_count, instance_memory_size_in_gbs, configuration_details, freeform_tags, defined_tags, system_tags].hash
    end
