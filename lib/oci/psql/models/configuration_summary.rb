...
module OCI
  ...
  class Psql::Models::ConfigurationSummary
    ...
    def initialize(attributes = {})
      ...
      self.is_flexible = false if is_flexible.nil? && !attributes.key?(:'isFlexible') # rubocop:disable Style/StringLiterals
      ...
      self.is_flexible = false if is_flexible.nil? && !attributes.key?(:'isFlexible') && !attributes.key?(:'is_flexible') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [id, display_name, compartment_id, time_created, lifecycle_state, lifecycle_details, db_version, shape, is_flexible, instance_ocpu_count, instance_memory_size_in_gbs, freeform_tags, defined_tags, system_tags].hash
    end
