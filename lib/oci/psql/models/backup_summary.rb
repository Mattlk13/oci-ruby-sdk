...
module OCI
  ...
  class Psql::Models::BackupSummary
    ...
    def hash
      [id, display_name, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, source_type, time_created_precise, backup_size, db_system_id, retention_period, copy_status, freeform_tags, defined_tags, system_tags].hash
    end
