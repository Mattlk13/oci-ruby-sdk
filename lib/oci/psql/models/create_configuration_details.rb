...
module OCI
  ...
  class Psql::Models::CreateConfigurationDetails
    ...
    def hash
      [display_name, compartment_id, description, db_version, shape, is_flexible, instance_ocpu_count, instance_memory_size_in_gbs, db_configuration_overrides, freeform_tags, defined_tags, system_tags].hash
    end
