...
module OCI
  ...
  class Psql::Models::ConnectionDetails
    ...
    # @option attributes [OCI::Psql::Models::Endpoint] :reader_endpoint The value to assign to the {#reader_endpoint} property
    def initialize(attributes = {})
      ...
      self.reader_endpoint = attributes[:'readerEndpoint'] if attributes[:'readerEndpoint']

      raise 'You cannot provide both :readerEndpoint and :reader_endpoint' if attributes.key?(:'readerEndpoint') && attributes.key?(:'reader_endpoint')

      self.reader_endpoint = attributes[:'reader_endpoint'] if attributes[:'reader_endpoint']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        reader_endpoint == other.reader_endpoint
    end
    ...
    def hash
      [ca_certificate, primary_db_endpoint, instance_endpoints, reader_endpoint].hash
    end
