...
module OCI
  # Backup Copy details
  class Psql::Models::BackupCopyDetails
    # **[Required]** target compartment to place a new backup
    # @return [String]
    ...
    # **[Required]** List of region names of the remote region
    # @return [Array<String>]
    ...
    def hash
      [compartment_id, retention_period, regions].hash
    end
