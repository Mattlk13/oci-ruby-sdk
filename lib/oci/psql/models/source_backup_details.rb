...
module OCI
  ...
  class Psql::Models::SourceBackupDetails
    # **[Required]** Backup Region of the COPY source type.
    # @return [String]
    attr_accessor :source_region

    # **[Required]** Backup ID of the COPY source type.
    # @return [String]
    ...
    def hash
      [source_region, source_backup_id].hash
    end
