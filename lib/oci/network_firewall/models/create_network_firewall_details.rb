...
module OCI
  ...
  class NetworkFirewall::Models::CreateNetworkFirewallDetails
    ...
    # @return [OCI::NetworkFirewall::Models::NatConfigurationRequest]
    ...
    def self.swagger_types
      {
        ...
        'nat_configuration': :'OCI::NetworkFirewall::Models::NatConfigurationRequest',
    ...
    # @option attributes [OCI::NetworkFirewall::Models::NatConfigurationRequest] :nat_configuration The value to assign to the {#nat_configuration} property
    ...
    def hash
      [display_name, compartment_id, subnet_id, availability_domain, network_firewall_policy_id, ipv4_address, ipv6_address, network_security_group_ids, nat_configuration, freeform_tags, defined_tags].hash
    end
