...
module OCI
  ...
  class NetworkFirewall::Models::TunnelInspectionRuleSummary
    PROTOCOL_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::NetworkFirewall::Models::VxlanInspectionRuleSummary' if type == 'VXLAN'
    ...
    def hash
      [name, protocol, action, priority_order, parent_resource_id].hash
    end
