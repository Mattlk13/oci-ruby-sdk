...
module OCI
  ...
  class NetworkFirewall::Models::CreateTunnelInspectionRuleDetails
    ACTION_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::NetworkFirewall::Models::CreateVxlanInspectionRuleDetails' if type == 'VXLAN'
    ...
    def hash
      [name, action, protocol, position].hash
    end
