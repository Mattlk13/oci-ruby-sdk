...
module OCI
  ...
  class NetworkFirewall::Models::NetworkFirewall
    ...
    # @return [OCI::NetworkFirewall::Models::NatConfigurationResponse]
    attr_accessor :nat_configuration
    ...
    # @option attributes [OCI::NetworkFirewall::Models::NatConfigurationResponse] :nat_configuration The value to assign to the {#nat_configuration} property
    ...
    def hash
      [id, compartment_id, display_name, subnet_id, ipv4_address, ipv6_address, network_firewall_policy_id, availability_domain, nat_configuration, network_security_group_ids, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
