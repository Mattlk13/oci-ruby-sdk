...
module OCI
  ...
  class NetworkFirewall::Models::NatRuleSummary
    TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::NetworkFirewall::Models::NatV4NatSummary' if type == 'NATV4'
    ...
    def hash
      [name, type, description, priority_order, parent_resource_id].hash
    end
