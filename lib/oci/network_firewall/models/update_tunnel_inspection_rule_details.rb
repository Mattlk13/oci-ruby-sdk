...
module OCI
  ...
  class NetworkFirewall::Models::UpdateTunnelInspectionRuleDetails
    ACTION_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::NetworkFirewall::Models::UpdateVxlanInspectionRuleDetails' if type == 'VXLAN'
