...
require 'oci/network_firewall/models/create_nat_rule_details'
require 'oci/network_firewall/models/create_nat_v4_rule_details'
...
require 'oci/network_firewall/models/nat_configuration_request'
require 'oci/network_firewall/models/nat_configuration_response'
require 'oci/network_firewall/models/nat_rule'
require 'oci/network_firewall/models/nat_rule_collection'
require 'oci/network_firewall/models/nat_rule_match_criteria'
require 'oci/network_firewall/models/nat_rule_summary'
require 'oci/network_firewall/models/nat_type'
require 'oci/network_firewall/models/nat_v4_action_type'
require 'oci/network_firewall/models/nat_v4_nat_rule'
require 'oci/network_firewall/models/nat_v4_nat_summary'
...
require 'oci/network_firewall/models/update_nat_rule_details'
require 'oci/network_firewall/models/update_nat_v4_rule_details'
