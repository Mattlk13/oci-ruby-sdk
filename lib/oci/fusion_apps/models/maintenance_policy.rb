...
module OCI
  ...
  class FusionApps::Models::MaintenancePolicy
    ...
    def monthly_patching_override=(monthly_patching_override)
      ...
      if monthly_patching_override && !MONTHLY_PATCHING_OVERRIDE_ENUM.include?(monthly_patching_override)
        OCI.logger.debug("Unknown value for 'monthly_patching_override' [" + monthly_patching_override + "]. Mapping to 'MONTHLY_PATCHING_OVERRIDE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @monthly_patching_override = MONTHLY_PATCHING_OVERRIDE_UNKNOWN_ENUM_VALUE
      else
    ...
    def environment_maintenance_override=(environment_maintenance_override)
      # rubocop:disable Style/ConditionalAssignment
      if environment_maintenance_override && !ENVIRONMENT_MAINTENANCE_OVERRIDE_ENUM.include?(environment_maintenance_override)
        OCI.logger.debug("Unknown value for 'environment_maintenance_override' [" + environment_maintenance_override + "]. Mapping to 'ENVIRONMENT_MAINTENANCE_OVERRIDE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @environment_maintenance_override = ENVIRONMENT_MAINTENANCE_OVERRIDE_UNKNOWN_ENUM_VALUE
      else
