...
module OCI
  ...
  class FusionApps::Models::FusionEnvironment
    ...
    # @option attributes [BOOLEAN] :is_suspended The value to assign to the {#is_suspended} property
    def initialize(attributes = {})
      ...
      self.is_suspended = attributes[:'isSuspended'] unless attributes[:'isSuspended'].nil?
      self.is_suspended = false if is_suspended.nil? && !attributes.key?(:'isSuspended') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :isSuspended and :is_suspended' if attributes.key?(:'isSuspended') && attributes.key?(:'is_suspended')

      self.is_suspended = attributes[:'is_suspended'] unless attributes[:'is_suspended'].nil?
      self.is_suspended = false if is_suspended.nil? && !attributes.key?(:'isSuspended') && !attributes.key?(:'is_suspended') # rubocop:disable Style/StringLiterals
    end
