...
module OCI
  ...
  class DataSafe::DataSafeClientCompositeOperations
    ...
    # Calls {OCI::DataSafe::DataSafeClient#bulk_create_sensitive_types} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String, IO] bulk_create_sensitive_types_details Details to upload a sensitive types file and create all.
    # @param [String] opc_compartment_id A header param to create bulk resources in the specified compartment OCID.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#bulk_create_sensitive_types}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def bulk_create_sensitive_types_and_wait_for_state(bulk_create_sensitive_types_details, opc_compartment_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.bulk_create_sensitive_types(bulk_create_sensitive_types_details, opc_compartment_id, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#bulk_create_sql_firewall_allowed_sqls} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DataSafe::Models::BulkCreateSqlFirewallAllowedSqlsDetails] bulk_create_sql_firewall_allowed_sqls_details Details of the allowed sql.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#bulk_create_sql_firewall_allowed_sqls}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def bulk_create_sql_firewall_allowed_sqls_and_wait_for_state(bulk_create_sql_firewall_allowed_sqls_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.bulk_create_sql_firewall_allowed_sqls(bulk_create_sql_firewall_allowed_sqls_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#bulk_delete_sql_firewall_allowed_sqls} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DataSafe::Models::BulkDeleteSqlFirewallAllowedSqlsDetails] bulk_delete_sql_firewall_allowed_sqls_details Details of the allowed sql to be deleted from the SQL firewall policy.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#bulk_delete_sql_firewall_allowed_sqls}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def bulk_delete_sql_firewall_allowed_sqls_and_wait_for_state(bulk_delete_sql_firewall_allowed_sqls_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.bulk_delete_sql_firewall_allowed_sqls(bulk_delete_sql_firewall_allowed_sqls_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#change_alert_policy_compartment} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] alert_policy_id The OCID of the alert policy.
    # @param [OCI::DataSafe::Models::ChangeAlertPolicyCompartmentDetails] change_alert_policy_compartment_details The details used to change the compartment of an alert policy.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#change_alert_policy_compartment}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def change_alert_policy_compartment_and_wait_for_state(alert_policy_id, change_alert_policy_compartment_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.change_alert_policy_compartment(alert_policy_id, change_alert_policy_compartment_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#create_alert_policy} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DataSafe::Models::CreateAlertPolicyDetails] create_alert_policy_details The details used to create a new alert policy.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#create_alert_policy}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def create_alert_policy_and_wait_for_state(create_alert_policy_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_alert_policy(create_alert_policy_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#create_alert_policy_rule} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DataSafe::Models::CreateAlertPolicyRuleDetails] create_alert_policy_rule_details The details used to create a new alert policy rule.
    # @param [String] alert_policy_id The OCID of the alert policy.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#create_alert_policy_rule}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def create_alert_policy_rule_and_wait_for_state(create_alert_policy_rule_details, alert_policy_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_alert_policy_rule(create_alert_policy_rule_details, alert_policy_id, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#create_referential_relation} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] sensitive_data_model_id The OCID of the sensitive data model.
    # @param [OCI::DataSafe::Models::CreateReferentialRelationDetails] create_referential_relation_details Details to create a new referential relation.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#create_referential_relation}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def create_referential_relation_and_wait_for_state(sensitive_data_model_id, create_referential_relation_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_referential_relation(sensitive_data_model_id, create_referential_relation_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#create_sensitive_type_group} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DataSafe::Models::CreateSensitiveTypeGroupDetails] create_sensitive_type_group_details Details of the sensitive type group.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#create_sensitive_type_group}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def create_sensitive_type_group_and_wait_for_state(create_sensitive_type_group_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_sensitive_type_group(create_sensitive_type_group_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#create_sensitive_types_export} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DataSafe::Models::CreateSensitiveTypesExportDetails] create_sensitive_types_export_details Details to create a new sensitive types export resource.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#create_sensitive_types_export}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def create_sensitive_types_export_and_wait_for_state(create_sensitive_types_export_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.create_sensitive_types_export(create_sensitive_types_export_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#delete_alert_policy} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] alert_policy_id The OCID of the alert policy.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#delete_alert_policy}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def delete_alert_policy_and_wait_for_state(alert_policy_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_alert_policy(alert_policy_id, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#delete_alert_policy_rule} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] alert_policy_id The OCID of the alert policy.
    # @param [String] rule_key The key of the alert policy rule.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#delete_alert_policy_rule}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def delete_alert_policy_rule_and_wait_for_state(alert_policy_id, rule_key, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_alert_policy_rule(alert_policy_id, rule_key, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#delete_masking_report} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] masking_report_id The OCID of the masking report.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#delete_masking_report}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def delete_masking_report_and_wait_for_state(masking_report_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_masking_report(masking_report_id, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#delete_sensitive_type_group} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] sensitive_type_group_id The OCID of the sensitive type group.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#delete_sensitive_type_group}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def delete_sensitive_type_group_and_wait_for_state(sensitive_type_group_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_sensitive_type_group(sensitive_type_group_id, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#delete_sensitive_types_export} and then waits for the {OCI::DataSafe::Models::SensitiveTypesExport} acted upon
    # to enter the given state(s).
    #
    # @param [String] sensitive_types_export_id The OCID of the sensitive types export.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::SensitiveTypesExport#lifecycle_state}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#delete_sensitive_types_export}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object with data of type nil
    def delete_sensitive_types_export_and_wait_for_state(sensitive_types_export_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      initial_get_result = @service_client.get_sensitive_types_export(sensitive_types_export_id)
      operation_result = @service_client.delete_sensitive_types_export(sensitive_types_export_id, base_operation_opts)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#delete_sql_firewall_allowed_sql} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] sql_firewall_allowed_sql_id The OCID of the sqlFirewallAllowedSql resource.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#delete_sql_firewall_allowed_sql}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def delete_sql_firewall_allowed_sql_and_wait_for_state(sql_firewall_allowed_sql_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.delete_sql_firewall_allowed_sql(sql_firewall_allowed_sql_id, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#patch_grouped_sensitive_types} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] sensitive_type_group_id The OCID of the sensitive type group.
    # @param [OCI::DataSafe::Models::PatchGroupedSensitiveTypesDetails] patch_grouped_sensitive_types_details Details to patch sensitive type ids in a SensitiveTypeGroup.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#patch_grouped_sensitive_types}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def patch_grouped_sensitive_types_and_wait_for_state(sensitive_type_group_id, patch_grouped_sensitive_types_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.patch_grouped_sensitive_types(sensitive_type_group_id, patch_grouped_sensitive_types_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#patch_sql_firewall_allowed_sql} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [OCI::DataSafe::Models::PatchSqlFirewallAllowedSqlDetails] patch_sql_firewall_allowed_sql_details The details used to patch the allowed sqls.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#patch_sql_firewall_allowed_sql}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def patch_sql_firewall_allowed_sql_and_wait_for_state(patch_sql_firewall_allowed_sql_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.patch_sql_firewall_allowed_sql(patch_sql_firewall_allowed_sql_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#update_alert_policy} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] alert_policy_id The OCID of the alert policy.
    # @param [OCI::DataSafe::Models::UpdateAlertPolicyDetails] update_alert_policy_details The details used to update the alert policy.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#update_alert_policy}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def update_alert_policy_and_wait_for_state(alert_policy_id, update_alert_policy_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_alert_policy(alert_policy_id, update_alert_policy_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#update_alert_policy_rule} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] alert_policy_id The OCID of the alert policy.
    # @param [String] rule_key The key of the alert policy rule.
    # @param [OCI::DataSafe::Models::UpdateAlertPolicyRuleDetails] update_alert_policy_rule_details The details used to update the alert policy rule.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#update_alert_policy_rule}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def update_alert_policy_rule_and_wait_for_state(alert_policy_id, rule_key, update_alert_policy_rule_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_alert_policy_rule(alert_policy_id, rule_key, update_alert_policy_rule_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#update_sensitive_type_group} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] sensitive_type_group_id The OCID of the sensitive type group.
    # @param [OCI::DataSafe::Models::UpdateSensitiveTypeGroupDetails] update_sensitive_type_group_details Details used to update the sensitive type group.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#update_sensitive_type_group}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def update_sensitive_type_group_and_wait_for_state(sensitive_type_group_id, update_sensitive_type_group_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_sensitive_type_group(sensitive_type_group_id, update_sensitive_type_group_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
    ...
    # Calls {OCI::DataSafe::DataSafeClient#update_sensitive_types_export} and then waits for the {OCI::DataSafe::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] sensitive_types_export_id The OCID of the sensitive types export.
    # @param [OCI::DataSafe::Models::UpdateSensitiveTypesExportDetails] update_sensitive_types_export_details Details to update a sensitive type.
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::DataSafe::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::DataSafe::DataSafeClient#update_sensitive_types_export}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::DataSafe::Models::WorkRequest}
    def update_sensitive_types_export_and_wait_for_state(sensitive_types_export_id, update_sensitive_types_export_details, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.update_sensitive_types_export(sensitive_types_export_id, update_sensitive_types_export_details, base_operation_opts)
      use_util = OCI::DataSafe::Util.respond_to?(:wait_on_work_request)
