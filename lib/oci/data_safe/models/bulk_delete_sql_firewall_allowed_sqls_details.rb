...
module OCI
  ...
  class DataSafe::Models::BulkDeleteSqlFirewallAllowedSqlsDetails
    # **[Required]** The OCID of the SQL firewall policy whose allowed SQLs needs to be deleted.
    # @return [String]
    attr_accessor :sql_firewall_policy_id

    # This attribute is required.
    # @return [OCI::DataSafe::Models::SelectionDetails]
    ...
    # @option attributes [OCI::DataSafe::Models::SelectionDetails] :selection The value to assign to the {#selection} property
    ...
    def hash
      [sql_firewall_policy_id, selection].hash
    end
