...
module OCI
  ...
  class DataSafe::Models::Alert
    ...
    def hash
      [id, status, severity, display_name, description, operation_time, operation, operation_status, target_ids, target_names, policy_id, alert_type, resource_name, feature_details, comment, compartment_id, lifecycle_state, time_created, time_updated, alert_policy_rule_key, alert_policy_rule_name, freeform_tags, defined_tags, system_tags].hash
    end
