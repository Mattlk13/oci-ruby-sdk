...
module OCI
  ...
  class DataSafe::Models::CreateUserAssessmentDetails
    ...
    # @return [BOOLEAN]
    attr_accessor :is_assessment_scheduled
    ...
    # @option attributes [BOOLEAN] :is_assessment_scheduled The value to assign to the {#is_assessment_scheduled} property
    ...
    def initialize(attributes = {})
      ...
      self.is_assessment_scheduled = attributes[:'isAssessmentScheduled'] unless attributes[:'isAssessmentScheduled'].nil?

      raise 'You cannot provide both :isAssessmentScheduled and :is_assessment_scheduled' if attributes.key?(:'isAssessmentScheduled') && attributes.key?(:'is_assessment_scheduled')

      self.is_assessment_scheduled = attributes[:'is_assessment_scheduled'] unless attributes[:'is_assessment_scheduled'].nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_assessment_scheduled == other.is_assessment_scheduled &&
    ...
    def hash
      [compartment_id, description, display_name, is_assessment_scheduled, schedule, target_id, freeform_tags, defined_tags].hash
    end
