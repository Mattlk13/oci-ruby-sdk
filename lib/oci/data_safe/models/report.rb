...
module OCI
  ...
  class DataSafe::Models::Report
    ...
    def hash
      [id, display_name, report_definition_id, description, compartment_id, mime_type, time_generated, lifecycle_state, type, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
