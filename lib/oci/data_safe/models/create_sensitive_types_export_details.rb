...
module OCI
  ...
  # sensitive types.
  #
  class DataSafe::Models::CreateSensitiveTypesExportDetails
    ...
    # **[Required]** The OCID of the compartment where the sensitive types export should be created.
    # @return [String]
    ...
    def hash
      [display_name, description, compartment_id, sensitive_type_ids_for_export, is_include_all_sensitive_types, freeform_tags, defined_tags].hash
    end
