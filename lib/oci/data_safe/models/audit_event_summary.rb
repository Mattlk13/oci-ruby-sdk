...
module OCI
  ...
  class DataSafe::Models::AuditEventSummary
    ...
    # @option attributes [String] :application_contexts The value to assign to the {#application_contexts} property
    # @option attributes [String] :fga_policy_name The value to assign to the {#fga_policy_name} property
    ...
    def initialize(attributes = {})
      ...
      self.application_contexts = attributes[:'applicationContexts'] if attributes[:'applicationContexts']

      raise 'You cannot provide both :applicationContexts and :application_contexts' if attributes.key?(:'applicationContexts') && attributes.key?(:'application_contexts')

      self.application_contexts = attributes[:'application_contexts'] if attributes[:'application_contexts']

      self.fga_policy_name = attributes[:'fgaPolicyName'] if attributes[:'fgaPolicyName']

      raise 'You cannot provide both :fgaPolicyName and :fga_policy_name' if attributes.key?(:'fgaPolicyName') && attributes.key?(:'fga_policy_name')

      self.fga_policy_name = attributes[:'fga_policy_name'] if attributes[:'fga_policy_name']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        application_contexts == other.application_contexts &&
        fga_policy_name == other.fga_policy_name &&
