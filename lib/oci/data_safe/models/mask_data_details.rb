...
module OCI
  ...
  class DataSafe::Models::MaskDataDetails
    RE_RUN_FROM_STEP_ENUM = [
      RE_RUN_FROM_STEP_PRE_MASKING_SCRIPT = 'PRE_MASKING_SCRIPT'.freeze,
      RE_RUN_FROM_STEP_POST_MASKING_SCRIPT = 'POST_MASKING_SCRIPT'.freeze
    ].freeze
    ...
    # @option attributes [String] :re_run_from_step The value to assign to the {#re_run_from_step} property
    ...
    def initialize(attributes = {})
      ...
      self.re_run_from_step = attributes[:'reRunFromStep'] if attributes[:'reRunFromStep']

      raise 'You cannot provide both :reRunFromStep and :re_run_from_step' if attributes.key?(:'reRunFromStep') && attributes.key?(:'re_run_from_step')

      self.re_run_from_step = attributes[:'re_run_from_step'] if attributes[:'re_run_from_step']
    ...
    # @param [Object] re_run_from_step Object to be assigned
    def re_run_from_step=(re_run_from_step)
      raise "Invalid value for 're_run_from_step': this must be one of the values in RE_RUN_FROM_STEP_ENUM." if re_run_from_step && !RE_RUN_FROM_STEP_ENUM.include?(re_run_from_step)

      @re_run_from_step = re_run_from_step
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        re_run_from_step == other.re_run_from_step &&
    ...
    def hash
      [target_id, is_decrypt, is_rerun, re_run_from_step, tablespace, is_ignore_errors_enabled, seed, is_move_interim_tables_enabled, is_execute_saved_script_enabled, is_drop_temp_tables_enabled, is_redo_logging_enabled, is_refresh_stats_enabled, parallel_degree, recompile].hash
    end
