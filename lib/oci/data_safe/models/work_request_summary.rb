...
module OCI
  ...
  class DataSafe::Models::WorkRequestSummary
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_DELETE_SQL_FIREWALL_ALLOWED_SQL = 'DELETE_SQL_FIREWALL_ALLOWED_SQL'.freeze,
      OPERATION_TYPE_BULK_CREATE_SQL_FIREWALL_ALLOWED_SQL = 'BULK_CREATE_SQL_FIREWALL_ALLOWED_SQL'.freeze,
      OPERATION_TYPE_BULK_DELETE_SQL_FIREWALL_ALLOWED_SQL = 'BULK_DELETE_SQL_FIREWALL_ALLOWED_SQL'.freeze,
      ...
      OPERATION_TYPE_CREATE_ARCHIVAL = 'CREATE_ARCHIVAL'.freeze,
      ...
      OPERATION_TYPE_MASK_POLICY_DELETE_HEALTH_REPORT = 'MASK_POLICY_DELETE_HEALTH_REPORT'.freeze,
      OPERATION_TYPE_CREATE_SENSITIVE_TYPES_EXPORT = 'CREATE_SENSITIVE_TYPES_EXPORT'.freeze,
      OPERATION_TYPE_UPDATE_SENSITIVE_TYPES_EXPORT = 'UPDATE_SENSITIVE_TYPES_EXPORT'.freeze,
      OPERATION_TYPE_BULK_CREATE_SENSITIVE_TYPES = 'BULK_CREATE_SENSITIVE_TYPES'.freeze,
      ...
      OPERATION_TYPE_CREATE_ALERT_POLICY = 'CREATE_ALERT_POLICY'.freeze,
      OPERATION_TYPE_UPDATE_ALERT_POLICY = 'UPDATE_ALERT_POLICY'.freeze,
      OPERATION_TYPE_DELETE_ALERT_POLICY = 'DELETE_ALERT_POLICY'.freeze,
      OPERATION_TYPE_CREATE_ALERT_POLICY_RULE = 'CREATE_ALERT_POLICY_RULE'.freeze,
      OPERATION_TYPE_UPDATE_ALERT_POLICY_RULE = 'UPDATE_ALERT_POLICY_RULE'.freeze,
      OPERATION_TYPE_DELETE_ALERT_POLICY_RULE = 'DELETE_ALERT_POLICY_RULE'.freeze,
      OPERATION_TYPE_CHANGE_ALERT_POLICY_COMPARTMENT = 'CHANGE_ALERT_POLICY_COMPARTMENT'.freeze,
