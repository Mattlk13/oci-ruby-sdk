...
module OCI
  ...
  #
  class DataSafe::Models::MaskingPolicyReferentialRelationSummary
    RELATION_TYPE_ENUM = [
    ...
    # **[Required]** The type of referential relationship the column has with its parent. DB_DEFINED indicates that the relationship is defined in the database
    ...
    # @return [OCI::DataSafe::Models::MaskingPolicyColumnsInfo]
    ...
    # @option attributes [OCI::DataSafe::Models::MaskingPolicyColumnsInfo] :parent The value to assign to the {#parent} property
    # @option attributes [OCI::DataSafe::Models::MaskingPolicyColumnsInfo] :child The value to assign to the {#child} property
    # @option attributes [Array<String>] :masking_format The value to assign to the {#masking_format} property
