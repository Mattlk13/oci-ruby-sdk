...
module OCI
  ...
  class DataSafe::Models::AlertSummary
    ...
    # @return [String]
    attr_accessor :alert_policy_rule_key

    # The display name of the rule of alert policy that triggered alert.
    # @return [String]
    attr_accessor :alert_policy_rule_name
    ...
    # @option attributes [String] :alert_policy_rule_key The value to assign to the {#alert_policy_rule_key} property
    # @option attributes [String] :alert_policy_rule_name The value to assign to the {#alert_policy_rule_name} property
    ...
    def initialize(attributes = {})
      ...
      self.alert_policy_rule_key = attributes[:'alertPolicyRuleKey'] if attributes[:'alertPolicyRuleKey']

      raise 'You cannot provide both :alertPolicyRuleKey and :alert_policy_rule_key' if attributes.key?(:'alertPolicyRuleKey') && attributes.key?(:'alert_policy_rule_key')

      self.alert_policy_rule_key = attributes[:'alert_policy_rule_key'] if attributes[:'alert_policy_rule_key']

      self.alert_policy_rule_name = attributes[:'alertPolicyRuleName'] if attributes[:'alertPolicyRuleName']

      raise 'You cannot provide both :alertPolicyRuleName and :alert_policy_rule_name' if attributes.key?(:'alertPolicyRuleName') && attributes.key?(:'alert_policy_rule_name')

      self.alert_policy_rule_name = attributes[:'alert_policy_rule_name'] if attributes[:'alert_policy_rule_name']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        alert_policy_rule_key == other.alert_policy_rule_key &&
        alert_policy_rule_name == other.alert_policy_rule_name &&
    ...
    def hash
      [id, status, display_name, description, severity, operation_time, operation, operation_status, target_ids, target_names, policy_id, alert_type, compartment_id, time_created, time_updated, lifecycle_state, alert_policy_rule_key, alert_policy_rule_name, feature_details, freeform_tags, defined_tags].hash
    end
