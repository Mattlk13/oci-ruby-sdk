...
module OCI
  ...
  class DataSafe::Models::SensitiveDataModelSensitiveTypeSummary
    # **[Required]** The OCID of the sensitive type.
    # @return [String]
    attr_accessor :sensitive_type_id

    # **[Required]** The total number of sensitive columns linked to this specific sensitive type .
    # @return [Integer]
    attr_accessor :count
