...
module OCI
  ...
  class DataSafe::Models::UserSummary
    ...
    # @return [DateTime]
    attr_accessor :time_password_expiry
    ...
    # @option attributes [DateTime] :time_password_expiry The value to assign to the {#time_password_expiry} property
    ...
    def hash
      [key, user_name, user_category, account_status, target_id, time_last_login, time_user_created, authentication_type, user_profile, time_password_changed, time_password_expiry, user_types, admin_roles, are_all_schemas_accessible, schema_list].hash
    end
