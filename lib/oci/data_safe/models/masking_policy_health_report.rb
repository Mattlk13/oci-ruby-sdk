...
module OCI
  ...
  class DataSafe::Models::MaskingPolicyHealthReport
    ...
    def hash
      [id, masking_policy_id, target_id, compartment_id, display_name, time_created, time_updated, lifecycle_state, description, error_count, warning_count, freeform_tags, defined_tags].hash
    end
