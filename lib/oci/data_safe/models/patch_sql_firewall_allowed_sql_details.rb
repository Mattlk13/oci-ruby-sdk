...
module OCI
  ...
  class DataSafe::Models::PatchSqlFirewallAllowedSqlDetails
    # **[Required]** An array of patch instructions.
    # @return [Array<OCI::DataSafe::Models::PatchInstruction>]
    attr_accessor :items

    # **[Required]** The OCID of the SQL firewall policy whose allowed SQL needs to be deleted.
    # @return [String]
    ...
    def hash
      [items, sql_firewall_policy_id].hash
    end
