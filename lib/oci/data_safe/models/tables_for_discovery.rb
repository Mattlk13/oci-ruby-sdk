...
module OCI
  ...
  class DataSafe::Models::TablesForDiscovery
    # **[Required]** This contains the name of the schema.
    # @return [String]
    ...
    # @option attributes [Array<String>] :table_names The value to assign to the {#table_names} property
    def initialize(attributes = {})
      ...
      self.table_names = attributes[:'tableNames'] if attributes[:'tableNames']

      raise 'You cannot provide both :tableNames and :table_names' if attributes.key?(:'tableNames') && attributes.key?(:'table_names')

      self.table_names = attributes[:'table_names'] if attributes[:'table_names']
    end
