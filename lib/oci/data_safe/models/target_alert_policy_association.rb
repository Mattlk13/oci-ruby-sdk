...
module OCI
  ...
  class DataSafe::Models::TargetAlertPolicyAssociation
    ...
    def hash
      [id, display_name, description, policy_id, target_id, is_enabled, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
