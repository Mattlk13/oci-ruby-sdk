...
module OCI
  ...
  class DataSafe::Models::UpdateSensitiveDataModelDetails
    ...
    # \"OE\", tableName : [\"T3\", \"T4\"]}].
    #
    # @return [Array<OCI::DataSafe::Models::TablesForDiscovery>]
    attr_accessor :tables_for_discovery
    ...
    #
    # @return [Array<String>]
    attr_accessor :sensitive_type_group_ids_for_discovery
    ...
    # @option attributes [Array<OCI::DataSafe::Models::TablesForDiscovery>] :tables_for_discovery The value to assign to the {#tables_for_discovery} property
    ...
    # @option attributes [Array<String>] :sensitive_type_group_ids_for_discovery The value to assign to the {#sensitive_type_group_ids_for_discovery} property
    ...
    def initialize(attributes = {})
      ...
      self.tables_for_discovery = attributes[:'tablesForDiscovery'] if attributes[:'tablesForDiscovery']

      raise 'You cannot provide both :tablesForDiscovery and :tables_for_discovery' if attributes.key?(:'tablesForDiscovery') && attributes.key?(:'tables_for_discovery')

      self.tables_for_discovery = attributes[:'tables_for_discovery'] if attributes[:'tables_for_discovery']
      ...
      self.sensitive_type_group_ids_for_discovery = attributes[:'sensitiveTypeGroupIdsForDiscovery'] if attributes[:'sensitiveTypeGroupIdsForDiscovery']

      raise 'You cannot provide both :sensitiveTypeGroupIdsForDiscovery and :sensitive_type_group_ids_for_discovery' if attributes.key?(:'sensitiveTypeGroupIdsForDiscovery') && attributes.key?(:'sensitive_type_group_ids_for_discovery')

      self.sensitive_type_group_ids_for_discovery = attributes[:'sensitive_type_group_ids_for_discovery'] if attributes[:'sensitive_type_group_ids_for_discovery']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        tables_for_discovery == other.tables_for_discovery &&
        sensitive_type_ids_for_discovery == other.sensitive_type_ids_for_discovery &&
        sensitive_type_group_ids_for_discovery == other.sensitive_type_group_ids_for_discovery &&
    ...
    def hash
      [display_name, target_id, app_suite_name, description, schemas_for_discovery, tables_for_discovery, sensitive_type_ids_for_discovery, sensitive_type_group_ids_for_discovery, is_sample_data_collection_enabled, is_app_defined_relation_discovery_enabled, freeform_tags, defined_tags].hash
    end
