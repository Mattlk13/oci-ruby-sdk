...
module OCI
  ...
  class Bds::Models::OsPatchPackageSummary
    ...
    PACKAGE_TYPE_ENUM = [
      ...
      PACKAGE_TYPE_PIP = 'PIP'.freeze,
      PACKAGE_TYPE_PIP3 = 'PIP3'.freeze,
      PACKAGE_TYPE_PIP3_8 = 'PIP3_8'.freeze,
    ...
    def hash
      [package_name, target_version, update_type, related_cv_es, package_type].hash
    end
