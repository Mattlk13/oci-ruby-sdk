...
module OCI
  ...
  class Bds::Models::InstallPatchDetails
    ...
    # @return [OCI::Bds::Models::OdhPatchingConfig]
    attr_accessor :patching_config
    ...
    def self.swagger_types
      {
        ...
        'patching_config': :'OCI::Bds::Models::OdhPatchingConfig'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::Bds::Models::OdhPatchingConfig] :patching_config The value to assign to the {#patching_config} property
    def initialize(attributes = {})
      ...
      self.patching_config = attributes[:'patchingConfig'] if attributes[:'patchingConfig']

      raise 'You cannot provide both :patchingConfig and :patching_config' if attributes.key?(:'patchingConfig') && attributes.key?(:'patching_config')

      self.patching_config = attributes[:'patching_config'] if attributes[:'patching_config']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        patching_config == other.patching_config
    end
    ...
    def hash
      [version, cluster_admin_password, patching_config].hash
    end
