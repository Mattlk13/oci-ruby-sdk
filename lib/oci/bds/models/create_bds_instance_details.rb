...
module OCI
  ...
  class Bds::Models::CreateBdsInstanceDetails
    ...
    # @return [OCI::Bds::Models::BdsClusterVersionSummary]
    attr_accessor :bds_cluster_version_summary
    ...
    # @option attributes [OCI::Bds::Models::BdsClusterVersionSummary] :bds_cluster_version_summary The value to assign to the {#bds_cluster_version_summary} property
    def initialize(attributes = {})
      ...
      self.bds_cluster_version_summary = attributes[:'bdsClusterVersionSummary'] if attributes[:'bdsClusterVersionSummary']

      raise 'You cannot provide both :bdsClusterVersionSummary and :bds_cluster_version_summary' if attributes.key?(:'bdsClusterVersionSummary') && attributes.key?(:'bds_cluster_version_summary')

      self.bds_cluster_version_summary = attributes[:'bds_cluster_version_summary'] if attributes[:'bds_cluster_version_summary']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        bds_cluster_version_summary == other.bds_cluster_version_summary
    end
    ...
    def hash
      [compartment_id, display_name, cluster_version, cluster_public_key, cluster_admin_password, is_high_availability, is_secure, network_config, bootstrap_script_url, nodes, kerberos_realm_name, freeform_tags, defined_tags, kms_key_id, cluster_profile, bds_cluster_version_summary].hash
    end
