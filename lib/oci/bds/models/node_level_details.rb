...
module OCI
  ...
  class Bds::Models::NodeLevelDetails < Bds::Models::LevelTypeDetails
    # **[Required]** Host name of the node to create backup configuration.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['levelType'] = 'NODE_LEVEL'
    ...
    def hash
      [level_type, node_host_name].hash
    end
