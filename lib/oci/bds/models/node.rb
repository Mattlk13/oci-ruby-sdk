...
module OCI
  ...
  class Bds::Models::Node
    ...
    # @option attributes [DateTime] :time_replaced The value to assign to the {#time_replaced} property
    ...
    def initialize(attributes = {})
      ...
      self.time_replaced = attributes[:'timeReplaced'] if attributes[:'timeReplaced']

      raise 'You cannot provide both :timeReplaced and :time_replaced' if attributes.key?(:'timeReplaced') && attributes.key?(:'time_replaced')

      self.time_replaced = attributes[:'time_replaced'] if attributes[:'time_replaced']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        time_replaced == other.time_replaced &&
