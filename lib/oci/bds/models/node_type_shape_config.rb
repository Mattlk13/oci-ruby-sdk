...
module OCI
  ...
  class Bds::Models::NodeTypeShapeConfig
    # **[Required]** The Big Data Service cluster node type.
    # @return [String]
    attr_accessor :node_type

    # **[Required]** Shape of the node. This has to be specified when starting the cluster. Defaults to wn0 for homogeneous clusters and remains empty for heterogeneous clusters.
