...
module OCI
  ...
  class Bds::Models::NodeBackupConfigurationSummary
    # **[Required]** The id of the NodeBackupConfiguration.
    # @return [String]
    attr_accessor :id
    ...
    def hash
      [id, bds_instance_id, display_name, level_type_details, lifecycle_state, time_created, time_updated].hash
    end
