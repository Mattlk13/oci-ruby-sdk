...
module OCI
  ...
  class Bds::Models::ActivateUpstConfigurationDetails
    # **[Required]** Base-64 encoded password for the cluster admin user.
    # @return [String]
    attr_accessor :cluster_admin_password

    # **[Required]** OCID of the vault to store token exchange service principal keyta, required for creating UPST configb
    # @return [String]
    attr_accessor :vault_id

    # **[Required]** OCID of the master encryption key in vault for encrypting token exchange service principal keytab, required for creating UPST config
    # @return [String]
    ...
    def hash
      [cluster_admin_password, vault_id, master_encryption_key_id].hash
    end
