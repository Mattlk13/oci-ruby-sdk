...
module OCI
  ...
  class Bds::Models::ResourcePrincipalConfiguration
    ...
    # **[Required]** Life span in hours of each resource principal session token.
    # @return [Integer]
    ...
    def hash
      [id, bds_instance_id, display_name, session_token_life_span_duration_in_hours, lifecycle_state, time_token_refreshed, time_token_expiry, time_created, time_updated].hash
    end
