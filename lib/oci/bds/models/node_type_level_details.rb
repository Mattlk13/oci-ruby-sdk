...
require 'date'
require_relative 'level_type_details'
...
module OCI
  ...
  class Bds::Models::NodeTypeLevelDetails < Bds::Models::LevelTypeDetails
    # **[Required]** Type of the node or nodes of the node backup configuration or node replacement configuration which are going to be created.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['levelType'] = 'NODE_TYPE_LEVEL'
