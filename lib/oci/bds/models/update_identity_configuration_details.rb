...
module OCI
  ...
  class Bds::Models::UpdateIdentityConfigurationDetails
    # **[Required]** Base-64 encoded password for the cluster admin user.
    # @return [String]
    attr_accessor :cluster_admin_password

    # @return [OCI::Bds::Models::UpstConfigurationDetails]
    attr_accessor :upst_configuration_details

    # @return [OCI::Bds::Models::IamUserSyncConfigurationDetails]
    attr_accessor :iam_user_sync_configuration_details
    ...
    # @option attributes [OCI::Bds::Models::UpstConfigurationDetails] :upst_configuration_details The value to assign to the {#upst_configuration_details} property
    # @option attributes [OCI::Bds::Models::IamUserSyncConfigurationDetails] :iam_user_sync_configuration_details The value to assign to the {#iam_user_sync_configuration_details} property
    ...
    def hash
      [cluster_admin_password, upst_configuration_details, iam_user_sync_configuration_details].hash
    end
