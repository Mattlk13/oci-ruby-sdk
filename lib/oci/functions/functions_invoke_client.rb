...
module OCI
  ...
  class Functions::FunctionsInvokeClient
    ...
    #
    # @option opts [BOOLEAN] :is_dry_run Indicates that the request is a dry run, if set to \"true\". A dry run request does not execute the function.
    #    (default to false)
    ...
    def invoke_function(function_id, opts = {}, &block)
      ...
      header_params[:'is-dry-run'] = opts[:is_dry_run] if !opts[:is_dry_run].nil?
