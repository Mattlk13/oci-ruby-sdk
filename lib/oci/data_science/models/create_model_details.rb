...
module OCI
  ...
  class DataScience::Models::CreateModelDetails
    ...
    def hash
      [compartment_id, project_id, display_name, description, freeform_tags, defined_tags, custom_metadata_list, defined_metadata_list, input_schema, output_schema, model_version_set_id, version_label, retention_setting, backup_setting].hash
    end
