...
module OCI
  ...
  class DataScience::Models::ModelDeployWorkloadConfigurationDetails < DataScience::Models::WorkloadConfigurationDetails
    # **[Required]** The container image run [CMD](https://docs.docker.com/engine/reference/builder/#cmd) as a list of strings.
    ...
    # **[Required]** The port on which the web server serving the inference is running.
    # The port can be anything between `1024` and `65535`. The following ports cannot be used `24224`, `8446`, `8447`.
    #
    # @return [Integer]
    attr_accessor :server_port

    # **[Required]** The port on which the container [HEALTHCHECK](https://docs.docker.com/engine/reference/builder/#healthcheck) would listen.
    # The port can be anything between `1024` and `65535`. The following ports cannot be used `24224`, `8446`, `8447`.
    #
    # @return [Integer]
    ...
    # @option attributes [String] :cmd The value to assign to the {#cmd} property
    ...
    # @option attributes [Hash<String, String>] :additional_configurations The value to assign to the {#additional_configurations} property
