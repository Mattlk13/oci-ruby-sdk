...
module OCI
  ...
  class DataScience::Models::ImplementationLogging
    # @return [OCI::DataScience::Models::ImplementationLogDetails]
    attr_accessor :implementation_log

    # @return [OCI::DataScience::Models::ImplementationLogDetails]
    attr_accessor :aggregated_instance_view_log
    ...
    # @option attributes [OCI::DataScience::Models::ImplementationLogDetails] :implementation_log The value to assign to the {#implementation_log} property
    # @option attributes [OCI::DataScience::Models::ImplementationLogDetails] :aggregated_instance_view_log The value to assign to the {#aggregated_instance_view_log} property
    # @option attributes [OCI::DataScience::Models::ImplementationLogDetails] :trigger_log The value to assign to the {#trigger_log} property
