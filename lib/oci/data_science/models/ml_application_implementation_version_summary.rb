...
module OCI
  ...
  class DataScience::Models::MlApplicationImplementationVersionSummary
    ...
    def hash
      [id, ml_application_implementation_id, name, description, ml_application_id, ml_application_name, package_version, configuration_schema, allowed_migration_destinations, time_created, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
