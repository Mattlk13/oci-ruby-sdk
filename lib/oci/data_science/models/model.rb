...
module OCI
  ...
  class DataScience::Models::Model
    ...
    # @return [BOOLEAN]
    attr_accessor :is_model_by_reference

    # This attribute is required.
    # @return [OCI::DataScience::Models::RetentionSetting]
    attr_accessor :retention_setting

    # This attribute is required.
    # @return [OCI::DataScience::Models::BackupSetting]
    attr_accessor :backup_setting

    # This attribute is required.
    # @return [OCI::DataScience::Models::RetentionOperationDetails]
    attr_accessor :retention_operation_details

    # This attribute is required.
    # @return [OCI::DataScience::Models::BackupOperationDetails]
    attr_accessor :backup_operation_details
    ...
    # @option attributes [BOOLEAN] :is_model_by_reference The value to assign to the {#is_model_by_reference} property
    # @option attributes [OCI::DataScience::Models::RetentionSetting] :retention_setting The value to assign to the {#retention_setting} property
    # @option attributes [OCI::DataScience::Models::BackupSetting] :backup_setting The value to assign to the {#backup_setting} property
    # @option attributes [OCI::DataScience::Models::RetentionOperationDetails] :retention_operation_details The value to assign to the {#retention_operation_details} property
    # @option attributes [OCI::DataScience::Models::BackupOperationDetails] :backup_operation_details The value to assign to the {#backup_operation_details} property
