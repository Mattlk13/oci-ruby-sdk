...
module OCI
  ...
  class DataScience::Models::ScheduleAction
    ACTION_TYPE_ENUM = [
      ACTION_TYPE_HTTP = 'HTTP'.freeze,
      ACTION_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The Schedule Action type
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::DataScience::Models::ScheduleHttpAction' if type == 'HTTP'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataScience::Models::ScheduleAction'
    end
