...
module OCI
  ...
  class DataScience::Models::MlApplication
    ...
    # **[Required]** The OCID of the MlApplication. Unique identifier that is immutable after creation.
    # @return [String]
    attr_accessor :id

    # **[Required]** The name of MlApplication. It is unique in a given tenancy.
    # @return [String]
    attr_accessor :name
    ...
    # **[Required]** The OCID of the compartment where the MlApplication is created.
    # @return [String]
    attr_accessor :compartment_id

    # **[Required]** Creation time of MlApplication in the format defined by RFC 3339.
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** Time of last MlApplication update in the format defined by RFC 3339.
    # @return [DateTime]
    attr_accessor :time_updated

    # **[Required]** The current state of the MlApplication.
    # @return [String]
    ...
    def hash
      [id, name, description, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
