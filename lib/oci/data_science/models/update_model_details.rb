...
module OCI
  ...
  class DataScience::Models::UpdateModelDetails
    ...
    def hash
      [display_name, description, freeform_tags, defined_tags, custom_metadata_list, defined_metadata_list, model_version_set_id, version_label, retention_setting, backup_setting].hash
    end
