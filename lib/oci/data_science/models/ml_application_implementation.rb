...
module OCI
  ...
  class DataScience::Models::MlApplicationImplementation
    ...
    # **[Required]** Creation time of MlApplicationImplementation creation in the format defined by RFC 3339.
    # @return [DateTime]
    attr_accessor :time_created

    # **[Required]** Time of last MlApplicationImplementation update in the format defined by RFC 3339.
    # @return [DateTime]
    attr_accessor :time_updated

    # **[Required]** The current state of the MlApplicationImplementation.
    # @return [String]
    ...
    def hash
      [id, name, description, ml_application_id, ml_application_name, package_version, application_components, configuration_schema, ml_application_package_arguments, allowed_migration_destinations, logging, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
