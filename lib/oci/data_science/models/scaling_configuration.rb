...
module OCI
  ...
  class DataScience::Models::ScalingConfiguration
    SCALING_CONFIGURATION_TYPE_ENUM = [
      ...
      SCALING_CONFIGURATION_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    def scaling_configuration_type=(scaling_configuration_type)
      ...
      if scaling_configuration_type && !SCALING_CONFIGURATION_TYPE_ENUM.include?(scaling_configuration_type)
        OCI.logger.debug("Unknown value for 'scaling_configuration_type' [" + scaling_configuration_type + "]. Mapping to 'SCALING_CONFIGURATION_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @scaling_configuration_type = SCALING_CONFIGURATION_TYPE_UNKNOWN_ENUM_VALUE
      else
