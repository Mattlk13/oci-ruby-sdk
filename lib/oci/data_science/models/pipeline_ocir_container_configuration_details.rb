...
require 'date'
require_relative 'pipeline_container_configuration_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Container configuration based on image stored in OCI Container Registry.
  class DataScience::Models::PipelineOcirContainerConfigurationDetails < DataScience::Models::PipelineContainerConfigurationDetails
