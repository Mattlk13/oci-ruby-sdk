...
module OCI
  ...
  class DataScience::Models::WorkloadConfigurationDetails
    WORKLOAD_TYPE_ENUM = [
      WORKLOAD_TYPE_MODEL_DEPLOYMENT = 'MODEL_DEPLOYMENT'.freeze,
      WORKLOAD_TYPE_JOB_RUN = 'JOB_RUN'.freeze,
      WORKLOAD_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** The workload use case.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'workloadType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::DataScience::Models::ModelDeployWorkloadConfigurationDetails' if type == 'MODEL_DEPLOYMENT'
      return 'OCI::DataScience::Models::JobRunWorkloadConfigurationDetails' if type == 'JOB_RUN'

      # TODO: Log a warning when the subtype is not found.
      'OCI::DataScience::Models::WorkloadConfigurationDetails'
    end
