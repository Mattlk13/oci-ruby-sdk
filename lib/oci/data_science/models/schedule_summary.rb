...
module OCI
  ...
  class DataScience::Models::ScheduleSummary
    ...
    def hash
      [id, display_name, compartment_id, project_id, trigger, time_created, time_updated, created_by, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
