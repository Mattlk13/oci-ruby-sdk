...
require 'date'
require_relative 'create_auth_configuration_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Configuration of IDCS AuthN/Z for online prediction
  class DataScience::Models::CreateIdcsAuthConfigurationDetails < DataScience::Models::CreateAuthConfigurationDetails
    # **[Required]** Identity Domain OCID
    # @return [String]
