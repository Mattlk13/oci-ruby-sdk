...
require 'date'
require_relative 'job_run_use_case_configuration_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The evaluation use-case configuration.
  class DataScience::Models::GenericJobRunUseCaseConfigurationDetails < DataScience::Models::JobRunUseCaseConfigurationDetails
    ...
    def initialize(attributes = {})
      ...
      attributes['useCaseType'] = 'GENERIC'
    ...
    def hash
      [use_case_type, additional_configurations].hash
    end
