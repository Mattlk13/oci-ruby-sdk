...
require 'date'
require_relative 'model_artifact_reference_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Reference to the OSS where model artifact is stored
  class DataScience::Models::OSSModelArtifactReferenceDetails < DataScience::Models::ModelArtifactReferenceDetails
    # **[Required]** The namespace of the model artifact reference in OSS.
    # @return [String]
    attr_accessor :namespace

    # **[Required]** The bucket name of the model artifact reference in OSS.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['modelArtifactReferenceType'] = 'OSS'
    ...
    def hash
      [model_artifact_reference_type, namespace, bucket_name, prefix].hash
    end
