...
module OCI
  ...
  class DataScience::Models::UpdatePipelineDetails
    ...
    attr_accessor :storage_mount_configuration_details_list
    ...
    # @option attributes [Array<OCI::DataScience::Models::StorageMountConfigurationDetails>] :storage_mount_configuration_details_list The value to assign to the {#storage_mount_configuration_details_list} property
    ...
    def hash
      [display_name, description, configuration_details, infrastructure_configuration_details, log_configuration_details, storage_mount_configuration_details_list, step_details, freeform_tags, defined_tags].hash
    end
