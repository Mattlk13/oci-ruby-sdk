...
module OCI
  ...
  class DataScience::Models::PipelineDataflowStepDetails < DataScience::Models::PipelineStepDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the dataflow application to be used as a step.
    # @return [String]
    attr_accessor :application_id

    # @return [OCI::DataScience::Models::PipelineDataflowConfigurationDetails]
    attr_accessor :step_dataflow_configuration_details
    ...
    # @option attributes [OCI::DataScience::Models::PipelineDataflowConfigurationDetails] :step_dataflow_configuration_details The value to assign to the {#step_dataflow_configuration_details} property
    def initialize(attributes = {})
      return unless attributes.is_a?(Hash)

      attributes['stepType'] = 'DATAFLOW'
    ...
    def hash
      [step_type, step_name, description, depends_on, step_configuration_details, application_id, step_dataflow_configuration_details].hash
    end
