...
module OCI
  ...
  class Waf::Models::WebAppFirewallPolicyRule
    ...
    CONDITION_LANGUAGE_ENUM = [
      ...
      CONDITION_LANGUAGE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    def condition_language=(condition_language)
      # rubocop:disable Style/ConditionalAssignment
      if condition_language && !CONDITION_LANGUAGE_ENUM.include?(condition_language)
        OCI.logger.debug("Unknown value for 'condition_language' [" + condition_language + "]. Mapping to 'CONDITION_LANGUAGE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @condition_language = CONDITION_LANGUAGE_UNKNOWN_ENUM_VALUE
      else
