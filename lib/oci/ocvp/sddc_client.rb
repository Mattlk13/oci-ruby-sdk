...
module OCI
  ...
  class Ocvp::SddcClient
    ...
    # @option opts [String] :host_shape_name A filter to return only resources that match or support the given ESXi host shape.
    # @option opts [String] :version_to_upgrade A filter to return only VMware software versions that the given VMware software version can be upgraded to.
    ...
    def list_supported_vmware_software_versions(compartment_id, opts = {})
      ...
      query_params[:hostShapeName] = opts[:host_shape_name] if opts[:host_shape_name]
      query_params[:versionToUpgrade] = opts[:version_to_upgrade] if opts[:version_to_upgrade]
