...
module OCI
  ...
  class Ocvp::Models::WorkRequest
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_CREATE_DATASTORE = 'CREATE_DATASTORE'.freeze,
      OPERATION_TYPE_UPDATE_DATASTORE = 'UPDATE_DATASTORE'.freeze,
      OPERATION_TYPE_ADD_BLOCK_VOLUME_TO_DATASTORE = 'ADD_BLOCK_VOLUME_TO_DATASTORE'.freeze,
      OPERATION_TYPE_DELETE_DATASTORE = 'DELETE_DATASTORE'.freeze,
      OPERATION_TYPE_CREATE_DATASTORE_CLUSTER = 'CREATE_DATASTORE_CLUSTER'.freeze,
      OPERATION_TYPE_UPDATE_DATASTORE_CLUSTER = 'UPDATE_DATASTORE_CLUSTER'.freeze,
      OPERATION_TYPE_ATTACH_DATASTORE_CLUSTER_TO_ESXI_HOST = 'ATTACH_DATASTORE_CLUSTER_TO_ESXI_HOST'.freeze,
      OPERATION_TYPE_ATTACH_DATASTORE_CLUSTER_TO_CLUSTER = 'ATTACH_DATASTORE_CLUSTER_TO_CLUSTER'.freeze,
      OPERATION_TYPE_DETACH_DATASTORE_CLUSTER_FROM_ESXI_HOST = 'DETACH_DATASTORE_CLUSTER_FROM_ESXI_HOST'.freeze,
      OPERATION_TYPE_DETACH_DATASTORE_CLUSTER_FROM_CLUSTER = 'DETACH_DATASTORE_CLUSTER_FROM_CLUSTER'.freeze,
      OPERATION_TYPE_DELETE_DATASTORE_CLUSTER = 'DELETE_DATASTORE_CLUSTER'.freeze,
      OPERATION_TYPE_ADD_DATASTORE_TO_DATASTORE_CLUSTER = 'ADD_DATASTORE_TO_DATASTORE_CLUSTER'.freeze,
      OPERATION_TYPE_REMOVE_DATASTORE_FROM_DATASTORE_CLUSTER = 'REMOVE_DATASTORE_FROM_DATASTORE_CLUSTER'.freeze,
