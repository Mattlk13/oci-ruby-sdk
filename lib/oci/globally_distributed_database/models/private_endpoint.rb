...
module OCI
  ...
  class GloballyDistributedDatabase::Models::PrivateEndpoint
    ...
    def hash
      [id, compartment_id, subnet_id, vcn_id, display_name, description, private_ip, nsg_ids, sharded_databases, time_created, time_updated, lifecycle_state, lifecycle_state_details, proxy_compute_instance_id, freeform_tags, defined_tags, system_tags].hash
    end
