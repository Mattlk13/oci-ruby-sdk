...
module OCI
  ...
  class GloballyDistributedDatabase::Models::CreateDedicatedShardedDatabase < GloballyDistributedDatabase::Models::CreateShardedDatabaseDetails
    ...
    def hash
      [compartment_id, db_deployment_type, display_name, freeform_tags, defined_tags, replication_method, replication_factor, replication_unit, cluster_certificate_common_name, chunks, db_workload, sharding_method, db_version, character_set, ncharacter_set, listener_port, listener_port_tls, ons_port_local, ons_port_remote, prefix, shard_details, catalog_details].hash
    end
