...
module OCI
  ...
  class GloballyDistributedDatabase::ShardedDatabaseServiceClientCompositeOperations
    ...
    # Calls {OCI::GloballyDistributedDatabase::ShardedDatabaseServiceClient#reinstate_proxy_instance} and then waits for the {OCI::GloballyDistributedDatabase::Models::WorkRequest}
    # to enter the given state(s).
    #
    # @param [String] private_endpoint_id Oracle Sharded Database PrivateEndpoint identifier
    # @param [Array<String>] wait_for_states An array of states to wait on. These should be valid values for {OCI::GloballyDistributedDatabase::Models::WorkRequest#status}
    # @param [Hash] base_operation_opts Any optional arguments accepted by {OCI::GloballyDistributedDatabase::ShardedDatabaseServiceClient#reinstate_proxy_instance}
    # @param [Hash] waiter_opts Optional arguments for the waiter. Keys should be symbols, and the following keys are supported:
    #   * max_interval_seconds: The maximum interval between queries, in seconds.
    #   * max_wait_seconds The maximum time to wait, in seconds
    #
    # @return [OCI::Response] A {OCI::Response} object containing the completed {OCI::GloballyDistributedDatabase::Models::WorkRequest}
    def reinstate_proxy_instance_and_wait_for_state(private_endpoint_id, wait_for_states = [], base_operation_opts = {}, waiter_opts = {})
      operation_result = @service_client.reinstate_proxy_instance(private_endpoint_id, base_operation_opts)
      use_util = OCI::GloballyDistributedDatabase::Util.respond_to?(:wait_on_work_request)
