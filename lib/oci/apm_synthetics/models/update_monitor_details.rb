...
module OCI
  ...
  class ApmSynthetics::Models::UpdateMonitorDetails
    ...
    # @option attributes [BOOLEAN] :is_i_pv6 The value to assign to the {#is_i_pv6} property
    def initialize(attributes = {})
      ...
      self.is_i_pv6 = attributes[:'isIPv6'] unless attributes[:'isIPv6'].nil?
      self.is_i_pv6 = false if is_i_pv6.nil? && !attributes.key?(:'isIPv6') # rubocop:disable Style/StringLiterals

      raise 'You cannot provide both :isIPv6 and :is_i_pv6' if attributes.key?(:'isIPv6') && attributes.key?(:'is_i_pv6')

      self.is_i_pv6 = attributes[:'is_i_pv6'] unless attributes[:'is_i_pv6'].nil?
      self.is_i_pv6 = false if is_i_pv6.nil? && !attributes.key?(:'isIPv6') && !attributes.key?(:'is_i_pv6') # rubocop:disable Style/StringLiterals
    end
    ...
    def hash
      [display_name, vantage_points, script_id, status, repeat_interval_in_seconds, is_run_once, timeout_in_seconds, target, script_parameters, configuration, availability_configuration, maintenance_window_schedule, freeform_tags, defined_tags, is_run_now, scheduling_policy, batch_interval_in_seconds, is_i_pv6].hash
    end
