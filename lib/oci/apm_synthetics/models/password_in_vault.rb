...
module OCI
  ...
  #
  class ApmSynthetics::Models::PasswordInVault < ApmSynthetics::Models::Password
    # **[Required]** Vault secret OCID.
    # @return [String]
    ...
    def initialize(attributes = {})
      ...
      attributes['passwordType'] = 'VAULT_SECRET_ID'
    ...
    def hash
      [password_type, vault_secret_id].hash
    end
