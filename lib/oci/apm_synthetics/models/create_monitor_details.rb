...
module OCI
  ...
  class ApmSynthetics::Models::CreateMonitorDetails
    MONITOR_TYPE_ENUM = [
      ...
      MONITOR_TYPE_FTP = 'FTP'.freeze,
      MONITOR_TYPE_SQL = 'SQL'.freeze
    ].freeze
