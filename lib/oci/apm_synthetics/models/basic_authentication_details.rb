...
module OCI
  ...
  class ApmSynthetics::Models::BasicAuthenticationDetails
    # **[Required]** Username for authentication.
    # @return [String]
    attr_accessor :username

    # This attribute is required.
    # @return [OCI::ApmSynthetics::Models::Password]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'username': :'String',
        'password': :'OCI::ApmSynthetics::Models::Password'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::ApmSynthetics::Models::Password] :password The value to assign to the {#password} property
