...
module OCI
  ...
  class AiLanguage::Models::EndpointSummary
    ...
    # @option attributes [String] :compute_type The value to assign to the {#compute_type} property
    ...
    # @param [Object] compute_type Object to be assigned
    def compute_type=(compute_type)
      # rubocop:disable Style/ConditionalAssignment
      if compute_type && !COMPUTE_TYPE_ENUM.include?(compute_type)
        OCI.logger.debug("Unknown value for 'compute_type' [" + compute_type + "]. Mapping to 'COMPUTE_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @compute_type = COMPUTE_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [id, _alias, compute_type, display_name, compartment_id, project_id, description, time_created, lifecycle_state, lifecycle_details, inference_units, model_id, freeform_tags, defined_tags, system_tags].hash
    end
