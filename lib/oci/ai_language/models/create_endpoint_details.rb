...
module OCI
  ...
  class AiLanguage::Models::CreateEndpointDetails
    ...
    def compute_type=(compute_type)
      raise "Invalid value for 'compute_type': this must be one of the values in COMPUTE_TYPE_ENUM." if compute_type && !COMPUTE_TYPE_ENUM.include?(compute_type)
    ...
    def hash
      [display_name, compute_type, _alias, description, compartment_id, model_id, inference_units, freeform_tags, defined_tags].hash
    end
