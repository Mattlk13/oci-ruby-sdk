...
module OCI
  ...
  class AiLanguage::Models::PiiEntityReplace < AiLanguage::Models::PiiEntityMasking
    ...
    # @option attributes [Array<String>] :exclude The value to assign to the {OCI::AiLanguage::Models::PiiEntityMasking#exclude #exclude} proprety
    # @option attributes [BOOLEAN] :should_detect The value to assign to the {OCI::AiLanguage::Models::PiiEntityMasking#should_detect #should_detect} proprety
    ...
    def hash
      [mode, exclude, should_detect, replace_with].hash
    end
