...
module OCI
  ...
  class AiLanguage::Models::HierarchicalEntity
    # @return [OCI::AiLanguage::Models::MetaInfo]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'meta_info': :'OCI::AiLanguage::Models::MetaInfo',
        'offset': :'Integer',
        'length': :'Integer',
        'text': :'String',
        'type': :'String',
    ...
    # @option attributes [OCI::AiLanguage::Models::MetaInfo] :meta_info The value to assign to the {#meta_info} property
    ...
    def initialize(attributes = {})
      ...
      self.meta_info = attributes[:'metaInfo'] if attributes[:'metaInfo']

      raise 'You cannot provide both :metaInfo and :meta_info' if attributes.key?(:'metaInfo') && attributes.key?(:'meta_info')

      self.meta_info = attributes[:'meta_info'] if attributes[:'meta_info']
    ...
    def hash
      [meta_info, offset, length, text, type, sub_type, score].hash
    end
