...
module OCI
  ...
  class Limits::Models::LimitDefinitionSummary
    ...
    #
    # @return [Array<String>]
    attr_accessor :supported_subscriptions

    # Supported quota family names for creation of quota policy.
    #
    # @return [Array<String>]
    attr_accessor :supported_quota_families
    ...
    # @option attributes [Array<String>] :supported_subscriptions The value to assign to the {#supported_subscriptions} property
    # @option attributes [Array<String>] :supported_quota_families The value to assign to the {#supported_quota_families} property
