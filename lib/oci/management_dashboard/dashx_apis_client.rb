...
module OCI
  ...
  class ManagementDashboard::DashxApisClient
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::ManagementDashboard::Models::ManagementDashboard ManagementDashboard}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementdashboard/get_oob_management_dashboard.rb.html) to see an example of how to use get_oob_management_dashboard API.
    def get_oob_management_dashboard(management_dashboard_id, opts = {})
      logger.debug 'Calling operation DashxApisClient#get_oob_management_dashboard.' if logger

      raise "Missing the required parameter 'management_dashboard_id' when calling get_oob_management_dashboard." if management_dashboard_id.nil?
      raise "Parameter value for 'management_dashboard_id' must not be blank" if OCI::Internal::Util.blank_string?(management_dashboard_id)

      path = '/oobManagementDashboards/{managementDashboardId}'.sub('{managementDashboardId}', management_dashboard_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DashxApisClient#get_oob_management_dashboard') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @return [Response] A Response object with data of type {OCI::ManagementDashboard::Models::ManagementSavedSearch ManagementSavedSearch}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementdashboard/get_oob_management_saved_search.rb.html) to see an example of how to use get_oob_management_saved_search API.
    def get_oob_management_saved_search(management_saved_search_id, opts = {})
      logger.debug 'Calling operation DashxApisClient#get_oob_management_saved_search.' if logger

      raise "Missing the required parameter 'management_saved_search_id' when calling get_oob_management_saved_search." if management_saved_search_id.nil?
      raise "Parameter value for 'management_saved_search_id' must not be blank" if OCI::Internal::Util.blank_string?(management_saved_search_id)

      path = '/oobManagementSavedSearches/{managementSavedSearchId}'.sub('{managementSavedSearchId}', management_saved_search_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DashxApisClient#get_oob_management_saved_search') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    #   Allowed values are: timeCreated, displayName
    # @return [Response] A Response object with data of type {OCI::ManagementDashboard::Models::ManagementDashboardCollection ManagementDashboardCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementdashboard/list_oob_management_dashboards.rb.html) to see an example of how to use list_oob_management_dashboards API.
    def list_oob_management_dashboards(compartment_id, opts = {})
      logger.debug 'Calling operation DashxApisClient#list_oob_management_dashboards.' if logger

      raise "Missing the required parameter 'compartment_id' when calling list_oob_management_dashboards." if compartment_id.nil?
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DashxApisClient#list_oob_management_dashboards') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    #   Allowed values are: timeCreated, displayName
    # @return [Response] A Response object with data of type {OCI::ManagementDashboard::Models::ManagementSavedSearchCollection ManagementSavedSearchCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/managementdashboard/list_oob_management_saved_searches.rb.html) to see an example of how to use list_oob_management_saved_searches API.
    def list_oob_management_saved_searches(compartment_id, opts = {})
      logger.debug 'Calling operation DashxApisClient#list_oob_management_saved_searches.' if logger

      raise "Missing the required parameter 'compartment_id' when calling list_oob_management_saved_searches." if compartment_id.nil?
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DashxApisClient#list_oob_management_saved_searches') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
