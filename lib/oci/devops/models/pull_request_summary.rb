...
module OCI
  ...
  class Devops::Models::PullRequestSummary
    ...
    def hash
      [id, display_name, compartment_id, description, repository_id, source_repository_id, source_branch, destination_branch, source_commit_id_at_termination, merge_base_commit_id_at_termination, time_created, time_updated, lifecycle_state, lifecycle_details, total_comments, total_reviewers, created_by, freeform_tags, defined_tags, system_tags].hash
    end
