...
module OCI
  ...
  class Devops::Models::ForkSyncStatusSummary
    SYNC_STATUS_ENUM = [
      SYNC_STATUS_IN_SYNC = 'IN_SYNC'.freeze,
      SYNC_STATUS_SYNC_IN_PROGRESS = 'SYNC_IN_PROGRESS'.freeze,
      SYNC_STATUS_OUT_OF_SYNC = 'OUT_OF_SYNC'.freeze,
      SYNC_STATUS_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze

    # **[Required]** Sync status for the provided branch.
    # @return [String]
    attr_reader :sync_status

    # **[Required]** The OCID of the child repository.
    # @return [String]
    attr_accessor :repository_id

    # **[Required]** The branch in the child repository we are checking the sync status of.
    # @return [String]
    ...
    def hash
      [sync_status, repository_id, branch_name].hash
    end
