...
require 'date'
require_relative 'generic_artifact_location_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # ObjectStorage bucket details where artifact is located.
  class Devops::Models::ObjectStorageGenericArtifactLocationDetails < Devops::Models::GenericArtifactLocationDetails
    # **[Required]** Unique namespace in the tenancy which contains the bucket
    # @return [String]
    attr_accessor :namespace

    # **[Required]** Specifies the Object Storage bucket.
    # @return [String]
    attr_accessor :bucket_name

    # **[Required]** Specifies the name of object inside the bucket.
    # @return [String]
    ...
    def hash
      [storage_type, namespace, bucket_name, object_name, region].hash
    end
