...
module OCI
  ...
  class Devops::Models::BuildRunSnapshotSummary
    ...
    def hash
      [build_pipeline_id, commit_id, build_run_id, display_name, lifecycle_state, lifecycle_details, time_created, time_updated].hash
    end
