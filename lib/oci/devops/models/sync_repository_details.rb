...
module OCI
  ...
  class Devops::Models::SyncRepositoryDetails
    # **[Required]** The branch in the upstream repository we want to sync from.
    # @return [String]
    attr_accessor :source_branch

    # **[Required]** The branch in the repository we want to be updated with changes from the upstream.
    # @return [String]
    ...
    def hash
      [source_branch, destination_branch].hash
    end
