...
module OCI
  module Devops::Models
    OPERATION_TYPE_ENUM = [
      ...
      OPERATION_TYPE_FORK_REPOSITORY = 'FORK_REPOSITORY'.freeze,
      OPERATION_TYPE_SYNC_FORK_REPOSITORY = 'SYNC_FORK_REPOSITORY'.freeze,
      ...
      OPERATION_TYPE_CREATE_PULL_REQUEST = 'CREATE_PULL_REQUEST'.freeze,
      OPERATION_TYPE_UPDATE_PULL_REQUEST = 'UPDATE_PULL_REQUEST'.freeze,
      OPERATION_TYPE_DELETE_PULL_REQUEST = 'DELETE_PULL_REQUEST'.freeze,
      OPERATION_TYPE_MOVE_PULL_REQUEST = 'MOVE_PULL_REQUEST'.freeze,
      OPERATION_TYPE_MERGE_PULL_REQUEST = 'MERGE_PULL_REQUEST'.freeze
    ].freeze
  end
end
