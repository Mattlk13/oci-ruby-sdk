...
module OCI
  ...
  class Devops::Models::CreateOrUpdateGitRefDetails
    REF_TYPE_ENUM = [
      REF_TYPE_BRANCH = 'BRANCH'.freeze,
      REF_TYPE_TAG = 'TAG'.freeze
    ].freeze

    # **[Required]** The name of the reference to create or update.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::CreateOrUpdateGitBranchDetails' if type == 'BRANCH'
      return 'OCI::Devops::Models::CreateOrUpdateGitTagDetails' if type == 'TAG'
