...
require 'date'
require_relative 'create_or_update_git_ref_details'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # The information needed to create a branch.
  class Devops::Models::CreateOrUpdateGitBranchDetails < Devops::Models::CreateOrUpdateGitRefDetails
    ...
    # @option attributes [String] :ref_name The value to assign to the {OCI::Devops::Models::CreateOrUpdateGitRefDetails#ref_name #ref_name} proprety
    ...
    def hash
      [ref_name, ref_type, commit_id].hash
    end
