...
module OCI
  ...
  #
  class Devops::Models::PatchProhibitInstruction < Devops::Models::PatchInstruction
    ...
    # @option attributes [String] :selection The value to assign to the {OCI::Devops::Models::PatchInstruction#selection #selection} proprety
