...
module OCI
  ...
  class Devops::Models::MergeCheckCollection
    ...
    # ]}
    # @return [Array<OCI::Devops::Models::MergeCheck>]
    attr_accessor :items
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'items': :'Array<OCI::Devops::Models::MergeCheck>',
    ...
    # @option attributes [Array<OCI::Devops::Models::MergeCheck>] :items The value to assign to the {#items} property
