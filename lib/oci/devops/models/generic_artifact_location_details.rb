...
module OCI
  ...
  class Devops::Models::GenericArtifactLocationDetails
    STORAGE_TYPE_ENUM = [
      STORAGE_TYPE_OBJECT_STORAGE = 'OBJECT_STORAGE'.freeze
    ].freeze

    # **[Required]** Storage source like ObjectStorage, etc.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::ObjectStorageGenericArtifactLocationDetails' if type == 'OBJECT_STORAGE'
    ...
    def storage_type=(storage_type)
      raise "Invalid value for 'storage_type': this must be one of the values in STORAGE_TYPE_ENUM." if storage_type && !STORAGE_TYPE_ENUM.include?(storage_type)
