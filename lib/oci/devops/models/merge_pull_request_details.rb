...
module OCI
  ...
  class Devops::Models::MergePullRequestDetails
    ACTION_TYPE_ENUM = [
      ACTION_TYPE_EXECUTE = 'EXECUTE'.freeze,
      ACTION_TYPE_VALIDATE = 'VALIDATE'.freeze
    ].freeze

    # **[Required]** the type of action for this merge.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::ExecuteMergePullRequestDetails' if type == 'EXECUTE'
      return 'OCI::Devops::Models::ValidateMergePullRequestDetails' if type == 'VALIDATE'
