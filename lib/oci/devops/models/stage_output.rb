...
module OCI
  ...
  class Devops::Models::StageOutput
    OUTPUT_TYPE_ENUM = [
      OUTPUT_TYPE_ARTIFACT = 'ARTIFACT'.freeze,
      OUTPUT_TYPE_TEST_REPORT = 'TEST_REPORT'.freeze
    ].freeze

    # **[Required]** Type of output generated.
    # @return [String]
    attr_reader :output_type

    # **[Required]** Name of stage step at which this output is generated.
    # @return [String]
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::Devops::Models::TestReportOutput' if type == 'TEST_REPORT'
      return 'OCI::Devops::Models::GenericArtifacts' if type == 'ARTIFACT'
