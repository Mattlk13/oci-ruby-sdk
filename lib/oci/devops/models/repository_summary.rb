...
module OCI
  ...
  class Devops::Models::RepositorySummary
    ...
    # @return [String]
    attr_accessor :parent_repository_id
    ...
    # @option attributes [String] :parent_repository_id The value to assign to the {#parent_repository_id} property
    ...
    def initialize(attributes = {})
      ...
      self.parent_repository_id = attributes[:'parentRepositoryId'] if attributes[:'parentRepositoryId']

      raise 'You cannot provide both :parentRepositoryId and :parent_repository_id' if attributes.key?(:'parentRepositoryId') && attributes.key?(:'parent_repository_id')

      self.parent_repository_id = attributes[:'parent_repository_id'] if attributes[:'parent_repository_id']
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        parent_repository_id == other.parent_repository_id &&
    ...
    def hash
      [id, name, compartment_id, project_id, parent_repository_id, namespace, project_name, description, default_branch, repository_type, ssh_url, http_url, mirror_repository_config, time_created, time_updated, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
