...
module OCI
  ...
  class Devops::Models::CreatePullRequestDetails
    # **[Required]** Pull Request title
    # @return [String]
    attr_accessor :display_name

    # **[Required]** The source branch of the pull request.
    # @return [String]
    ...
    # @return [Array<OCI::Devops::Models::CreateReviewerDetails>]
    ...
    def self.swagger_types
      {
        ...
        'description': :'String',
        'reviewers': :'Array<OCI::Devops::Models::CreateReviewerDetails>',
    ...
    # @option attributes [Array<OCI::Devops::Models::CreateReviewerDetails>] :reviewers The value to assign to the {#reviewers} property
    ...
    def hash
      [display_name, source_branch, destination_branch, repository_id, source_repository_id, description, reviewers, freeform_tags, defined_tags].hash
    end
