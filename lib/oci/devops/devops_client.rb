...
module OCI
  ...
  class Devops::DevopsClient
    ...
    # @param [OCI::Devops::Models::CreateOrUpdateGitRefDetails] create_or_update_git_ref_details The information to create a reference with the type specified in the query.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    ...
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/create_or_update_git_ref.rb.html) to see an example of how to use create_or_update_git_ref API.
    def create_or_update_git_ref(repository_id, create_or_update_git_ref_details, opts = {})
      logger.debug 'Calling operation DevopsClient#create_or_update_git_ref.' if logger

      raise "Missing the required parameter 'repository_id' when calling create_or_update_git_ref." if repository_id.nil?
      raise "Missing the required parameter 'create_or_update_git_ref_details' when calling create_or_update_git_ref." if create_or_update_git_ref_details.nil?
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)

      path = '/repositories/{repositoryId}/actions/createOrUpdateGitRef'.sub('{repositoryId}', repository_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#create_or_update_git_ref') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [String] repository_id Unique repository identifier.
    # @param [OCI::Devops::Models::CreateOrUpdateProtectedBranchDetails] create_or_update_protected_branch_details Details for a protected branch
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or server error without risk of executing that same action again. Retry tokens expire after 24 hours, but can be invalidated earlier due to conflicting operations. For example, if a resource has been deleted and purged from the system, then a retry of the original creation request might be rejected.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::ProtectedBranch ProtectedBranch}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/create_or_update_protected_branch.rb.html) to see an example of how to use create_or_update_protected_branch API.
    def create_or_update_protected_branch(repository_id, create_or_update_protected_branch_details, opts = {})
      logger.debug 'Calling operation DevopsClient#create_or_update_protected_branch.' if logger

      raise "Missing the required parameter 'repository_id' when calling create_or_update_protected_branch." if repository_id.nil?
      raise "Missing the required parameter 'create_or_update_protected_branch_details' when calling create_or_update_protected_branch." if create_or_update_protected_branch_details.nil?
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)

      path = '/repositories/{repositoryId}/actions/createOrUpdateProtectedBranch'.sub('{repositoryId}', repository_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(create_or_update_protected_branch_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#create_or_update_protected_branch') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::ProtectedBranch'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @param [OCI::Devops::Models::CreatePullRequestDetails] create_pull_request_details Details for the new PullRequest.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or server error without risk of executing that same action again. Retry tokens expire after 24 hours, but can be invalidated earlier due to conflicting operations. For example, if a resource has been deleted and purged from the system, then a retry of the original creation request might be rejected.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequest PullRequest}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/create_pull_request.rb.html) to see an example of how to use create_pull_request API.
    def create_pull_request(create_pull_request_details, opts = {})
      logger.debug 'Calling operation DevopsClient#create_pull_request.' if logger

      raise "Missing the required parameter 'create_pull_request_details' when calling create_pull_request." if create_pull_request_details.nil?
      ...
      post_body = @api_client.object_to_http_body(create_pull_request_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#create_pull_request') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::PullRequest'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @param [String] pull_request_id unique PullRequest identifier
    # @param [String] content_disposition The Content-Disposition response-header field has been proposed as a means for the origin server to suggest a default filename if the user requests that the content is saved to a file.
    # @param [String, IO] create_pull_request_attachment_body Uploads the content of the attachment.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or server error without risk of executing that same action again. Retry tokens expire after 24 hours, but can be invalidated earlier due to conflicting operations. For example, if a resource has been deleted and purged from the system, then a retry of the original creation request might be rejected.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestAttachment PullRequestAttachment}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/create_pull_request_attachment.rb.html) to see an example of how to use create_pull_request_attachment API.
    def create_pull_request_attachment(pull_request_id, content_disposition, create_pull_request_attachment_body, opts = {})
      logger.debug 'Calling operation DevopsClient#create_pull_request_attachment.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling create_pull_request_attachment." if pull_request_id.nil?
      raise "Missing the required parameter 'content_disposition' when calling create_pull_request_attachment." if content_disposition.nil?
      raise "Missing the required parameter 'create_pull_request_attachment_body' when calling create_pull_request_attachment." if create_pull_request_attachment_body.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)

      path = '/pullRequests/{pullRequestId}/attachments'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(create_pull_request_attachment_body)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#create_pull_request_attachment') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::PullRequestAttachment'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #
    # @param [String] pull_request_id unique PullRequest identifier
    # @param [OCI::Devops::Models::CreatePullRequestCommentDetails] create_pull_request_comment_details Details for the new PullRequest comment.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or server error without risk of executing that same action again. Retry tokens expire after 24 hours, but can be invalidated earlier due to conflicting operations. For example, if a resource has been deleted and purged from the system, then a retry of the original creation request might be rejected.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestComment PullRequestComment}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/create_pull_request_comment.rb.html) to see an example of how to use create_pull_request_comment API.
    def create_pull_request_comment(pull_request_id, create_pull_request_comment_details, opts = {})
      logger.debug 'Calling operation DevopsClient#create_pull_request_comment.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling create_pull_request_comment." if pull_request_id.nil?
      raise "Missing the required parameter 'create_pull_request_comment_details' when calling create_pull_request_comment." if create_pull_request_comment_details.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)

      path = '/pullRequests/{pullRequestId}/comments'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(create_pull_request_comment_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#create_pull_request_comment') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::PullRequestComment'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequest PullRequest}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/decline_pull_request.rb.html) to see an example of how to use decline_pull_request API.
    def decline_pull_request(pull_request_id, opts = {})
      logger.debug 'Calling operation DevopsClient#decline_pull_request.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling decline_pull_request." if pull_request_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)

      path = '/pullRequests/{pullRequestId}/actions/decline'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#decline_pull_request') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [String] repository_id Unique repository identifier.
    # @param [OCI::Devops::Models::DeleteGitRefDetails] delete_git_ref_details The information to delete a reference.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/delete_git_ref.rb.html) to see an example of how to use delete_git_ref API.
    def delete_git_ref(repository_id, delete_git_ref_details, opts = {})
      logger.debug 'Calling operation DevopsClient#delete_git_ref.' if logger

      raise "Missing the required parameter 'repository_id' when calling delete_git_ref." if repository_id.nil?
      raise "Missing the required parameter 'delete_git_ref_details' when calling delete_git_ref." if delete_git_ref_details.nil?
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)

      path = '/repositories/{repositoryId}/actions/deleteGitRef'.sub('{repositoryId}', repository_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(delete_git_ref_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#delete_git_ref') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/delete_project_repository_settings.rb.html) to see an example of how to use delete_project_repository_settings API.
    def delete_project_repository_settings(project_id, opts = {})
      logger.debug 'Calling operation DevopsClient#delete_project_repository_settings.' if logger

      raise "Missing the required parameter 'project_id' when calling delete_project_repository_settings." if project_id.nil?
      raise "Parameter value for 'project_id' must not be blank" if OCI::Internal::Util.blank_string?(project_id)

      path = '/projects/{projectId}/repositorySettings'.sub('{projectId}', project_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#delete_project_repository_settings') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
    ...
    # @param [String] repository_id Unique repository identifier.
    # @param [OCI::Devops::Models::DeleteProtectedBranchDetails] delete_protected_branch_details Details for a protected branch
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/delete_protected_branch.rb.html) to see an example of how to use delete_protected_branch API.
    def delete_protected_branch(repository_id, delete_protected_branch_details, opts = {})
      logger.debug 'Calling operation DevopsClient#delete_protected_branch.' if logger

      raise "Missing the required parameter 'repository_id' when calling delete_protected_branch." if repository_id.nil?
      raise "Missing the required parameter 'delete_protected_branch_details' when calling delete_protected_branch." if delete_protected_branch_details.nil?
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)

      path = '/repositories/{repositoryId}/actions/deleteProtectedBranch'.sub('{repositoryId}', repository_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#delete_protected_branch') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/delete_pull_request.rb.html) to see an example of how to use delete_pull_request API.
    def delete_pull_request(pull_request_id, opts = {})
      logger.debug 'Calling operation DevopsClient#delete_pull_request.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling delete_pull_request." if pull_request_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)

      path = '/pullRequests/{pullRequestId}'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#delete_pull_request') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
    ...
    # @param [String] pull_request_id unique PullRequest identifier
    # @param [String] attachment_id unique PullRequest attachment identifier
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/delete_pull_request_attachment.rb.html) to see an example of how to use delete_pull_request_attachment API.
    def delete_pull_request_attachment(pull_request_id, attachment_id, opts = {})
      logger.debug 'Calling operation DevopsClient#delete_pull_request_attachment.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling delete_pull_request_attachment." if pull_request_id.nil?
      raise "Missing the required parameter 'attachment_id' when calling delete_pull_request_attachment." if attachment_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      raise "Parameter value for 'attachment_id' must not be blank" if OCI::Internal::Util.blank_string?(attachment_id)

      path = '/pullRequests/{pullRequestId}/attachments/{attachmentId}'.sub('{pullRequestId}', pull_request_id.to_s).sub('{attachmentId}', attachment_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#delete_pull_request_attachment') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
    ...
    # @param [String] pull_request_id unique PullRequest identifier
    # @param [String] comment_id unique PullRequest Comment identifier
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/delete_pull_request_comment.rb.html) to see an example of how to use delete_pull_request_comment API.
    def delete_pull_request_comment(pull_request_id, comment_id, opts = {})
      logger.debug 'Calling operation DevopsClient#delete_pull_request_comment.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling delete_pull_request_comment." if pull_request_id.nil?
      raise "Missing the required parameter 'comment_id' when calling delete_pull_request_comment." if comment_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      raise "Parameter value for 'comment_id' must not be blank" if OCI::Internal::Util.blank_string?(comment_id)

      path = '/pullRequests/{pullRequestId}/comments/{commentId}'.sub('{pullRequestId}', pull_request_id.to_s).sub('{commentId}', comment_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#delete_pull_request_comment') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/delete_repository_settings.rb.html) to see an example of how to use delete_repository_settings API.
    def delete_repository_settings(repository_id, opts = {})
      logger.debug 'Calling operation DevopsClient#delete_repository_settings.' if logger

      raise "Missing the required parameter 'repository_id' when calling delete_repository_settings." if repository_id.nil?
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)

      path = '/repositories/{repositoryId}/repositorySettings'.sub('{repositoryId}', repository_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#delete_repository_settings') do
        @api_client.call_api(
          :DELETE,
          path,
          endpoint,
    ...
    # @option opts [String] :target_repository_id The target repository identifier
    ...
    def get_commit_diff(repository_id, target_version, opts = {})
      ...
      query_params[:targetRepositoryId] = opts[:target_repository_id] if opts[:target_repository_id]
    ...
    # @param [String] project_id Unique project identifier.
    # @param [String] principal_id Unique principal identifier.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::ProjectNotificationPreference ProjectNotificationPreference}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/get_project_notification_preference.rb.html) to see an example of how to use get_project_notification_preference API.
    def get_project_notification_preference(project_id, principal_id, opts = {})
      logger.debug 'Calling operation DevopsClient#get_project_notification_preference.' if logger

      raise "Missing the required parameter 'project_id' when calling get_project_notification_preference." if project_id.nil?
      raise "Missing the required parameter 'principal_id' when calling get_project_notification_preference." if principal_id.nil?
      raise "Parameter value for 'project_id' must not be blank" if OCI::Internal::Util.blank_string?(project_id)
      raise "Parameter value for 'principal_id' must not be blank" if OCI::Internal::Util.blank_string?(principal_id)

      path = '/projects/{projectId}/principals/{principalId}/pullRequestNotificationPreference'.sub('{projectId}', project_id.to_s).sub('{principalId}', principal_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#get_project_notification_preference') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::ProjectNotificationPreference'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::ProjectRepositorySettings ProjectRepositorySettings}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/get_project_repository_settings.rb.html) to see an example of how to use get_project_repository_settings API.
    def get_project_repository_settings(project_id, opts = {})
      logger.debug 'Calling operation DevopsClient#get_project_repository_settings.' if logger

      raise "Missing the required parameter 'project_id' when calling get_project_repository_settings." if project_id.nil?
      raise "Parameter value for 'project_id' must not be blank" if OCI::Internal::Util.blank_string?(project_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#get_project_repository_settings') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::ProjectRepositorySettings'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequest PullRequest}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/get_pull_request.rb.html) to see an example of how to use get_pull_request API.
    def get_pull_request(pull_request_id, opts = {})
      logger.debug 'Calling operation DevopsClient#get_pull_request.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling get_pull_request." if pull_request_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#get_pull_request') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestAttachment PullRequestAttachment}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/get_pull_request_attachment.rb.html) to see an example of how to use get_pull_request_attachment API.
    def get_pull_request_attachment(pull_request_id, attachment_id, opts = {})
      logger.debug 'Calling operation DevopsClient#get_pull_request_attachment.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling get_pull_request_attachment." if pull_request_id.nil?
      raise "Missing the required parameter 'attachment_id' when calling get_pull_request_attachment." if attachment_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      raise "Parameter value for 'attachment_id' must not be blank" if OCI::Internal::Util.blank_string?(attachment_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#get_pull_request_attachment') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @option [Block] &block Streaming http body to the block
    # @return [Response] A Response object with data of type String if response_target and block are not given, otherwise with nil data
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/get_pull_request_attachment_content.rb.html) to see an example of how to use get_pull_request_attachment_content API.
    def get_pull_request_attachment_content(pull_request_id, attachment_id, opts = {}, &block)
      logger.debug 'Calling operation DevopsClient#get_pull_request_attachment_content.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling get_pull_request_attachment_content." if pull_request_id.nil?
      raise "Missing the required parameter 'attachment_id' when calling get_pull_request_attachment_content." if attachment_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      raise "Parameter value for 'attachment_id' must not be blank" if OCI::Internal::Util.blank_string?(attachment_id)

      path = '/pullRequests/{pullRequestId}/attachments/{attachmentId}/content'.sub('{pullRequestId}', pull_request_id.to_s).sub('{attachmentId}', attachment_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#get_pull_request_attachment_content') do
        if !block.nil?
          @api_client.call_api(
            :GET,
            path,
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestChangeSummaryMetrics PullRequestChangeSummaryMetrics}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/get_pull_request_change_summary_metrics.rb.html) to see an example of how to use get_pull_request_change_summary_metrics API.
    def get_pull_request_change_summary_metrics(pull_request_id, opts = {})
      logger.debug 'Calling operation DevopsClient#get_pull_request_change_summary_metrics.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling get_pull_request_change_summary_metrics." if pull_request_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)

      path = '/pullRequests/{pullRequestId}/changeSummaryMetrics'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#get_pull_request_change_summary_metrics') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::PullRequestChangeSummaryMetrics'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestComment PullRequestComment}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/get_pull_request_comment.rb.html) to see an example of how to use get_pull_request_comment API.
    def get_pull_request_comment(pull_request_id, comment_id, opts = {})
      logger.debug 'Calling operation DevopsClient#get_pull_request_comment.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling get_pull_request_comment." if pull_request_id.nil?
      raise "Missing the required parameter 'comment_id' when calling get_pull_request_comment." if comment_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      raise "Parameter value for 'comment_id' must not be blank" if OCI::Internal::Util.blank_string?(comment_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#get_pull_request_comment') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestNotificationPreference PullRequestNotificationPreference}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/get_pull_request_notification_preference.rb.html) to see an example of how to use get_pull_request_notification_preference API.
    def get_pull_request_notification_preference(pull_request_id, principal_id, opts = {})
      logger.debug 'Calling operation DevopsClient#get_pull_request_notification_preference.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling get_pull_request_notification_preference." if pull_request_id.nil?
      raise "Missing the required parameter 'principal_id' when calling get_pull_request_notification_preference." if principal_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      raise "Parameter value for 'principal_id' must not be blank" if OCI::Internal::Util.blank_string?(principal_id)

      path = '/pullRequests/{pullRequestId}/principals/{principalId}/pullRequestNotificationPreference'.sub('{pullRequestId}', pull_request_id.to_s).sub('{principalId}', principal_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#get_pull_request_notification_preference') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::PullRequestNotificationPreference'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::RepositoryNotificationPreference RepositoryNotificationPreference}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/get_repository_notification_preference.rb.html) to see an example of how to use get_repository_notification_preference API.
    def get_repository_notification_preference(repository_id, principal_id, opts = {})
      logger.debug 'Calling operation DevopsClient#get_repository_notification_preference.' if logger

      raise "Missing the required parameter 'repository_id' when calling get_repository_notification_preference." if repository_id.nil?
      raise "Missing the required parameter 'principal_id' when calling get_repository_notification_preference." if principal_id.nil?
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)
      raise "Parameter value for 'principal_id' must not be blank" if OCI::Internal::Util.blank_string?(principal_id)

      path = '/repositories/{repositoryId}/principals/{principalId}/pullRequestNotificationPreference'.sub('{repositoryId}', repository_id.to_s).sub('{principalId}', principal_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#get_repository_notification_preference') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::RepositoryNotificationPreference'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::RepositorySettings RepositorySettings}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/get_repository_settings.rb.html) to see an example of how to use get_repository_settings API.
    def get_repository_settings(repository_id, opts = {})
      logger.debug 'Calling operation DevopsClient#get_repository_settings.' if logger

      raise "Missing the required parameter 'repository_id' when calling get_repository_settings." if repository_id.nil?
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#get_repository_settings') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::RepositorySettings'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestComment PullRequestComment}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/like_pull_request_comment.rb.html) to see an example of how to use like_pull_request_comment API.
    def like_pull_request_comment(pull_request_id, comment_id, opts = {})
      logger.debug 'Calling operation DevopsClient#like_pull_request_comment.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling like_pull_request_comment." if pull_request_id.nil?
      raise "Missing the required parameter 'comment_id' when calling like_pull_request_comment." if comment_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      raise "Parameter value for 'comment_id' must not be blank" if OCI::Internal::Util.blank_string?(comment_id)

      path = '/pullRequests/{pullRequestId}/comments/{commentId}/actions/like'.sub('{pullRequestId}', pull_request_id.to_s).sub('{commentId}', comment_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#like_pull_request_comment') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :pipeline_id Unique build pipeline identifier.
    # @option opts [String] :build_run_id Unique build run identifier.
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::BuildRunSnapshotCollection BuildRunSnapshotCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/list_build_run_snapshots.rb.html) to see an example of how to use list_build_run_snapshots API.
    def list_build_run_snapshots(pull_request_id, opts = {})
      logger.debug 'Calling operation DevopsClient#list_build_run_snapshots.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling list_build_run_snapshots." if pull_request_id.nil?
      ...
      path = '/pullRequests/{pullRequestId}/buildRunSnapshots'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      query_params[:buildRunId] = opts[:build_run_id] if opts[:build_run_id]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#list_build_run_snapshots') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::BuildRunSnapshotCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @param [String] repository_id Unique repository identifier.
    # @param [String] branch_name_query_param Specifies the branch for which the fork sync status will be checked.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::ForkSyncStatusCollection ForkSyncStatusCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/list_fork_sync_statuses.rb.html) to see an example of how to use list_fork_sync_statuses API.
    def list_fork_sync_statuses(repository_id, branch_name_query_param, opts = {})
      logger.debug 'Calling operation DevopsClient#list_fork_sync_statuses.' if logger

      raise "Missing the required parameter 'repository_id' when calling list_fork_sync_statuses." if repository_id.nil?
      raise "Missing the required parameter 'branch_name_query_param' when calling list_fork_sync_statuses." if branch_name_query_param.nil?
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)

      path = '/repositories/{repositoryId}/forkSyncStatuses'.sub('{repositoryId}', repository_id.to_s)
      operation_signing_strategy = :standard

      # rubocop:disable Style/NegatedIf
      # Query Params
      query_params = {}
      query_params[:branchNameQueryParam] = branch_name_query_param
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#list_fork_sync_statuses') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::ForkSyncStatusCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :sort_order The sort order to use. Use either ascending or descending. (default to ASC)
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @option opts [String] :sort_by The field to sort by. Only one sort by value is supported for this parameter. Default order for author name is ascending.
    #    (default to authorName)
    #   Allowed values are: authorName
    # @return [Response] A Response object with data of type {OCI::Devops::Models::CommitAnalyticsAuthorCollection CommitAnalyticsAuthorCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/list_project_commit_analytics_authors.rb.html) to see an example of how to use list_project_commit_analytics_authors API.
    def list_project_commit_analytics_authors(project_id, opts = {})
      logger.debug 'Calling operation DevopsClient#list_project_commit_analytics_authors.' if logger

      raise "Missing the required parameter 'project_id' when calling list_project_commit_analytics_authors." if project_id.nil?

      if opts[:sort_order] && !OCI::Devops::Models::SORT_ORDER_ENUM.include?(opts[:sort_order])
        raise 'Invalid value for "sort_order", must be one of the values in OCI::Devops::Models::SORT_ORDER_ENUM.'
      end

      if opts[:sort_by] && !%w[authorName].include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of authorName.'
      end
      raise "Parameter value for 'project_id' must not be blank" if OCI::Internal::Util.blank_string?(project_id)

      path = '/projects/{projectId}/commitAnalyticsAuthors'.sub('{projectId}', project_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#list_project_commit_analytics_authors') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::CommitAnalyticsAuthorCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :name A filter to return only resources that match the given branch name.
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page The page token representing the page at which to start retrieving results. This is usually retrieved from a previous list call.
    # @option opts [String] :sort_order The sort order to use. Use either ascending or descending. (default to ASC)
    # @option opts [String] :sort_by The field to sort by. Only one sort order may be provided. Default order for branch name is ascending. If no value is specified branch name is default.
    #    (default to branchName)
    #   Allowed values are: branchName
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::ProtectedBranchCollection ProtectedBranchCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/list_protected_branches.rb.html) to see an example of how to use list_protected_branches API.
    def list_protected_branches(repository_id, opts = {})
      logger.debug 'Calling operation DevopsClient#list_protected_branches.' if logger

      raise "Missing the required parameter 'repository_id' when calling list_protected_branches." if repository_id.nil?

      if opts[:sort_order] && !OCI::Devops::Models::SORT_ORDER_ENUM.include?(opts[:sort_order])
        raise 'Invalid value for "sort_order", must be one of the values in OCI::Devops::Models::SORT_ORDER_ENUM.'
      end

      if opts[:sort_by] && !%w[branchName].include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of branchName.'
      end
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)

      path = '/repositories/{repositoryId}/protectedBranches'.sub('{repositoryId}', repository_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#list_protected_branches') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::ProtectedBranchCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :activity_type An optional filter to list activities based on activity type. If no value is specified, all activity types will returned.
    #
    ...
    # @option opts [String] :page The page token representing the page at which to start retrieving results. This is usually retrieved from a previous list call.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestActivityCollection PullRequestActivityCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/list_pull_request_activities.rb.html) to see an example of how to use list_pull_request_activities API.
    def list_pull_request_activities(pull_request_id, opts = {})
      logger.debug 'Calling operation DevopsClient#list_pull_request_activities.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling list_pull_request_activities." if pull_request_id.nil?

      if opts[:activity_type] && !%w[LIFECYCLE APPROVAL COMMIT REVIEWER COMMENT].include?(opts[:activity_type])
        raise 'Invalid value for "activity_type", must be one of LIFECYCLE, APPROVAL, COMMIT, REVIEWER, COMMENT.'
      end
      ...
      path = '/pullRequests/{pullRequestId}/activities'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard

      # rubocop:disable Style/NegatedIf
      # Query Params
      query_params = {}
      query_params[:activityType] = opts[:activity_type] if opts[:activity_type]
      query_params[:sortOrder] = opts[:sort_order] if opts[:sort_order]
      query_params[:limit] = opts[:limit] if opts[:limit]
      query_params[:page] = opts[:page] if opts[:page]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#list_pull_request_activities') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::PullRequestActivityCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :compartment_id The OCID of the compartment in which to list resources.
    # @option opts [String] :sort_order The sort order to use. Use either ascending or descending. (default to ASC)
    # @option opts [String] :sort_by The field to sort by. Only one sort order may be provided. Default order is ascending. If no value is specified timeCreated is default.
    #    (default to timeCreated)
    #   Allowed values are: fileName, timeCreated, createdBy
    # @option opts [String] :file_name A filter to return only resources that match the entire file name given.
    # @option opts [Integer] :limit The maximum number of items to return. (default to 100)
    # @option opts [String] :page The page token representing the page at which to start retrieving results. This is usually retrieved from a previous list call.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestAttachmentCollection PullRequestAttachmentCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/list_pull_request_attachments.rb.html) to see an example of how to use list_pull_request_attachments API.
    def list_pull_request_attachments(pull_request_id, opts = {})
      logger.debug 'Calling operation DevopsClient#list_pull_request_attachments.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling list_pull_request_attachments." if pull_request_id.nil?

      if opts[:sort_order] && !OCI::Devops::Models::SORT_ORDER_ENUM.include?(opts[:sort_order])
        raise 'Invalid value for "sort_order", must be one of the values in OCI::Devops::Models::SORT_ORDER_ENUM.'
      end

      if opts[:sort_by] && !%w[fileName timeCreated createdBy].include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of fileName, timeCreated, createdBy.'
      end
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#list_pull_request_attachments') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::PullRequestAttachmentCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :sort_order The sort order to use. Use either ascending or descending. (default to ASC)
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestAuthorCollection PullRequestAuthorCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/list_pull_request_authors.rb.html) to see an example of how to use list_pull_request_authors API.
    def list_pull_request_authors(repository_id, opts = {})
      logger.debug 'Calling operation DevopsClient#list_pull_request_authors.' if logger

      raise "Missing the required parameter 'repository_id' when calling list_pull_request_authors." if repository_id.nil?
      ...
      path = '/repositories/{repositoryId}/pullRequestAuthors'.sub('{repositoryId}', repository_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#list_pull_request_authors') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::PullRequestAuthorCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :comment_id unique PullRequest Comment identifier
    # @option opts [String] :commit_id PullRequest Comment Commit SHA
    # @option opts [String] :file_path PullRequest File Path
    # @option opts [Integer] :limit The maximum number of items to return. (default to 100)
    # @option opts [String] :page The page token representing the page at which to start retrieving results. This is usually retrieved from a previous list call.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestCommentCollection PullRequestCommentCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/list_pull_request_comments.rb.html) to see an example of how to use list_pull_request_comments API.
    def list_pull_request_comments(pull_request_id, opts = {})
      logger.debug 'Calling operation DevopsClient#list_pull_request_comments.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling list_pull_request_comments." if pull_request_id.nil?

      if opts[:sort_order] && !OCI::Devops::Models::SORT_ORDER_ENUM.include?(opts[:sort_order])
        raise 'Invalid value for "sort_order", must be one of the values in OCI::Devops::Models::SORT_ORDER_ENUM.'
      end

      if opts[:sort_by] && !%w[timeCreated createdBy].include?(opts[:sort_by])
        raise 'Invalid value for "sort_by", must be one of timeCreated, createdBy.'
      end
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      ...
      query_params[:sortOrder] = opts[:sort_order] if opts[:sort_order]
      query_params[:sortBy] = opts[:sort_by] if opts[:sort_by]
      query_params[:commentId] = opts[:comment_id] if opts[:comment_id]
      query_params[:commitId] = opts[:commit_id] if opts[:commit_id]
      query_params[:filePath] = opts[:file_path] if opts[:file_path]
      query_params[:limit] = opts[:limit] if opts[:limit]
      query_params[:page] = opts[:page] if opts[:page]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#list_pull_request_comments') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::PullRequestCommentCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::RepositoryCommitCollection RepositoryCommitCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/list_pull_request_commits.rb.html) to see an example of how to use list_pull_request_commits API.
    def list_pull_request_commits(pull_request_id, opts = {})
      logger.debug 'Calling operation DevopsClient#list_pull_request_commits.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling list_pull_request_commits." if pull_request_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)

      path = '/pullRequests/{pullRequestId}/commits'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#list_pull_request_commits') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @option opts [String] :page The page token representing the page at which to start retrieving results. This is usually retrieved from a previous list call.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestFileChangeCollection PullRequestFileChangeCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/list_pull_request_file_changes.rb.html) to see an example of how to use list_pull_request_file_changes API.
    def list_pull_request_file_changes(pull_request_id, opts = {})
      logger.debug 'Calling operation DevopsClient#list_pull_request_file_changes.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling list_pull_request_file_changes." if pull_request_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)

      path = '/pullRequests/{pullRequestId}/fileChanges'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#list_pull_request_file_changes') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::PullRequestFileChangeCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :compartment_id The OCID of the compartment in which to list resources.
    # @option opts [String] :lifecycle_state A filter to return only pull requests that match the given lifecycle state.
    # @option opts [String] :lifecycle_details A filter to return only pull requests that match the given lifecycle state.
    # @option opts [String] :repository_id The OCID of the repository in which to list resources.
    # @option opts [String] :display_name A filter to return only resources that match the entire display name given.
    # @option opts [String] :id Unique identifier or OCID for listing a single resource by ID.
    # @option opts [String] :created_by PullRequest Created By
    # @option opts [String] :destination_branch PullRequest Target Branch
    # @option opts [String] :source_branch PullRequest Source Branch.
    # @option opts [String] :reviewer_principal_id PullRequest Reviewer Id
    # @option opts [String] :source_repository_id PullRequest Source Repository Id
    # @option opts [Integer] :limit The maximum number of items to return. (default to 100)
    # @option opts [String] :page The page token representing the page at which to start retrieving results. This is usually retrieved from a previous list call.
    # @option opts [String] :sort_order The sort order to use. Use either ascending or descending. (default to ASC)
    # @option opts [String] :sort_by The field to sort by. Only one sort order may be provided. Default order for time created is descending. Default order for display name is ascending. If no value is specified, then the default time created value is considered. (default to timeCreated)
    #   Allowed values are: timeCreated, displayName
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestCollection PullRequestCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/list_pull_requests.rb.html) to see an example of how to use list_pull_requests API.
    def list_pull_requests(opts = {})
      logger.debug 'Calling operation DevopsClient#list_pull_requests.' if logger


      if opts[:lifecycle_state] && !OCI::Devops::Models::PullRequest::LIFECYCLE_STATE_ENUM.include?(opts[:lifecycle_state])
        raise 'Invalid value for "lifecycle_state", must be one of the values in OCI::Devops::Models::PullRequest::LIFECYCLE_STATE_ENUM.'
      end

      if opts[:lifecycle_details] && !OCI::Devops::Models::PullRequest::LIFECYCLE_DETAILS_ENUM.include?(opts[:lifecycle_details])
        raise 'Invalid value for "lifecycle_details", must be one of the values in OCI::Devops::Models::PullRequest::LIFECYCLE_DETAILS_ENUM.'
      end
      ...
      query_params[:destinationBranch] = opts[:destination_branch] if opts[:destination_branch]
      query_params[:sourceBranch] = opts[:source_branch] if opts[:source_branch]
      query_params[:reviewerPrincipalId] = opts[:reviewer_principal_id] if opts[:reviewer_principal_id]
      query_params[:sourceRepositoryId] = opts[:source_repository_id] if opts[:source_repository_id]
      query_params[:limit] = opts[:limit] if opts[:limit]
      query_params[:page] = opts[:page] if opts[:page]
      query_params[:sortOrder] = opts[:sort_order] if opts[:sort_order]
      query_params[:sortBy] = opts[:sort_by] if opts[:sort_by]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#list_pull_requests') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::PullRequestCollection'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    #   Allowed values are: authorName
    # @return [Response] A Response object with data of type {OCI::Devops::Models::CommitAnalyticsAuthorCollection CommitAnalyticsAuthorCollection}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/list_repository_commit_analytics_authors.rb.html) to see an example of how to use list_repository_commit_analytics_authors API.
    def list_repository_commit_analytics_authors(repository_id, opts = {})
      logger.debug 'Calling operation DevopsClient#list_repository_commit_analytics_authors.' if logger

      raise "Missing the required parameter 'repository_id' when calling list_repository_commit_analytics_authors." if repository_id.nil?
      ...
      path = '/repositories/{repositoryId}/commitAnalyticsAuthors'.sub('{repositoryId}', repository_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#list_repository_commit_analytics_authors') do
        @api_client.call_api(
          :GET,
          path,
          endpoint,
    ...
    # @param [String] pull_request_id unique PullRequest identifier
    # @param [OCI::Devops::Models::MergePullRequestDetails] merge_pull_request_details The details about the merge operation.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    ...
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or server error without risk of executing that same action again. Retry tokens expire after 24 hours, but can be invalidated earlier due to conflicting operations. For example, if a resource has been deleted and purged from the system, then a retry of the original creation request might be rejected.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequest PullRequest}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/merge_pull_request.rb.html) to see an example of how to use merge_pull_request API.
    def merge_pull_request(pull_request_id, merge_pull_request_details, opts = {})
      logger.debug 'Calling operation DevopsClient#merge_pull_request.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling merge_pull_request." if pull_request_id.nil?
      raise "Missing the required parameter 'merge_pull_request_details' when calling merge_pull_request." if merge_pull_request_details.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)

      path = '/pullRequests/{pullRequestId}/actions/merge'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(merge_pull_request_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#merge_pull_request') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [String] pull_request_id unique PullRequest identifier
    # @param [OCI::Devops::Models::PatchPullRequestDetails] patch_pull_request_details Details for the PullRequest update.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequest PullRequest}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/patch_pull_request.rb.html) to see an example of how to use patch_pull_request API.
    def patch_pull_request(pull_request_id, patch_pull_request_details, opts = {})
      logger.debug 'Calling operation DevopsClient#patch_pull_request.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling patch_pull_request." if pull_request_id.nil?
      raise "Missing the required parameter 'patch_pull_request_details' when calling patch_pull_request." if patch_pull_request_details.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      ...
      post_body = @api_client.object_to_http_body(patch_pull_request_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#patch_pull_request') do
        @api_client.call_api(
          :PATCH,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequest PullRequest}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/reopen_pull_request.rb.html) to see an example of how to use reopen_pull_request API.
    def reopen_pull_request(pull_request_id, opts = {})
      logger.debug 'Calling operation DevopsClient#reopen_pull_request.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling reopen_pull_request." if pull_request_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)

      path = '/pullRequests/{pullRequestId}/actions/reopen'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#reopen_pull_request') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [String] pull_request_id unique PullRequest identifier
    # @param [OCI::Devops::Models::ReviewPullRequestDetails] review_pull_request_details Details to submit a review.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequest PullRequest}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/review_pull_request.rb.html) to see an example of how to use review_pull_request API.
    def review_pull_request(pull_request_id, review_pull_request_details, opts = {})
      logger.debug 'Calling operation DevopsClient#review_pull_request.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling review_pull_request." if pull_request_id.nil?
      raise "Missing the required parameter 'review_pull_request_details' when calling review_pull_request." if review_pull_request_details.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)

      path = '/pullRequests/{pullRequestId}/actions/review'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(review_pull_request_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#review_pull_request') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @param [String] project_id Unique project identifier.
    # @param [OCI::Devops::Models::SummarizeProjectRepositoryAnalyticsDetails] summarize_project_repository_analytics_details Details to fetch the repository analytics.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    # @option opts [String] :page The page token representing the page at which to start retrieving results. This is usually retrieved from a previous list call.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::RepositoryMetricAggregation RepositoryMetricAggregation}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/summarize_project_repository_analytics.rb.html) to see an example of how to use summarize_project_repository_analytics API.
    def summarize_project_repository_analytics(project_id, summarize_project_repository_analytics_details, opts = {})
      logger.debug 'Calling operation DevopsClient#summarize_project_repository_analytics.' if logger

      raise "Missing the required parameter 'project_id' when calling summarize_project_repository_analytics." if project_id.nil?
      raise "Missing the required parameter 'summarize_project_repository_analytics_details' when calling summarize_project_repository_analytics." if summarize_project_repository_analytics_details.nil?
      raise "Parameter value for 'project_id' must not be blank" if OCI::Internal::Util.blank_string?(project_id)

      path = '/projects/{projectId}/repositoryAnalytics'.sub('{projectId}', project_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(summarize_project_repository_analytics_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#summarize_project_repository_analytics') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
          ...
          operation_signing_strategy: operation_signing_strategy,
          body: post_body,
          return_type: 'OCI::Devops::Models::RepositoryMetricAggregation'
        )
      end
      # rubocop:enable Metrics/BlockLength
    end
    ...
    # @param [String] repository_id Unique repository identifier.
    # @param [OCI::Devops::Models::SummarizeRepositoryAnalyticsDetails] summarize_repository_analytics_details Details to fetch the repository analytics.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [Integer] :limit The maximum number of items to return. (default to 10)
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::RepositoryMetricAggregation RepositoryMetricAggregation}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/summarize_repository_analytics.rb.html) to see an example of how to use summarize_repository_analytics API.
    def summarize_repository_analytics(repository_id, summarize_repository_analytics_details, opts = {})
      logger.debug 'Calling operation DevopsClient#summarize_repository_analytics.' if logger

      raise "Missing the required parameter 'repository_id' when calling summarize_repository_analytics." if repository_id.nil?
      raise "Missing the required parameter 'summarize_repository_analytics_details' when calling summarize_repository_analytics." if summarize_repository_analytics_details.nil?
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)

      path = '/repository/{repositoryId}/repositoryAnalytics'.sub('{repositoryId}', repository_id.to_s)
      operation_signing_strategy = :standard
      ...
      post_body = @api_client.object_to_http_body(summarize_repository_analytics_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#summarize_repository_analytics') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    #
    # @param [String] repository_id Unique repository identifier.
    # @param [String] sync_merge_strategy If fetch and merge is passed in, the changes from the upstream will be fetched and merged into the destination branch.
    ...
    # @param [OCI::Devops::Models::SyncRepositoryDetails] sync_repository_details Details required for syncing a repository with its upstream.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    ...
    # @option opts [String] :opc_retry_token A token that uniquely identifies a request so it can be retried in case of a timeout or server error without risk of executing that same action again. Retry tokens expire after 24 hours, but can be invalidated earlier due to conflicting operations. For example, if a resource has been deleted and purged from the system, then a retry of the original creation request might be rejected.
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/sync_repository.rb.html) to see an example of how to use sync_repository API.
    def sync_repository(repository_id, sync_merge_strategy, sync_repository_details, opts = {})
      logger.debug 'Calling operation DevopsClient#sync_repository.' if logger

      raise "Missing the required parameter 'repository_id' when calling sync_repository." if repository_id.nil?
      raise "Missing the required parameter 'sync_merge_strategy' when calling sync_repository." if sync_merge_strategy.nil?
      unless %w[FETCH_AND_MERGE DISCARD].include?(sync_merge_strategy)
        raise "Invalid value for 'sync_merge_strategy', must be one of FETCH_AND_MERGE, DISCARD."
      end
      raise "Missing the required parameter 'sync_repository_details' when calling sync_repository." if sync_repository_details.nil?
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)

      path = '/repositories/{repositoryId}/actions/sync'.sub('{repositoryId}', repository_id.to_s)
      operation_signing_strategy = :standard

      # rubocop:disable Style/NegatedIf
      # Query Params
      query_params = {}
      query_params[:syncMergeStrategy] = sync_merge_strategy
      ...
      post_body = @api_client.object_to_http_body(sync_repository_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#sync_repository') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestComment PullRequestComment}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/unlike_pull_request_comment.rb.html) to see an example of how to use unlike_pull_request_comment API.
    def unlike_pull_request_comment(pull_request_id, comment_id, opts = {})
      logger.debug 'Calling operation DevopsClient#unlike_pull_request_comment.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling unlike_pull_request_comment." if pull_request_id.nil?
      raise "Missing the required parameter 'comment_id' when calling unlike_pull_request_comment." if comment_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      raise "Parameter value for 'comment_id' must not be blank" if OCI::Internal::Util.blank_string?(comment_id)

      path = '/pullRequests/{pullRequestId}/comments/{commentId}/actions/unlike'.sub('{pullRequestId}', pull_request_id.to_s).sub('{commentId}', comment_id.to_s)
      operation_signing_strategy = :standard
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#unlike_pull_request_comment') do
        @api_client.call_api(
          :POST,
          path,
          endpoint,
    ...
    # @option [Block] &block Streaming http body to the block
    # @return [Response] A Response object with data of type String if response_target and block are not given, otherwise with nil data
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/unsubscribe_pull_request.rb.html) to see an example of how to use unsubscribe_pull_request API.
    def unsubscribe_pull_request(pull_request_id, token, opts = {}, &block)
      logger.debug 'Calling operation DevopsClient#unsubscribe_pull_request.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling unsubscribe_pull_request." if pull_request_id.nil?
      raise "Missing the required parameter 'token' when calling unsubscribe_pull_request." if token.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)

      path = '/pullRequests/{pullRequestId}/actions/unsubscribe'.sub('{pullRequestId}', pull_request_id.to_s)
      operation_signing_strategy = :standard
      ...
      header_params = {}
      header_params[:accept] = opts[:accept] if opts[:accept]
      header_params[:accept] ||= 'text/html'
      header_params[:'accept-encoding'] = opts[:accept_encoding] if opts[:accept_encoding]
      header_params[:'content-type'] = 'application/json'
      header_params[:'if-match'] = opts[:if_match] if opts[:if_match]
      header_params[:'opc-request-id'] = opts[:opc_request_id] if opts[:opc_request_id]
      ...
      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#unsubscribe_pull_request') do
        if !block.nil?
          @api_client.call_api(
            :GET,
            path,
    ...
    # @param [OCI::Devops::Models::UpdateProjectNotificationPreferenceDetails] update_project_notification_preference_details The information to be updated.
    # @param [String] project_id Unique project identifier.
    # @param [String] principal_id Unique principal identifier.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::ProjectNotificationPreference ProjectNotificationPreference}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/update_project_notification_preference.rb.html) to see an example of how to use update_project_notification_preference API.
    def update_project_notification_preference(update_project_notification_preference_details, project_id, principal_id, opts = {})
      logger.debug 'Calling operation DevopsClient#update_project_notification_preference.' if logger

      raise "Missing the required parameter 'update_project_notification_preference_details' when calling update_project_notification_preference." if update_project_notification_preference_details.nil?
      raise "Missing the required parameter 'project_id' when calling update_project_notification_preference." if project_id.nil?
      raise "Missing the required parameter 'principal_id' when calling update_project_notification_preference." if principal_id.nil?
      raise "Parameter value for 'project_id' must not be blank" if OCI::Internal::Util.blank_string?(project_id)
      raise "Parameter value for 'principal_id' must not be blank" if OCI::Internal::Util.blank_string?(principal_id)
      ...
      post_body = @api_client.object_to_http_body(update_project_notification_preference_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#update_project_notification_preference') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
    ...
    # @param [String] project_id Unique project identifier.
    # @param [OCI::Devops::Models::UpdateProjectRepositorySettingsDetails] update_project_repository_settings_details Details to update the repository settings for a project.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::ProjectRepositorySettings ProjectRepositorySettings}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/update_project_repository_settings.rb.html) to see an example of how to use update_project_repository_settings API.
    def update_project_repository_settings(project_id, update_project_repository_settings_details, opts = {})
      logger.debug 'Calling operation DevopsClient#update_project_repository_settings.' if logger

      raise "Missing the required parameter 'project_id' when calling update_project_repository_settings." if project_id.nil?
      raise "Missing the required parameter 'update_project_repository_settings_details' when calling update_project_repository_settings." if update_project_repository_settings_details.nil?
      raise "Parameter value for 'project_id' must not be blank" if OCI::Internal::Util.blank_string?(project_id)
      ...
      post_body = @api_client.object_to_http_body(update_project_repository_settings_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#update_project_repository_settings') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
    ...
    # @param [String] pull_request_id unique PullRequest identifier
    # @param [OCI::Devops::Models::UpdatePullRequestDetails] update_pull_request_details The information to be updated.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequest PullRequest}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/update_pull_request.rb.html) to see an example of how to use update_pull_request API.
    def update_pull_request(pull_request_id, update_pull_request_details, opts = {})
      logger.debug 'Calling operation DevopsClient#update_pull_request.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling update_pull_request." if pull_request_id.nil?
      raise "Missing the required parameter 'update_pull_request_details' when calling update_pull_request." if update_pull_request_details.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      ...
      post_body = @api_client.object_to_http_body(update_pull_request_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#update_pull_request') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
    ...
    # @param [String] pull_request_id unique PullRequest identifier
    # @param [String] comment_id unique PullRequest Comment identifier
    # @param [OCI::Devops::Models::UpdatePullRequestCommentDetails] update_pull_request_comment_details The new comment content to be updated.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestComment PullRequestComment}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/update_pull_request_comment.rb.html) to see an example of how to use update_pull_request_comment API.
    def update_pull_request_comment(pull_request_id, comment_id, update_pull_request_comment_details, opts = {})
      logger.debug 'Calling operation DevopsClient#update_pull_request_comment.' if logger

      raise "Missing the required parameter 'pull_request_id' when calling update_pull_request_comment." if pull_request_id.nil?
      raise "Missing the required parameter 'comment_id' when calling update_pull_request_comment." if comment_id.nil?
      raise "Missing the required parameter 'update_pull_request_comment_details' when calling update_pull_request_comment." if update_pull_request_comment_details.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      raise "Parameter value for 'comment_id' must not be blank" if OCI::Internal::Util.blank_string?(comment_id)
      ...
      post_body = @api_client.object_to_http_body(update_pull_request_comment_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#update_pull_request_comment') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
    ...
    # @param [OCI::Devops::Models::UpdatePullRequestNotificationPreferenceDetails] update_pull_request_notification_preference_details The information to be updated.
    # @param [String] pull_request_id unique PullRequest identifier
    # @param [String] principal_id Unique principal identifier.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::PullRequestNotificationPreference PullRequestNotificationPreference}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/update_pull_request_notification_preference.rb.html) to see an example of how to use update_pull_request_notification_preference API.
    def update_pull_request_notification_preference(update_pull_request_notification_preference_details, pull_request_id, principal_id, opts = {})
      logger.debug 'Calling operation DevopsClient#update_pull_request_notification_preference.' if logger

      raise "Missing the required parameter 'update_pull_request_notification_preference_details' when calling update_pull_request_notification_preference." if update_pull_request_notification_preference_details.nil?
      raise "Missing the required parameter 'pull_request_id' when calling update_pull_request_notification_preference." if pull_request_id.nil?
      raise "Missing the required parameter 'principal_id' when calling update_pull_request_notification_preference." if principal_id.nil?
      raise "Parameter value for 'pull_request_id' must not be blank" if OCI::Internal::Util.blank_string?(pull_request_id)
      raise "Parameter value for 'principal_id' must not be blank" if OCI::Internal::Util.blank_string?(principal_id)
      ...
      post_body = @api_client.object_to_http_body(update_pull_request_notification_preference_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#update_pull_request_notification_preference') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
    ...
    # @param [OCI::Devops::Models::UpdateRepositoryNotificationPreferenceDetails] update_repository_notification_preference_details The information to be updated.
    # @param [String] repository_id Unique repository identifier.
    # @param [String] principal_id Unique principal identifier.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::RepositoryNotificationPreference RepositoryNotificationPreference}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/update_repository_notification_preference.rb.html) to see an example of how to use update_repository_notification_preference API.
    def update_repository_notification_preference(update_repository_notification_preference_details, repository_id, principal_id, opts = {})
      logger.debug 'Calling operation DevopsClient#update_repository_notification_preference.' if logger

      raise "Missing the required parameter 'update_repository_notification_preference_details' when calling update_repository_notification_preference." if update_repository_notification_preference_details.nil?
      raise "Missing the required parameter 'repository_id' when calling update_repository_notification_preference." if repository_id.nil?
      raise "Missing the required parameter 'principal_id' when calling update_repository_notification_preference." if principal_id.nil?
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)
      raise "Parameter value for 'principal_id' must not be blank" if OCI::Internal::Util.blank_string?(principal_id)
      ...
      post_body = @api_client.object_to_http_body(update_repository_notification_preference_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#update_repository_notification_preference') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
    ...
    # @param [String] repository_id Unique repository identifier.
    # @param [OCI::Devops::Models::UpdateRepositorySettingsDetails] update_repository_settings_details Details to update settings for a repository.
    # @param [Hash] opts the optional parameters
    # @option opts [OCI::Retry::RetryConfig] :retry_config The retry configuration to apply to this operation. If no key is provided then the service-level
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :if_match For optimistic concurrency control. In the PUT or DELETE call for a resource, set the `if-match` parameter to the value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only if the etag you provide matches the resource's current etag value.
    ...
    # @option opts [String] :opc_request_id Unique Oracle-assigned identifier for the request.  If you need to contact Oracle about a particular request, provide the request ID.
    # @return [Response] A Response object with data of type {OCI::Devops::Models::RepositorySettings RepositorySettings}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/devops/update_repository_settings.rb.html) to see an example of how to use update_repository_settings API.
    def update_repository_settings(repository_id, update_repository_settings_details, opts = {})
      logger.debug 'Calling operation DevopsClient#update_repository_settings.' if logger

      raise "Missing the required parameter 'repository_id' when calling update_repository_settings." if repository_id.nil?
      raise "Missing the required parameter 'update_repository_settings_details' when calling update_repository_settings." if update_repository_settings_details.nil?
      raise "Parameter value for 'repository_id' must not be blank" if OCI::Internal::Util.blank_string?(repository_id)
      ...
      post_body = @api_client.object_to_http_body(update_repository_settings_details)

      # rubocop:disable Metrics/BlockLength
      OCI::Retry.make_retrying_call(applicable_retry_config(opts), call_name: 'DevopsClient#update_repository_settings') do
        @api_client.call_api(
          :PUT,
          path,
          endpoint,
